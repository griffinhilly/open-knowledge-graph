...
- **Path engine primitives** (for the upcoming BUILD cluster): `computePathToGoal`/`computeLearningPath` in fluency.js (BFS + topo-sort); index learning-path section lazy-loads `js/graph.js` (3.4MB) only when goals exist.
