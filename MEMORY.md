...
- **15,290 topics / 19 domains / 261 courses / 6 stages**; radial shows 18 domains (practical-life-skills excluded). Live at `openknowledgegraph.com`; `SITE_BASE_URL` in `tools/parse_topic.py` is the single source of truth for all URLs.
