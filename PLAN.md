...
- **Premortem condition still open: node-click/panel-open analytics beacon must exist BEFORE the ~Jul-15 parent-push traffic** (CF Web Analytics is page-level only; without an event, Level 1's effect is unmeasurable). Not blocking the Level-1 push.
