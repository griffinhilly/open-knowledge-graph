...
- question: "For a spherically symmetric charge distribution where density varies primarily with radius (e.g., ρ = ρ₀r), Gauss's law cannot be used to find the field because the distribution is non-uniform."
  type: true-false
  answer: false
