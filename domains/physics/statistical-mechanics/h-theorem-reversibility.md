...
- question: "The H-theorem demonstrates that entropy is expected to generally increase because the fundamental microscopic laws of physics are time-asymmetric — they distinguish past from future at the molecular level."
  type: true-false
  answer: false
