...
- question: "When electrons are fired one at a time through a double slit, each electron should pass through only one slit — it is a localized particle — and the interference pattern arises from many such particles arriving at random positions."
  type: true-false
  answer: false
