...
- Radio waves, X-rays, and visible light are completely different phenomena. (They are all the same type of wave — electromagnetic — just at different frequencies and wavelengths.)
- Visible light is the most important part of the spectrum. (Visible light is just the range human eyes can detect. Radio, infrared, and other bands carry just as much energy and information.)
- Higher frequency always means more dangerous. (While gamma rays and X-rays can damage cells, the danger depends on intensity and exposure time too. A powerful radio transmitter can also be harmful.)
- Electromagnetic waves need a medium to travel. (Unlike sound, EM waves travel through empty space. This is how sunlight and radio signals reach us from space.)
...
- question: "Which type of electromagnetic wave has the longest wavelength?"
  ...
  answer: 2
  explanation: "Radio waves have the longest wavelengths (from about 1 millimeter to hundreds of kilometers) and the lowest frequencies in the electromagnetic spectrum."

- question: "All electromagnetic waves travel at the same speed in a vacuum."
  type: true-false
  answer: true
  explanation: "In a vacuum, all EM waves — from radio to gamma — travel at the speed of light, approximately 3 × 10⁸ m/s."

- question: "What determines whether an electromagnetic wave is classified as visible light, infrared, or ultraviolet?"
  type: short-answer
  answer: "Its frequency (or equivalently, its wavelength). Visible light has frequencies between about 4.3 × 10¹⁴ Hz and 7.5 × 10¹⁴ Hz. Lower frequencies are infrared; higher frequencies are ultraviolet."
  explanation: "The electromagnetic spectrum is organized by frequency and wavelength. Each named region (radio, microwave, infrared, visible, ultraviolet, X-ray, gamma) corresponds to a specific range of frequencies."
```
