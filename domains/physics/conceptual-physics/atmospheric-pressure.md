...
- We are not affected by atmospheric pressure. (Atmospheric pressure pushes on us with about 10 N per square centimeter, but we do not feel it because the pressure inside our body pushes back equally.)
- Suction cups work by creating a vacuum that "sucks" onto surfaces. (Suction cups work because atmospheric pressure pushes them onto the surface after the air is squeezed out from underneath.)
- Air is weightless. (Air has mass and weight. A room-sized volume of air can weigh hundreds of pounds, and its total weight above us creates atmospheric pressure.)
- Atmospheric pressure is the same everywhere on Earth. (It varies with altitude, temperature, and weather. Mountain tops have lower pressure than sea level, and weather systems cause pressure to fluctuate.)

## Questions

```yaml
- question: "Why does atmospheric pressure decrease as you go higher in altitude?"
  type: multiple-choice
  options: ["Because gravity is weaker", "Because there is less air above you pushing down", "Because the air moves faster at high altitude", "Because the temperature is lower"]
  answer: 1
  explanation: "Atmospheric pressure is caused by the weight of the air column above you. At higher altitude, there is less air above, so the weight — and therefore the pressure — is lower."

- question: "A suction cup sticks to a wall because atmospheric pressure pushes it against the surface."
  type: true-false
  answer: true
  explanation: "When the air is pushed out from beneath the suction cup, the atmospheric pressure on the outside is greater than the near-zero pressure underneath, pushing the cup firmly against the surface."

- question: "If atmospheric pressure at sea level is about 101,325 Pa, why are we not crushed by it?"
  type: short-answer
  answer: "Because the fluids and gases inside our bodies push outward with the same pressure. The internal and external pressures balance, so we feel no net force."
  explanation: "Our bodies evolved at this pressure. Internal pressure matches external atmospheric pressure, so the forces on our tissues cancel out. We only notice pressure changes, like when our ears pop during altitude changes."
```
