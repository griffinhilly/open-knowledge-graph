...
title: "Electric Charge: Positive and Negative"
domain: physics
...
- Rubbing objects creates electric charge. (Rubbing transfers electrons from one object to the other. The total charge in the system stays the same — charge is conserved.)
- Protons move to create static charge. (In solids, protons are locked in the nucleus. It is almost always electrons that move.)
- Positive charge means an object has extra protons. (Usually it means the object has lost electrons, leaving more protons than electrons.)
- Charged objects only attract other charged objects. (A charged object can attract neutral objects through a process called polarization — it induces a slight charge separation in the neutral object.)

## Questions

```yaml
- question: "Why does a balloon stick to a wall after rubbing it on your hair?"
  type: multiple-choice
  options: ["The balloon becomes magnetic", "Rubbing creates new charges on the balloon", "The balloon gains extra electrons and attracts the neutral wall by polarizing it", "The balloon becomes lighter from rubbing"]
  answer: 2
  explanation: "Rubbing transfers electrons from your hair to the balloon, making it negatively charged. The charged balloon then polarizes the neutral wall (pushes wall electrons slightly away), creating a local positive region on the wall surface that attracts the balloon."

- question: "An object that has lost electrons has a net positive charge."
  type: true-false
  answer: true
  explanation: "When electrons are removed, the object has more protons than electrons, giving it a net positive charge."

- question: "What happens when two negatively charged objects are brought close together?"
  type: short-answer
  answer: "They repel each other, because like charges repel."
  explanation: "The fundamental rule of electric charge: like charges (positive-positive or negative-negative) repel, while opposite charges (positive-negative) attract."
```
