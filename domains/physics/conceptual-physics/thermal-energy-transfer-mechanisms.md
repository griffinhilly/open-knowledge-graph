...
title: "Thermal Energy Transfer: Conduction, Convection, and Radiation"
domain: physics
...
- Heat only travels by one method at a time. (In most real situations, two or three methods operate simultaneously. A campfire heats you by radiation and heats the air by convection.)
- Convection works in solids. (Convection requires fluid flow — it only occurs in liquids and gases, not in solids.)
- Radiation requires a medium to travel through. (Radiation travels through empty space — this is how the Sun's energy reaches Earth across the vacuum of space.)
- Cold flows into warm objects. (Heat always flows from hot to cold. A cold drink does not "send cold" into your hand — your hand sends heat into the drink.)
...
- question: "How does the Sun's heat reach Earth?"
  ...
  options: ["Conduction through space", "Convection through space", "Radiation through space", "All three equally"]
  answer: 2
  explanation: "Space is a vacuum with no matter for conduction or convection. The Sun's energy reaches Earth as electromagnetic radiation, which does not need a medium."

- question: "When you stir hot soup with a metal spoon, heat reaches your hand through conduction."
  type: true-false
  answer: true
  explanation: "Heat transfers through the metal spoon by conduction — vibrating particles in the hot end pass energy to neighboring particles, working up the spoon to your hand."

- question: "Why does warm air rise above a heater?"
  type: short-answer
  answer: "When air is heated, it expands and becomes less dense than the cooler air above it. The lighter warm air rises while denser cool air sinks, creating a convection current."
  explanation: "Convection occurs because heating a fluid decreases its density. The buoyant, less-dense warm air rises, and cooler, denser air flows in to replace it, forming a circulation pattern."
```
