...
- All materials heat up at the same rate when given the same energy. (Different materials have different specific heats — metal heats up faster than water for the same energy input.)
- A high specific heat means the material is hot. (High specific heat means the material resists temperature change — it takes more energy to heat up, not that it is already hot.)
- Temperature and heat are the same thing. (Temperature measures the average kinetic energy of particles; heat is the total energy transferred. A substance with high specific heat absorbs lots of heat with little temperature change.)
- Specific heat is a measure of temperature. (It is a material property that describes how resistant a substance is to temperature change per unit mass per unit energy input.)

## Questions

```yaml
- question: "Why does sand on a beach get much hotter than the ocean water on a sunny day?"
  type: multiple-choice
  options: ["The sun shines more on the sand", "Sand absorbs more sunlight than water", "Sand has a lower specific heat than water, so it heats up more with the same energy", "Water reflects all sunlight"]
  answer: 2
  explanation: "Sand has a much lower specific heat than water. The same solar energy causes a much larger temperature increase in sand than in water."

- question: "Water has a higher specific heat capacity than most common materials."
  type: true-false
  answer: true
  explanation: "Water's specific heat (4,186 J/kg·°C) is among the highest of common substances, which is why it is effective as a coolant and why it moderates climate near coastlines."

- question: "What does it mean to say that copper has a specific heat of 385 J/kg·°C?"
  type: short-answer
  answer: "It takes 385 joules of energy to raise the temperature of 1 kg of copper by 1°C."
  explanation: "Specific heat tells you exactly how much energy per kilogram is needed per degree of temperature change. Copper's low value means it heats up quickly compared to water."
```
