...
title: "Newton's First Law: Objects Resist Change"
domain: physics
...
- Objects need a constant force to keep moving at constant speed. (In the absence of friction and air resistance, an object in motion would keep moving forever with no force at all.)
- If an object is not moving, no forces act on it. (Stationary objects often have multiple forces acting on them that are perfectly balanced, like a book sitting on a table.)
- Newton's First Law only applies to objects at rest. (It applies equally to objects in motion — they will continue at constant velocity unless a net force changes that.)
- A ball thrown through the air keeps moving because the thrower's force stays with it. (Once released, the only forces on the ball are gravity and air resistance. The throw gave it velocity, not a lasting force.)

## Questions

```yaml
- question: "A spacecraft in deep space, far from any stars or planets, fires its engines and then shuts them off. What happens next?"
  type: multiple-choice
  options: ["It gradually slows down and stops", "It keeps moving at the same speed in the same direction", "It speeds up because there is no gravity", "It drifts to a stop because the fuel ran out"]
  answer: 1
  explanation: "Newton's First Law states that without an unbalanced force, an object in motion continues at constant velocity. In deep space there is virtually no friction or air resistance to slow it down."

- question: "A force is required to keep an object moving at constant speed on a perfectly frictionless surface."
  type: true-false
  answer: false
  explanation: "Newton's First Law says that without unbalanced forces (like friction), an object already in motion continues at constant speed. No force is needed to maintain that motion."

- question: "Why does a passenger lurch forward when a bus suddenly stops?"
  type: short-answer
  answer: "The passenger's body has inertia and continues moving forward at the bus's original speed, even though the bus has stopped."
  explanation: "Newton's First Law says a moving object stays in motion unless acted on by an unbalanced force. The bus stopped due to brakes, but the passenger's body resists that change in motion."
```
