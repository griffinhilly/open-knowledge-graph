...
- Only springs store elastic potential energy. (Rubber bands, trampolines, bows, bungee cords, and even compressed air store elastic potential energy.)
- The energy is created when the spring is released. (The energy was stored during the stretching or compressing. Releasing it just converts stored energy into motion.)
- Stretching a spring twice as far stores twice as much energy. (Energy stored in a spring depends on the square of the deformation — double the stretch stores four times the energy.)
- A broken or permanently bent spring still has elastic potential energy. (Once permanently deformed, the material has lost its elasticity and the energy has been converted to heat and deformation, not stored for recovery.)

## Questions

```yaml
- question: "A spring is compressed 2 cm and stores 4 J of elastic potential energy. If compressed to 4 cm, approximately how much energy does it store?"
  type: multiple-choice
  options: ["8 J", "16 J", "2 J", "4 J"]
  answer: 1
  explanation: "Elastic PE depends on the square of the compression. Doubling the compression from 2 cm to 4 cm means 2² = 4 times the energy: 4 × 4 = 16 J."

- question: "A stretched rubber band stores elastic potential energy."
  type: true-false
  answer: true
  explanation: "When you stretch a rubber band from its natural shape, you do work on it, and that energy is stored as elastic potential energy until the band is released."

- question: "Where does the energy come from when a compressed spring launches a ball?"
  type: short-answer
  answer: "The energy comes from the elastic potential energy stored in the compressed spring. Work was done to compress the spring, and that stored energy converts to the ball's kinetic energy when released."
  explanation: "Energy is conserved. The work you did compressing the spring was stored as elastic PE, which converts to the ball's KE upon release."
```
