...
- Action and reaction forces cancel each other out. (They act on different objects, so they cannot cancel. You push on the wall; the wall pushes on you.)
- The action force happens first, and then the reaction follows. (Both forces occur at exactly the same time. There is no delay between action and reaction.)
- A bigger or stronger object exerts more force than a smaller one. (A bug hitting a truck windshield experiences the same magnitude of force as the truck exerts on the bug — they differ in acceleration because of their different masses.)
- Reaction forces only exist when objects are touching. (Gravity is also a force pair: Earth pulls you down, and you pull Earth up with equal force.)

## Questions

```yaml
- question: "A swimmer pushes water backward with her hands. What is the reaction force?"
  type: multiple-choice
  options: ["Gravity pulling the swimmer down", "The water pushing the swimmer forward", "The swimmer pushing harder on the next stroke", "Friction from the pool floor"]
  answer: 1
  explanation: "By Newton's Third Law, when the swimmer pushes water backward, the water pushes the swimmer forward with an equal and opposite force."

- question: "When a small car collides with a large truck, the truck exerts more force on the car than the car exerts on the truck."
  type: true-false
  answer: false
  explanation: "Newton's Third Law guarantees that the forces are equal in magnitude and opposite in direction, regardless of the objects' sizes. The car and truck experience the same force, but the car accelerates more because it has less mass."

- question: "When you stand on the ground, you push Earth down with your weight. What is the reaction force?"
  type: short-answer
  answer: "Earth pushes you upward with a force equal to your weight (the normal force)."
  explanation: "By Newton's Third Law, if you exert a downward force on Earth, Earth exerts an equal upward force on you. This is the normal force that keeps you from falling through the ground."
```
