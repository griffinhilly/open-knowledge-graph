...
title: Sound Properties and the Speed of Sound
domain: physics
...
- Sound can travel through space. (Space is a near-vacuum with almost no particles. Sound requires a medium — it cannot propagate where there is nothing to compress and expand.)
- Sound travels at the same speed in all materials. (Sound travels much faster in solids and liquids than in gases because the particles are closer together and transmit vibrations more quickly.)
- Louder sounds travel faster. (Amplitude affects loudness, not speed. A shout and a whisper travel at the same speed in the same medium.)
- Temperature does not affect the speed of sound. (Warmer air molecules move faster and transmit vibrations more quickly, increasing the speed of sound by about 0.6 m/s for each degree Celsius.)
...
- question: "In which medium does sound travel fastest?"
  ...
  answer: 2
  explanation: "Sound travels fastest in solids like steel (~5,960 m/s) because the tightly packed particles transmit vibrations very efficiently. It cannot travel in a vacuum at all."

- question: "Sound can travel through outer space."
  type: true-false
  answer: false
  explanation: "Sound is a mechanical wave that requires a medium (matter) to propagate. Outer space is essentially a vacuum with too few particles to carry sound waves."

- question: "You see lightning and hear the thunder 3 seconds later. Approximately how far away was the lightning strike? (Speed of sound ≈ 340 m/s)"
  type: short-answer
  answer: "About 1,020 meters (roughly 1 km), because distance = speed × time = 340 × 3 = 1,020 m."
  explanation: "Light reaches you almost instantly. The thunder takes 3 seconds at 340 m/s, so the strike was 340 × 3 = 1,020 m away. This is the basis of the 'count the seconds' rule."
```
