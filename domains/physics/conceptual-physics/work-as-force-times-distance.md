...
- Any effort counts as "work" in physics. (You must move an object in the direction of the force. Holding a heavy box while standing still does zero physics work.)
- Carrying a box across a flat room does work on the box. (Your upward support force is perpendicular to the horizontal motion, so it does no work on the box in the physics sense.)
- More force always means more work. (If the object does not move, no work is done regardless of the force applied.)
- Work can only be positive. (Friction does negative work by opposing motion, removing energy from the system.)

## Questions

```yaml
- question: "You push a crate with 40 N of force across 3 meters of floor. How much work do you do?"
  type: multiple-choice
  options: ["13.3 J", "43 J", "120 J", "40 J"]
  answer: 2
  explanation: "Work = Force × Distance = 40 N × 3 m = 120 J."

- question: "Holding a heavy suitcase while standing still counts as doing work in physics."
  type: true-false
  answer: false
  explanation: "Work requires movement in the direction of the force. If the suitcase does not move, no work is done on it, even though your muscles are exerting force."

- question: "Why does friction do negative work on a sliding object?"
  type: short-answer
  answer: "Because friction acts in the opposite direction to the object's motion, removing kinetic energy rather than adding it."
  explanation: "Work is negative when the force opposes the direction of motion. Friction always opposes sliding, so it always does negative work on the moving object."
```
