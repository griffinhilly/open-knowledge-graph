...
- Sound waves are transverse. (Sound waves in air are longitudinal — air molecules vibrate back and forth along the direction the sound travels.)
- Longitudinal waves do not have wavelength or frequency. (They do. The wavelength is the distance between successive compressions or rarefactions.)
- Transverse waves can travel through any medium. (Transverse waves cannot travel through fluids — they require a medium with shear strength, like a solid. Sound in water is longitudinal.)
- The wave type determines its speed. (Speed depends on the medium's properties, not on whether the wave is transverse or longitudinal.)

## Questions

```yaml
- question: "Which type of wave is a sound wave traveling through air?"
  type: multiple-choice
  options: ["Transverse", "Longitudinal", "Both", "Neither"]
  answer: 1
  explanation: "Sound waves in air are longitudinal — air molecules vibrate back and forth parallel to the direction the sound travels, creating compressions and rarefactions."

- question: "In a transverse wave, the particles of the medium move perpendicular to the direction the wave travels."
  type: true-false
  answer: true
  explanation: "This is the defining characteristic of a transverse wave — the medium's displacement is at right angles to the wave's propagation direction."

- question: "What are the regions of high and low density in a longitudinal wave called?"
  type: short-answer
  answer: "The high-density regions are called compressions and the low-density regions are called rarefactions."
  explanation: "In a longitudinal wave, particles bunch together in compressions and spread apart in rarefactions. These alternate along the wave's direction of travel."
```
