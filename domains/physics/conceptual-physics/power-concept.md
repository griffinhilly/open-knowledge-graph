---
id: power-concept
title: "Power: How Fast Work Gets Done"
domain: physics
...
- More power always means more total work. (Power is about how fast work is done. A low-power motor running for a long time can do the same total work as a high-power motor running briefly.)
- Power and force are the same thing. (Force is a push or pull. Power is the rate of doing work, which involves both force and speed.)
- A 100-watt light bulb does 100 joules of work. (It uses 100 joules of energy every second. The total energy used depends on how long it is on.)
- Watts only measure electrical power. (Watts measure any kind of power — mechanical, thermal, electrical, or otherwise.)

## Questions

```yaml
- question: "A crane lifts a load, doing 6,000 J of work in 30 seconds. What is the crane's power output?"
  type: multiple-choice
  options: ["180,000 W", "200 W", "6,030 W", "5,970 W"]
  answer: 1
  explanation: "Power = Work / Time = 6,000 J / 30 s = 200 W."

- question: "If two motors do the same amount of work but one takes half the time, the faster motor has twice the power."
  type: true-false
  answer: true
  explanation: "P = W/t. Same work in half the time means double the power."

- question: "A 60 W light bulb is left on for 5 seconds. How much energy does it use?"
  type: short-answer
  answer: "300 J, because Energy = Power × Time = 60 × 5 = 300 J."
  explanation: "Rearranging P = W/t gives W = P × t. 60 watts × 5 seconds = 300 joules."
```
