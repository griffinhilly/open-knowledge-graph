...
title: "Pressure: Force Divided by Area"
domain: physics
...
- Pressure and force are the same thing. (Pressure depends on both force AND the area over which it acts. The same force over a smaller area produces much higher pressure.)
- A heavier person always exerts more pressure on the floor. (A lighter person in high heels can exert more pressure per square centimeter than a heavier person in wide boots.)
- Pressure only applies to solids pushing on surfaces. (Pressure applies to fluids too — gases and liquids exert pressure in all directions.)
- Increasing the area always increases the pressure. (Increasing the area with the same force decreases the pressure, since P = F/A.)

## Questions

```yaml
- question: "A 600 N person stands on one foot with an area of 0.02 m². What pressure do they exert on the ground?"
  type: multiple-choice
  options: ["12 Pa", "300 Pa", "30,000 Pa", "600 Pa"]
  answer: 2
  explanation: "P = F/A = 600 N / 0.02 m² = 30,000 Pa."

- question: "A sharp knife cuts better than a dull one because it applies the same force over a smaller area, creating higher pressure."
  type: true-false
  answer: true
  explanation: "The sharp blade has a much smaller contact area than the dull blade. Since P = F/A, a smaller area means higher pressure, which makes cutting easier."

- question: "Why do snowshoes keep you from sinking into deep snow?"
  type: short-answer
  answer: "Snowshoes spread your weight over a much larger area, reducing the pressure on the snow. The lower pressure means the snow can support you without collapsing."
  explanation: "P = F/A. Your weight (force) stays the same, but the large area of the snowshoe decreases the pressure enough that the snow's surface can bear it."
```
