...
- Heavier objects always have more momentum. (A bullet has much less mass than a parked car, but the fast-moving bullet has far more momentum than the stationary car, which has zero momentum.)
- Momentum and kinetic energy are the same thing. (Momentum is p = mv, while kinetic energy is KE = ½mv². They are related but different quantities and behave differently in collisions.)
- An object at rest has momentum because it has mass. (Momentum requires both mass AND velocity. If velocity is zero, momentum is zero.)
- Momentum has no direction. (Momentum is a vector. A ball moving left has momentum in the left direction, which is different from the same ball moving right.)

## Questions

```yaml
- question: "Which has more momentum: a 2,000 kg truck moving at 2 m/s or a 0.01 kg bullet moving at 500 m/s?"
  type: multiple-choice
  options: ["The truck (4,000 kg·m/s)", "The bullet (5 kg·m/s)", "They have the same momentum", "Neither has momentum because they are different objects"]
  answer: 0
  explanation: "Truck momentum = 2,000 × 2 = 4,000 kg·m/s. Bullet momentum = 0.01 × 500 = 5 kg·m/s. The truck has far more momentum."

- question: "A moving object's momentum doubles if its velocity doubles."
  type: true-false
  answer: true
  explanation: "Since p = mv, and mass stays the same, doubling v doubles p. Momentum is directly proportional to velocity."

- question: "A 50 kg skater moves at 3 m/s. What is her momentum?"
  type: short-answer
  answer: "150 kg·m/s, because p = mv = 50 × 3 = 150."
  explanation: "Momentum equals mass times velocity. 50 kg × 3 m/s = 150 kg·m/s in the direction she is moving."
```
