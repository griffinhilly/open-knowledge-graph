...
- id: electric-charge-conceptual
  type: hard
- id: magnetic-attraction-and-repulsion
  type: soft
builds-toward:
- electric-field
...
- Electric fields only exist between charged objects. (Every charged object has a field that extends in all directions through all of space, though it weakens with distance.)
- Field lines are real physical things that you can see. (Field lines are a visualization tool that represents the direction and strength of the field. They are not physical objects.)
- The field points from negative to positive. (By convention, electric field lines point in the direction a positive test charge would move: away from positive charges and toward negative charges.)
- Electric fields and magnetic fields are the same thing. (They are different fields with different sources. Electric fields come from charges; magnetic fields come from moving charges or magnets. They are related but not identical.)

## Questions

```yaml
- question: "In which direction do electric field lines point around a single positive charge?"
  type: multiple-choice
  options: ["Toward the charge", "Away from the charge", "In circles around the charge", "They do not have a direction"]
  answer: 1
  explanation: "By convention, electric field lines point in the direction a positive test charge would be pushed. Since like charges repel, a positive test charge would be pushed away from a positive source charge."

- question: "Electric field lines are closer together where the field is stronger."
  type: true-false
  answer: true
  explanation: "The density of field lines represents field strength. Closely spaced lines mean strong field; widely spaced lines mean weak field."

- question: "What does an electric field tell you about a point in space?"
  type: short-answer
  answer: "It tells you the direction and strength of the electric force that would act on a positive test charge placed at that point."
  explanation: "The electric field at a point is defined as the force per unit positive charge: E = F/q. It describes what force a charge would experience if placed there, even if no charge is actually present."
```
