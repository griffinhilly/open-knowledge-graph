...
- The wheel is the only important part. (The wheel and axle work together — neither is useful without the other.)
- Wheels only help because they roll. (The wheel-and-axle as a machine multiplies force or speed, which is a separate benefit from reducing friction.)
- All wheels are round like car wheels. (Doorknobs, steering wheels, and faucet handles are all wheels in the science sense.)
- The bigger the wheel, the less force you always need. (A bigger wheel lets you use less force, but you have to turn it through a larger distance.)

## Questions

```yaml
- question: "Why is a doorknob easier to turn than the thin rod inside the door?"
  type: multiple-choice
  options: ["The doorknob is slippery", "The doorknob is a larger wheel that multiplies your force on the smaller axle", "The doorknob weighs less", "The rod is stuck"]
  answer: 1
  explanation: "The doorknob acts as the wheel. Because it is larger than the rod (axle), a small turning force on the knob becomes a bigger turning force on the rod."

- question: "A wheel and axle is a simple machine."
  type: true-false
  answer: true
  explanation: "A wheel and axle is one of the six classic simple machines. It uses a larger wheel connected to a smaller axle to multiply force or speed."

- question: "Name one example of a wheel and axle that is NOT on a vehicle."
  type: short-answer
  answer: "A doorknob (also acceptable: screwdriver, faucet handle, steering wheel, fishing reel, pencil sharpener)."
  explanation: "Many everyday objects use the wheel-and-axle principle — any time a larger knob or handle turns a thinner rod, that is a wheel and axle."
```
