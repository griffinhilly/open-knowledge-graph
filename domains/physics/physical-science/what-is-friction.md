...
- Friction only slows things down. (Friction also helps things start moving — your shoes grip the floor to let you walk.)
- Smooth surfaces have no friction at all. (Every surface has some friction; truly frictionless surfaces do not exist in everyday life.)
- Friction is always bad. (Without friction you could not walk, hold a pencil, or stop a bicycle.)
- Heavier objects always have more friction just because they are heavy. (Weight increases friction, but the type of surface matters too.)

## Questions

```yaml
- question: "Why does a hockey puck slide farther on ice than on carpet?"
  type: multiple-choice
  options: ["Ice is colder", "Ice has less friction than carpet", "The puck is lighter on ice", "Carpet has more gravity"]
  answer: 1
  explanation: "Ice is a very smooth surface, so there is less friction to slow the puck down compared to rough carpet."

- question: "Friction can produce heat."
  type: true-false
  answer: true
  explanation: "When two surfaces rub together, friction turns some energy into heat. You can feel this by rubbing your hands together quickly."

- question: "Give one example of friction being helpful in everyday life."
  type: short-answer
  answer: "Friction between your shoes and the ground lets you walk without slipping."
  explanation: "Without friction, your feet would slide on the floor and you could not push yourself forward."
```
