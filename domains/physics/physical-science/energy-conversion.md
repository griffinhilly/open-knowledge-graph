...
- Energy conversions are 100% efficient. (Some energy always becomes heat during conversion, even if heat is not the goal.)
- Energy conversion means energy is used up. (The energy changes form but the total amount stays the same.)
- Only machines convert energy. (Your body, plants, and even the Sun convert energy.)
- Each device converts energy in only one step. (Many devices involve chains of conversions — a car converts chemical to heat to kinetic energy.)

## Questions

```yaml
- question: "What energy conversion happens when you turn on a lamp?"
  type: multiple-choice
  options: ["Light to chemical", "Kinetic to sound", "Electrical to light and heat", "Sound to electrical"]
  answer: 2
  explanation: "A lamp converts electrical energy into light energy and heat energy. If you touch a light bulb that has been on, you can feel the heat."

- question: "Your body converts chemical energy from food into kinetic energy when you run."
  type: true-false
  answer: true
  explanation: "The food you eat contains chemical energy. Your body breaks it down and converts that energy into motion (kinetic energy) and heat."

- question: "What form of energy does a solar panel's input start as, and what does it convert to?"
  type: short-answer
  answer: "A solar panel converts light energy from the Sun into electrical energy."
  explanation: "Solar panels absorb sunlight (light energy) and convert it into electrical energy that can power homes and devices."
```
