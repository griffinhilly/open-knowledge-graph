...
- Metal objects are always cold. (Metals are not cold; they just conduct heat away from your warm hand quickly, which makes them feel cold.)
- Heat conduction happens instantly. (It takes time for heat to travel through a material; the speed depends on the material and its thickness.)
- All solids conduct heat equally well. (Metals conduct heat much better than wood, plastic, or rubber.)
- Conduction only works through solids. (Conduction can happen through liquids and gases too, though it is slower because particles are farther apart.)

## Questions

```yaml
- question: "Why does a metal spoon in hot soup get hot faster than a wooden spoon?"
  type: multiple-choice
  options: ["Metal is thinner", "Metal is a better conductor of heat", "Metal attracts more heat", "Wood is colder"]
  answer: 1
  explanation: "Metal conducts heat very well because its particles pass energy along quickly. Wood is a poor heat conductor, so it takes much longer to transfer heat."

- question: "Heat conduction requires two objects to be in direct contact."
  type: true-false
  answer: true
  explanation: "Conduction transfers heat through direct touch. The particles of the hot object bump into particles of the cooler object, passing energy along."

- question: "Why are pot handles often made of wood or plastic instead of metal?"
  type: short-answer
  answer: "Wood and plastic are poor heat conductors (good insulators), so they do not transfer the pot's heat to your hand."
  explanation: "If pot handles were metal, heat from the hot pot would conduct quickly to the handle and burn your hand. Wood and plastic slow down heat transfer, keeping the handle cool."
```
