...
- A ramp reduces the total amount of work you do. (You do the same total work — the ramp just lets you spread it over a longer distance with less force.)
- Steeper ramps are always better because they are shorter. (Steeper ramps require more force, which defeats the purpose of using a ramp.)
- Wedges and inclined planes are completely different machines. (A wedge is made of two inclined planes joined at their bases.)
- Ramps are only useful for wheelchairs. (Ramps are used to load trucks, build pyramids, move furniture, and much more.)
...
- question: "Why is it easier to push a heavy box up a ramp than to lift it straight up?"
  ...
  options: ["The ramp removes gravity", "The ramp spreads the effort over a longer distance so less force is needed", "The box weighs less on a ramp", "The ramp pushes the box up automatically"]
  answer: 1
  explanation: "A ramp lets you use less force by spreading the effort over a longer distance. Gravity still pulls on the box the same amount."

- question: "A wedge is made of two inclined planes joined together."
  type: true-false
  answer: true
  explanation: "A wedge looks like two ramps placed back to back, forming a point. An axe blade is a good example."

- question: "Give one example of a wedge that you might find at home."
  type: short-answer
  answer: "A knife (also acceptable: doorstop, axe, chisel, zipper)."
  explanation: "A knife blade is shaped like a wedge — it uses its thin edge to push food apart when you cut."
```
