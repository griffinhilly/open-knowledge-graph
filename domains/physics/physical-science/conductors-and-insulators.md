...
- All metals are perfect conductors. (All metals conduct, but some are much better than others. Copper and silver are excellent; iron is less so.)
- Insulators block electricity completely. (With enough voltage, even insulators can break down and allow current — that is how lightning passes through air.)
- Water is always a conductor. (Pure water is actually a poor conductor; it is the dissolved minerals and salts that make tap water conduct electricity.)
- Plastic is used on wires because it is cheap. (The main reason is that plastic is an excellent insulator that keeps the electricity safely inside the wire.)

## Questions

```yaml
- question: "Why are electrical wires usually made of copper?"
  type: multiple-choice
  options: ["Copper is shiny", "Copper is a good conductor of electricity", "Copper is the cheapest metal", "Copper is the lightest metal"]
  answer: 1
  explanation: "Copper is an excellent conductor, meaning it allows electric charges to flow through it very easily with little resistance."

- question: "Rubber is a good insulator."
  type: true-false
  answer: true
  explanation: "Rubber does not let electricity flow through it easily, which is why it is used to coat wires and make protective gloves for electricians."

- question: "What is the purpose of the plastic coating around electrical wires?"
  type: short-answer
  answer: "The plastic acts as an insulator to keep electricity from escaping the wire and to prevent shocks."
  explanation: "Plastic is an insulator — it blocks the flow of electricity. The coating keeps the current safely inside the metal wire."
```
