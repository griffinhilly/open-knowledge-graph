...
title: "Mechanical Advantage: Doing More with Less"
domain: physics
...
- Simple machines reduce the total amount of work. (They reduce the force needed but increase the distance, keeping total work roughly the same.)
- A higher mechanical advantage is always better. (Higher mechanical advantage means less force but more distance, which may not always be practical.)
- Mechanical advantage means getting free energy. (Energy is conserved; machines just rearrange how it is applied.)
- Only big complicated machines have mechanical advantage. (Every simple machine — even a doorknob or a bottle opener — has a mechanical advantage.)

## Questions

```yaml
- question: "A lever lets you lift a 20-pound rock by pushing with only 5 pounds of force. What is the mechanical advantage?"
  type: multiple-choice
  options: ["5", "4", "20", "25"]
  answer: 1
  explanation: "Mechanical advantage = output force ÷ input force = 20 ÷ 5 = 4."

- question: "A machine with a mechanical advantage of 2 lets you use half the force but you must push twice as far."
  type: true-false
  answer: true
  explanation: "Machines trade force for distance. With a mechanical advantage of 2, the force is halved, but the distance you push doubles."

- question: "What does mechanical advantage measure?"
  type: short-answer
  answer: "Mechanical advantage measures how much a machine multiplies your input force."
  explanation: "It is the ratio of the output force (what the machine produces) to the input force (what you put in)."
```
