...
- Speed and distance are the same thing. (Speed includes time — it is how far you go in a certain amount of time.)
- A faster object always travels a longer distance. (Only if both objects travel for the same amount of time.)
- If an object is moving, its speed is always constant. (Most objects speed up and slow down as they move.)
- Speed only applies to cars and runners. (Everything that moves has a speed, from a snail to a planet.)

## Questions

```yaml
- question: "A car travels 100 miles in 2 hours. What is its speed?"
  type: multiple-choice
  options: ["200 miles per hour", "100 miles per hour", "50 miles per hour", "2 miles per hour"]
  answer: 2
  explanation: "Speed equals distance divided by time: 100 miles ÷ 2 hours = 50 miles per hour."

- question: "Speed tells you how far something has traveled."
  type: true-false
  answer: false
  explanation: "Speed tells you how far something travels in a given amount of time, not just how far it has gone. Distance alone is not speed."

- question: "What two measurements do you need to calculate speed?"
  type: short-answer
  answer: "You need distance and time."
  explanation: "Speed is calculated by dividing the distance an object travels by the time it takes to travel that distance."
```
