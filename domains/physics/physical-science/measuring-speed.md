...
- You can measure speed just by watching how something moves. (You need actual distance and time measurements to calculate a number.)
- A stopwatch is perfectly accurate every time. (Human reaction time creates small errors when starting and stopping the watch.)
- Speed measurements always give the same answer. (Small differences in timing or distance measurement create variation.)
- You always need fancy equipment to measure speed. (A tape measure and a clock are enough for most everyday speed measurements.)

## Questions

```yaml
- question: "A student measures that a toy car travels 3 meters in 6 seconds. What is the car's speed?"
  type: multiple-choice
  options: ["18 meters per second", "3 meters per second", "0.5 meters per second", "2 meters per second"]
  answer: 2
...
- question: "Why might two students get slightly different speed measurements for the same toy car?"
  type: short-answer
  answer: "They may have started or stopped their stopwatches at slightly different moments, or measured the distance slightly differently."
  explanation: "Small differences in reaction time and measurement precision cause slight variations in results."
```
