...
- Electricity and electrical energy are the same thing. (Electricity is the flow of charges; electrical energy is the energy those moving charges carry.)
- Batteries create energy from nothing. (Batteries store chemical energy and convert it to electrical energy.)
- Electrical energy is used up when you turn on a light. (It is converted into light and heat energy, not used up or destroyed.)
- Electricity is only dangerous at high voltages. (Even moderate amounts of electricity can be dangerous if it flows through your body.)

## Questions

```yaml
- question: "What does a battery convert into electrical energy?"
  type: multiple-choice
  options: ["Light energy", "Sound energy", "Chemical energy", "Kinetic energy"]
  answer: 2
  explanation: "A battery stores chemical energy in its materials. When connected in a circuit, that chemical energy is converted into electrical energy."

- question: "Electrical energy can be converted into heat, light, and sound."
  type: true-false
  answer: true
  explanation: "Electrical energy is very versatile. A toaster turns it into heat, a lamp turns it into light, and a speaker turns it into sound."

- question: "Name two devices in your home that run on electrical energy."
  type: short-answer
  answer: "A refrigerator and a television (also acceptable: lamp, toaster, computer, phone charger, microwave, fan, etc.)."
  explanation: "Almost every device you plug in or that uses a battery runs on electrical energy converted from other forms."
```
