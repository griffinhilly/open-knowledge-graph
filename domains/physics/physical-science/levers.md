...
- A lever creates extra force from nothing. (It does not create force; it trades distance for force — you push farther to lift more.)
- The fulcrum must always be in the middle. (The fulcrum can be at any point along the lever — different positions change how the lever works.)
- Levers are old-fashioned and not used today. (Levers are everywhere: scissors, staple removers, fishing rods, your arm.)
- All levers look like seesaws. (Many levers look nothing like seesaws, such as a broom, tweezers, or a nutcracker.)

## Questions

```yaml
- question: "What is the fixed turning point of a lever called?"
  type: multiple-choice
  options: ["The handle", "The fulcrum", "The effort", "The load"]
  answer: 1
  explanation: "The fulcrum is the point where a lever pivots or turns. The lever rotates around this point."

- question: "A lever lets you lift a heavy object with less force by pushing over a longer distance."
  type: true-false
  answer: true
  explanation: "Levers trade distance for force. When you push your end farther, you do not have to push as hard to lift the load on the other end."

- question: "Name one everyday object that is a lever."
  type: short-answer
  answer: "A seesaw (also acceptable: scissors, bottle opener, claw hammer, wheelbarrow, stapler, etc.)."
  explanation: "Many everyday tools are levers — they have a bar that rotates around a fulcrum to help move a load."
```
