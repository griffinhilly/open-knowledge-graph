...
- Insulators add heat. (Insulators do not create heat; they just slow down its escape. A winter coat keeps you warm by trapping the heat your body already makes.)
- Only thick materials insulate well. (Thin layers of trapped air — like in bubble wrap or double-pane windows — can be excellent insulators.)
- Metal foil is a good insulator. (Metal is actually a good conductor. Foil in thermoses works differently — it reflects radiant heat rather than slowing conduction.)
- Insulators stop all heat transfer. (No insulator stops heat transfer completely; they only slow it down.)

## Questions

```yaml
- question: "How does a winter coat keep you warm?"
  type: multiple-choice
  options: ["It creates heat for your body", "It traps heat your body produces and slows its escape", "It absorbs cold from the air", "It pushes warm air toward you"]
  answer: 1
  explanation: "A coat is a thermal insulator. It slows the flow of heat from your warm body to the cold air outside, keeping you warm."

- question: "Trapped air is a good thermal insulator."
  type: true-false
  answer: true
  explanation: "Air that is trapped in small pockets (like in foam, feathers, or bubble wrap) cannot move around and carry heat away, making it an excellent insulator."

- question: "Why does a thermos keep hot drinks hot and cold drinks cold?"
  type: short-answer
  answer: "A thermos uses insulating materials (like a vacuum and reflective layers) to slow heat transfer in both directions."
  explanation: "The thermos slows heat from escaping (keeping hot things hot) and slows heat from entering (keeping cold things cold). It works both ways because it reduces heat transfer."
```
