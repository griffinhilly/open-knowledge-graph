...
- Only gases expand when heated. (Solids and liquids expand too, just by smaller amounts.)
- Materials grow because new particles are added. (No new particles appear — the same particles just spread farther apart.)
- Thermal expansion is too small to matter. (In large structures like bridges and railroad tracks, even tiny expansion per unit length adds up to significant changes.)
- Water always expands when heated. (Water has an unusual property: it actually expands when cooled below 4 degrees Celsius, which is why ice floats.)

## Questions

```yaml
- question: "Why do sidewalks have small gaps between the concrete sections?"
  type: multiple-choice
  options: ["To save concrete", "To let rain drain through", "To give the concrete room to expand when it gets hot", "To make the sidewalk look nice"]
  answer: 2
  explanation: "The gaps are expansion joints. Without them, concrete would push against itself when it expands in hot weather and could crack or buckle."

- question: "When a solid is heated, its particles move farther apart."
  type: true-false
  answer: true
  explanation: "Heating gives particles more energy, causing them to vibrate faster and push farther apart. This is why the material expands."

- question: "What happens to a metal bridge on a very hot summer day?"
  type: short-answer
  answer: "The metal expands slightly, making the bridge a little longer."
  explanation: "Heat causes the metal atoms to vibrate more and spread apart. Engineers include expansion joints in bridges to give the metal room to grow without causing damage."
```
