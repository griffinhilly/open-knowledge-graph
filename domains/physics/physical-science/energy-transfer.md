...
- Energy can appear from nowhere. (Energy always transfers from one object or place to another.)
- Energy transfer only happens through touching. (Light and heat from the Sun transfer energy across millions of miles of empty space.)
- When energy transfers, none is lost. (In practice, some energy always converts to heat due to friction or resistance.)
- Only big events transfer energy. (Even tiny events like a vibrating atom transfer energy.)

## Questions

```yaml
- question: "When a rolling ball hits a stationary ball and the stationary ball starts moving, what happened?"
  type: multiple-choice
  options: ["New energy was created in the second ball", "Energy transferred from the first ball to the second ball", "The second ball used its own stored energy", "Nothing happened to the energy"]
  answer: 1
  explanation: "The first ball's kinetic energy was transferred to the second ball during the collision, causing it to move."

- question: "Heat energy can transfer from the Sun to the Earth even through empty space."
  type: true-false
  answer: true
  explanation: "The Sun's energy travels through space as radiation (light and heat waves) and does not need a material to travel through."

- question: "Give one everyday example of energy being transferred from one object to another."
  type: short-answer
  answer: "A hot cup of cocoa warming your hands (also acceptable: a bat hitting a ball, the Sun warming the ground, a heater warming a room)."
  explanation: "When you hold a hot mug, heat energy from the mug transfers to your cooler hands, warming them up."
```
