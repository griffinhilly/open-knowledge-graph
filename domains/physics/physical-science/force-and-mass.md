...
- Mass and weight are the same thing. (Mass is how much stuff is in an object; weight is the pull of gravity on that mass.)
- A bigger force always means faster speed. (It means faster change in speed, not a higher constant speed.)
- Heavy objects cannot be moved by small forces. (Even a small force can move a heavy object, just very slowly.)
- An object with more mass needs more force to keep moving at a constant speed on a frictionless surface. (Once moving, no extra force is needed to maintain speed without friction.)

## Questions

```yaml
- question: "You push an empty shopping cart and a full shopping cart with the same force. Which one speeds up more?"
  type: multiple-choice
  options: ["The full cart", "The empty cart", "They speed up equally", "Neither one moves"]
  answer: 1
  explanation: "The empty cart has less mass, so the same force causes a bigger change in its motion. It speeds up more than the heavier full cart."

- question: "An object with more mass is harder to push into motion."
  type: true-false
  answer: true
  explanation: "Mass resists changes in motion. The more mass an object has, the more force you need to get it moving or to stop it."

- question: "What two things determine how much an object's motion changes?"
  type: short-answer
  answer: "The size of the force and the mass of the object."
  explanation: "A larger force causes more change in motion, and a larger mass resists that change more."
```
