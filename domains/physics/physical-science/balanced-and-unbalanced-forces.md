...
- An object with balanced forces has no forces on it. (It has forces, but they cancel each other out.)
- Objects can only move if forces are unbalanced. (An object already moving can keep moving with balanced forces — it just will not speed up or slow down.)
- If something is not moving, no forces are acting on it. (A book on a table has gravity pulling down and the table pushing up — two forces, perfectly balanced.)
- Bigger objects always need bigger forces to move. (True that more force is needed, but even a gentle push can move a large object on a frictionless surface.)

## Questions

```yaml
- question: "Two kids push on opposite sides of a box with the same strength. What happens?"
  type: multiple-choice
  options: ["The box moves to the left", "The box moves to the right", "The box does not move", "The box moves up"]
  answer: 2
  explanation: "When equal forces push in opposite directions, they are balanced and cancel each other out, so the box stays still."

- question: "A book sitting on a table has no forces acting on it."
  type: true-false
  answer: false
  explanation: "The book has two balanced forces: gravity pulling it down and the table pushing it up. They cancel out, so the book stays still."

- question: "What type of forces cause an object to change its motion?"
  type: short-answer
  answer: "Unbalanced forces cause an object to change its motion."
  explanation: "When forces on an object are unbalanced, there is a net force that makes the object speed up, slow down, or change direction."
```
