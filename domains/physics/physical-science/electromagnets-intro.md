...
- Electromagnets are permanent. (They only work when electricity is flowing; turn off the current and the magnetism stops.)
- Any wire carrying electricity is an electromagnet. (A straight wire produces a very weak magnetic field. Coiling the wire concentrates the field and makes a useful electromagnet.)
- Electromagnets are always weaker than permanent magnets. (Very powerful electromagnets can be far stronger than any permanent magnet.)
- The nail creates the magnetism. (The electricity in the wire creates the magnetic field; the iron nail strengthens it by becoming temporarily magnetized.)

## Questions

```yaml
- question: "What happens to an electromagnet when you turn off the electricity?"
  type: multiple-choice
  options: ["It stays magnetic forever", "It loses its magnetism", "It becomes stronger", "It explodes"]
  answer: 1
  explanation: "An electromagnet's magnetism depends on flowing electricity. When the current stops, the magnetic field disappears and the nail is no longer a magnet."

- question: "Wrapping more coils of wire around the nail makes the electromagnet stronger."
  type: true-false
  answer: true
  explanation: "Each coil of wire adds to the magnetic field. More coils means a stronger concentrated field, which makes the electromagnet more powerful."

- question: "Name one advantage an electromagnet has over a permanent magnet."
  type: short-answer
  answer: "An electromagnet can be turned on and off (also acceptable: its strength can be adjusted)."
  explanation: "Unlike a permanent magnet, an electromagnet only works when electricity flows. This lets you control when it is magnetic and how strong it is."
```
