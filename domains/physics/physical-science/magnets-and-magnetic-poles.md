...
title: Magnets and Magnetic Poles
domain: physics
...
- Magnets attract all metals. (Magnets only attract certain metals like iron, nickel, and cobalt. They do not attract aluminum, copper, or gold.)
- A magnet's force is the same all over. (The force is strongest at the two poles and weaker in the middle.)
- If you break a magnet in half, you get a separate north piece and a separate south piece. (Each piece becomes a complete magnet with its own north and south poles.)
- Magnets work because of electricity. (Permanent magnets work because of the arrangement of atoms inside them, not because of an electric current.)

## Questions

```yaml
- question: "What happens when you bring the north pole of one magnet near the south pole of another?"
  type: multiple-choice
  options: ["They push apart", "They pull toward each other", "Nothing happens", "They spin around"]
  answer: 1
...
- question: "What are the two poles of a magnet called?"
  ...
  explanation: "Every magnet has a north pole and a south pole, where the magnetic force is strongest."
```
