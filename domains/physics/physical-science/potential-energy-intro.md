...
- An object at rest has no energy. (It can have lots of potential energy due to its height, stretch, or chemical makeup.)
- Potential energy only comes from height. (Stretched springs, compressed air, batteries, and food all have potential energy.)
- Potential energy just sits there forever. (It can be released at any time and converted into kinetic energy or other forms.)
- Only heavy objects have significant potential energy. (Even a light object high up has meaningful potential energy — a small rock dropped from a tall building can do damage.)

## Questions

```yaml
- question: "Which has more gravitational potential energy: a book on the top shelf or the same book on the bottom shelf?"
  type: multiple-choice
  options: ["The book on the bottom shelf", "They have the same potential energy", "The book on the top shelf", "Neither book has potential energy"]
  answer: 2
  explanation: "The higher an object is, the more gravitational potential energy it has. The book on the top shelf can fall farther, so it has more stored energy."

- question: "A stretched rubber band has potential energy."
  type: true-false
  answer: true
  explanation: "When you stretch a rubber band, you store energy in it. When you let go, that potential energy converts to kinetic energy as the rubber band snaps back."

- question: "What happens to the potential energy of a ball when you drop it?"
  type: short-answer
  answer: "The potential energy converts into kinetic energy as the ball falls."
  explanation: "As the ball drops, it loses height (potential energy decreases) and gains speed (kinetic energy increases). The stored energy transforms into motion energy."
```
