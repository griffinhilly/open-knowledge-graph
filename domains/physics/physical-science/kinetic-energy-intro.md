...
- Only fast things have kinetic energy. (Even a slowly crawling snail has kinetic energy because it is moving.)
- Kinetic energy depends only on speed. (It depends on both speed and mass — a slow truck can have more kinetic energy than a fast baseball.)
- When something stops, its kinetic energy is destroyed. (The kinetic energy is transformed into other forms like heat and sound, not destroyed.)
- Kinetic energy and speed are the same thing. (Speed is how fast something moves; kinetic energy also accounts for mass.)

## Questions

```yaml
- question: "Which has more kinetic energy: a bowling ball rolling at 5 mph or a tennis ball rolling at 5 mph?"
  type: multiple-choice
  options: ["The tennis ball", "They have the same kinetic energy", "The bowling ball", "Neither has kinetic energy"]
  answer: 2
  explanation: "At the same speed, the heavier object has more kinetic energy. The bowling ball has much more mass than the tennis ball."

- question: "A parked car has kinetic energy."
  type: true-false
  answer: false
  explanation: "Kinetic energy is the energy of motion. A parked car is not moving, so it has zero kinetic energy."

- question: "What two factors determine how much kinetic energy a moving object has?"
  type: short-answer
  answer: "Its speed and its mass."
  explanation: "Kinetic energy increases when an object moves faster or when it has more mass. Both factors matter."
```
