...
- Static electricity is different from regular electricity. (Both involve electric charges; static electricity is charges sitting still, while current electricity is charges flowing.)
- Rubbing creates electric charges. (Rubbing does not create charges; it transfers electrons that already exist from one object to another.)
- Static electricity only happens in winter. (It happens year-round, but is more noticeable in dry, cold air because moisture helps charges leak away.)
- The spark you feel is the charge entering your body. (The spark is actually charges jumping between your body and the object to equalize the charge difference.)

## Questions

```yaml
- question: "What moves from one object to another when you rub a balloon on your hair?"
  type: multiple-choice
  options: ["Atoms", "Protons", "Electrons", "Light"]
  answer: 2
  explanation: "When you rub a balloon on your hair, electrons transfer from your hair to the balloon, giving the balloon a negative charge."

- question: "A balloon rubbed on your hair can stick to a wall because of static electricity."
  type: true-false
  answer: true
  explanation: "The charged balloon induces an opposite charge on the wall's surface, creating an attractive force that holds the balloon up."

- question: "Why do you sometimes feel a shock when you touch a metal doorknob after walking across carpet?"
  type: short-answer
  answer: "Electrons built up on your body from the carpet transfer to the doorknob as a spark."
  explanation: "Walking on carpet causes electrons to transfer to your body. When you touch a metal doorknob, the excess charges jump to the metal, which you feel as a small shock."
```
