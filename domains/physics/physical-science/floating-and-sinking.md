...
- Heavy objects always sink and light objects always float. (A heavy log floats because wood is less dense than water. A tiny pebble sinks because rock is denser than water.)
- Floating objects have no gravity pulling them down. (Gravity still pulls on floating objects, but the upward buoyant force balances gravity out.)
- You cannot make a sinking material float. (By changing the shape — like making a bowl — you can trap air and lower the overall density so it floats.)
- All liquids have the same buoyancy. (Denser liquids like salt water provide more buoyant force than fresh water, which is why it is easier to float in the ocean.)

## Questions

```yaml
- question: "Why does a solid ball of clay sink but a clay bowl floats?"
  type: multiple-choice
  options: ["The bowl is lighter", "The bowl shape traps air, lowering the overall density below that of water", "The bowl is made of different clay", "The water pushes the bowl up harder"]
  answer: 1
  explanation: "The bowl has the same mass of clay but takes up more space because of the air inside. This makes the overall density less than water, so it floats."

- question: "An object floats when its density is less than the density of the liquid it is in."
  type: true-false
  answer: true
  explanation: "If the object's density is lower than the liquid's density, the liquid's buoyant force is strong enough to support the object, and it floats."

- question: "Why is it easier to float in the ocean than in a freshwater pool?"
  type: short-answer
  answer: "Ocean water has dissolved salt, which makes it denser than fresh water. The denser water provides more buoyant force."
  explanation: "Salt water has a higher density than fresh water. Since the liquid is denser, it pushes up harder on your body, making it easier to float."
```
