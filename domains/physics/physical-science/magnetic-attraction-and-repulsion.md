...
- Magnetic force only works through air. (Magnets can attract or repel through paper, glass, water, wood, and many other materials.)
- Bringing magnets closer always makes them attract. (If like poles face each other, getting closer makes the repulsion stronger, not weaker.)
- Magnetic force works over any distance. (Magnetic force weakens quickly with distance. A few inches can make a big difference.)
- Attraction and repulsion are different forces. (They are two behaviors of the same magnetic force, depending on which poles face each other.)
...
- question: "What happens to the magnetic force between two magnets as you move them farther apart?"
  ...
  options: ["It gets stronger", "It stays the same", "It gets weaker", "It reverses direction"]
  answer: 2
  explanation: "Magnetic force gets weaker as the distance between magnets increases. The closer the magnets are, the stronger the force."

- question: "A magnet can attract a paper clip through a sheet of paper."
  type: true-false
  answer: true
  explanation: "Magnetic force passes through many non-magnetic materials like paper, cardboard, and plastic without much weakening."

- question: "Two magnets are placed with their north poles facing each other. What will happen?"
  type: short-answer
  answer: "The magnets will push apart (repel each other)."
  explanation: "Like poles repel. Two north poles facing each other create a pushing force that drives the magnets apart."
```
