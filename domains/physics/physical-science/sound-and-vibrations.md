...
- Sound can travel through empty space. (Sound needs a medium — air, water, or a solid — to travel. In the vacuum of space, there is no sound.)
- Only musical instruments vibrate to make sound. (Everything that makes sound is vibrating — your vocal cords, a closing door, a clap of thunder.)
- You can always see the vibration that makes a sound. (Many vibrations are too small or too fast to see, but they are still happening.)
- Loud sounds vibrate and quiet sounds do not. (Both loud and quiet sounds come from vibrations; loud sounds just have bigger vibrations.)

## Questions

```yaml
- question: "What must happen for a sound to be produced?"
  type: multiple-choice
  options: ["An object must be heated", "An object must vibrate", "An object must be visible", "An object must be falling"]
  answer: 1
  explanation: "Every sound starts with a vibration. The vibrating object pushes on the surrounding air (or other material), creating sound waves."

- question: "Sound can travel through outer space."
  type: true-false
  answer: false
  explanation: "Sound needs a medium like air, water, or solid material to travel through. Space is a vacuum with no material, so sound cannot travel there."

- question: "How does sound get from a ringing bell to your ear?"
  type: short-answer
  answer: "The bell vibrates and pushes on the air, creating sound waves that travel through the air to your ear."
  explanation: "The vibrating bell creates waves of compressed and expanded air. These waves travel outward until they reach your ear, where they are heard as sound."
```
