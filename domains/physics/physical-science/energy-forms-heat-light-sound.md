...
title: "Forms of Energy: Heat, Light, and Sound"
domain: physics
...
- Heat and temperature are the same thing. (Temperature measures how hot something is; heat is the energy that flows between objects at different temperatures.)
- Light can only come from the Sun or light bulbs. (Fire, TV screens, fireflies, and glow sticks all produce light.)
- Sound can travel through empty space. (Sound needs a material like air, water, or solid objects to travel through.)
- These energy forms are completely separate and unrelated. (They are all forms of energy and can convert into each other — a light bulb turns electrical energy into both light and heat.)

## Questions

```yaml
- question: "What form of energy do you feel when you hold your hands near a campfire?"
  type: multiple-choice
  options: ["Sound energy", "Light energy", "Heat energy", "Kinetic energy"]
  answer: 2
  explanation: "The warmth you feel near a campfire is heat energy. The fire also produces light energy, but the warmth on your hands is heat."

- question: "Sound is produced by vibrations."
  type: true-false
  answer: true
  explanation: "Every sound is created by something vibrating. The vibrations travel through the air as waves and reach your ears."

- question: "Name one object that gives off both light energy and heat energy at the same time."
  type: short-answer
  answer: "The Sun (also acceptable: a campfire, a light bulb, a candle)."
  explanation: "Many energy sources produce more than one form of energy. The Sun gives off tremendous amounts of both light and heat."
```
