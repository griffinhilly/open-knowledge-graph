...
- Sound travels at the same speed through everything. (Sound travels much faster in solids and liquids than in air.)
- Sound travels best through air because that is where we usually hear it. (Sound actually travels better and faster through solids and water.)
- Sound waves look like ocean waves. (Sound waves are compression waves — they push and pull particles back and forth in the direction the wave travels, not up and down.)
- If you cannot hear a sound, it does not exist. (Sounds can be too quiet or at frequencies outside human hearing range, like dog whistles.)

## Questions

```yaml
- question: "Through which material does sound travel the fastest?"
  type: multiple-choice
  options: ["Air", "Water", "Steel", "It travels the same speed in all materials"]
  answer: 2
  explanation: "Sound travels fastest through solids like steel because the particles are packed very closely together and pass vibrations along very quickly."

- question: "Sound can travel through water."
  type: true-false
  answer: true
  explanation: "Sound travels well through water — in fact, it travels about four times faster through water than through air. Whales and dolphins use this to communicate over long distances."

- question: "Why can't sound travel through outer space?"
  type: short-answer
  answer: "Space is a vacuum with no particles, and sound needs particles to carry the vibration."
  explanation: "Sound waves work by passing vibrations from one particle to the next. Without particles (air, liquid, or solid), there is nothing to vibrate, so the sound cannot travel."
```
