...
- Only mirrors reflect light. (All surfaces reflect light — mirrors just reflect it in an organized way. You can see a book because it reflects light too.)
- Light always reflects at the same angle no matter what. (The angle of reflection equals the angle at which the light hits the surface, but it changes when you change the incoming angle.)
- You see things because your eyes send out light. (You see because light from a source reflects off objects and enters your eyes.)
- Colored objects make their own colored light. (They reflect certain colors of light and absorb others.)

## Questions

```yaml
- question: "Why can you see a clear image of yourself in a flat mirror but not in a rough wall?"
  type: multiple-choice
  options: ["The mirror is thicker", "The mirror's smooth surface reflects light in an organized pattern", "The wall absorbs all light", "The mirror produces its own light"]
  answer: 1
  explanation: "A smooth surface reflects light rays in an orderly way, preserving the pattern of light so your eyes see a clear image. A rough surface scatters light in many directions."

- question: "All objects reflect at least some light."
  type: true-false
  answer: true
  explanation: "You can see any object because it reflects some light to your eyes. Even dark objects reflect a small amount of light."

- question: "What happens when you shine a flashlight at a mirror at an angle?"
  type: short-answer
  answer: "The light bounces off the mirror at the same angle on the other side."
  explanation: "The angle at which light hits a surface (the angle of incidence) equals the angle at which it bounces off (the angle of reflection)."
```
