---
id: density-intro
title: "Density: Heavy for Its Size"
domain: physics
...
- Bigger objects are always denser. (A huge beach ball is much less dense than a small rock.)
- Heavy objects are always dense. (A large pillow is heavy but not dense; a tiny lead pellet is very dense.)
- Density and weight are the same thing. (Weight depends on both mass and gravity; density is mass per unit of volume.)
- All metals have the same density. (Aluminum, iron, gold, and lead all have very different densities.)

## Questions

```yaml
- question: "A block of wood and a block of iron are the same size. The iron block is much heavier. Which is denser?"
  type: multiple-choice
  options: ["The wood block", "They have the same density", "The iron block", "You cannot tell from this information"]
  answer: 2
...
- question: "How do you calculate the density of an object?"
  type: short-answer
  answer: "Divide the object's mass by its volume (density = mass ÷ volume)."
  explanation: "Density measures how tightly matter is packed. You need to know both how much stuff is there (mass) and how much space it takes up (volume)."
```
