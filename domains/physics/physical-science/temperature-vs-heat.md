...
- Temperature and heat are the same thing. (Temperature is a measurement of particle speed; heat is energy flowing between objects of different temperatures.)
- Cold objects have no heat energy. (Even cold objects have thermal energy — their particles are still moving, just more slowly.)
- A bigger object is always hotter. (A large bathtub of lukewarm water has more total heat energy than a small cup of boiling water, but the cup has a higher temperature.)
- Heat flows from bigger objects to smaller ones. (Heat flows from hotter objects to cooler ones, regardless of size.)
...
- question: "What is the difference between temperature and heat?"
  ...
  options: ["There is no difference", "Temperature measures particle speed; heat is energy flowing between objects", "Heat is measured with a thermometer; temperature is not", "Temperature is for liquids; heat is for solids"]
  answer: 1
  explanation: "Temperature tells you how fast particles are moving (how hot or cold something is). Heat is the energy that transfers from a warmer object to a cooler one."

- question: "Heat always flows from a warmer object to a cooler object."
  type: true-false
  answer: true
  explanation: "Heat energy naturally flows from regions of higher temperature to regions of lower temperature until both reach the same temperature."

- question: "If you put a metal spoon in a cup of hot soup, which direction does the heat flow?"
  type: short-answer
  answer: "Heat flows from the hot soup into the cooler spoon."
  explanation: "The soup is warmer than the spoon, so heat energy transfers from the soup to the spoon, making the spoon feel hot."
```
