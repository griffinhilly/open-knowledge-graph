...
- Transparent means colorless. (Colored glass or tinted sunglasses are transparent — they let light through, just in certain colors.)
- Translucent and transparent mean the same thing. (Transparent materials let you see clear images through them; translucent materials let light through but scatter it so images are blurry.)
- Opaque objects absorb all light. (Opaque objects block light from passing through, but they can still reflect light — that is how you see them.)
- A material is always in the same category. (Some materials change — water is transparent in a thin layer but can appear opaque when very deep.)

## Questions

```yaml
- question: "Through which type of material can you clearly see objects on the other side?"
  type: multiple-choice
  options: ["Opaque", "Translucent", "Transparent", "None of the above"]
  answer: 2
  explanation: "Transparent materials let light pass through without scattering it much, so you can see clear images through them."

- question: "Frosted glass is an example of a translucent material."
  type: true-false
  answer: true
  explanation: "Frosted glass lets light through, but the rough surface scatters it so you can see brightness but not clear shapes or details."

- question: "What does an opaque material do to light?"
  type: short-answer
  answer: "An opaque material blocks light from passing through it."
  explanation: "Opaque materials do not let any light through to the other side, which is why they create shadows."
```
