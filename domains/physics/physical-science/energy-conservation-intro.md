...
title: Energy Is Never Created or Destroyed
domain: physics
...
- Energy can be created from nothing by machines or power plants. (Power plants convert energy from one form to another; they do not create it.)
- Energy disappears when something stops moving. (The kinetic energy was converted to heat, sound, or other forms.)
- "Using energy" means it is gone forever. (We say "using" energy, but we really mean converting it to less useful forms like spread-out heat.)
- Conservation of energy means we should not waste energy. (In science, "conservation" means the total stays the same. Everyday "energy conservation" means using less energy, which is a different idea.)

## Questions

```yaml
- question: "A ball is dropped and hits the ground but does not bounce back to its original height. What happened to the missing energy?"
  type: multiple-choice
  options: ["It was destroyed", "It was converted to heat and sound when the ball hit the ground", "It floated away into the air", "There was no missing energy"]
  answer: 1
  explanation: "The energy was not destroyed. When the ball hit the ground, some kinetic energy was converted into heat and sound, so less energy was available for the bounce."

- question: "The total energy in a closed system always stays the same."
  type: true-false
  answer: true
  explanation: "This is the law of conservation of energy. Energy can change forms and transfer between objects, but the total amount never increases or decreases."

- question: "Where does the energy 'go' when you rub your hands together and they get warm?"
  type: short-answer
  answer: "The kinetic energy of your moving hands is converted into heat energy."
  explanation: "Friction between your hands converts motion energy into thermal energy (heat), which is why your palms feel warmer."
```
