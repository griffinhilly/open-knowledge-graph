...
- There is no gravity in space. (Gravity exists everywhere; astronauts float because they are falling around Earth, not because gravity is gone.)
- Heavier objects always fall faster than lighter ones. (In the absence of air resistance, all objects fall at the same rate.)
- Gravity only pulls things downward. (Gravity pulls toward the center of any massive object — "down" just means toward Earth's center.)
- Gravity is something only Earth has. (Every planet, moon, and star has gravity.)

## Questions

```yaml
- question: "Why does a ball fall to the ground when you let go of it?"
  type: multiple-choice
  options: ["Because air pushes it down", "Because gravity pulls it toward Earth", "Because the ball is heavy", "Because the ground attracts only round objects"]
  answer: 1
...
- question: "What direction does gravity pull things on Earth?"
  type: short-answer
  answer: "Gravity pulls things down, toward the center of the Earth."
  explanation: "Earth's gravity always pulls objects toward its center, which we experience as the downward direction."
```
