...
- Forces only exist when something is moving. (Forces can also hold things still, like when you push against a wall.)
- Heavier objects are harder to move because they "want" to stay still. (They resist changes in motion because of their mass, not because they have a desire.)
- You can only push or pull with your hands. (Wind, magnets, and gravity are also pushes and pulls.)
- A ball rolling on the floor will stop on its own. (It stops because friction is pushing against it.)

## Questions

```yaml
- question: "What happens when you push a toy car sitting on a table?"
  type: multiple-choice
  options: ["It stays perfectly still", "It moves in the direction you pushed it", "It floats into the air", "It moves in the opposite direction"]
  answer: 1
  explanation: "When you push a toy car, the force makes it move in the same direction as your push."

- question: "A pull is a type of force."
  type: true-false
  answer: true
  explanation: "A force is any push or pull. Pulling a wagon, opening a drawer, and tugging a rope are all examples of forces."

- question: "Name two ways a force can change how an object moves."
  type: short-answer
  answer: "A force can make an object start moving and change its direction (also: stop moving, speed up, or slow down)."
  explanation: "Forces do not just make things go — they can also make things stop, go faster, go slower, or turn."
```
