...
- Energy is a substance you can hold or see. (Energy is not a material; it is a property that describes an object's ability to cause change.)
- Only moving things have energy. (A rock at the top of a hill, a stretched spring, and food all have stored energy even though they are not moving.)
- Energy gets "used up" and disappears. (Energy changes form but is never created or destroyed.)
- Only electricity is "real" energy. (Heat, light, sound, motion, and stored chemical energy are all forms of energy.)

## Questions

```yaml
- question: "Which of these is the best description of energy?"
  type: multiple-choice
  options: ["Energy is a type of matter", "Energy is the ability to cause change or do work", "Energy is only found in batteries", "Energy is the same as force"]
  answer: 1
  explanation: "Energy is defined as the ability to cause change — to move things, heat them up, light them up, or make sounds."

- question: "A ball sitting at the top of a hill has energy even though it is not moving."
  type: true-false
  answer: true
  explanation: "The ball has stored (potential) energy because of its height. If it rolls down the hill, that stored energy turns into motion energy."

- question: "Name two different things that have energy."
  type: short-answer
  answer: "A moving car and the Sun (also acceptable: food, a battery, a stretched rubber band, wind, etc.)."
  explanation: "Energy exists in many forms — motion, light, heat, stored chemical energy, and more. Almost everything around you has some form of energy."
```
