...
- Pitch and volume are the same thing. (Pitch is how high or low; volume is how loud or soft. They are independent.)
- Higher pitch always means louder. (A high-pitched whisper is quiet, and a low-pitched shout is loud.)
- Only special instruments can change pitch. (Anything that vibrates can change pitch — changing the size, length, or tightness of the vibrating object changes the pitch.)
- Volume only depends on how hard you hit something. (Volume also depends on the size and shape of the vibrating object and how far you are from it.)
...
- question: "What determines the pitch of a sound?"
  ...
  options: ["How big the vibrations are", "How fast the vibrations are", "How far the sound travels", "How long the sound lasts"]
  answer: 1
  explanation: "Pitch depends on the frequency (speed) of vibrations. Faster vibrations produce a higher pitch, and slower vibrations produce a lower pitch."

- question: "A louder sound is made by bigger vibrations."
  type: true-false
  answer: true
  explanation: "The size (amplitude) of the vibration determines the volume. Bigger vibrations push more air and create louder sounds."

- question: "How could you make a guitar string produce a higher pitch sound?"
  type: short-answer
  answer: "Tighten the string (or press it down to shorten the vibrating length)."
  explanation: "A tighter or shorter string vibrates faster, which produces a higher pitch. This is how guitarists play different notes."
```
