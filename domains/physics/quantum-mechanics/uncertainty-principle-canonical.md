...
- question: "Two observables that commute ([Â, B̂] = 0) cannot both be measured precisely in the same quantum state — there will always be some uncertainty in at least one of them."
  type: true-false
  answer: false
