...
- question: "The selection rule Δv = ±2 for the quantum harmonic oscillator is forbidden under the electric dipole mechanism, so first overtone absorptions are completely absent from vibrational spectra."
  type: true-false
  answer: false
