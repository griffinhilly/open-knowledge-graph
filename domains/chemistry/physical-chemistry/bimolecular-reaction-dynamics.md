...
- question: "The steric factor p in simple collision theory fully accounts for all the reasons why the observed rate constant falls below the hard-sphere collision rate, including quantum tunneling and orbital symmetry constraints."
  type: true-false
  answer: false
