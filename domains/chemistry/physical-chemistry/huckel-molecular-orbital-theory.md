...
- question: "Hückel molecular orbital theory gives quantitatively accurate orbital energies because it uses the complete electronic Hamiltonian with most electron-electron repulsion terms included."
  type: true-false
  answer: false
