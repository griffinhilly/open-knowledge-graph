...
- When something burns and seems to disappear, the mass has not been destroyed — it has been converted to gases (like CO2 and water vapor) that escape into the air.
- Mass is not lost when a substance dissolves — the dissolved substance still has mass, even though you cannot see it.
- The law applies to chemical reactions, not nuclear reactions — in nuclear reactions, tiny amounts of mass can convert to energy (but that is a topic for physics).
- A lighter product does not mean mass was destroyed — it means some products escaped (usually as gases).

## Questions

```yaml
- question: "If 10 grams of reactants undergo a chemical reaction in a sealed container, what is the total mass of the products?"
  type: multiple-choice
  options: ["Less than 10 grams", "Exactly 10 grams", "More than 10 grams", "It depends on the reaction"]
  answer: 1
  explanation: "The law of conservation of mass states that mass is neither created nor destroyed in a chemical reaction. In a sealed container where nothing can escape, the total mass of products must equal the total mass of reactants — exactly 10 grams."

- question: "When a log burns in a campfire, the remaining ash weighs less than the original log. This means mass was destroyed."
  type: true-false
  answer: false
  explanation: "Mass was not destroyed — it was converted to gases (carbon dioxide, water vapor, and others) that escaped into the atmosphere. If you could capture and weigh all the gases plus the ash, the total mass would equal the mass of the original log plus the oxygen consumed from the air."

- question: "Who is credited with establishing the law of conservation of mass through careful experiments?"
  type: short-answer
  answer: "Antoine Lavoisier."
  explanation: "French chemist Antoine Lavoisier conducted precise experiments in the late 1700s, carefully weighing reactants and products in sealed containers. He demonstrated that mass is conserved in chemical reactions, earning him the title 'father of modern chemistry.' His insistence on careful measurement transformed chemistry from a qualitative art into a quantitative science."
```
