...
title: "Periodic Trends: Size and Reactivity Patterns"
domain: chemistry
...
- Atoms do not get larger across a period from left to right — they actually get smaller because the increasing number of protons pulls the electrons closer.
- High reactivity in metals and high reactivity in nonmetals have different causes — metals are reactive because they lose electrons easily, while nonmetals are reactive because they gain electrons easily.
- The most reactive metal and the most reactive nonmetal are in opposite corners of the table — cesium/francium at the bottom left and fluorine at the top right.
- Trends are general patterns, not absolute rules — some exceptions exist, especially among transition metals.

## Questions

```yaml
- question: "As you move down a group on the periodic table, what happens to atomic size?"
  type: multiple-choice
  options: ["It decreases", "It stays the same", "It increases", "It alternates"]
  answer: 2
  explanation: "Atomic size increases moving down a group because each row adds a new electron energy level (shell), making the atom physically larger. The outermost electrons are farther from the nucleus."

- question: "Fluorine is more reactive than iodine because it is higher in Group 17."
  type: true-false
  answer: true
  explanation: "For nonmetals (like the halogens in Group 17), reactivity increases going up the group. Fluorine is at the top and is the most reactive nonmetal because its small size and strong nuclear pull make it extremely effective at gaining electrons. Iodine, being much larger, holds incoming electrons less tightly and is less reactive."

- question: "Explain why sodium is more reactive than magnesium, even though magnesium is right next to it on the periodic table."
  type: short-answer
  answer: "Sodium (Group 1) has only one valence electron to lose, making it easier to react. Magnesium (Group 2) has two valence electrons to lose, which requires more energy, making it less reactive."
  explanation: "Metal reactivity depends on how easily an atom gives up its valence electrons. Sodium needs to lose only 1 electron to achieve a stable arrangement, while magnesium needs to lose 2. Losing 2 electrons requires more energy, so magnesium reacts less readily than sodium. In general, Group 1 metals are more reactive than Group 2 metals in the same period."
```
