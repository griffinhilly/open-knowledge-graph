...
- Water is not truly "universal" — it cannot dissolve everything. Nonpolar substances like fats and oils do not dissolve in water.
- Dissolving is not the same as melting — when salt dissolves in water, the salt particles separate and spread out among water molecules, but nothing is being heated to a liquid state.
- Clear solutions are not the same as pure water — a solution of salt in water looks clear but contains dissolved particles.
- Water dissolves ionic compounds by pulling ions apart, not by breaking the chemical bonds within the ions themselves.

## Questions

```yaml
- question: "Why does water dissolve table salt so effectively?"
  type: multiple-choice
  options: ["Water is hot enough to melt the salt", "Water's polar molecules attract the positive and negative ions in salt", "Water chemically reacts with salt to destroy it", "Water physically crushes the salt crystals"]
  answer: 1
...
- question: "Explain the phrase 'like dissolves like' in terms of water and oil."
  type: short-answer
  answer: "Water is polar and oil is nonpolar, so they do not dissolve in each other because polar and nonpolar substances are not attracted to each other strongly enough."
  explanation: "Polar molecules have uneven charge distributions that attract other polar molecules. Nonpolar molecules have even charge distributions and attract each other through weaker forces. Water (polar) strongly attracts other polar or ionic substances but cannot attract nonpolar oil molecules strongly enough to pull them into solution, so oil and water separate."
```
