...
- Isotopes are not different elements — they have the same atomic number and nearly identical chemical behavior.
- "Isotope" does not mean "radioactive" — most isotopes are perfectly stable (like carbon-12 and carbon-13). Only certain isotopes are radioactive.
- The mass number is not the same as the atomic number — mass number = protons + neutrons, while atomic number = protons only.
- The atomic mass shown on the periodic table is not a whole number because it is a weighted average of all naturally occurring isotopes of that element.

## Questions

```yaml
- question: "Carbon-12 and carbon-14 are isotopes of each other. What is different about them?"
  type: multiple-choice
  options: ["Number of protons", "Number of electrons", "Number of neutrons", "Their chemical symbol"]
  answer: 2
...
- question: "An atom has 6 protons and 8 neutrons. What is its mass number?"
  type: short-answer
  answer: "14."
  explanation: "The mass number is the total number of protons plus neutrons in the nucleus. This atom has 6 protons + 8 neutrons = 14. Since it has 6 protons, it is a carbon atom, specifically carbon-14."
```
