...
title: "Acids: Properties and Everyday Examples"
domain: chemistry
...
- Not all acids are dangerous or corrosive — many are found in foods and are perfectly safe in small amounts (citric acid in oranges, acetic acid in vinegar).
- The sour taste of acids is caused by hydrogen ions, not by some inherent "sour substance."
- Acids and acidic solutions are not always liquids — some acids exist as solids or gases before being dissolved.
- Strong acids and concentrated acids are not the same thing — "strong" refers to how completely the acid releases H+ ions, while "concentrated" refers to how much acid is dissolved.

## Questions

```yaml
- question: "Which property is characteristic of acids?"
  type: multiple-choice
  options: ["They feel slippery", "They taste bitter", "They turn blue litmus paper red", "They turn red litmus paper blue"]
  answer: 2
...
- question: "What do acids produce when they dissolve in water?"
  type: short-answer
  answer: "Hydrogen ions (H+)."
  explanation: "When an acid dissolves in water, it releases hydrogen ions (H+) into the solution. These hydrogen ions are responsible for the characteristic properties of acids — sour taste, reactivity with metals, ability to turn litmus paper red, and ability to conduct electricity. The more H+ ions in solution, the more acidic it is."
```
