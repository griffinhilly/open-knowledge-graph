...
title: "Bases: Properties and Everyday Examples"
domain: chemistry
...
- Bases are not the opposite of chemicals — they are chemicals themselves, just with different properties than acids.
- The slippery feel of bases is not because they are lubricants — it is because they react with oils on your skin to form soap-like compounds.
- Not all bases are safe — strong bases like sodium hydroxide (lye) are extremely corrosive and dangerous.
- "Basic" in chemistry does not mean simple — it means the substance has the properties of a base.

## Questions

```yaml
- question: "Which property is characteristic of bases?"
  type: multiple-choice
  options: ["They taste sour", "They turn red litmus paper blue", "They react vigorously with metals", "They turn blue litmus paper red"]
  answer: 1
...
- question: "What ions do bases produce when dissolved in water?"
  type: short-answer
  answer: "Hydroxide ions (OH-)."
  explanation: "When a base dissolves in water, it produces hydroxide ions (OH-), which consist of one oxygen atom bonded to one hydrogen atom with a negative charge. These OH- ions are responsible for the characteristic properties of bases — bitter taste, slippery feel, and the ability to turn red litmus paper blue."
```
