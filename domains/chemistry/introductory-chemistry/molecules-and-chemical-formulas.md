...
title: Molecules and Reading Chemical Formulas
domain: chemistry
...
- A subscript applies only to the element immediately before it — in H2O, the 2 belongs to hydrogen, not to oxygen.
- Not all molecules are compounds — O2 is a molecule but not a compound because it contains only one element.
- Chemical formulas show the ratio of atoms, not the physical arrangement — H2O tells you the count but not the shape of the molecule.
- The subscript "1" is never written — if no subscript appears after a symbol, it means there is exactly one atom of that element.

## Questions

```yaml
- question: "How many total atoms are in one molecule of glucose, C6H12O6?"
  type: multiple-choice
  options: ["6", "12", "18", "24"]
  answer: 3
  explanation: "Count each element's subscript: 6 carbon atoms + 12 hydrogen atoms + 6 oxygen atoms = 24 total atoms per glucose molecule."

- question: "In the formula CO2, the subscript 2 means there are two carbon atoms."
  type: true-false
  answer: false
  explanation: "The subscript 2 in CO2 applies to the oxygen, not the carbon. The formula means one carbon atom bonded to two oxygen atoms. Carbon has no subscript, which means there is exactly one carbon atom."

- question: "Write the number of each type of atom in a molecule of ammonia, NH3."
  type: short-answer
  answer: "1 nitrogen atom and 3 hydrogen atoms."
  explanation: "In the formula NH3, the N has no subscript, so there is 1 nitrogen atom. The H has a subscript of 3, meaning there are 3 hydrogen atoms. A molecule of ammonia therefore contains 4 atoms in total."
```
