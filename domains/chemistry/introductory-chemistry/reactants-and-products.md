...
prerequisites:
- id: physical-vs-chemical-change-summary
  type: hard
...
- Atoms are not created or destroyed in a chemical reaction — they are rearranged. The same atoms present in the reactants appear in the products.
- The arrow in a chemical equation does not mean "equals" — it means "produces" or "yields." The substances on each side are different.
- Reactants do not simply disappear — they are converted into products. If a solid seems to vanish, it may have become a gas or dissolved into a liquid.
- Not every change you can see is a chemical reaction — dissolving and melting are physical changes, not chemical reactions.

## Questions

```yaml
- question: "In a chemical equation, where are the reactants written?"
  type: multiple-choice
  options: ["Above the arrow", "Below the arrow", "On the left side of the arrow", "On the right side of the arrow"]
  answer: 2
  explanation: "By convention, reactants are written on the left side of the arrow and products on the right. The arrow points from reactants to products, indicating the direction of the transformation."

- question: "In a chemical reaction, new atoms are created to form the products."
  type: true-false
  answer: false
  explanation: "No atoms are created or destroyed during a chemical reaction. The atoms in the reactants are rearranged — their bonds break and new bonds form — to produce the products. The total number of each type of atom remains the same."

- question: "When iron rusts, iron reacts with oxygen to form iron oxide. Identify the reactants and products."
  type: short-answer
  answer: "Reactants: iron and oxygen. Product: iron oxide (rust)."
  explanation: "The reactants are the starting substances (iron metal and oxygen gas from the air). The product is the new substance formed by the reaction (iron oxide, commonly known as rust). The iron and oxygen atoms rearrange to form a new compound with different properties."
```
