...
title: "Inside the Atom: Protons, Neutrons, and Electrons"
domain: chemistry
...
- Electrons do not orbit the nucleus in neat circular paths like planets — they exist in a cloud-like region around the nucleus.
- The nucleus is incredibly tiny compared to the whole atom, but it contains nearly all of the atom's mass.
- Neutrons are not unimportant just because they have no charge — they help hold the nucleus together.
- Protons and electrons do not have the same mass — a proton is roughly 1,836 times heavier than an electron.

## Questions

```yaml
- question: "Which subatomic particle is found in the nucleus and carries no electrical charge?"
  type: multiple-choice
  options: ["Proton", "Electron", "Neutron", "Photon"]
  answer: 2
  explanation: "Neutrons are located in the nucleus alongside protons. Unlike protons (positive charge) and electrons (negative charge), neutrons carry no electrical charge. Photons are particles of light, not parts of an atom."

- question: "In a neutral atom, the number of protons equals the number of electrons."
  type: true-false
  answer: true
  explanation: "Each proton carries a +1 charge and each electron carries a -1 charge. For the atom to have no overall charge (neutral), these must be equal in number. If the counts are unequal, the particle is called an ion, not a neutral atom."
...
- question: "Where is almost all of the mass of an atom concentrated?"
  ...
  explanation: "Protons and neutrons are each about 1,836 times more massive than an electron. Because both protons and neutrons are packed into the tiny nucleus, that is where essentially all of the atom's mass is found, even though the nucleus is only a tiny fraction of the atom's total volume."
```
