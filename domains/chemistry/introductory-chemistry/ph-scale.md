...
prerequisites:
- id: acids-properties-and-examples
  type: hard
- id: bases-properties-and-examples
  type: hard
...
- A pH of 0 does not mean "no acid" — it means the solution is extremely acidic. Zero is the acidic end of the scale.
- The pH scale is not linear — it is logarithmic, so each whole number step represents a tenfold change. A pH of 2 is 100 times more acidic than a pH of 4.
- Neutral (pH 7) does not mean safe — a substance can be neutral and still be harmful for other reasons.
- Most everyday substances are not at the extremes of the scale — stomach acid is about pH 2, and oven cleaner is about pH 13-14, but most things you encounter are between pH 3 and pH 11.

## Questions

```yaml
- question: "A solution has a pH of 3. How does it compare to a solution with a pH of 5?"
  type: multiple-choice
  options: ["It is 2 times more acidic", "It is 20 times more acidic", "It is 100 times more acidic", "It is less acidic"]
  answer: 2
  explanation: "Each step on the pH scale represents a tenfold change. From pH 5 to pH 4 is 10 times more acidic, and from pH 4 to pH 3 is another 10 times. So pH 3 is 10 x 10 = 100 times more acidic than pH 5."

- question: "A solution with a pH of 7 is considered basic."
  type: true-false
  answer: false
  explanation: "A pH of 7 is neutral — neither acidic nor basic. This is the pH of pure water. Solutions with pH below 7 are acidic, and solutions with pH above 7 are basic (alkaline)."

- question: "What is the approximate pH of stomach acid, and is it acidic, neutral, or basic?"
  type: short-answer
  answer: "Stomach acid has a pH of about 1-2, and it is strongly acidic."
  explanation: "The hydrochloric acid in your stomach has a very low pH (about 1-2), making it one of the most acidic substances in your body. This strong acidity is necessary to break down food and kill harmful bacteria. Your stomach lining has special protective mechanisms to prevent the acid from damaging it."
```
