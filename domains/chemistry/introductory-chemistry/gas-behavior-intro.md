...
title: "Gas Behavior: Pressure, Volume, and Temperature"
domain: chemistry
...
- Gas pressure is not caused by gas particles pushing on each other — it is caused by particles colliding with the walls of their container.
- Heating a gas does not make the particles bigger — it makes them move faster.
- Compressing a gas does not change the number of particles — it pushes the same particles into a smaller space.
- Gases do not have a fixed volume — they expand and compress depending on conditions, unlike solids and liquids.

## Questions

```yaml
- question: "What happens to the pressure of a gas in a sealed, rigid container when the temperature increases?"
  type: multiple-choice
  options: ["Pressure decreases", "Pressure stays the same", "Pressure increases", "The gas escapes"]
  answer: 2
  explanation: "In a sealed, rigid container (fixed volume), increasing the temperature makes gas particles move faster. Faster particles hit the container walls more often and with greater force, which increases the pressure. Since the container is rigid and sealed, the volume cannot change and no gas escapes."

- question: "Compressing a gas into a smaller volume decreases its pressure."
  type: true-false
  answer: false
  explanation: "Compressing a gas into a smaller volume increases its pressure. With the same number of particles squeezed into less space, the particles collide with the container walls more frequently, producing more force per unit area — which is higher pressure."

- question: "Explain why a balloon shrinks when placed in a freezer."
  type: short-answer
  answer: "Cooling the gas inside the balloon makes the particles move slower. They hit the balloon walls less often and with less force, so the pressure inside decreases and the balloon shrinks as the outside air pressure pushes in."
  explanation: "A balloon is flexible, so its volume adjusts when the internal pressure changes. Cooling the gas lowers the kinetic energy of the particles, reducing the frequency and force of their collisions with the balloon walls. The internal pressure drops below the external atmospheric pressure, and the balloon contracts until the pressures balance again."
```
