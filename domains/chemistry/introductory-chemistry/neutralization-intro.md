...
title: "Neutralization: When Acids Meet Bases"
domain: chemistry
...
- The "salt" produced in a neutralization reaction is not always table salt (NaCl) — "salt" in chemistry refers to any ionic compound formed from an acid-base reaction.
- Neutralization does not always produce a perfectly neutral (pH 7) solution — the final pH depends on the strengths and amounts of the acid and base.
- The water produced is not "special" — it is ordinary water, the same as any other H2O.
- Neutralization reactions still follow conservation of mass — no atoms are created or destroyed.

## Questions

```yaml
- question: "What are the two products of a neutralization reaction between an acid and a base?"
  type: multiple-choice
  options: ["An acid and a gas", "Water and a salt", "A base and hydrogen gas", "Water and a metal"]
  answer: 1
...
- question: "Explain how an antacid tablet relieves an upset stomach."
  type: short-answer
  answer: "The antacid contains a base (like calcium carbonate) that neutralizes excess hydrochloric acid in the stomach, raising the pH and reducing acidity."
  explanation: "Your stomach naturally produces hydrochloric acid to digest food. When too much acid is produced, it causes discomfort. The base in an antacid reacts with the excess H+ ions in the stomach acid through a neutralization reaction, producing water and a salt. This raises the pH of the stomach contents, reducing the burning sensation."
```
