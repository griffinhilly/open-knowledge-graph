...
- The flame is not a "thing" — it is the visible region where combustion gases are hot enough to glow.
- Combustion requires oxygen — burning cannot happen in a vacuum or in pure nitrogen.
- Smoke and soot are signs of incomplete combustion (not enough oxygen), not a normal product of clean combustion.
- The fuel does not simply disappear when it burns — its atoms become part of the gaseous products (CO2 and H2O).

## Questions

```yaml
- question: "What are the typical products when a hydrocarbon fuel undergoes complete combustion?"
  type: multiple-choice
  options: ["Carbon and water", "Carbon dioxide and hydrogen", "Carbon dioxide and water", "Carbon monoxide and oxygen"]
  answer: 2
  explanation: "Complete combustion of a hydrocarbon (a compound of carbon and hydrogen) in sufficient oxygen produces carbon dioxide (CO2) and water (H2O). This is the standard combustion pattern for fuels like methane, propane, gasoline, and candle wax."

- question: "Combustion reactions are endothermic because fire needs heat to start."
  type: true-false
  answer: false
  explanation: "While it is true that combustion needs a spark or initial heat to get started (activation energy), the reaction itself releases far more energy than it absorbs, making it exothermic. The initial spark overcomes the activation energy barrier, and then the reaction sustains itself by producing heat."

- question: "Why does a fire go out when you smother it with a blanket?"
  type: short-answer
  answer: "Smothering a fire cuts off its oxygen supply. Without oxygen, the combustion reaction cannot continue."
  explanation: "Combustion requires three things: fuel, oxygen, and sufficient heat. Removing any one of these stops the reaction. A blanket blocks oxygen from reaching the fire, preventing the fuel from reacting. This is the principle behind many fire extinguishing methods — they remove oxygen, fuel, or heat."
```
