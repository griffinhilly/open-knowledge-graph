...
- Decomposition does not mean the atoms themselves are destroyed — the compound breaks into simpler substances, but the atoms remain intact.
- Not all synthesis reactions involve just two reactants — some combine three or more.
- Decomposition reactions often need energy input (heat, electricity, or light) to occur — compounds do not just fall apart on their own under normal conditions.
- These are just two of several reaction types — not all reactions fit neatly into synthesis or decomposition.

## Questions

```yaml
- question: "Which type of reaction is represented by the general equation A + B → AB?"
  type: multiple-choice
  options: ["Decomposition", "Synthesis", "Single replacement", "Combustion"]
  answer: 1
  explanation: "When two or more substances combine to form a single product, it is a synthesis (or combination) reaction. The general pattern is A + B → AB. Decomposition is the reverse: AB → A + B."

- question: "A decomposition reaction produces a single, more complex product from simpler reactants."
  type: true-false
  answer: false
  explanation: "That describes a synthesis reaction, not decomposition. A decomposition reaction is the opposite: a single compound breaks down into two or more simpler substances. Think of it as 'de-composing' — taking apart."

- question: "When water is split into hydrogen gas and oxygen gas using electricity, what type of reaction is this?"
  type: short-answer
  answer: "A decomposition reaction."
  explanation: "One compound (water, H2O) is broken down into two simpler substances (hydrogen gas, H2, and oxygen gas, O2). This fits the decomposition pattern: AB → A + B. The electricity provides the energy needed to break the bonds holding water molecules together."
```
