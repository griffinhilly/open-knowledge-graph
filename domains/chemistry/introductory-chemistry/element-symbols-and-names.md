...
title: Element Symbols and Names
domain: chemistry
...
- A two-letter symbol like Co (cobalt) is not the same as CO (carbon and oxygen) — capitalization matters enormously in chemistry.
- Not all symbols are abbreviations of English names — many come from Latin, Greek, or German roots.
- You do not need to memorize all 118 symbols — most chemistry work uses a core set of 30-40 elements regularly.
...
- question: "What is the chemical symbol for sodium?"
  ...
  options: ["So", "Sd", "Na", "S"]
  answer: 2
  explanation: "Sodium's symbol is Na, which comes from its Latin name 'natrium.' The symbol S belongs to sulfur. This is one of several cases where the symbol does not match the English name."

- question: "In a two-letter element symbol, both letters are capitalized."
  type: true-false
  answer: false
  explanation: "The first letter is always uppercase and the second letter is always lowercase. This rule prevents confusion — for example, Co means cobalt (one element), while CO means one carbon atom and one oxygen atom (two elements)."

- question: "Why does gold have the symbol Au instead of Go or Gd?"
  type: short-answer
  answer: "Au comes from gold's Latin name, 'aurum.'"
  explanation: "Many element symbols were established when Latin was the international language of science. Gold's Latin name is 'aurum,' giving it the symbol Au. Similarly, silver comes from 'argentum' (Ag), iron from 'ferrum' (Fe), and lead from 'plumbum' (Pb). These historical symbols are used worldwide regardless of what language a scientist speaks."
```
