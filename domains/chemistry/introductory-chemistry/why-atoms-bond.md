...
- Atoms do not bond because they "want" to — bonding is driven by energy considerations. Bonded atoms are in a lower-energy, more stable state.
- Not every atom needs exactly 8 outer electrons — hydrogen only needs 2 to be stable, and some elements beyond the second row can have more than 8.
- Atoms do not always completely transfer or completely share electrons — there is a spectrum between purely ionic and purely covalent bonding.

## Questions

```yaml
- question: "Why do most atoms form chemical bonds?"
  type: multiple-choice
  options: ["To become radioactive", "To increase their mass", "To reach a more stable electron arrangement", "To change their atomic number"]
  answer: 2
  explanation: "Atoms form bonds to achieve a more stable arrangement of electrons, typically resembling the full outer electron configuration of a noble gas. Bonding does not change the number of protons (atomic number) or make atoms radioactive."

- question: "Noble gases are unreactive because they already have a stable electron arrangement."
  type: true-false
  answer: true
  explanation: "Noble gases (helium, neon, argon, etc.) have completely filled outer electron levels, which is an extremely stable configuration. Because they are already stable, they have little tendency to gain, lose, or share electrons — and therefore they rarely form bonds."

- question: "What are the two main ways atoms can achieve a stable electron arrangement through bonding?"
  type: short-answer
  answer: "By transferring electrons from one atom to another, or by sharing electrons between atoms."
  explanation: "Transferring electrons leads to ionic bonds (one atom gives electrons, the other receives them). Sharing electrons leads to covalent bonds (both atoms hold onto the shared electrons). In both cases, the atoms end up with more stable electron arrangements than they had alone."
```
