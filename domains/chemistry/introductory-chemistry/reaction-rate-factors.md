...
title: "What Affects How Fast a Reaction Happens?"
domain: chemistry
...
- Increasing temperature does not add new chemicals — it makes existing particles move faster and collide with more energy.
- A higher reaction rate does not mean more product is formed — it means the same amount of product forms in less time.
- Surface area matters because reactions happen at the surface of solids — the interior particles are not exposed to the other reactant.
- Stirring a reaction does not change the reaction rate in the same way temperature does — stirring mainly helps by ensuring reactants stay in contact.

## Questions

```yaml
- question: "Why does increasing the temperature generally speed up a chemical reaction?"
  type: multiple-choice
  options: ["It adds more reactant particles", "It makes particles move faster and collide with more energy", "It changes the type of reaction", "It removes the products faster"]
  answer: 1
  explanation: "Higher temperature gives particles more kinetic energy, so they move faster and collide more often with greater force. More energetic collisions are more likely to break bonds and start the reaction. Temperature does not add particles or change the reaction type."

- question: "Grinding a solid reactant into a fine powder slows down the reaction because the pieces are smaller."
  type: true-false
  answer: false
  explanation: "Grinding into a powder speeds up the reaction, not slows it down. A fine powder has much more surface area exposed to the other reactant compared to a single large chunk. Since chemical reactions occur at the surface of solids, more surface area means more collisions and a faster reaction."

- question: "Explain why a campfire burns faster when you blow on it."
  type: short-answer
  answer: "Blowing increases the supply of oxygen (a reactant) reaching the fire, which increases the concentration of oxygen at the surface of the burning material and speeds up the combustion reaction."
  explanation: "Combustion requires fuel and oxygen. Blowing air on a campfire delivers fresh oxygen to the burning surface more quickly, increasing the rate of collisions between oxygen molecules and the fuel. This is essentially an increase in the local concentration of one reactant, which speeds up the reaction rate."
```
