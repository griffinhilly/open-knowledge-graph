---
id: catalysts-intro
title: "Catalysts: Speeding Up Reactions"
domain: chemistry
...
- A catalyst does not make a reaction happen that otherwise could not — it speeds up a reaction that would eventually happen anyway, just much more slowly.
- Catalysts are not consumed or used up — they are recovered unchanged at the end of the reaction.
- A catalyst does not increase the amount of product — it just makes the product form faster.
- Enzymes are catalysts, but not all catalysts are enzymes — many catalysts are metals or other inorganic substances.

## Questions

```yaml
- question: "What is the defining characteristic of a catalyst?"
  type: multiple-choice
  options: ["It is consumed during the reaction", "It speeds up a reaction without being used up", "It increases the amount of product formed", "It changes the products of a reaction"]
  answer: 1
  explanation: "A catalyst speeds up a reaction without being permanently changed or consumed. It participates in the reaction process but is regenerated at the end, so it can catalyze the same reaction many times. It does not change what products form or how much product is made."

- question: "A catalyst increases the total amount of product that a reaction can produce."
  type: true-false
  answer: false
  explanation: "A catalyst speeds up the rate at which products form but does not change the total amount of product. The same amount of product would eventually form without the catalyst — it would just take much longer. Catalysts affect speed, not quantity."

- question: "What is the name for catalysts that speed up chemical reactions in living organisms?"
  type: short-answer
  answer: "Enzymes."
  explanation: "Enzymes are biological catalysts — specialized protein molecules that speed up the thousands of chemical reactions happening in your cells every second. Without enzymes, reactions like digesting food or building DNA would be far too slow to sustain life. Each enzyme typically catalyzes one specific reaction."
```
