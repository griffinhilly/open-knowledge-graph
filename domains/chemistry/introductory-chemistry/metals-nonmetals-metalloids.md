...
- id: periodic-table-intro
  type: hard
- id: thermal-and-electrical-conductivity
  type: soft
builds-toward:
...
- Not all metals are hard and heavy — mercury is a liquid at room temperature, and sodium is soft enough to cut with a knife.
- Not all nonmetals are gases — carbon and sulfur are solid nonmetals.
- Metalloids are not a 50/50 blend of metal and nonmetal properties — they have their own distinct behavior, particularly as semiconductors.
- The metal/nonmetal boundary is not a sharp dividing line — some elements near the boundary can behave more like metals or nonmetals depending on conditions.
...
- question: "Which property is most characteristic of metals?"
  ...
  options: ["They are brittle", "They are poor conductors of heat", "They conduct electricity well", "They are always gases at room temperature"]
  answer: 2
  explanation: "Metals are excellent conductors of electricity and heat. This is one of their defining characteristics, caused by the way metal atoms share electrons. Metals are generally not brittle (they are malleable), and most are solids at room temperature."

- question: "Metalloids are found along the staircase-shaped boundary between metals and nonmetals on the periodic table."
  type: true-false
  answer: true
  explanation: "The periodic table has a zigzag line (often called a staircase) running diagonally from boron to astatine. Elements along this boundary — such as boron, silicon, germanium, and arsenic — are metalloids. They have intermediate properties between metals and nonmetals."

- question: "Why is silicon, a metalloid, used in computer chips?"
  type: short-answer
  answer: "Silicon is a semiconductor, meaning its ability to conduct electricity can be precisely controlled, which is essential for electronic circuits."
  explanation: "Metalloids like silicon do not conduct electricity as well as metals, but they conduct better than nonmetals. This intermediate conductivity can be fine-tuned by adding tiny amounts of other elements (a process called doping), making semiconductors ideal for building the transistors and circuits inside computer chips."
```
