...
- Temperature does not always increase when you add heat — during a phase change, the temperature remains constant while the energy goes into breaking or forming attractions between particles.
- Steam and boiling water are the same temperature (100°C at standard pressure), but steam carries extra energy that was absorbed during boiling — which is why steam burns are often worse than hot water burns.
- Freezing releases energy — it does not require energy. The particles slow down and form stronger attractions, releasing heat in the process.
- Phase changes are physical changes, not chemical changes — the substance itself does not transform into a different substance.

## Questions

```yaml
- question: "What happens to the temperature of water while it is boiling at 100°C?"
  type: multiple-choice
  options: ["It continues to increase above 100°C", "It stays constant at 100°C", "It decreases slightly", "It fluctuates up and down"]
  answer: 1
  explanation: "During boiling, the temperature remains constant at 100°C (at standard pressure) even as heat continues to be added. All the incoming energy is used to break the attractions between liquid water molecules, converting them to gas, rather than increasing the temperature."

- question: "Freezing is an exothermic process."
  type: true-false
  answer: true
  explanation: "When a liquid freezes, its particles slow down and form stronger attractions with neighboring particles. This process releases energy (heat) into the surroundings. This is why the air near a freezing lake can actually feel slightly warmer — the water is releasing heat as it turns to ice."

- question: "Explain why a heating curve has flat sections during phase changes."
  type: short-answer
  answer: "During a phase change, all the added energy goes into breaking attractions between particles rather than increasing their speed, so the temperature remains constant."
  explanation: "Temperature measures the average kinetic energy (speed) of particles. During a phase change like melting or boiling, the energy being added is used to overcome the forces holding particles together in the current phase, not to make them move faster. Once all the substance has changed phase, the temperature begins to rise again."
```
