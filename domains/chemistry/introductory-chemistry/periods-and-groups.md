...
title: Periods and Groups on the Periodic Table
domain: chemistry
...
- Periods go across (horizontal) and groups go down (vertical) — these are frequently confused.
- Elements in the same group are not identical — they share similar chemical behavior but can differ greatly in physical properties (lithium is a soft, light metal; cesium is dense and reacts explosively with water).
- The group number does not always directly tell you the number of valence electrons for transition metals in the middle of the table — the simple rule works best for the main group elements on the sides.
- Not all periodic tables use the same numbering system — the most common modern system numbers groups 1-18 from left to right.
...
- question: "What do elements in the same group of the periodic table have in common?"
  ...
  options: ["The same number of protons", "The same number of neutrons", "Similar chemical properties", "The same atomic mass"]
  answer: 2
  explanation: "Elements in the same group (vertical column) have similar chemical properties because they have the same number of valence (outer) electrons. This shared electron arrangement causes them to react in similar ways. They do not share the same number of protons, neutrons, or atomic mass."

- question: "A period on the periodic table is a vertical column."
  type: true-false
  answer: false
  explanation: "A period is a horizontal row, not a vertical column. Vertical columns are called groups (or families). There are 7 periods and 18 groups in the standard periodic table."

- question: "Name the group of elements found in the far-right column (Group 18) of the periodic table and explain why they are notable."
  type: short-answer
  answer: "The noble gases (helium, neon, argon, krypton, xenon, radon). They are notable because they are extremely unreactive — they rarely form chemical bonds with other elements."
  explanation: "Noble gases have completely filled outer electron levels, making them exceptionally stable. Because they have no tendency to gain, lose, or share electrons, they almost never participate in chemical reactions. This makes them useful for applications where inertness is desired, such as filling light bulbs (argon) and advertising signs (neon)."
```
