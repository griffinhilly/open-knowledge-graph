...
- Acids and bases in your home are not unusual or exotic — they are in almost every room.
- "Chemical-free" products still contain chemicals — water itself is a chemical, and many "natural" products contain acids and bases.
- Acid rain is not pure acid — it is rain with a slightly lower pH than normal (below about 5.6), caused by pollution dissolving in atmospheric moisture.
- Your body carefully regulates its pH — eating acidic or basic foods does not significantly change your blood pH.

## Questions

```yaml
- question: "Which common household substance is a base used for cleaning?"
  type: multiple-choice
  options: ["Lemon juice", "Vinegar", "Ammonia", "Orange juice"]
  answer: 2
  explanation: "Ammonia is a base commonly found in household cleaning products. It has a high pH and is effective at dissolving grease and grime. Lemon juice, vinegar, and orange juice are all acids."

- question: "Eating acidic foods like lemons will make your blood significantly more acidic."
  type: true-false
  answer: false
  explanation: "Your body has powerful buffer systems that maintain blood pH at approximately 7.4 regardless of what you eat. While acidic foods can affect the pH inside your stomach temporarily, they do not significantly change your blood pH. Your kidneys and lungs constantly work to keep blood pH in a very narrow range."

- question: "What causes acid rain, and why is it harmful to the environment?"
  type: short-answer
  answer: "Acid rain is caused by sulfur dioxide and nitrogen oxide pollutants dissolving in atmospheric moisture to form sulfuric and nitric acids. It harms ecosystems by making lakes and soil more acidic, damaging plants and aquatic life."
  explanation: "Burning fossil fuels releases sulfur dioxide (SO2) and nitrogen oxides (NOx) into the atmosphere. These gases react with water vapor to form sulfuric acid and nitric acid, which fall as rain with a pH below the normal 5.6. This acidic rain can kill fish in lakes, damage forest trees, and erode stone buildings and statues."
```
