...
title: "Ionic and Covalent Bonds: An Introduction"
domain: chemistry
...
- Ionic bonds are not weaker than covalent bonds — ionic compounds like salt have very high melting points because of the strong attractions between ions in the crystal.
- Covalent compounds are not always gases or liquids — diamond and quartz are covalent solids with extremely high melting points.
- The distinction between ionic and covalent is not absolute — many bonds have both ionic and covalent character to varying degrees.
- Ions are not molecules — ionic compounds form extended lattice structures rather than individual molecules.

## Questions

```yaml
- question: "Which type of bond typically forms between a metal and a nonmetal?"
  type: multiple-choice
  options: ["Covalent bond", "Ionic bond", "Metallic bond", "Hydrogen bond"]
  answer: 1
  explanation: "When a metal (which tends to lose electrons) bonds with a nonmetal (which tends to gain electrons), electrons are transferred from the metal to the nonmetal, forming positively and negatively charged ions. The attraction between these opposite charges creates an ionic bond."

- question: "Covalent bonds form when atoms share electrons."
  type: true-false
  answer: true
  explanation: "In a covalent bond, two atoms (usually nonmetals) each contribute electrons to a shared pair. Neither atom completely gives up or takes the electrons — they share them, which allows both atoms to achieve a more stable electron arrangement."

- question: "Explain why table salt (NaCl) has a much higher melting point than water (H2O)."
  type: short-answer
  answer: "Table salt is an ionic compound with strong attractions between many ions in a crystal lattice, which requires a lot of energy to break apart. Water is a covalent compound with weaker attractions between its molecules."
  explanation: "In NaCl, every sodium ion is surrounded by chloride ions and vice versa, creating a rigid crystal lattice held together by strong electrostatic forces throughout the entire structure. Melting requires breaking many of these attractions simultaneously. Water molecules are held together by weaker forces between molecules, so less energy is needed to separate them."
```
