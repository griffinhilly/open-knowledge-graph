...
title: Crystal Structures in Everyday Life
domain: chemistry
...
- Crystals are not rare or exotic — they are extremely common. Table salt, ice, and most metals are all crystalline.
- A crystal does not have to be clear or gem-like — metals are crystalline even though they look nothing like quartz or diamonds.
- The flat faces and sharp edges of crystals are not carved or shaped — they result naturally from the orderly arrangement of particles.
- Not all shiny, clear minerals are the same type of crystal — the internal arrangement differs greatly between substances.

## Questions

```yaml
- question: "What makes a solid crystalline rather than amorphous?"
  type: multiple-choice
  options: ["It must be transparent", "Its particles are arranged in a repeating pattern", "It must be very hard", "It must be made of ions"]
  answer: 1
  explanation: "A crystalline solid has particles arranged in a regular, repeating three-dimensional pattern (lattice). An amorphous solid, like glass, has particles in a disordered arrangement. Crystalline solids can be opaque, soft, or made of atoms or molecules — the defining feature is the ordered pattern."

- question: "Glass is an example of a crystalline solid."
  type: true-false
  answer: false
  explanation: "Glass is an amorphous solid, meaning its particles are arranged in a disordered, random pattern rather than a regular repeating lattice. This is why glass does not have natural flat faces or a characteristic geometric shape like crystalline solids do."

- question: "Why does table salt naturally form small cube-shaped crystals?"
  type: short-answer
  answer: "The sodium and chloride ions in salt arrange themselves in a cubic lattice pattern, so the crystal's outer shape reflects the internal arrangement."
  explanation: "In NaCl, sodium ions and chloride ions alternate in a three-dimensional cubic grid. This internal cubic arrangement extends outward, producing the cube-shaped crystals you can see with a magnifying glass. The external shape of a crystal is a direct reflection of how its particles are organized inside."
```
