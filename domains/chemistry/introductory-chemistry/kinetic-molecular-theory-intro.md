...
title: "Particles in Motion: Introduction to Kinetic Theory"
domain: chemistry
...
- id: energy-in-phase-changes
  type: hard
- id: density-how-packed-together
  type: soft
builds-toward:
...
- Particles in a solid are not motionless — they vibrate constantly in place. Only at absolute zero (-273°C) would particles theoretically stop moving.
- Temperature is not the same as heat — temperature measures the average kinetic energy of particles, while heat is the total energy transferred between objects.
- Gas particles do not slow down and stop on their own — they keep moving until they collide with something. In a sealed container, they bounce around indefinitely.
- The spaces between gas particles are enormous compared to the particles themselves — gas is mostly empty space.

## Questions

```yaml
- question: "According to kinetic molecular theory, what happens to particle motion when temperature increases?"
  type: multiple-choice
  options: ["Particles stop moving", "Particles move faster on average", "Particles get larger", "Particles move slower"]
  answer: 1
...
- question: "Why does a gas fill its entire container while a liquid does not?"
  type: short-answer
  answer: "Gas particles move freely at high speeds with very weak attractions between them, so they spread out to fill all available space. Liquid particles are attracted to each other strongly enough to stay close together but can slide past one another, so they take the shape of the container but do not expand to fill it."
  explanation: "In a gas, kinetic energy dominates over the weak attractions between particles. Particles fly in all directions, bouncing off container walls and each other, until they occupy the entire volume. In a liquid, attractions between particles are strong enough to keep them close, but not strong enough to lock them in fixed positions. This intermediate behavior gives liquids a definite volume but no definite shape."
```
