...
- Breaking bonds does not release energy — it requires energy. Only forming bonds releases energy. This is one of the most commonly reversed facts in chemistry.
- Exothermic reactions still require some energy to start (activation energy) — the match that lights a campfire provides that initial push.
- Energy is not created in exothermic reactions — it is converted from the chemical potential energy stored in bonds.
- The total energy in the universe is conserved — energy absorbed in endothermic reactions comes from the surroundings, not from nothing.

## Questions

```yaml
- question: "What is required in terms of energy to break a chemical bond?"
  type: multiple-choice
  options: ["Energy is released", "Energy is absorbed", "No energy is involved", "Energy is created"]
  answer: 1
  explanation: "Breaking a chemical bond always requires energy input — you must add energy to pull bonded atoms apart. This is a common point of confusion. It is the reverse process — forming a bond — that releases energy."

- question: "In an exothermic reaction, the energy released by forming new bonds is greater than the energy needed to break old bonds."
  type: true-false
  answer: true
  explanation: "An exothermic reaction has a net release of energy because the bond-forming step produces more energy than the bond-breaking step consumes. The surplus energy exits the reaction as heat or light, warming the surroundings."

- question: "Using the concept of bond energy, explain why burning methane releases heat."
  type: short-answer
  answer: "The energy released by forming the new bonds in the products (CO2 and H2O) is greater than the energy required to break the bonds in the reactants (CH4 and O2), so the excess energy is released as heat."
  explanation: "In the combustion of methane (CH4 + 2O2 → CO2 + 2H2O), the C-H and O=O bonds in the reactants must be broken (energy absorbed), then C=O and O-H bonds form in the products (energy released). The bonds formed in CO2 and H2O are particularly strong, so the energy released during bond formation exceeds the energy consumed during bond breaking, making the overall reaction exothermic."
```
