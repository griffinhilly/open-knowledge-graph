...
- question: "Since all orbitals within the second principal shell (n = 2) share the same principal quantum number, they all have the same energy in a multi-electron atom like carbon."
  type: true-false
  answer: false
