...
- question: "In a covalent bond, each atom contributes electrons to the bond, but those electrons remain localized on their original atom — they are mainly 'shared' in the sense that both atoms benefit from proximity to the other."
  type: true-false
  answer: false
