...
- Thinking clouds are made of water vapor (they are actually tiny liquid droplets or ice crystals — the vapor already condensed).
- Believing the water cycle only happens over oceans.
- Thinking rainwater is "new" water rather than recycled water that has existed for billions of years.
- Assuming the water cycle stops at night or in winter.

## Questions

```yaml
- question: "What causes water from a lake to enter the atmosphere and eventually form clouds?"
  type: multiple-choice
  options:
    - "The wind blows the water straight up into the sky"
    - "The sun heats the water, it evaporates into vapor, and the vapor rises and condenses into cloud droplets"
    - "Fish push the water out of the lake and into the air"
    - "Clouds suck water up from the lake like a vacuum"
  answer: 1
  explanation: "The sun's heat provides energy for liquid water to evaporate from the lake's surface. The invisible water vapor rises because warm air is lighter. As it reaches higher, cooler air, the vapor condenses into tiny liquid droplets that we see as clouds."

- question: "Clouds are made of water vapor."
  type: true-false
  answer: false
  explanation: "False. Clouds are made of tiny liquid water droplets or tiny ice crystals — not water vapor. Water vapor is invisible. The vapor condensed into visible droplets to form the cloud. If clouds were vapor, you would not be able to see them."

- question: "Name the three main steps of the water cycle in order."
  type: short-answer
  answer: "Evaporation, condensation, and precipitation. Water evaporates from bodies of water, the vapor condenses into clouds, and water falls back to Earth as precipitation (rain, snow, or hail)."
  explanation: "The water cycle is driven by heat from the sun. Evaporation moves water from liquid to gas, condensation moves it from gas back to liquid (as clouds), and precipitation brings that liquid (or solid, as snow) back to the ground. Then it starts over."
```
