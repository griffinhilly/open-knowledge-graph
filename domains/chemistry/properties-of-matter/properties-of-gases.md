...
- Thinking gases are not matter because they are invisible.
- Believing air has no weight.
- Assuming gases cannot push on things or exert pressure.
- Thinking that an "empty" bottle or cup contains nothing (it is full of air).

## Questions

```yaml
- question: "You push down on a sealed syringe filled with air. What happens?"
  type: multiple-choice
  options:
    - "The air disappears because you pushed it out"
    - "The air compresses into a smaller space and pushes back against your thumb"
    - "The air turns into a liquid because of the pressure"
    - "Nothing happens — air cannot be squeezed"
  answer: 1
...
- question: "How can you prove that air takes up space?"
  type: short-answer
  answer: "Push an upside-down cup straight down into a bowl of water. The air trapped inside the cup keeps the water from filling the cup, proving the air is taking up space."
  explanation: "This classic experiment shows that air is real matter occupying space. The water cannot enter the cup because the air is already there. If you tilt the cup, air bubbles escape and water rushes in to take the air's place."
```
