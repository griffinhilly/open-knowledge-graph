...
- Reading the thermometer at an angle instead of at eye level, which causes parallax errors.
- Thinking the thermometer creates heat rather than measuring it.
- Confusing Celsius and Fahrenheit scales or not knowing which one they are reading.
- Believing the colored liquid in the thermometer IS the temperature rather than understanding it is an indicator that responds to temperature.

## Questions

```yaml
- question: "You place a thermometer in a cup of warm water. The liquid inside the thermometer rises. Why?"
  type: multiple-choice
  options:
    - "The warm water pushed the liquid up through the tube"
    - "The heat from the water caused the liquid in the thermometer to expand and rise"
    - "The thermometer is creating its own heat"
    - "The liquid is boiling inside the tube"
  answer: 1
  explanation: "When the thermometer is placed in warm water, heat flows from the water into the liquid inside the thermometer. The liquid expands (takes up more space) as it warms, causing it to rise up the narrow tube. This is how thermometers translate temperature into a visible reading you can measure."

- question: "Water freezes at 0 degrees Fahrenheit."
  type: true-false
  answer: false
  explanation: "False. Water freezes at 0 degrees Celsius, not Fahrenheit. In Fahrenheit, water freezes at 32 degrees. In science, the Celsius scale is standard because it is based on the freezing and boiling points of water: 0 degrees for freezing, 100 degrees for boiling."

- question: "Why should you read a thermometer with your eyes level with the top of the liquid?"
  type: short-answer
  answer: "Reading at eye level gives an accurate measurement. If you look from above or below, the angle makes the liquid appear to be at a different level than it actually is, which gives you a wrong reading. This error is called parallax."
  explanation: "Parallax is a reading error caused by viewing an instrument from an angle. When your eyes are level with the liquid, you see exactly where it lines up on the scale. From above, it looks lower than it is; from below, it looks higher. Eye-level reading eliminates this error."
```
