...
- Thinking all metals conduct only electricity but not heat (metals conduct both).
- Believing insulators stop heat forever (they slow it down but do not block it permanently).
- Assuming "conductor" means the material creates heat or electricity (it just allows passage).
- Thinking a cold metal object is colder than a wooden object at the same temperature (metal just feels colder because it conducts heat away from your hand faster).

## Questions

```yaml
- question: "A metal spoon and a wooden spoon sit in the same cup of hot soup. After two minutes, the metal spoon's handle is hot but the wooden spoon's handle is still cool. Why?"
  type: multiple-choice
  options:
    - "The metal spoon is closer to the soup"
    - "Metal is a conductor — it lets heat travel through it quickly from the soup to the handle. Wood is an insulator — it slows heat flow."
    - "The soup is hotter near the metal spoon"
    - "The wooden spoon is absorbing all the heat, so it does not feel warm"
  answer: 1
...
- question: "Why are electrical wires made of copper but covered in plastic?"
  type: short-answer
  answer: "Copper is an excellent conductor of electricity, so it carries the current efficiently. Plastic is an excellent insulator, so it prevents the electricity from escaping the wire and shocking people or causing short circuits."
  explanation: "This is a practical application of conductor and insulator properties. The copper core does the job of carrying electricity, and the plastic coating does the job of keeping that electricity safely contained. Each material is chosen for the property it contributes."
```
