...
title: "Saturation: When No More Will Dissolve"
domain: chemistry
...
- Thinking you can dissolve an unlimited amount of any solute if you stir hard enough.
- Believing the undissolved solute at the bottom is different from the dissolved solute.
- Not realizing that temperature changes the saturation limit.
- Thinking all substances have the same saturation point in water.

## Questions

```yaml
- question: "You keep adding salt to a cup of water and stirring. Eventually, salt starts sitting at the bottom no matter how much you stir. What has happened?"
  type: multiple-choice
  options:
    - "The water is broken and can no longer dissolve salt"
    - "The solution is saturated — the water is holding the maximum amount of salt it can"
    - "You are stirring in the wrong direction"
    - "The salt at the bottom is a different kind of salt that does not dissolve"
  answer: 1
  explanation: "The solution has reached saturation. Every solvent can only hold a certain amount of a given solute at a given temperature. Once that limit is reached, adding more solute just leaves it undissolved at the bottom. The water is not broken — it is simply full."

- question: "Heating water allows you to dissolve more sugar in it."
  type: true-false
  answer: true
  explanation: "True. For most solids like sugar and salt, warm water can dissolve more solute than cold water. The warmer water particles move faster and can pull apart more solute particles. This is why making sweet tea works better with hot water — you can dissolve much more sugar."

- question: "What does it mean when a solution is saturated?"
  type: short-answer
  answer: "A saturated solution is one that has dissolved the maximum amount of solute it can hold at that temperature. No more solute will dissolve — any extra will remain undissolved."
  explanation: "Saturation is the dissolving limit. It depends on the specific solute, the specific solvent, and the temperature. If you change any of these factors, the saturation point changes too."
```
