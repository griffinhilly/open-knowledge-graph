...
- Thinking liquids always look like water (clear, thin, and colorless).
- Believing thick liquids like honey or ketchup might be solids because they move slowly.
- Assuming liquids have no definite volume because they change shape.
- Thinking that stirring or shaking a liquid changes the amount you have.

## Questions

```yaml
- question: "You pour 200 mL of orange juice from a tall, thin glass into a short, wide bowl. How much orange juice is now in the bowl?"
  type: multiple-choice
  options:
    - "Less than 200 mL — some stayed behind in the glass"
    - "200 mL — the shape changed but the amount did not"
    - "More than 200 mL — the juice spread out, so there is more"
    - "You cannot tell without measuring again"
  answer: 1
  explanation: "Liquids keep a definite volume. Changing the container changes the shape of the liquid, not the amount. If you poured all 200 mL out, you still have 200 mL. The juice looks different because the bowl is wider, but the volume is the same."

- question: "Honey is a solid because it moves very slowly."
  type: true-false
  answer: false
  explanation: "False. Honey is a liquid — it flows and takes the shape of its container. It moves slowly because it has high viscosity (it is thick), but slow flow is still flow. A solid would not flow at all; it would keep its own shape."

- question: "What does the word viscosity describe about a liquid?"
  type: short-answer
  answer: "Viscosity describes how thick a liquid is, or how slowly or quickly it flows. High viscosity means the liquid is thick and flows slowly (like honey). Low viscosity means it is thin and flows quickly (like water)."
  explanation: "Viscosity is a measure of a liquid's resistance to flowing. All liquids flow, but some flow much faster than others. Comparing flow speeds is a hands-on way to observe differences in viscosity."
```
