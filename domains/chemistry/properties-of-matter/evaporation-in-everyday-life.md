...
title: Evaporation in Everyday Life
domain: chemistry
...
- Thinking evaporation only happens when water is boiling or very hot.
- Believing the water "disappears" or is destroyed when it evaporates.
- Not realizing that evaporation happens only at the surface, not throughout the liquid.
- Thinking clothes dryers work only by heat, when air movement is equally important.

## Questions

```yaml
- question: "A puddle on the sidewalk is gone by the afternoon, but nobody mopped it up. What happened to the water?"
  type: multiple-choice
  options:
    - "The water was destroyed by the sun"
    - "The water soaked into the ground and completely disappeared"
    - "The water evaporated — it turned from liquid into invisible water vapor in the air"
    - "The water is still there but became invisible on the sidewalk"
  answer: 2
...
- question: "Why does a wet towel spread out flat dry faster than the same wet towel bunched up in a ball?"
  type: short-answer
  answer: "The flat towel has more surface area exposed to the air, so more water can evaporate at the same time. The bunched-up towel traps wet surfaces against each other where the air cannot reach them."
  explanation: "Evaporation only happens at the surface where liquid meets air. More surface area means more liquid is exposed and can turn into vapor at once. This is why spreading laundry out makes it dry faster."
```
