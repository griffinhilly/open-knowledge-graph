---
id: recording-observations-in-science
title: Recording Observations Like a Scientist
domain: chemistry
...
- Thinking you can remember observations well enough without writing them down.
- Not including units (writing "25" instead of "25 degrees Celsius" or "25 mL").
- Recording only final results and not the process or intermediate observations.
- Believing that only numbers count as data (descriptions, drawings, and color observations are valuable data too).

## Questions

```yaml
- question: "A student records the mass of an object as '42.' What is missing from this observation?"
  type: multiple-choice
  options:
    - "Nothing — 42 is a clear number"
    - "The unit of measurement — it should say '42 grams' or '42 kg' so others know what 42 means"
...
- question: "Why is a data table more useful than a paragraph for recording measurements taken over time?"
  type: short-answer
  answer: "A data table organizes numbers in rows and columns with clear labels, making it easy to compare values, spot patterns, and find specific measurements quickly. A paragraph buries the numbers in sentences, making them harder to find and compare."
  explanation: "Tables are designed for organized comparison. When you have repeated measurements (like temperature every 2 minutes), a table lets you scan down a column and instantly see whether values are rising, falling, or staying the same. This visual clarity is why scientists use tables for quantitative data."
```
