...
- Thinking the solute disappears or is destroyed when it dissolves.
- Believing everything dissolves in water.
- Assuming dissolving is a chemical change (it is usually a physical change — the solute can be recovered).
- Thinking stirring is what causes dissolving rather than just speeding it up.

## Questions

```yaml
- question: "You stir a spoonful of salt into a glass of warm water. The water looks clear. Where did the salt go?"
  type: multiple-choice
  options:
    - "The salt was destroyed by the water"
    - "The salt melted into a liquid"
    - "The salt dissolved — it broke into pieces too tiny to see and spread throughout the water"
    - "The salt sank to the bottom where you cannot see it"
  answer: 2
...
- question: "What is the difference between a solute and a solvent?"
  type: short-answer
  answer: "The solute is the substance that gets dissolved (like sugar or salt), and the solvent is the substance that does the dissolving (like water). The solute breaks apart and spreads throughout the solvent to form a solution."
  explanation: "Think of the solvent as the host and the solute as the guest. Water is the most common solvent, but other liquids can be solvents too. The solute is always the material that seems to disappear into the solvent."
```
