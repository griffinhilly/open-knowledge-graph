...
title: Flexibility and Brittleness
domain: chemistry
...
- Thinking flexible materials are always weak (steel cables are flexible and extremely strong).
- Believing brittle materials are always hard (a dry leaf is brittle but not hard).
- Assuming flexibility means the material will return to its original shape (some bend and stay bent).
- Confusing softness with flexibility — a sponge is soft but does not bend the way a wire does.

## Questions

```yaml
- question: "You try to bend a dry spaghetti noodle and it snaps in half. What property does this demonstrate?"
  type: multiple-choice
  options:
    - "Flexibility — the noodle bent before it broke"
    - "Brittleness — the noodle broke instead of bending"
    - "Hardness — the noodle resisted your force"
    - "Strength — the noodle was too strong to bend"
  answer: 1
...
- question: "Why would an engineer choose a flexible material instead of a rigid one for a phone case?"
  type: short-answer
  answer: "A flexible phone case can absorb the shock of being dropped by bending slightly, rather than cracking or shattering. The flexibility helps it protect the phone by cushioning the impact."
  explanation: "Flexible materials absorb and distribute force by deforming, which reduces the chance of breaking. A rigid, brittle case might shatter on impact, leaving the phone unprotected. Flexibility is an advantage whenever a material needs to handle sudden forces."
```
