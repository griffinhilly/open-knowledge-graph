---
id: choosing-materials-for-a-purpose
title: Choosing the Right Material for the Job
domain: chemistry
course: properties-of-matter
prerequisites:
- id: hardness-and-strength
  type: hard
- id: flexibility-and-brittleness
  type: hard
...
- Thinking there is always one "best" material (the best choice depends on the specific requirements).
- Believing expensive materials are always better than cheap ones.
- Not considering that a single object might need different materials for different parts.
- Assuming engineers only think about strength (they also consider weight, cost, flexibility, and many other properties).

## Questions

```yaml
- question: "You are designing a kitchen spatula. Why might you use metal for the flat part but rubber for the handle?"
  type: multiple-choice
  options:
    - "Metal is cheaper and rubber is more colorful"
    - "Metal is a good heat conductor and is rigid enough to flip food; rubber is an insulator that keeps the handle cool and provides a comfortable, non-slip grip"
    - "Metal is lighter than rubber"
    - "There is no good reason — both parts should be the same material"
  answer: 1
...
- question: "What properties would you look for in a material to make an umbrella?"
  type: short-answer
  answer: "Waterproof (non-absorbent) so rain slides off, lightweight so it is easy to carry, flexible enough to fold, and strong enough not to break in wind."
  explanation: "An umbrella needs several properties at once: it must repel water, be light, fold up, and withstand wind. No single property is enough — the designer must consider all the requirements together and find a material (usually a synthetic fabric like nylon) that satisfies them all."
```
