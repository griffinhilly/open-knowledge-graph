...
- Thinking the bubbles in boiling water are air, not water vapor.
- Believing steam and water vapor are different things (visible "steam" is actually tiny water droplets that formed from condensation; true water vapor is invisible).
- Thinking boiling water gets hotter and hotter the longer you boil it (it stays at 100 degrees Celsius).
- Believing condensation is water leaking through the glass from inside a cold drink.

## Questions

```yaml
- question: "You see water droplets forming on the outside of a cold glass of lemonade on a warm day. Where did the water come from?"
  type: multiple-choice
  options:
    - "The lemonade leaked through the glass"
    - "The cold glass cooled the water vapor in the warm air, and it condensed into liquid droplets"
    - "The ice inside the glass pushed water out through tiny holes"
    - "The glass is sweating, just like a person does"
  answer: 1
  explanation: "The warm air around the glass contains invisible water vapor. When this vapor touches the cold surface of the glass, it loses heat and condenses — turns from gas back into liquid. The droplets come from the air, not from inside the glass."

- question: "Boiling water keeps getting hotter the longer you heat it."
  type: true-false
  answer: false
  explanation: "False. Once water reaches its boiling point (100 degrees Celsius at normal air pressure), its temperature stops rising. All the extra heat energy goes into turning the liquid water into gas (steam) rather than making the water hotter."

- question: "What is condensation?"
  type: short-answer
  answer: "Condensation is when a gas cools down and turns into a liquid. For example, water vapor in the air turns into liquid water droplets when it touches a cold surface."
  explanation: "Condensation is the reverse of boiling or evaporation. Gas particles slow down as they lose heat, come closer together, and form a liquid. You see condensation on bathroom mirrors after a hot shower and on cold windows on a warm, humid day."
```
