...
title: "Magnetism: Which Materials Are Magnetic?"
domain: chemistry
...
- Thinking all metals are magnetic (copper, aluminum, gold, and silver are not).
- Believing magnets attract everything or that bigger magnets attract non-magnetic materials.
- Confusing "metal" with "magnetic" — most metals are actually not magnetic.
- Thinking the magnet is pulling on the object with some kind of glue or stickiness.

## Questions

```yaml
- question: "You test four metal objects with a magnet: a steel paper clip, a copper penny, an aluminum can, and a nickel coin. Which ones will the magnet attract?"
  type: multiple-choice
  options:
    - "All four — they are all metals, and magnets attract metal"
    - "Only the steel paper clip — steel is the only metal"
    - "The steel paper clip and the nickel coin — steel contains iron and nickel is a magnetic metal"
    - "None of them — magnets only attract other magnets"
  answer: 2
...
- question: "How can you test whether an object is magnetic?"
  type: short-answer
  answer: "Hold a magnet near the object. If the object is pulled toward the magnet (attracted to it), it is magnetic. If nothing happens, it is not magnetic."
  explanation: "The magnet test is simple and reliable. If the object moves toward the magnet or sticks to it, the object contains a magnetic material like iron, nickel, or cobalt. Objects that show no response contain no magnetic materials."
```
