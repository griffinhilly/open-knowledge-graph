---
id: suspensions-and-colloids
title: "Suspensions: Mixtures That Don't Dissolve"
domain: chemistry
...
- Thinking all mixtures with liquid are solutions.
- Believing muddy water is a solution because the dirt is "mixed in."
- Not understanding that the particles in a suspension will eventually settle if left alone.
- Confusing cloudy appearance with a different kind of liquid rather than recognizing floating particles.

## Questions

```yaml
- question: "You shake a jar of sand and water. The water turns cloudy brown. After 10 minutes, the sand is sitting at the bottom and the water is clear again. What type of mixture is this?"
  type: multiple-choice
  options:
    - "A solution — because the sand mixed with the water when you shook it"
    - "A suspension — because the sand particles were temporarily spread through the water but settled out"
    - "A pure substance — because the sand and water separated on their own"
    - "A chemical reaction — because the water changed color"
  answer: 1
  explanation: "This is a suspension. The sand particles were spread through the water by shaking, making it look cloudy, but they were too large to truly dissolve. Given time, gravity pulled them to the bottom. In a true solution, the particles would not settle out."

- question: "Orange juice with pulp is a suspension."
  type: true-false
  answer: true
  explanation: "True. The pulp pieces are tiny bits of orange fruit floating in the juice. They are too large to dissolve, and if you let the juice sit long enough, pulp settles toward the bottom. That is why orange juice cartons say 'shake well' — the suspension separates over time."

- question: "How can you tell the difference between a solution and a suspension just by looking?"
  type: short-answer
  answer: "A solution is usually clear because the dissolved particles are too small to see or block light. A suspension looks cloudy or murky because the particles are large enough to scatter light. A suspension will also settle over time if left undisturbed."
  explanation: "Clarity is the quickest visual test. Solutions let light pass straight through, while suspensions scatter it, making the mixture look foggy or opaque. Watching whether the mixture separates on its own is another reliable test."
```
