...
- Thinking fire "eats" or destroys matter rather than changing it into new substances (ash, gases).
- Believing fire is a substance or a state of matter rather than a chemical reaction.
- Not realizing that invisible gases (carbon dioxide, water vapor) are produced by burning.
- Thinking only wood or paper can burn.

## Questions

```yaml
- question: "A candle is burning inside a sealed glass jar. After a short time, the flame goes out. Why?"
  type: multiple-choice
  options:
    - "The candle got too hot and melted completely"
    - "The candle used up all the oxygen inside the jar, so burning could not continue"
    - "The glass blocked the light from reaching the flame"
    - "The jar trapped too much smoke, which put the fire out"
  answer: 1
...
- question: "What three things are needed for fire to exist?"
  type: short-answer
  answer: "Fuel (something to burn, like wood or paper), oxygen (from the air), and heat (enough to start the reaction). These three are called the fire triangle."
  explanation: "The fire triangle explains both how fires start and how they can be stopped. Remove the fuel (clear the area), remove the oxygen (smother with a blanket or use a fire extinguisher), or remove the heat (spray with water) — take away any one of the three and the fire goes out."
```
