...
title: Hardness and Strength of Materials
domain: chemistry
...
- Thinking hardness and strength are the same property.
- Believing heavier materials are always harder or stronger.
- Assuming soft materials are useless (soft materials are chosen when comfort or flexibility matters).
- Thinking diamond is strong just because it is hard (diamond can shatter if struck the right way).

## Questions

```yaml
- question: "A glass window is hard to scratch with a coin, but it can shatter when a baseball hits it. Which statement is correct?"
  type: multiple-choice
  options:
    - "Glass is both hard and strong"
    - "Glass is hard (scratch-resistant) but not very strong (it breaks under impact)"
    - "Glass is strong but not hard"
    - "Glass is neither hard nor strong — it is just fragile"
  answer: 1
...
- question: "What is the difference between hardness and strength?"
  type: short-answer
  answer: "Hardness is how well a material resists being scratched or dented. Strength is how well a material resists being broken, bent, or pulled apart. A material can be hard without being strong, or strong without being hard."
  explanation: "Think of it this way: hardness is about the surface (can you scratch it?), while strength is about the whole object (can you break it?). Glass has a hard surface but breaks easily. Rope is soft (easy to dent) but incredibly strong (hard to snap)."
```
