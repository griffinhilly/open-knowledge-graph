...
title: Observing and Describing Matter
domain: chemistry
...
- Thinking observation means just looking (touch, smell, and hearing are observations too).
- Using vague words like "nice," "cool," or "weird" instead of specific property descriptions.
- Believing scientists need fancy equipment for all observations (your senses are powerful scientific tools).
- Forgetting that observation is about what IS there, not what you think or feel about it.

## Questions

```yaml
- question: "A student describes a rock as 'pretty cool.' A scientist describes the same rock as 'a rough, gray, opaque solid about 5 cm wide with dark speckles.' Which description is more useful for science?"
  type: multiple-choice
  options:
    - "The student's — it is shorter and easier to understand"
    - "The scientist's — it uses specific property words that help anyone identify and compare the rock"
    - "Both are equally useful — they describe the same rock"
    - "Neither — you need a microscope to truly describe a rock"
  answer: 1
...
- question: "List three properties you could use to describe a wooden pencil."
  type: short-answer
  answer: "Possible answers include: yellow color, cylindrical shape, lightweight, smooth texture (painted surface), solid state, about 19 cm long, opaque, made of wood with a graphite center, has a rubber eraser on one end."
  explanation: "A good description uses multiple properties. Color, shape, size, texture, weight, and material are all valid properties you can observe. The more specific your description, the easier it is for someone else to know exactly what you are talking about."
```
