---
id: rusting-and-tarnishing
title: Rusting and Tarnishing
domain: chemistry
...
- Thinking rust is just dirt on the metal that can be wiped away to reveal the original iron underneath.
- Believing only water causes rust (oxygen is also required).
- Assuming all metals rust (only iron and steel rust; other metals tarnish differently).
- Thinking rusting happens suddenly rather than gradually over time.

## Questions

```yaml
- question: "A nail left outside in the rain develops a flaky, reddish-brown coating. What happened?"
  type: multiple-choice
  options:
    - "Dirt from the rain stained the nail"
    - "The iron in the nail reacted with oxygen and water to form rust — a new substance"
    - "The nail melted slightly in the rain and changed color"
    - "The paint on the nail wore off, revealing the red metal underneath"
  answer: 1
  explanation: "The nail rusted. Iron reacted chemically with oxygen from the air and water from the rain to create iron oxide, commonly called rust. Rust is a completely different substance from iron — it is flaky, reddish-brown, and weaker. This is a chemical change, not just a surface stain."

- question: "Rust can be turned back into iron by simply washing it off with water."
  type: true-false
  answer: false
  explanation: "False. Rust is a new chemical substance (iron oxide) formed by a chemical change. You cannot reverse a chemical change by washing it. The iron atoms have combined with oxygen atoms to form something entirely different. Once iron has rusted, that portion of the iron is gone — it has become rust."

- question: "Why does painting a metal fence help prevent rusting?"
  type: short-answer
  answer: "Paint creates a barrier that keeps oxygen and water from touching the iron surface. Since rust requires both oxygen and water to react with iron, blocking them prevents the chemical change from happening."
  explanation: "Rusting needs three things: iron, oxygen, and water. Remove any one of these and rusting stops. Paint acts as a shield over the iron, stopping oxygen and moisture in the air from reaching the metal. This is why scratches in paint often lead to rust spots — the exposed metal can now react."
```
