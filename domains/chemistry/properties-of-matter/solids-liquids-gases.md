...
- Thinking that very small solids (like sand or sugar) are liquids because they pour.
- Believing gases are "nothing" because they are invisible.
- Assuming all liquids are water or look like water.
- Thinking that soft solids (like a pillow) might be a gas because they are squishy.

## Questions

```yaml
- question: "A sealed plastic bag is filled with air. You squeeze the bag and it gets smaller. What state of matter is the air inside?"
  type: multiple-choice
  options:
    - "Solid — because it pushes back when you squeeze"
    - "Liquid — because it moves around inside the bag"
    - "Gas — because it fills the whole bag and can be squeezed into a smaller space"
    - "It is not matter — air is invisible so it is nothing"
  answer: 2
  explanation: "Air is a gas. Gases spread out to fill their container and can be compressed (squeezed into a smaller space). The push-back you feel is the gas resisting compression, not a solid property."

- question: "Sand pours out of a bucket, so sand is a liquid."
  type: true-false
  answer: false
  explanation: "False. Each grain of sand is a tiny solid that keeps its own shape. When you pour sand, the individual grains slide past each other, which looks like flowing, but each piece is still a solid. A liquid would have no separate pieces — it would be one continuous flowing substance."

- question: "What is one way you can tell the difference between a solid and a liquid without looking at them?"
  type: short-answer
  answer: "You can feel whether it keeps its shape. A solid holds its shape when you pick it up or set it down, while a liquid flows and changes shape to match whatever is holding it."
  explanation: "The key property that separates solids from liquids is shape. Solids have a definite shape of their own. Liquids take the shape of their container. You can discover this by touch — a solid feels firm and holds its form, while a liquid slips and flows through your fingers."
```
