...
- Thinking melting means the matter disappears or is destroyed.
- Believing all solids melt at the same temperature.
- Not realizing that freezing and melting are reverse processes of each other.
- Thinking you need to heat something to extremely high temperatures for any melting to occur.

## Questions

```yaml
- question: "You leave a chocolate bar on a sunny windowsill and it becomes soft and gooey. What happened?"
  type: multiple-choice
  options:
    - "The chocolate disappeared because of the heat"
    - "The chocolate melted — the heat from the sun changed it from solid to liquid"
    - "The chocolate became a gas because it got too hot"
    - "The sun broke the chocolate into smaller pieces"
  answer: 1
  explanation: "The heat from the sun raised the chocolate's temperature past its melting point, turning it from a solid into a soft, flowing liquid. The chocolate did not disappear or become a gas — it simply changed state from solid to liquid."

- question: "Freezing and melting are reverse processes of each other."
  type: true-false
  answer: true
  explanation: "True. Melting turns a solid into a liquid by adding heat. Freezing turns a liquid into a solid by removing heat. They are exact opposites. You can melt an ice cube into water and then freeze that water back into an ice cube — the matter goes back and forth between the two states."

- question: "Why does an ice cube melt faster on a warm day than on a cold day?"
  type: short-answer
  answer: "On a warm day, the surrounding air has more heat to transfer to the ice cube, so the ice gains heat faster and reaches its melting point more quickly."
  explanation: "Melting requires heat energy. The warmer the environment around the ice, the faster heat flows into the ice. On a cold day, there is less heat available in the air, so the ice gains heat slowly and melts slowly."
```
