---
id: mass-and-weight
title: "Mass and Weight: What's the Difference?"
domain: chemistry
...
- Thinking bigger objects always have more mass (a small rock can have more mass than a big balloon).
- Believing mass changes when you go to a different planet.
- Assuming a balance and a scale measure the same thing (a balance compares masses; a scale measures the pull of gravity).

## Questions

```yaml
- question: "An astronaut has a mass of 70 kilograms on Earth. What is the astronaut's mass on the Moon?"
  type: multiple-choice
  options:
    - "About 12 kilograms — the Moon has less gravity"
    - "70 kilograms — mass does not change based on location"
    - "0 kilograms — there is no gravity on the Moon"
    - "140 kilograms — the Moon doubles your mass"
  answer: 1
  explanation: "Mass is the amount of matter in an object, and it stays the same no matter where you are. The astronaut is still made of the same amount of stuff on the Moon. Weight would change (the astronaut would feel lighter because the Moon's gravity is weaker), but mass does not."

- question: "A bowling ball and a basketball are about the same size, so they have the same mass."
  type: true-false
  answer: false
  explanation: "False. The bowling ball has much more mass than the basketball even though they are similar in size. The bowling ball is packed with dense, heavy material, while the basketball is mostly filled with air. Mass depends on how much matter is inside, not on how big the object looks."

- question: "What is the difference between mass and weight?"
  type: short-answer
  answer: "Mass is the amount of matter in an object and stays the same everywhere. Weight is the force of gravity pulling on that mass and changes depending on the strength of gravity (for example, you weigh less on the Moon than on Earth, but your mass stays the same)."
  explanation: "Mass is an intrinsic property of matter — it belongs to the object itself. Weight is a force that depends on the environment. On Earth, we often use the words interchangeably in casual conversation, but in science they have precise, different meanings."
```
