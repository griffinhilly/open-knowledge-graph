---
id: natural-and-synthetic-materials
...
- Thinking "natural" always means better or safer (some natural materials are toxic; some synthetic materials are perfectly safe).
- Believing synthetic materials are not real matter.
- Assuming all plastics are the same material (there are many different types with very different properties).
- Thinking natural materials cannot be changed or processed (lumber is processed wood, fabric is processed cotton or wool).

## Questions

```yaml
- question: "Which of these is a synthetic material?"
...
- question: "What is the difference between a natural material and a synthetic material?"
  type: short-answer
  answer: "Natural materials come from nature (plants, animals, or the earth) and are not made by people. Synthetic materials are made by people in factories using chemical processes."
  explanation: "The key difference is origin. Wood, stone, cotton, leather, and silk are natural. Plastic, nylon, polyester, and fiberglass are synthetic. Some materials are tricky — rubber can be natural (from rubber trees) or synthetic (made in a factory), and processed materials like paper started natural but were manufactured into a new form."
```
