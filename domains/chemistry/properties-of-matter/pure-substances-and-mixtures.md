...
- Thinking that if a mixture looks uniform (like salt water), it must be a pure substance.
- Believing that mixing things together creates a new substance.
- Assuming you cannot separate a mixture back into its parts.
- Thinking "pure" means "natural" or "healthy" rather than "made of one kind of material."
...
- question: "Which of the following is a mixture?"
  ...
  options:
    - "A gold ring made of pure gold"
    - "A glass of distilled water"
    - "A bowl of chicken noodle soup"
    - "A block of pure iron"
  answer: 2
  explanation: "Chicken noodle soup contains broth, noodles, chicken, and vegetables — several different materials combined together. Each ingredient keeps its own identity and could be separated out. The gold ring, distilled water, and iron block are each made of only one kind of material, making them pure substances."

- question: "When you mix salt into water, the salt becomes water."
  type: true-false
  answer: false
  explanation: "False. The salt dissolves and seems to disappear, but it is still salt — it keeps its salty taste and can be recovered by evaporating the water. In a mixture, each substance keeps its own properties even when you cannot see them separately."

- question: "What is the main difference between a pure substance and a mixture?"
  type: short-answer
  answer: "A pure substance is made of only one kind of material, while a mixture is two or more different materials combined together, where each material keeps its own properties."
  explanation: "The key idea is that in a mixture, the ingredients do not lose their identity. Salt water tastes salty because the salt is still salt. You can separate the parts of a mixture using physical methods like filtering or evaporating, which proves the materials were not changed by being mixed."
```
