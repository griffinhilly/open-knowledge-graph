...
title: Cooking as Chemical Change
domain: chemistry
course: properties-of-matter
prerequisites:
- id: signs-of-chemical-change
  type: hard
builds-toward:
...
- Thinking cooking is just melting food or heating it up (physical change) rather than creating new substances (chemical change).
- Believing you can uncook food if you cool it down fast enough.
- Assuming all heating of food is a chemical change (warming up soup is mostly physical; baking a cake is chemical).
- Thinking the brown color on toast is just a tan from the heat rather than a sign of new substances forming.

## Questions

```yaml
- question: "You crack a raw egg into a hot pan. The clear, runny egg white becomes solid and white. What kind of change is this?"
  type: multiple-choice
  options:
    - "Physical change — the egg just melted into a different shape"
    - "Reversible change — if you cool the egg, it will become runny again"
    - "Chemical change — heat caused the egg proteins to form new bonds, creating a new substance with different properties"
    - "No change — the egg was always white"
  answer: 2
  explanation: "Cooking an egg is a chemical change. The heat breaks apart the protein structures in the egg and causes them to reform in a completely new arrangement. The result — a firm, white, opaque solid — has entirely different properties from the raw egg. You cannot reverse this by cooling the egg."

- question: "If you cool a baked cake back down to room temperature, it will turn back into raw batter."
  type: true-false
  answer: false
  explanation: "False. Baking a cake is an irreversible chemical change. The heat caused the flour, eggs, sugar, and other ingredients to react and form new substances. Cooling the cake just makes it a cold cake — it does not reverse the chemical reactions that occurred during baking."

- question: "Why is cooking an egg a chemical change but melting butter a physical change?"
  type: short-answer
  answer: "Cooking an egg creates new substances — the proteins change permanently and cannot go back to their raw form. Melting butter just changes its state from solid to liquid without creating new substances. You can re-solidify butter by cooling it, but you cannot uncook an egg."
  explanation: "The key difference is whether new substances form. Melted butter is still butter — same substance, different state. A cooked egg is a different substance entirely from a raw egg — different color, texture, and properties. The chemical bonds in the egg proteins were broken and reformed into a new arrangement."
```
