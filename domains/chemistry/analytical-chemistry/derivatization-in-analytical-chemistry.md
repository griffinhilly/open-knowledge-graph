...
- question: "Because derivatization chemically transforms the analyte into a new compound, the mass spectrum of the derivative can seldom be used to identify the original analyte."
  type: true-false
  answer: false
