...
- question: "In chemometrics, including more spectral variables (wavelengths) in a calibration model typically improves its predictive accuracy on new samples."
  type: true-false
  answer: false
