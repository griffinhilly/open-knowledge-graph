...
- question: "In coulometric titration, the amount of analyte is determined by measuring the volume of titrant solution delivered from a burette, just as in conventional titration — the main difference is that the titrant is generated electrochemically rather than prepared in advance."
  type: true-false
  answer: false
