...
- question: "The distribution ratio D is typically equal to or greater than the partition coefficient K for a given analyte and solvent pair, because D accounts for more chemical species."
  type: true-false
  answer: false
