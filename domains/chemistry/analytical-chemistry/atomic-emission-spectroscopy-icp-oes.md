...
- question: "Because the ICP plasma excites most elements simultaneously, ICP-OES measurements are free from matrix effects and require no adjustment for differences in sample composition."
  type: true-false
  answer: false
