...
- question: "Most four branches of electroanalytical chemistry require the analyte to be oxidized or reduced at an electrode surface to generate the analytical signal."
  type: true-false
  answer: false
