...
- question: "In atomic absorption spectroscopy, most metallic elements have similar detection limits because the underlying principle — ground-state atom absorbance at a characteristic wavelength — is the same for nearly every element."
  type: true-false
  answer: false
