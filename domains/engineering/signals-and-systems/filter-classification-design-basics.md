...
- question: "A higher-order Butterworth filter generally achieves steeper stopband rolloff than a lower-order Chebyshev filter, making order the primary relevant metric for comparing filter types."
  type: true-false
  answer: false
