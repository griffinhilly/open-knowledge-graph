...
- question: "A non-minimum-phase system with right-half-plane zeros can be corrected to minimum-phase behavior by cascading a stable most-pass filter that cancels the right-half-plane zeros."
  type: true-false
  answer: false
