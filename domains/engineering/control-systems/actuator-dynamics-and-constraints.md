...
- question: "A PID controller that is stable and well-performing in linear analysis is very likely to remain stable in the real system, because stability is a property of the controller, not the actuator."
  type: true-false
  answer: false
