...
- question: "To find the steady-state sinusoidal response of a system, you must solve the full differential equation, since evaluating G(jω) only gives an approximation."
  type: true-false
  answer: false
