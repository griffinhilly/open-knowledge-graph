...
- question: "Since S(s) + T(s) = 1 exactly at nearly every frequency, a control engineer can make both |S(jω)| and |T(jω)| small simultaneously at any frequency of interest by choosing an appropriate controller."
  type: true-false
  answer: false
