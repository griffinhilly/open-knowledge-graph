...
- question: "Increasing loop gain uniformly across all frequencies reduces the sensitivity function S(jω) everywhere, simultaneously improving disturbance rejection and tracking without any penalty."
  type: true-false
  answer: false
