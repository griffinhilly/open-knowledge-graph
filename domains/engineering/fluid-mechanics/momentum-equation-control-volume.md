...
- question: "The momentum equation ΣF = ṁ(V_out − V_in) applies only to control volumes that are themselves in motion, since a stationary control volume has no net force acting on it."
  type: true-false
  answer: false
