...
- question: "A diverging nozzle section always decelerates a flow because the larger cross-sectional area reduces velocity by conservation of mass, just as water slows in a widening river."
  type: true-false
  answer: false
