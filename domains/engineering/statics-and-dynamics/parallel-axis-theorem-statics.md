...
- question: "The centroidal moment of inertia Ī is the maximum moment of inertia about all axes parallel to the centroidal axis, because any axis farther from the centroid has less area concentrated near it."
  type: true-false
  answer: false
