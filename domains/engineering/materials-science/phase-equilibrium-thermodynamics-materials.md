...
- question: "At thermodynamic equilibrium, the phase present in the largest amount in a two-phase alloy is expected to have the lower Gibbs free energy of the two phases."
  type: true-false
  answer: false
