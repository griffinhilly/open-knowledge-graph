...
- question: "A combustion system that rejects no heat to the environment achieves 100% second-law efficiency because most energy is retained as thermal exergy in the exhaust."
  type: true-false
  answer: false
