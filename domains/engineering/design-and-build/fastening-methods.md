...
title: "Fastening: Glue, Tape, Screws, and Nails"
domain: engineering
...
- More glue makes a stronger joint. (Too much glue actually weakens many joints because the glue layer is thick and flexible instead of thin and rigid. A thin, even coat of glue on both surfaces usually makes the strongest bond.)
- Tape is just as strong as glue for permanent projects. (Tape is convenient for temporary or light-duty connections, but it weakens over time — especially with heat, moisture, or stress. For permanent structures, glue, screws, or nails are much stronger.)
- Screws and nails do the same thing. (Screws have threads that grip the material, making them much stronger at resisting pulling-out forces. Nails rely on friction. Screws are stronger and removable but slower to install. Nails are faster but weaker against pull-out.)

## Questions

```yaml
- question: "You need to join two pieces of wood for an outdoor birdhouse. Which fastener is the best choice?"
  type: multiple-choice
  options: ["Masking tape — it is easy to use", "White school glue — it works on paper", "Waterproof wood glue and screws — they resist rain and hold strongly", "Rubber bands — they are flexible"]
  answer: 2
...
- question: "What is one advantage screws have over nails, and one advantage nails have over screws?"
  type: short-answer
  answer: "Screws are stronger at resisting pull-out forces because their threads grip the material, and they can be removed and reused. Nails are faster to install — you can hammer a nail in seconds, while driving a screw takes longer."
  explanation: "Screws and nails are both common fasteners, but they serve different purposes. Screws are preferred when strength and removability matter (furniture, decks). Nails are preferred when speed matters and the joint does not need to come apart (framing houses, where hundreds of joints are needed quickly)."
```
