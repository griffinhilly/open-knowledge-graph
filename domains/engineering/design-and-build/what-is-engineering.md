...
- Engineering is only about machines and computers. (Engineers design everything from medical devices to sports equipment to clean water systems.)
- You have to be a genius to be an engineer. (Engineering is a process anyone can learn — it is about persistence and creative thinking, not innate talent.)
- Engineers work alone. (Most engineering is done in teams where people contribute different skills and ideas.)
- Engineering and science are the same thing. (Science asks "how does this work?" while engineering asks "how can I build something that works?")
...
- question: "What is the main goal of engineering?"
  ...
  options: ["To memorize science facts", "To solve problems by designing and building things", "To take apart machines to see how they work", "To study animals in nature"]
  answer: 1
...
- question: "What is one difference between a scientist and an engineer?"
  type: short-answer
  answer: "A scientist discovers how the world works, while an engineer uses those discoveries to design and build things that solve problems."
  explanation: "Science and engineering are related but have different goals. Science seeks understanding (why does gravity pull things down?), while engineering applies understanding to create solutions (how do I build a bridge that does not fall down?). Both are important and work together."
```
