...
title: Safety with Tools
domain: engineering
course: design-and-build
prerequisites:
- id: what-is-engineering
  type: hard
- id: measuring-and-cutting
  type: soft
- id: fastening-methods
  type: soft
builds-toward: []
tags:
- safety
...
- Safety rules slow you down and are not really necessary if you are careful. (Even careful, experienced professionals follow safety rules because accidents are unpredictable. Safety rules are based on real injuries that happened to real people who thought they were being careful enough.)
- Safety is only about avoiding injuries while building. (Engineers also design for the safety of the people who will use the finished product. A playground engineer considers whether children could get fingers stuck, fall from heights, or trip on edges.)
- Only dangerous tools need safety rules. (Even simple tools like scissors and rulers can cause injuries. A ruler can snap and send sharp pieces flying. Scissors can slip. The simpler the tool, the easier it is to become careless — which is when injuries happen.)

## Questions

```yaml
- question: "When cutting with scissors, which direction should you cut relative to your body?"
  type: multiple-choice
  options: ["Toward your body so you can see the cut line better", "Away from your body so the scissors move toward open space if they slip", "It does not matter as long as you are careful", "Sideways so the scissors cannot reach your body"]
  answer: 1
...
- question: "Why is keeping your workspace clean and organized an important safety practice?"
  type: short-answer
  answer: "A cluttered workspace creates tripping hazards, hides sharp objects under loose materials, and makes it harder to control your tools. Keeping the workspace clean means you can see potential dangers, move freely, and maintain control of your work."
  explanation: "Professional workshops, labs, and construction sites all have strict cleanliness rules. A stray nail on the floor, a pile of scraps near a cutting area, or a tangled cord across a walkway are all accident risks that are eliminated by simply cleaning as you go."
```
