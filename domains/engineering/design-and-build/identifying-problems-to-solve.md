---
id: identifying-problems-to-solve
title: Identifying Problems to Solve
domain: engineering
...
- Any complaint is a good engineering problem. (A good engineering problem is specific and solvable. "School is boring" is a complaint; "students do not have a quiet place to read during recess" is an engineering problem.)
- The problem is obvious and does not need careful study. (Many engineering failures happen because the builder assumed they knew the problem without asking the people who actually experience it.)
- Constraints make problems harder. (Constraints actually help — they narrow the options and prevent wasted effort on solutions that would never work in the real world.)

## Questions

```yaml
- question: "Which of these is the best example of a specific, solvable engineering problem?"
  type: multiple-choice
  options: ["Recess is too short", "The classroom is not fun enough", "Papers blow off the outdoor lunch tables when it is windy", "Everything at school is old"]
  answer: 2
  explanation: "Papers blowing off outdoor lunch tables is specific (we know exactly what happens), observable (we can see it), and solvable (we could design a clip, a weighted placemat, or a windscreen). The other options are too vague — what exactly would you build to make recess longer or the classroom more fun?"

- question: "Engineers should start building a solution before fully understanding the problem so they do not waste time."
  type: true-false
  answer: false
  explanation: "Jumping to building before understanding the problem is one of the biggest causes of engineering failure. If you build a solution to the wrong problem — or to a vaguely defined problem — your work is wasted. Time spent understanding the problem and its constraints saves much more time than it costs."

- question: "What is a constraint, and why is it helpful when solving an engineering problem?"
  type: short-answer
  answer: "A constraint is a rule or limit that a solution must follow, such as a budget, size, weight, or safety requirement. Constraints are helpful because they narrow the options and prevent wasted effort on solutions that would not work in the real world."
  explanation: "Without constraints, engineers would have infinite possibilities and no way to choose between them. Constraints like 'must cost less than ten dollars' or 'must be safe for small children' immediately rule out many options and focus effort on ideas that could actually be used."
```
