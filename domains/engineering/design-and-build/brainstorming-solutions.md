...
- The first good idea is good enough. (The first idea is rarely the best idea. Engineers who brainstorm many options almost always end up with a better final design.)
- Wild or silly ideas are a waste of time. (Many real inventions started as "silly" ideas. Brainstorming is specifically designed to capture ideas that structured thinking would miss.)
- Brainstorming means shouting out ideas in a group. (Silent individual brainstorming often produces more ideas than group shouting, because quieter people contribute and nobody's ideas get drowned out.)
- You should only think of ideas that you know will work. (The point of brainstorming is to generate possibilities, not certainties. Testing comes later.)

## Questions

```yaml
- question: "During brainstorming, a teammate suggests using a catapult to deliver lunch trays. What should you do?"
  type: multiple-choice
  options: ["Tell them that is a silly idea and move on", "Write it down — all ideas are welcome during brainstorming", "Ignore it because it will not work in real life", "Stop brainstorming and start building the catapult"]
  answer: 1
  explanation: "During brainstorming, every idea gets recorded without judgment. The catapult idea might not work literally, but it might spark a related idea — like a conveyor belt or a sliding tray system — that does work. Judging ideas during brainstorming kills creativity and makes people afraid to share."

- question: "The best time to decide which brainstormed idea is most practical is during the brainstorming session itself."
  type: true-false
  answer: false
  explanation: "Brainstorming and evaluation are two separate phases. During brainstorming, the goal is quantity — get as many ideas as possible without filtering. After brainstorming is done, you switch to evaluation mode and judge ideas against your constraints and criteria. Mixing the two phases reduces the number and creativity of ideas generated."

- question: "Why do engineers brainstorm many ideas instead of just going with the first good idea they think of?"
  type: short-answer
  answer: "Because the first idea is rarely the best. By generating many ideas, engineers discover options they would not have thought of otherwise. Later ideas often build on or combine earlier ones to create better solutions."
  explanation: "Research on creative problem-solving consistently shows that people who generate more ideas end up with better final solutions. The first idea is shaped by habits and obvious thinking. The tenth or twentieth idea forces you into unfamiliar territory where creative solutions live."
```
