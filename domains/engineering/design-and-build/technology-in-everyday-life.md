...
- Technology means computers and electronics. (Technology includes every designed object: tools, clothing, vehicles, containers, buildings, furniture. A hammer is technology. A bridge is technology. A pencil is technology.)
- Technology is always new and modern. (The wheel, the lever, the arch, and the nail are ancient technologies that are still used daily. Technology is about solving problems, not about being new.)
- Technology is too complicated for kids to design. (Students have been learning the building blocks — design process, materials, structures, simple machines, circuits — and can combine them to design real solutions to real problems.)

## Questions

```yaml
- question: "Which of the following is an example of technology?"
  type: multiple-choice
  options: ["Only smartphones and computers", "Only things invented in the last 50 years", "Any designed object that solves a problem, from a pencil to a spacecraft", "Only objects that use electricity"]
  answer: 2
  explanation: "Technology is any designed object or system that solves a problem. A pencil solves the problem of making marks. A bridge solves the problem of crossing a river. A smartphone solves many problems at once. Age and complexity do not define technology — purpose does."

- question: "A bicycle is not really technology because it does not use electricity or computers."
  type: true-false
  answer: false
  explanation: "A bicycle is a sophisticated piece of technology that combines multiple engineering principles: wheels and axles reduce friction, gears provide adjustable speed-to-force ratios, levers (brake handles, pedals) multiply force, a triangulated frame provides structural rigidity, and selected materials balance weight and strength. Technology does not require electricity."

- question: "Pick an everyday object and identify at least two engineering concepts from this course that are used in its design."
  type: short-answer
  answer: "A flashlight uses a simple circuit (battery, switch, and LED or bulb) and choosing materials (metal housing for durability, rubber grip for comfort, glass lens to focus light). It also demonstrates the design process — early flashlights were large and dim, and engineers improved them over many generations into today's bright, compact versions."
  explanation: "This question practices seeing the designed world through an engineering lens. Every everyday object embodies multiple engineering concepts. A stapler uses levers and material selection. A water bottle uses material properties and fastening. Looking at objects this way reinforces the idea that engineering is not distant or abstract — it is in every object you touch."
```
