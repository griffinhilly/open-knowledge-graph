...
- A single pulley reduces the force you need. (A single fixed pulley only changes direction — it takes the same force. You need at least two pulleys working together to reduce force.)
- More pulleys always means less work. (More pulleys reduce force but increase the distance you pull. The total work stays the same — you just spread it over a longer rope pull.)
- Pulleys are old technology that nobody uses anymore. (Cranes, elevators, sailboats, gym equipment, and window blinds all use pulleys today.)

## Questions

```yaml
- question: "What is the advantage of a single fixed pulley?"
  type: multiple-choice
  options: ["It cuts the force needed in half", "It changes the direction of your pull so you pull down to lift up", "It makes the load lighter", "It doubles the speed of lifting"]
  answer: 1
  explanation: "A single fixed pulley changes the direction of force — you pull down on the rope and the load goes up. This is useful because pulling down is easier than reaching up and lifting. However, it does not reduce the force needed. To reduce force, you need a compound pulley system with two or more pulleys."

- question: "A compound pulley system lets you lift a heavy load with less force, but you have to pull the rope a longer distance."
  type: true-false
  answer: true
  explanation: "This is the fundamental trade-off. A two-pulley system cuts the force in half, but you must pull twice as much rope. A three-pulley system cuts force to one-third, but requires pulling three times as much rope. The total work (force times distance) stays the same — the pulleys just let you spread it out."

- question: "Name two places where pulleys are used in everyday life."
  type: short-answer
  answer: "Flagpoles and construction cranes (also acceptable: elevators, window blinds, sailboats, gym weight machines, clotheslines, garage doors)."
  explanation: "Pulleys are used wherever something heavy needs to be lifted or where changing the direction of a pull is useful. A flagpole uses a fixed pulley so you can stand on the ground and pull down to raise the flag up. A construction crane uses a compound pulley system to lift multi-ton steel beams."
```
