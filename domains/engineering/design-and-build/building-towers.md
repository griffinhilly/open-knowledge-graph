...
- The tallest tower is the best tower. (Height without stability is not good engineering. A tower that falls in a light breeze is worse than a shorter tower that stands firm in a storm.)
- A tower just needs to be strong enough to support its own weight. (Wind is often the biggest challenge for tall structures. A tower might easily support its weight but topple when the wind pushes it.)
- Making the base wider always weakens the tower because it uses material at the bottom instead of the top. (A wide base is critical for stability — without it, the tower topples. The material at the base is doing essential work holding everything up and preventing tipping.)

## Questions

```yaml
- question: "Why does the Eiffel Tower get narrower as it goes up?"
  type: multiple-choice
  options: ["To look elegant", "Because they ran out of iron", "To reduce weight at the top, lower the center of gravity, and reduce wind force on the upper sections", "Because narrow structures are always stronger"]
  answer: 2
  explanation: "Tapering serves multiple engineering purposes: less material at the top means less weight the bottom must support, a lower center of gravity makes the structure harder to tip, and a narrower profile at the top catches less wind. The elegant look is a bonus — the tapering is driven by engineering necessity."

- question: "The biggest challenge for a very tall tower is supporting the weight on top of it."
  type: true-false
  answer: false
  explanation: "While supporting weight is important, wind is usually the bigger challenge for very tall structures. Wind force increases with height, and a tall tower acts like a long lever arm that amplifies the tipping force. Engineers spend more time designing for wind resistance than for weight support in most skyscrapers and communication towers."

- question: "What three strategies do engineers use to make tall towers strong and stable?"
  type: short-answer
  answer: "A wide base (to spread weight and resist tipping), tapering (getting narrower toward the top to reduce weight and wind exposure), and bracing with triangles (to prevent swaying and add rigidity)."
  explanation: "These three strategies work together. The wide base provides a stable foundation. Tapering reduces the forces that try to tip the tower. Triangular bracing makes the frame rigid so it does not sway or deform. The Eiffel Tower, cell phone towers, and modern skyscrapers all use some combination of these three approaches."
```
