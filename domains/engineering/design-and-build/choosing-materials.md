...
- The most expensive material is the best. (Cost does not equal performance. Cardboard is cheap and perfect for packaging. Marble is expensive and terrible for packaging. The right material matches the task, not the price tag.)
- One material can do everything. (Every material has weaknesses. Engineers combine materials to get the best properties of each — like reinforced concrete, which combines the compression strength of concrete with the tension strength of steel.)
- Material choice is just about strength. (Engineers consider many properties: weight, flexibility, water resistance, heat resistance, cost, appearance, and environmental impact. Strength is only one factor.)

## Questions

```yaml
- question: "A hammer has a steel head and a wooden handle. Why are two different materials used instead of making the whole hammer from one material?"
  type: multiple-choice
  options: ["Because they ran out of steel", "Because the head needs to be hard and heavy to drive nails, while the handle needs to be light and absorb shock for comfortable gripping", "Because wood is stronger than steel", "Because all tools must use exactly two materials"]
  answer: 1
...
- question: "Name three properties of materials that engineers consider when choosing what to build with."
  type: short-answer
  answer: "Strength, weight, and water resistance (also acceptable: flexibility, cost, heat resistance, durability, appearance, environmental impact, availability)."
  explanation: "Material selection requires balancing many properties. A material that is strong but heavy might not work in a design that needs to be carried. A material that is waterproof but brittle might not work in a design that needs to flex. Engineers evaluate materials against the full list of requirements, not just one property."
```
