...
title: Natural vs. Manufactured Materials
domain: engineering
...
- Natural materials are always better than manufactured ones. (Each has advantages and disadvantages. Natural materials are often renewable but can be inconsistent in quality. Manufactured materials can be precisely controlled but may not be biodegradable.)
- Manufactured materials come from nowhere — they are completely artificial. (Almost all manufactured materials start with natural raw materials. Plastic comes from petroleum, glass comes from sand, steel comes from iron ore. Manufacturing transforms natural materials, not creates materials from nothing.)
- Natural materials are always weaker than manufactured ones. (Some natural materials are remarkably strong. Spider silk is stronger than steel by weight. Bamboo has higher tensile strength than many steel alloys. Wood is an excellent structural material that has been used for thousands of years.)

## Questions

```yaml
- question: "Which of these is a manufactured material?"
  type: multiple-choice
  options: ["Wood", "Wool", "Plastic", "Cotton"]
  answer: 2
...
- question: "Give one advantage of natural materials and one advantage of manufactured materials."
  type: short-answer
  answer: "Natural materials are often renewable and biodegradable — wood grows back, cotton decomposes. Manufactured materials can be designed with precise, consistent properties — every batch of plastic can have the exact same strength and flexibility."
  explanation: "Neither type is universally better. Engineers choose based on the project's needs. A biodegradable flower pot might use a natural material. An airplane wing needs the precise, consistent strength of a manufactured aluminum alloy. Many projects use both types — a wooden table with steel screws and a polyurethane finish."
```
