...
- The design process is a straight line from start to finish. (It is a cycle — engineers often go back to earlier steps when they learn something new from testing.)
- The first design should work perfectly. (Almost no first design works perfectly. The process expects multiple rounds of improvement.)
- "Improve" means starting over. (Improving means making targeted changes based on what you learned from testing, not throwing everything away.)
- Only the "Create" step matters. (Skipping the Ask and Imagine steps leads to solutions that do not actually solve the right problem.)

## Questions

```yaml
- question: "What are the five steps of the engineering design process in order?"
  type: multiple-choice
  options: ["Build, Test, Fix, Rebuild, Finish", "Ask, Imagine, Plan, Create, Improve", "Think, Draw, Cut, Glue, Present", "Research, Hypothesis, Experiment, Conclude, Report"]
  answer: 1
  explanation: "The engineering design process follows Ask (understand the problem), Imagine (brainstorm solutions), Plan (choose and design), Create (build a prototype), and Improve (test and make better). The last option describes the scientific method, which is a different process."

- question: "An engineer's first prototype should work perfectly if they planned well enough."
  type: true-false
  answer: false
  explanation: "Even with excellent planning, first prototypes almost never work perfectly. That is expected and normal. The 'Improve' step exists because testing reveals problems that are impossible to predict just by thinking. The cycle of build-test-improve is what makes the final product good."

- question: "Why is the engineering design process drawn as a circle or loop instead of a straight line?"
  type: short-answer
  answer: "Because engineers go back to earlier steps when testing reveals problems. After improving, they may need to ask new questions, imagine new solutions, or plan again. The process repeats until the solution works well."
  explanation: "The cyclical nature of the design process is its most important feature. A straight line implies you are done after one pass. In reality, each round of testing teaches you something new, which sends you back to rethink, redesign, or rebuild. Professional engineers may cycle through dozens of iterations."
```
