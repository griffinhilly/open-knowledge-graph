...
- question: "A capacitor in DC steady state cannot have a nonzero voltage across it, because capacitors block DC current and therefore cannot store energy in a DC circuit."
  type: true-false
  answer: false
