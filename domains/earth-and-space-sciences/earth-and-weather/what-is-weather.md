...
- Weather and climate are the same thing. Weather is what happens today; climate is the pattern over many years.
- Weather only means rain or storms. Sunny, calm days are also weather.
- Weather is the same everywhere at the same time.
...
- question: "Weather is the same most days."
  type: true-false
  answer: false
...
- question: "If you walked outside right now, what things would you look at and feel to describe today's weather?"
  type: short-answer
  answer: "You would look at the sky to see if it is sunny or cloudy, feel the air to see if it is warm or cold, notice if the wind is blowing, and check if it is raining or snowing. Weather is what you can see and feel in the air around you."
  explanation: "Weather is something you experience with your senses. Looking up and feeling the air gives you all the information you need to describe weather -- no special tools required for a basic description."
```
