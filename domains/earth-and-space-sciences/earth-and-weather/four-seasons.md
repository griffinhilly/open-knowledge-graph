...
- Seasons are caused by Earth being closer to or farther from the sun. The real cause is Earth's tilt on its axis.
- All places on Earth experience the same seasons at the same time. The Southern Hemisphere has opposite seasons from the Northern Hemisphere.
- The transition between seasons happens suddenly. Seasons blend gradually into one another.

## Questions

```yaml
- question: "Which season comes after winter and before summer?"
  type: multiple-choice
  options:
    - "Autumn"
    - "Spring"
    - "Another winter"
    - "There is no season between winter and summer"
  answer: 1
  explanation: "The seasons always follow the same order: winter, spring, summer, autumn, then back to winter. Spring comes after winter and before summer. It is the season when temperatures warm up, days get longer, and plants start growing again after the cold of winter."

- question: "The four seasons follow the same order every year."
  type: true-false
  answer: true
  explanation: "The seasons always cycle in the same order: spring, summer, autumn, winter, and then spring again. This pattern repeats every year because it is caused by Earth's orbit around the sun and the tilt of Earth's axis, which do not change from year to year."

- question: "Pick one season and describe what the weather and nature are usually like during that time."
  type: short-answer
  answer: "Example for summer: Summer is the warmest season, with long sunny days and short nights. Plants are fully green and growing. Many flowers bloom and trees have full leaves. People spend more time outdoors. (Any season with appropriate weather and nature descriptions is acceptable.)"
  explanation: "Each season has a recognizable set of characteristics that affect weather, plant life, animal behavior, and daily human activities. Connecting seasons to personal experience makes the concept concrete."
```
