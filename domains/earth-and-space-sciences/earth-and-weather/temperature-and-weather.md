...
- The sun is closer to Earth on hot days and farther away on cold days. Temperature changes are mostly caused by the angle of sunlight, not distance.
- Temperature is the same everywhere at the same time. Shady spots, sunny spots, and different cities all have different temperatures.
- Cold means the sun is not working. The sun is always producing energy; cold days happen when less of that energy reaches the surface.

## Questions

```yaml
- question: "Why is it usually warmer in the afternoon than in the early morning?"
  type: multiple-choice
  options:
    - "The sun gets closer to Earth as the day goes on"
    - "The sun has been shining and warming the ground and air for several hours by afternoon"
    - "The wind stops blowing in the afternoon"
    - "Warm air comes from underground in the afternoon"
  answer: 1
  explanation: "The sun rises in the morning and shines on the ground all day. The ground absorbs that sunlight and slowly warms up, and the warm ground heats the air above it. By afternoon, the ground and air have been absorbing sunlight for hours, so the temperature is at its highest. In the morning, the ground has cooled overnight without sun, so it is cooler."

- question: "The sun makes the Earth warmer during the day and the Earth cools down at night."
  type: true-false
  answer: true
  explanation: "During the day, sunlight warms the ground and air. At night, with no sunlight, the Earth releases heat into space and cools down. This is why early morning -- just before sunrise -- is usually the coldest part of the day. The daily warming and cooling cycle is one of the most basic weather patterns."

- question: "If the temperature outside is near freezing (0 degrees Celsius), would you expect rain or snow to fall from the clouds? Why?"
  type: short-answer
  answer: "Near freezing, you might get either one. If the temperature is at or below freezing, water in the clouds freezes into ice crystals and falls as snow. If it is just above freezing, the water stays liquid and falls as rain. Temperature decides whether precipitation is rain or snow."
  explanation: "This question connects temperature to precipitation type, reinforcing that temperature is not just about comfort -- it directly affects what kind of weather happens."
```
