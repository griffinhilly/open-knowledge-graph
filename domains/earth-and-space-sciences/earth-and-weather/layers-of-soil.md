...
- Soil goes down forever. Below the soil layers, there is solid rock (bedrock). Soil is a relatively thin layer on top of rock.
- All layers of soil are the same color and material. Each layer is visibly different in color, texture, and composition.
- The layers formed overnight. Soil layers develop over hundreds to thousands of years.

## Questions

```yaml
- question: "Why is the top layer of soil (topsoil) usually darker than the layers below it?"
  type: multiple-choice
  options:
    - "It is darker because it gets more sunlight"
    - "It is darker because it contains more decomposed plant and animal material (organic matter)"
    - "Rain stains the top layer dark"
    - "The darker color is from pollution"
  answer: 1
  explanation: "Topsoil is dark because it contains humus -- decomposed leaves, roots, insects, and other organic matter. This dark, nutrient-rich material is what makes topsoil the best layer for growing plants. Lower layers have less organic matter and more mineral content, so they are lighter in color."

- question: "Below all layers of soil, there is always solid rock called bedrock."
  type: true-false
  answer: true
  explanation: "If you could dig deep enough in any location, you would eventually reach solid, unbroken rock called bedrock. The soil layers above it formed from the slow breakdown of this rock (and rock carried by water and ice) combined with organic matter. Bedrock is the foundation that soil sits on."

- question: "Describe what you would see if you could look at a slice of ground from the surface all the way down to solid rock."
  type: short-answer
  answer: "At the top, you would see dark topsoil full of roots, worms, and decomposed plant material. Below that, lighter-colored subsoil with more clay and minerals. Below that, a layer of broken rock fragments. At the very bottom, solid bedrock -- unbroken rock. Each layer is different in color, texture, and what it contains."
  explanation: "Understanding soil layers (horizons) shows that the ground beneath us is not uniform -- it has structure that tells a story about how soil forms over time. The top layer is darkest and most alive; each layer below is more like rock and less like living soil."
```
