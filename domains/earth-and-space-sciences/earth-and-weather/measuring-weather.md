...
- You do not need tools to know the weather. While you can describe weather by feeling, tools give precise measurements that let you compare and track changes accurately.
- A thermometer measures how hot YOU feel. It measures air temperature, which is different from how warm you feel (wind and humidity affect that).
- Rain gauges measure how hard it is raining. They measure the total amount of rain that collects, not the intensity at any given moment.

## Questions

```yaml
- question: "Why is it better to use a thermometer to measure temperature instead of just saying 'it feels warm'?"
  type: multiple-choice
  options:
    - "Thermometers are more fun to use than just guessing"
    - "A thermometer gives an exact number that everyone agrees on, while 'warm' means different things to different people"
    - "Thermometers can predict tomorrow's weather"
    - "You cannot feel temperature without a thermometer"
  answer: 1
  explanation: "When one person says 'it feels warm,' another person might disagree -- warm is a feeling, not a measurement. A thermometer gives a number (like 25 degrees Celsius) that means the same thing to everyone. This lets us compare temperatures from different days or different places accurately."

- question: "A rain gauge measures how hard it is raining at any given moment."
  type: true-false
  answer: false
  explanation: "A rain gauge measures the total amount of rain that has collected over a period of time -- like how many centimeters of rain fell today. It does not tell you how hard it is raining right now. A light rain over many hours and a heavy rain over a few minutes could both leave the same amount of water in the gauge."

- question: "Name two weather tools and explain what each one measures."
  type: short-answer
  answer: "A thermometer measures temperature -- how hot or cold the air is. A rain gauge measures how much rain has fallen by collecting rainwater in a container with markings. Other correct answers include a wind vane (shows wind direction) or an anemometer (measures wind speed)."
  explanation: "Each weather tool focuses on one specific part of weather. Using multiple tools together gives a complete picture of the weather at a given time and place."
```
