...
- There is unlimited freshwater available. Only about 3% of Earth's water is freshwater, and much of that is locked in ice caps. The available freshwater supply is limited.
- Tap water comes from a factory that makes water. Tap water comes from natural sources (rivers, lakes, underground aquifers) that are part of the water cycle.
- Water shortages only happen in faraway places. Water scarcity affects communities worldwide, including parts of developed countries.

## Questions

```yaml
- question: "If most of Earth is covered in water, why do we need to be careful about using water wisely?"
  type: multiple-choice
  options:
    - "Most of Earth's water is salty ocean water that people cannot drink -- only a tiny fraction is usable freshwater"
    - "Water is disappearing from Earth"
    - "We have plenty of water so we do not need to be careful"
    - "All water is the same and can be used for anything"
  answer: 0
  explanation: "About 97% of Earth's water is salty ocean water. Of the remaining 3% that is freshwater, most is locked in ice caps and glaciers. Only a tiny fraction -- less than 1% of all water on Earth -- is available as freshwater in rivers, lakes, and underground sources. That small supply has to serve all the people, animals, and plants on land."

- question: "All living things on Earth need water to survive."
  type: true-false
  answer: true
  explanation: "Every known living thing -- from the largest elephant to the smallest bacteria -- requires water. Plants need water to grow and make food. Animals need water to drink and keep their bodies working. Human bodies are about 60% water. Without water, life as we know it would not exist."

- question: "Name three ways that people use water every day."
  type: short-answer
  answer: "People use water for drinking, cooking food, bathing and washing, watering gardens and crops, cleaning dishes and clothes, and flushing toilets. These are just a few -- water is used in almost everything we do."
  explanation: "Most children do not realize how many daily activities depend on water until they actively list them. This exercise builds awareness of why water conservation matters -- every use they list draws from a limited freshwater supply."
```
