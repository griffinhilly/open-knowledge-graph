...
- Wind is invisible and therefore mysterious or magical. Wind is simply air moving, and we can feel it and see its effects.
- Wind always blows in the same direction. Wind direction changes frequently.
- Wind comes from the sky. Wind moves horizontally along the ground and at all levels of the atmosphere.

## Questions

```yaml
- question: "You cannot see wind. How do you know it is blowing?"
  type: multiple-choice
  options:
    - "You can hear the wind talking"
    - "You can see and feel what it does -- it moves leaves, bends trees, and pushes against your skin"
    - "Wind only happens at night, so you cannot know"
    - "You can only know if someone tells you"
  answer: 1
  explanation: "Wind is invisible air in motion, but it pushes on everything it touches. You can feel it on your face, hear it in the trees, see flags waving and leaves tumbling. These clues tell you wind is blowing even though you cannot see the air itself."

- question: "Wind is air that is moving."
  type: true-false
  answer: true
  explanation: "That is exactly what wind is. Air does not always stay still -- it moves from place to place. When you feel air moving past you, that is wind. A gentle movement is a breeze; a fast, strong movement is a gust or a gale."

- question: "If you hold a pinwheel outside and it starts spinning, what does that tell you about the air?"
  type: short-answer
  answer: "It tells you that the air is moving -- there is wind. The moving air pushes against the blades of the pinwheel and makes it spin. The faster the pinwheel spins, the stronger the wind is blowing."
  explanation: "Pinwheels, flags, and windsocks are all simple tools that make invisible wind visible by showing how air pushes on objects. This is how we observe something we cannot see directly."
```
