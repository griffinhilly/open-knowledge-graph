...
title: Erosion and Weathering Basics
...
- Weathering and erosion are the same thing. Weathering breaks rocks down; erosion carries the pieces away. They often work together but are different processes.
- Erosion only happens in dramatic places like the Grand Canyon. Erosion happens everywhere -- in your backyard, along roads, on hillsides.
- Erosion is always bad. Erosion creates beaches, river deltas, and fertile floodplains. It is a natural process that is only problematic when it is accelerated by human activity.
...
- question: "What is the difference between weathering and erosion?"
  ...
  options:
    - "They are the same thing -- both words mean rocks breaking apart"
    - "Weathering is the breaking down of rocks into smaller pieces; erosion is the carrying away of those pieces to a new location"
    - "Erosion breaks rocks and weathering moves them"
    - "Weathering only happens in warm climates and erosion only happens in cold climates"
  answer: 1
...
- question: "The Grand Canyon was carved quickly by a single large flood."
  type: true-false
  answer: false
  explanation: "The Grand Canyon was carved by the Colorado River over roughly 5 to 6 million years. The river slowly wore away rock layer by layer through continuous erosion. This is one of the most powerful lessons about erosion: it is usually slow, but given enough time, water can carve through solid rock and create enormous landforms."

- question: "Name two natural forces that can break down rocks (weathering) and explain how each one works."
  type: short-answer
  answer: "Water: water seeps into cracks in rock and freezes in cold weather. When water freezes, it expands, pushing the crack wider and eventually splitting the rock apart. Plant roots: tree roots grow into small cracks in rock and slowly push them apart as the roots get thicker. Both processes slowly break large rocks into smaller pieces over time."
  explanation: "Other correct answers include wind (blowing sand particles that scrape against rock), chemical weathering (slightly acidic rain dissolving minerals in rock), and temperature changes (repeated heating and cooling causing rock to expand and contract until it cracks)."
```
