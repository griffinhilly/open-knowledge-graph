---
id: how-seasons-affect-plants
title: How Seasons Affect Plants
...
- Trees that lose their leaves in autumn are dead. They are dormant -- alive but resting. The roots and trunk are still living.
- All plants lose their leaves in winter. Evergreen trees keep their leaves (needles) year-round.
- Leaves change color because they are dying. Leaves change color because the green pigment (chlorophyll) breaks down, revealing other colors that were there all along.

## Questions

```yaml
- question: "Why do many trees drop their leaves in autumn?"
  type: multiple-choice
  options:
    - "The leaves are too heavy for the tree to hold"
    - "Dropping leaves helps the tree save water and energy during the cold winter when there is less sunlight for growth"
    - "The wind blows the leaves off"
    - "The tree does not need leaves anymore because it is finished growing forever"
  answer: 1
...
- question: "How can you tell that a tree is still alive in winter even though it has no leaves?"
  type: short-answer
  answer: "You can look for buds on the branches -- small bumps where new leaves will grow in spring. You can also scratch a small part of a twig and see green living tissue underneath the bark. The trunk and roots are alive even though the tree looks bare."
  explanation: "Dormancy can look like death to an untrained eye. Learning to spot signs of life in a dormant tree -- buds, green tissue under bark -- builds observational skills and reinforces that dormancy is a temporary resting state."
```
