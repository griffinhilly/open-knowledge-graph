...
- Lava is the most dangerous part of a volcanic eruption. Ash clouds, mudflows (lahars), and toxic gases often cause more damage and danger than lava flows.
- Volcanoes are always cone-shaped mountains. Some volcanoes are flat shield shapes (like Hawaii), and some are just cracks in the ground.
- All mountains are volcanoes. Most mountains are formed by tectonic forces pushing rock up, not by volcanic eruptions.
...
- question: "What is the difference between magma and lava?"
  ...
  options:
    ...
    - "Magma is hot melted rock underground; when it reaches the surface through a volcano, it is called lava"
    - "Lava is hotter than magma"
    - "Magma is found on the surface and lava is underground"
  answer: 1
...
- question: "Why are most volcanoes found in certain areas of the world rather than being spread out evenly?"
  type: short-answer
  ...
  explanation: "This connects volcanism to plate tectonics at an introductory level. Children do not need to understand plate tectonics in detail, but knowing that volcanoes occur in specific zones (not randomly) because of Earth's structure is an important foundational idea."
```
