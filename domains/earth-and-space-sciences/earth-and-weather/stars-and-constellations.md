...
- Stars are tiny. Stars are enormous -- many are far larger than our sun. They only look tiny because they are incredibly far away.
- All stars are the same color (white or yellow). Stars range from blue (hottest) through white and yellow to orange and red (coolest).
- Constellations are real physical groups of stars close together. The stars in a constellation are usually at vastly different distances from Earth -- they only appear to form patterns from our viewpoint.

## Questions

```yaml
- question: "Why do stars look like tiny dots of light even though they are actually very large?"
  type: multiple-choice
  options:
    - "Stars are actually small objects, about the size of a basketball"
    - "Stars are enormous, but they are so incredibly far away that they appear as tiny points of light from Earth"
    - "Earth's atmosphere shrinks the appearance of stars"
    - "Stars look tiny because the moon outshines them"
  answer: 1
  explanation: "Stars are huge -- many are much larger than our sun, which itself is about 1.4 million kilometers in diameter. But the nearest star (other than the sun) is over 4 light-years away, which means its light takes over 4 years to reach us traveling at 300,000 kilometers per second. At that unimaginable distance, even a giant star appears as a tiny point of light."

- question: "The stars in a constellation are close together in space."
  type: true-false
  answer: false
  explanation: "The stars in a constellation only appear to be near each other from our viewpoint on Earth. In reality, they are usually at vastly different distances from us. Two stars that look side by side in the sky might be hundreds of light-years apart from each other. Constellations are patterns created by our perspective, not physical groupings."

- question: "Why can we not see stars during the day?"
  type: short-answer
  answer: "The stars are always there in the sky, even during the day. But the sun is so bright that its light fills the atmosphere with scattered blue light, which overwhelms the faint light from distant stars. It is like trying to see a candle flame next to a spotlight -- the spotlight is so bright that the candle becomes invisible. At night, when the sun is below the horizon, the sky is dark enough for starlight to be visible."
  explanation: "Stars do not go away during the day -- they are outshone by the sun. This reinforces the idea that stars are always present; our ability to see them depends on how dark the sky is."
```
