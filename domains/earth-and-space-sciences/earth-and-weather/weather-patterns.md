...
- Weather is random and unpredictable. While individual days can surprise us, weather follows broad patterns (warmer in summer, cooler in winter, certain storm seasons).
- A pattern means the weather is always the same. Patterns are trends, not guarantees -- there will always be unusual days.
- Weather patterns are the same everywhere on Earth.

## Questions

```yaml
- question: "A class records the temperature every day for a month. They notice it is usually warmer in the afternoon than in the morning. What kind of observation is this?"
  type: multiple-choice
  options:
    - "A lucky guess"
    - "A weather pattern -- a trend that repeats regularly"
    - "An error in their thermometer"
    - "A coincidence that will not happen next month"
  answer: 1
  explanation: "The daily warming from morning to afternoon is a real weather pattern caused by the sun heating the ground throughout the day. Patterns are trends that repeat reliably, even if the exact temperatures differ from day to day. Recognizing patterns is the foundation of weather prediction."

- question: "If it rained three days in a row, it will definitely rain on the fourth day too."
  type: true-false
  answer: false
  explanation: "Weather patterns give us clues, but they are not guarantees. Three rainy days might be part of a storm system passing through, but the storm could move away by the fourth day. Patterns help us make educated guesses, not certainties."

- question: "Why is it useful to record weather measurements every day over many weeks?"
  type: short-answer
  answer: "Recording weather over many weeks lets you spot patterns -- like which times of day are warmest, how often it rains, or whether temperatures are going up or down over time. These patterns help you make predictions about future weather and understand the seasons."
  explanation: "A single day's weather tells you very little. But weeks and months of data reveal trends that are invisible on any single day. This is the basic principle behind weather forecasting and climate science."
```
