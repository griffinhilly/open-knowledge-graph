...
- All rocks are hard. Some rocks (like chalk or talc) are very soft and can be scratched with a fingernail.
- Color alone identifies a rock. Many different rocks can be the same color. Scientists use multiple properties together to identify rocks.
- Shiny rocks are always valuable. Luster (shininess) is just one property and does not indicate value.

## Questions

```yaml
- question: "You have two rocks. You scratch one with your fingernail and it leaves a mark. You try the same on the other rock and your fingernail cannot scratch it. What property are you testing?"
  type: multiple-choice
  options:
    - "Color"
    - "Weight"
    - "Hardness -- how easy or difficult the rock is to scratch"
    - "Temperature"
  answer: 2
...
- question: "Describe two different properties you could observe about a rock without using any special tools."
  type: short-answer
  answer: "You could observe its color (is it gray, brown, white, speckled?) and its texture (does it feel smooth, rough, or grainy?). You could also describe its shape (round, flat, jagged) or whether it looks shiny or dull (luster). These observations can all be made with just your eyes and hands."
  explanation: "Rock identification starts with careful observation using the senses. Before using any tools, simply looking at and touching a rock reveals its color, texture, shape, and luster -- four useful properties that help narrow down what kind of rock it is."
```
