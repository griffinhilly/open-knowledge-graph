...
- All clouds produce rain. Most clouds are made of droplets far too small to fall -- only certain cloud types and conditions produce precipitation.
- Clouds are empty space filled with water. Clouds have physical structure -- they are collections of billions of tiny water droplets or ice crystals.
- Dark clouds are dirty. Dark clouds appear dark because they are thick and block more sunlight from passing through, not because they contain dirt.

## Questions

```yaml
- question: "Why do some clouds look white and fluffy while others are dark and heavy-looking?"
  type: multiple-choice
  options:
    - "Dark clouds are older than white clouds"
    - "White clouds are thin and let sunlight pass through; dark clouds are thick and tall, blocking more sunlight"
    - "Dark clouds are made of a different kind of water"
    - "The sun changes the color of clouds based on the time of day"
  answer: 1
...
- question: "You see tall, dark clouds building in the sky. What type of weather might they bring, and why?"
  type: short-answer
  answer: "Tall, dark clouds are likely cumulonimbus clouds, which bring thunderstorms with heavy rain, lightning, and sometimes strong winds or hail. They are dark because they are so tall and thick that they block most sunlight. Their height means they contain a huge amount of water, which is why they produce the heaviest rain."
  explanation: "Connecting cloud appearance to expected weather is the practical payoff of learning about cloud types. Being able to look at the sky and predict what is coming is one of the most useful skills in observational weather science."
```
