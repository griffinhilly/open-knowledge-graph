...
- Pluto is a planet. Pluto was reclassified as a "dwarf planet" in 2006 because it has not cleared its orbital neighborhood of other debris.
- The planets are close together. The distances between planets are enormous -- it takes years for spacecraft to travel from one to another.
- The sun is not much bigger than the planets. The sun contains 99.86% of all the mass in the solar system. It is vastly larger than all the planets combined.

## Questions

```yaml
- question: "What is the correct order of the planets from closest to the sun to farthest?"
  type: multiple-choice
  options:
    - "Mars, Venus, Earth, Mercury, Saturn, Jupiter, Neptune, Uranus"
    - "Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, Neptune"
    - "Earth, Mercury, Venus, Mars, Jupiter, Saturn, Neptune, Uranus"
    - "Mercury, Mars, Venus, Earth, Jupiter, Neptune, Saturn, Uranus"
  answer: 1
...
- question: "What makes Earth different from all the other planets in our solar system?"
  type: short-answer
  answer: "Earth is the only known planet with liquid water on its surface, a breathable atmosphere with oxygen, and conditions that support life. It is at just the right distance from the sun -- not too hot and not too cold -- for water to exist as a liquid. No other planet in our solar system has been found to have living things."
  explanation: "Understanding what makes Earth special helps frame why we study other planets -- we compare them to Earth to understand what conditions are needed for life and what makes our planet unique in the solar system."
```
