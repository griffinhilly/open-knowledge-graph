...
- Beach sand is manufactured or brought to beaches. Most beach sand is natural -- it comes from rocks, shells, and coral broken down by waves and weathering over thousands of years.
- All beaches have golden sand. Beaches can be white (coral/shell), black (volcanic rock), pink (coral), brown (mixed minerals), or even green (olivine crystals).
- Coastlines are permanent features. Coastlines are constantly changing as waves erode and deposit material, sometimes dramatically after storms.

## Questions

```yaml
- question: "Where does the sand on a beach come from?"
  type: multiple-choice
  options:
    - "People bring sand to the beach in trucks"
    - "Rocks, shells, and coral are broken into tiny pieces by waves, weathering, and rivers over thousands of years"
    - "Sand grows on the ocean floor like plants"
    - "The ocean creates sand from seawater"
  answer: 1
  explanation: "Beach sand is the result of weathering and erosion. Waves crash against rocky cliffs and shorelines, breaking off small pieces. Rivers carry sediment from inland rocks to the coast. Shells and coral are ground down by wave action. Over thousands of years, all this material is broken into the tiny grains we call sand. The type of rock or shell determines the sand's color and texture."

- question: "Coastlines stay the same shape forever."
  type: true-false
  answer: false
  explanation: "Coastlines are constantly changing. Waves erode rocky headlands and cliffs, wearing them back over time. Storms can dramatically reshape beaches in a single event. Sea stacks, arches, and sea caves are all formed by waves eroding the coast. At the same time, sand and sediment are deposited in other areas, building new beaches and sandbars. The coastline you see today looks different from what it looked like a thousand years ago."

- question: "How do waves shape the coastline over time?"
  type: short-answer
  answer: "Waves continuously crash against the shore, wearing away rock and cliffs through erosion. The broken pieces of rock are carried by currents and deposited elsewhere, forming beaches and sandbars. Over time, waves can carve caves into cliffs, create arches, and eventually leave behind sea stacks (pillars of rock standing in the water). Waves both tear down and build up the coastline."
  explanation: "Beaches and coastlines are a visible, relatable example of erosion and deposition happening together. What waves take from one part of the coast, they often give to another part -- making coastline change a continuous process of reshaping, not just destruction."
```
