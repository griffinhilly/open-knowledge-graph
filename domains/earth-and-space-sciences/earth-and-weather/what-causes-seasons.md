...
- Seasons are caused by Earth being closer to the sun in summer. Earth's orbit is nearly circular, and the Northern Hemisphere actually has summer when Earth is slightly farther from the sun.
- The sun moves to cause seasons. The sun stays roughly in place; it is Earth's tilt during its orbit that creates the seasonal effect.
- The tilt itself changes throughout the year. The tilt direction stays the same (pointing at the North Star); it is Earth's position in its orbit that changes.

## Questions

```yaml
- question: "What is the real reason we have warmer weather in summer?"
  type: multiple-choice
  options:
    - "Earth is closer to the sun in summer"
    - "Earth's tilt causes sunlight to hit our part of Earth more directly in summer, warming it more"
    - "The sun gets hotter in summer"
    - "There are fewer clouds in summer, so more heat gets through"
  answer: 1
  explanation: "Earth is tilted about 23.5 degrees on its axis. When your hemisphere is tilted toward the sun, sunlight hits at a steeper, more direct angle, concentrating energy on a smaller area and warming the surface more. Earth's distance from the sun barely changes and is NOT the cause of seasons -- in fact, Earth is slightly farther from the sun during Northern Hemisphere summer."

- question: "Seasons are caused by Earth moving closer to and farther from the sun."
  type: true-false
  answer: false
  explanation: "This is the most common misconception about seasons. Earth's orbit is nearly circular, so the distance change is small and does not cause seasons. The real cause is Earth's tilt. When your hemisphere tilts toward the sun, you get more direct sunlight (summer). When it tilts away, you get less direct sunlight (winter)."

- question: "If you shine a flashlight straight down at the floor versus at a steep angle, how does the light spread differently? How does this relate to seasons?"
  type: short-answer
  answer: "When you shine the flashlight straight down, the light makes a small bright circle on the floor. When you tilt it at an angle, the same light spreads over a larger area and each spot gets less light. This is like seasons: in summer, the sun is higher and its light hits more directly (small bright area, more heating). In winter, the sun is lower and its light spreads over more ground (less heating per area)."
  explanation: "This flashlight analogy is the clearest way to understand why sun angle matters. The same total amount of light spread over a larger area means less heating per square meter -- that is why angled sunlight in winter warms the ground less than direct sunlight in summer."
```
