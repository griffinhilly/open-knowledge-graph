...
- The whole world has the same seasons at the same time. The hemispheres have opposite seasons.
- Everywhere on Earth has four distinct seasons. Tropical areas and polar regions experience seasons very differently from mid-latitude regions.
- It is always hot at the equator because it is closest to the sun. The equator gets consistent direct sunlight year-round due to Earth's geometry, not because of being physically closer to the sun.

## Questions

```yaml
- question: "When it is July and summer in the United States, what season is it in Australia?"
  type: multiple-choice
  options:
    - "Summer -- all countries have the same seasons at the same time"
    - "Spring -- Australia is one season behind"
    - "Winter -- the Southern Hemisphere has opposite seasons from the Northern Hemisphere"
    - "There are no seasons in Australia"
  answer: 2
...
- question: "Why do the Northern Hemisphere and the Southern Hemisphere have opposite seasons?"
  type: short-answer
  answer: "Because of Earth's tilt. When the Northern Hemisphere tilts toward the sun and gets more direct sunlight (summer), the Southern Hemisphere is tilted away from the sun and gets less direct sunlight (winter). Six months later, the positions reverse. Since both hemispheres cannot tilt toward the sun at the same time, their seasons are always opposite."
  explanation: "This question ties back to the cause of seasons. Understanding opposite hemispheric seasons is strong evidence that seasons are caused by tilt, not by distance from the sun -- if distance were the cause, both hemispheres would have the same season simultaneously."
```
