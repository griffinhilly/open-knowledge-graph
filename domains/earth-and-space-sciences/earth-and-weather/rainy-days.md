...
- Rain comes from clouds "breaking open." Water droplets grow too heavy to float and fall out gradually.
- All rain is the same. Rain varies from a fine mist to large heavy drops.
- Rain is dirty or dangerous. Rainwater is generally clean water falling from clouds.

## Questions

```yaml
- question: "What has to happen inside a cloud for it to start raining?"
  type: multiple-choice
  options:
    - "The cloud has to turn a dark color"
    - "The tiny water droplets inside the cloud have to grow big and heavy enough to fall"
    - "Lightning has to break the cloud open"
    - "The wind has to push the cloud down to the ground"
  answer: 1
...
- question: "Why is rain important for the Earth?"
  type: short-answer
  answer: "Rain gives water to plants so they can grow, fills up rivers and lakes, provides fresh water that animals and people need to drink, and soaks into the ground to keep soil moist. Without rain, the land would dry out and most living things could not survive."
  explanation: "Rain is the main way that fresh water gets from the sky to the land. Understanding that rain is essential for life helps connect weather to the broader idea of why water matters on Earth."
```
