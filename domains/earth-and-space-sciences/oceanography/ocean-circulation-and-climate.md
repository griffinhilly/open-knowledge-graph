...
title: Ocean Circulation's Role in Climate Regulation
...
- The ocean does not simply absorb and store CO₂ indefinitely — it exchanges with the atmosphere on timescales that depend on circulation depth and overturning rates.
- AMOC weakening would not cool the entire globe — it would warm the equatorial Atlantic (less northward transport) while cooling the North Atlantic and parts of Europe.

## Questions

```yaml
- question: "If the Atlantic Meridional Overturning Circulation (AMOC) significantly weakened, which regional climate outcome would most likely result?"
  type: multiple-choice
  options: ["Global temperatures would drop uniformly as less heat is transported poleward", "The North Atlantic and parts of Europe would cool while the tropical Atlantic warms", "The entire Northern Hemisphere would experience accelerated warming", "The Southern Ocean would cool due to reduced export of heat from the tropics"]
  answer: 1
