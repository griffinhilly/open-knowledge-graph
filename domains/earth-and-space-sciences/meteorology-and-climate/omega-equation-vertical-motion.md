...
- question: "In the omega equation, greater static stability produces stronger vertical motion for the same forcing, because a more stable atmosphere resists vertical displacement and should move faster to achieve dynamical balance."
  type: true-false
  answer: false
