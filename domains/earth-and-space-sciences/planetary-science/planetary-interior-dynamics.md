...
title: Planetary Interior Dynamics
...
- All planetary interiors have the same structure as Earth.
- Planetary cores are always cooling uniformly.
- Internal heat has negligible influence on surface processes.

## Questions

```yaml
- question: "What are the two primary sources of heat driving planetary interior dynamics?"
  type: multiple-choice
  options:
    - "Solar radiation absorbed at the surface and heat from meteor impacts during the current era"
    - "Accretional heat from planetary formation and radiogenic heat from radioactive decay of isotopes in the interior"
    - "Chemical reactions between core iron and mantle silicates, and heat conducted inward from space"
    - "Gravitational compression from the planet's own mass and heat released by surface volcanism"
  answer: 1
