...
- Erosion requires weathering to have occurred first, but they are distinct processes operating at different rates.
- Chemical weathering does not require a highly acidic environment; even slightly acidic rainwater (carbonic acid) weathers limestone effectively over geological time.
- Harder minerals are not always more resistant to chemical weathering; solubility, not hardness, governs dissolution rates.

## Questions

```yaml
- question: "Granite and limestone are both common surface rocks. Which statement best explains why limestone dissolves far faster than granite in a humid climate, even though calcite (the main mineral in limestone) is softer than quartz?"
  type: multiple-choice
  options:
    - "Limestone is more porous than granite, so water penetrates deeper and removes material faster."
    - "Granite contains iron oxides that form a protective coating, shielding it from rainwater."
    - "Calcite is soluble in weakly acidic water, while quartz resists dissolution — solubility, not hardness, governs chemical weathering rate."
    - "Frost wedging is more effective on limestone because its crystals are smaller."
  answer: 2
  explanation: "Hardness (resistance to scratching) measures the strength of atomic bonds against mechanical disruption — it has little bearing on how readily a mineral dissolves in water. Calcite (CaCO₃) reacts with carbonic acid (H₂CO₃, formed when CO₂ dissolves in rainwater) to produce soluble calcium bicarbonate that washes away. Quartz (SiO₂) is nearly insoluble in neutral to weakly acidic water and weathers almost entirely by mechanical means. This is why caves and karst landscapes form in limestone regions but not in granite terrain."

- question: "Weathering and erosion are two names for the same geological process: the physical breakdown and removal of rock material from Earth's surface."
  type: true-false
  answer: false
