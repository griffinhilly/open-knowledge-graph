...
title: Earth's Interior Structure
...
- The mantle is not magma; it is mostly solid rock that deforms plastically over millions of years.
- The crust and lithosphere are not synonymous; the lithosphere includes the crust plus the uppermost brittle mantle.
- Earth's magnetic field is not a permanent magnet; it is generated dynamically by convection in the liquid outer core and has reversed polarity hundreds of times.

## Questions

```yaml
- question: "Seismologists observe that S-waves do not arrive in a large shadow zone on the far side of Earth from an earthquake. What does this most directly imply about Earth's outer core?"
  type: multiple-choice
  options: ["The outer core is extremely dense and absorbs S-waves", "The outer core is liquid, because S-waves cannot propagate through fluids", "The outer core is composed of iron and nickel", "The outer core is hotter than the surrounding mantle"]
  answer: 1
...
- question: "The lithosphere and the crust are synonymous terms for the same layer of Earth."
  type: true-false
  answer: false
  explanation: "The crust is defined compositionally — it is the outermost shell of rock with a distinct chemical composition (silica-rich for continental crust, more mafic for oceanic crust). The lithosphere is defined mechanically — it is the rigid outer layer comprising the crust plus the uppermost brittle portion of the mantle. The lithosphere is thicker than the crust alone. Its base, the lithosphere-asthenosphere boundary, is where the mantle transitions from rigid to ductile, and this mechanical boundary is what matters for plate tectonics."

- question: "If the inner core is deeper than the outer core and therefore at a higher temperature, why is the inner core solid while the outer core is liquid?"
  type: short-answer
  answer: "The inner core is solid because the enormous pressure at that depth raises iron's melting point above the local temperature. Even though the inner core is hotter in absolute terms, the pressure-adjusted melting point of iron is even higher, so it solidifies. The outer core is at lower pressure, so its melting point is lower and iron remains liquid there despite the high temperature."
