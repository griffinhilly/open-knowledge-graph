...
- Limestone is not always biogenic; it can precipitate inorganically in evaporite settings.
- Shale is not just fine-grained mud; it has fissility (splitting parallel to bedding) due to aligned clay mineral platy structure.
- Cementation, not just compaction, is required for lithification; loose sand remains sand until pore-filling minerals (quartz overgrowths, calcite) bind grains together.

## Questions

```yaml
- question: "A geologist finds a fine-grained rock that splits into thin, parallel sheets along flat planes. Which property distinguishes this rock as shale rather than simply fine-grained mudstone?"
  type: multiple-choice
  options: ["High quartz content", "Fissility caused by aligned clay minerals", "Presence of calcite cement", "High porosity and permeability"]
  answer: 1
  explanation: "Fissility — the tendency to split parallel to bedding — results from clay mineral platelets aligning during burial and compaction. This structural property is what defines shale; mudstone lacks this alignment and breaks into blocky fragments instead of sheets."

- question: "Compaction alone is sufficient to convert loose beach sand into sandstone."
  type: true-false
  answer: false
  explanation: "Compaction reduces pore space but does not bind grains together. Cementation — precipitation of minerals (such as quartz overgrowths or calcite) into pore spaces between grains — is required to create the rigid grain-to-grain bonds that make sandstone a rock. Without cement, the grains remain loose regardless of how tightly they are packed."

- question: "What feature of sedimentary rocks makes them the primary archive of Earth's surface history, and give one example of what such a feature records?"
  type: short-answer
  answer: "Sedimentary rocks preserve primary structures (such as cross-bedding, graded bedding, ripple marks, and fossils) that formed at the time of deposition and record the conditions of ancient environments. For example, cross-bedding records the direction of ancient currents, and fossils record past life forms and relative age."
  explanation: "Unlike igneous and metamorphic rocks, which are reset by heat or pressure, sedimentary rocks retain physical and biological imprints from their depositional environment. Each layer (stratum) is a snapshot in time, allowing geologists to reconstruct past climates, sea levels, and ecosystems — the foundation of stratigraphy and paleontology."
```
