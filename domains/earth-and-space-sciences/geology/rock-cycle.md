...
- The rock cycle does not always follow a simple igneous → sedimentary → metamorphic → igneous sequence; shortcuts are common (e.g., igneous rock directly metamorphosed without first becoming sedimentary).
