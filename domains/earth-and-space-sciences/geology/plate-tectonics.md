...
- Continents do not plow through oceanic crust; the entire lithospheric plate (continent + attached ocean floor) moves as a unit.
- Mantle convection is not boiling; the mantle is solid rock that flows viscously over millions of years.
- Plates move because of slab pull at subduction zones more than because of convective push from ridges; spreading ridges are a consequence as much as a cause.

## Questions

```yaml
- question: "Which mechanism is now understood to be the dominant driver of plate motion?"
  type: multiple-choice
  options: ["Ridge push — hot magma upwelling at mid-ocean ridges forces plates apart", "Slab pull — dense, cold oceanic lithosphere sinking at subduction zones drags the plate behind it", "Mantle convection currents directly pushing the base of plates like a conveyor belt", "Tidal forces from the Moon stretching the lithosphere"]
  answer: 1
  explanation: "Slab pull is estimated to contribute roughly three times more force to plate motion than ridge push. Cold oceanic lithosphere is denser than the underlying asthenosphere, so when it subducts, gravity pulls the sinking slab downward and the rest of the plate follows. Ridge push is real but secondary — the elevated ridge does create a gravitational slide force, but it is weaker. Mantle convection is important but acts as a lubricating background rather than the primary driver."

- question: "The mantle is liquid rock that flows like a slow-moving fluid, similar to thick lava, which is why convection can occur within it."
  type: true-false
  answer: false
  explanation: "The mantle is composed of solid rock under most conditions. It behaves like a fluid only over geological timescales (millions of years) through solid-state creep — atoms diffuse through crystal lattices and minerals deform plastically under sustained stress. This is fundamentally different from a liquid: seismic S-waves (which cannot travel through liquids) propagate through the mantle, confirming it is solid. The asthenosphere is partially molten in some regions but is still largely solid."

- question: "Why are the world's major earthquake belts and volcanic zones concentrated at plate boundaries rather than distributed randomly across continents and ocean floors?"
  type: short-answer
