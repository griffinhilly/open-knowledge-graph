...
- question: "A region that contains both folds and faults must have experienced at least two separate deformation events, because folding and faulting require fundamentally different stress orientations."
  type: true-false
  answer: false
