...
- question: "Paleoclimate records from Greenland ice cores show that the AMOC has mainly weakened gradually over geological time and has rarely undergone rapid collapse."
  type: true-false
  answer: false
