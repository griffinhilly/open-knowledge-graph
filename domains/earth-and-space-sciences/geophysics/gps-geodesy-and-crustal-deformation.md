...
- question: "Seasonal oscillations observed in GPS position time-series represent noise that should be removed before the data can be used to study crustal deformation — they carry no meaningful geophysical information."
  type: true-false
  answer: false
