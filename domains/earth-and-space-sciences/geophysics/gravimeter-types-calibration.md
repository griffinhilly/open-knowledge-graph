...
- question: "A sudden unexplained step offset ('tare') in repeated base-station readings from a relative gravimeter permanently corrupts all data collected after the tare occurs."
  type: true-false
  answer: false
