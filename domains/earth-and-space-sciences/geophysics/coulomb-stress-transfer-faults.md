...
- question: "After a large earthquake, most stress in the surrounding region is released equally — the ruptured fault and nearby faults are most equally stable because the mainshock reduced stress throughout the area."
  type: true-false
  answer: false
