...
- question: "According to core accretion theory, the difference between rocky terrestrial planets and gas giants is only one of distance from the star — gas giants simply form in a denser part of the inner disk, not through a fundamentally different process."
  type: true-false
  answer: false
