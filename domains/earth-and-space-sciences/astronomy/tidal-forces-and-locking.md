...
- question: "Tidal locking means tidal forces on the locked moon have ceased entirely, since synchronizing rotation with the orbit eliminates the displaced tidal bulge."
  type: true-false
  answer: false
