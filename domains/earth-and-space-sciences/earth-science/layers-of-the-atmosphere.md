...
- The atmosphere has a sharp boundary with space. The atmosphere gradually thins out — there is no clear edge where it ends and space begins.
- The ozone layer is in the troposphere. It is in the stratosphere, well above where weather occurs.
- The thermosphere must feel very hot. Despite extreme temperatures (up to 2,000 degrees Celsius), the air is so thin that there are almost no molecules to transfer heat — an astronaut there would not feel warm.

## Questions

```yaml
- question: "In which layer of the atmosphere does all weather (rain, snow, clouds, storms) occur?"
  ...
  options:
    ...
    - "Thermosphere"
  answer: 2
  explanation: "The troposphere is the lowest layer (0-12 km) and contains about 75% of the atmosphere's mass and almost all of its water vapor. All clouds, rain, snow, wind, and storms occur here. This is the layer we live in and interact with every day."

- question: "Why does the stratosphere get warmer with increasing altitude, unlike the troposphere which gets colder?"
  type: short-answer
  answer: "The stratosphere contains the ozone layer. Ozone molecules absorb ultraviolet (UV) radiation from the Sun, converting it to heat. The more UV that is absorbed, the warmer the air becomes. Since UV comes from above, the upper stratosphere absorbs the most and is the warmest."
  explanation: "This temperature inversion (warming with altitude) is why the stratosphere is very stable — warm air sitting above cool air does not rise. This stability is also why commercial airplanes fly in the lower stratosphere: it is above the weather and the air is calm."

- question: "The atmosphere has a clear, sharp boundary where it ends and outer space begins."
  type: true-false
  answer: false
  explanation: "The atmosphere does not have a sharp edge. It gradually thins out with altitude — there are fewer and fewer air molecules per unit of volume. The Karman line (100 km altitude) is often used as a conventional boundary for space, but it is a human-defined line, not a physical boundary. Some atmospheric molecules extend thousands of kilometers above Earth's surface."
```
