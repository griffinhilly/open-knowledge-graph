...
- climate-classification-systems-koppen
...
- A cold winter day disproves global warming. A single weather event says nothing about long-term climate trends. Climate is about averages over decades, not individual days.
- Climate never changes naturally. Climate has always changed naturally (ice ages, warm periods), but the current rate of change is unprecedented and driven by human activities.
- Climate and weather are the same thing at different scales. They are fundamentally different concepts — weather is a state, climate is a statistical pattern.

## Questions

```yaml
- question: "Which of the following is an example of climate rather than weather?"
  type: multiple-choice
  options:
    - "It is raining in Chicago right now"
    - "Tomorrow's high temperature will be 28 degrees Celsius"
    - "The Sahara Desert receives less than 25 cm of rain per year on average"
    - "A thunderstorm is approaching from the west"
  answer: 2
  explanation: "Climate describes average conditions over long periods. The Sahara's average annual rainfall is a climate fact — it describes the typical pattern over many years. The other three options describe specific weather events or forecasts (what is happening now or in the near future at a specific time and place)."

- question: "If someone says 'It snowed in April, so global warming must not be real,' what is wrong with their reasoning?"
  type: short-answer
  answer: "They are confusing weather with climate. A single snow event in April is a weather observation — a short-term event at one location. Climate change refers to long-term shifts in average temperature and weather patterns over decades across the entire globe. Individual weather events cannot confirm or disprove climate trends, just as one coin flip cannot tell you whether a coin is fair."
  explanation: "This is one of the most common and important misconceptions about climate change. The analogy of a single coin flip versus thousands of flips captures it well — you need the long-term pattern, not individual data points. A warming climate can still produce cold days, just as a loaded coin can still land on tails sometimes."

- question: "Climate is simply the average weather over a long period of time."
  type: true-false
  answer: true
  explanation: "Climate is indeed the statistical summary of weather — including averages, ranges, and extremes of temperature, precipitation, humidity, wind, and other atmospheric variables — typically calculated over a 30-year period. This means climate is derived from weather data, but it describes a pattern rather than a state."
```
