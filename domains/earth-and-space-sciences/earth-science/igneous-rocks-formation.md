...
- All igneous rocks come from volcanoes. Many form underground from magma that never reaches the surface (like granite).
- Lava and magma are the same thing. Magma is underground; lava is what it is called once it reaches the surface.
- Bigger crystals mean the rock is older. Crystal size reflects cooling speed, not age.

## Questions

```yaml
- question: "Why does granite have large, visible crystals while basalt has crystals too small to see?"
  type: multiple-choice
  options:
    - "Granite is older, so the crystals had more time to grow over the centuries"
    - "Granite cooled slowly deep underground, giving crystals time to grow; basalt cooled quickly at the surface"
    - "Granite is made of different chemicals that naturally form bigger crystals"
    - "Basalt's crystals were worn away by wind and rain"
  answer: 1
  explanation: "Crystal size depends on cooling rate. Granite forms deep underground where magma cools over thousands to millions of years, so crystals grow large. Basalt forms from lava that cools in days to weeks at the surface, leaving no time for large crystals."

- question: "Obsidian is a volcanic glass with no crystals at all. What does this tell you about how it formed?"
  type: short-answer
  answer: "Obsidian cooled so quickly that there was no time for any crystals to form at all. The atoms froze in place before they could arrange themselves into an orderly crystal structure."
  explanation: "Obsidian represents the extreme end of fast cooling. It often forms when lava contacts water or is ejected into cold air during an eruption."

- question: "Magma and lava are the same substance — the only difference is location."
  type: true-false
  answer: true
  explanation: "Magma is melted rock beneath Earth's surface. The moment it erupts and reaches the surface, it is called lava. The material itself is the same; only the name changes based on where it is."
```
