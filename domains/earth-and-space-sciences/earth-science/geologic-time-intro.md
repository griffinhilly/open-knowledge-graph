...
- Humans lived alongside dinosaurs. Dinosaurs went extinct about 66 million years ago; modern humans appeared about 300,000 years ago.
- A million years and a billion years are roughly the same. A billion is a thousand millions — the difference is enormous.
- Scientists just guess at the ages of rocks. Radiometric dating and careful study of rock layers provide reliable, testable age estimates.

## Questions

```yaml
- question: "If Earth's entire 4.6-billion-year history were compressed into a single 24-hour day, when would modern humans first appear?"
  type: multiple-choice
  options:
    - "Around noon — halfway through Earth's history"
    - "Around 6:00 PM — in the last quarter of the day"
    - "Around 11:00 PM — in the last hour"
    - "Less than one second before midnight"
  answer: 3
  explanation: "Modern humans have existed for roughly 300,000 years. On a 24-hour scale representing 4.6 billion years, that is about 0.006% of the total — less than one second before midnight. This dramatically illustrates how recent humans are in Earth's story."

- question: "In undisturbed sedimentary rock layers, the oldest layers are at the bottom and the youngest are at the top."
  type: true-false
  answer: true
  explanation: "This is the law of superposition — one of the fundamental principles of geology. Each new layer of sediment is deposited on top of older layers, so in undisturbed sequences, deeper means older."

- question: "Why do geologists divide Earth's history into different eras and periods instead of just using years?"
  type: short-answer
  answer: "The time spans are so enormous that raw numbers of years are hard to grasp and work with. Dividing history into named eras and periods (like the Mesozoic Era or the Jurassic Period) based on major events like mass extinctions and the appearance of new life forms makes it easier to discuss and organize Earth's history."
  explanation: "Named time divisions also reflect real changes in life and geology. The boundary between the Mesozoic and Cenozoic, for example, marks the mass extinction that killed the dinosaurs — a genuine turning point in Earth's history, not an arbitrary line."
```
