...
title: Rock Identification Skills
...
- id: sedimentary-rocks-formation
  type: hard
- id: metamorphic-rocks-formation
  type: hard
builds-toward:
...
- You can identify a rock just by its color. Color is one of the least reliable clues — many different rocks share the same color, and the same rock type can come in different colors.
- Shiny rocks are always valuable. Shininess (luster) is just one property and does not indicate value.
- If it is hard, it is igneous. Metamorphic rocks like quartzite are among the hardest rocks, and some igneous rocks (like pumice) are quite soft.

## Questions

```yaml
- question: "You find a rock with visible layers of different-colored material and what looks like a shell impression. Which rock type is it most likely?"
  type: multiple-choice
  options:
    - "Igneous — the layers are from different lava flows"
    - "Metamorphic — the layers are from pressure alignment"
    - "Sedimentary — the layers are from sediment deposited over time, and fossils are most common in sedimentary rocks"
    - "It could be any type — you cannot tell from these clues alone"
  answer: 2
  explanation: "Layers of sediment and fossil impressions are strong indicators of sedimentary rock. While metamorphic rocks can have bands (foliation), they would not contain well-preserved fossils because the heat and pressure of metamorphism would distort or destroy them."

- question: "A rock has large, interlocking crystals of several different minerals that you can see clearly without a magnifying glass. What does this texture tell you about how the rock formed?"
  type: short-answer
  answer: "The rock is most likely an intrusive igneous rock that cooled slowly deep underground. Slow cooling gave the minerals time to grow into large, visible crystals. A rock like granite has this texture."
  explanation: "Large crystal size is the hallmark of slow cooling. The key word is 'interlocking' — the crystals grew into each other like puzzle pieces as the magma slowly solidified, which is different from the rounded grains you see in sedimentary rocks."

- question: "Color is the most reliable property for identifying a rock."
  type: true-false
  answer: false
  explanation: "Color is one of the least reliable properties. Granite can be pink, white, or gray. Sandstone can be red, tan, or white. The same rock type comes in many colors depending on its mineral content and chemical impurities. Texture, grain size, hardness, and how the rock breaks are all more reliable than color."
```
