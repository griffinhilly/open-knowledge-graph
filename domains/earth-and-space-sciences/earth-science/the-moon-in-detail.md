...
- The Moon produces its own light. The Moon reflects sunlight — it has no light source of its own.
- There is a permanent "dark side" of the Moon. All sides of the Moon receive sunlight as it rotates. The "far side" is the side that always faces away from Earth, but it gets just as much sunlight as the near side.
- The Moon is very far away in space terms. At about 384,000 km, the Moon is actually very close — you could fit all other planets in the solar system in the gap between Earth and the Moon.

## Questions

```yaml
- question: "What are the dark, smooth areas on the Moon's surface, and how did they form?"
  type: multiple-choice
  options:
    - "They are oceans of water, which is why they are called 'seas' (maria)"
    - "They are shadows from tall mountains on the Moon"
    - "They are large basins filled by ancient lava flows that solidified into dark basaltic rock billions of years ago"
    - "They are areas where the Moon's surface has been worn smooth by wind"
  answer: 2
