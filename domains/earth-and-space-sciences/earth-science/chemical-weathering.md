...
- weathering-processes-rates-factors
- soil-formation
tags:
- weathering
- chemical
...
- Chemical weathering only happens with acid rain from pollution. Normal rainwater is naturally slightly acidic (pH about 5.6) because CO2 dissolves in it. Acid rain from pollution accelerates the process but did not create it.
- Chemical weathering and mechanical weathering are completely separate. They work together — mechanical weathering creates cracks and surfaces that expose more rock to chemical attack, speeding up chemical weathering.
- Chemical weathering dissolves all rocks equally. Different minerals have very different resistance to chemical weathering. Quartz is very resistant; feldspar and calcite are much more vulnerable.

## Questions

```yaml
- question: "Why does limestone dissolve in rainwater even without pollution?"
  type: multiple-choice
  options:
    - "Rainwater is naturally slightly acidic because it absorbs carbon dioxide from the air, forming carbonic acid that dissolves calcium carbonate in limestone"
    - "Rainwater is pure H2O, which is a natural solvent for all rocks"
    - "Limestone is not actually rock — it is a soft material that dissolves in any liquid"
    - "Only polluted rain can dissolve limestone"
  answer: 0
  explanation: "Rainwater absorbs CO2 from the atmosphere, forming weak carbonic acid (H2CO3). This acid reacts with calcium carbonate (CaCO3) in limestone, dissolving it slowly. This natural process created caves, sinkholes, and karst landscapes long before industrial pollution existed."

- question: "How do mechanical weathering and chemical weathering work together to break down rock faster than either could alone?"
  type: short-answer
  answer: "Mechanical weathering cracks rock and breaks it into smaller pieces, increasing the total surface area exposed to water and air. More exposed surface means more area for chemical reactions to occur, speeding up chemical weathering. In turn, chemical weathering weakens the rock along grain boundaries, making it easier for mechanical forces to break it apart further."
  explanation: "They form a positive feedback loop. A solid boulder has limited surface area for chemical attack. Break it into a thousand pieces and you have vastly more surface area — same total rock, but much more exposure to chemicals. This is why weathering accelerates once it begins."

- question: "Chemical weathering produces the same minerals as the original rock, just in smaller pieces."
  type: true-false
  answer: false
  explanation: "This describes mechanical weathering, not chemical weathering. Chemical weathering transforms minerals into different substances through chemical reactions. For example, feldspar in granite reacts with water and becomes clay minerals — an entirely different substance with different properties. This is the key distinction between the two types of weathering."
```
