...
title: The Greenhouse Effect Basics
...
- The greenhouse effect is entirely bad. The natural greenhouse effect is essential — without it, Earth would be frozen at about -18 degrees Celsius. The problem is the enhanced greenhouse effect from human emissions.
- The greenhouse effect works like a glass greenhouse. A glass greenhouse traps warm air by preventing convection (warm air cannot rise and escape). The atmospheric greenhouse effect works by absorbing and re-emitting infrared radiation — a different mechanism entirely.
- CO2 is the only greenhouse gas. Water vapor, methane, nitrous oxide, and ozone are all greenhouse gases. Water vapor is actually the most abundant, but its concentration responds to temperature rather than causing it independently.

## Questions

```yaml
- question: "Without the natural greenhouse effect, what would Earth's average surface temperature be?"
  type: multiple-choice
  options:
    - "About the same as it is now — 15 degrees Celsius"
    - "About -18 degrees Celsius — too cold for liquid water"
    - "About 100 degrees Celsius — too hot for life"
    - "About 0 degrees Celsius — just at the freezing point"
  answer: 1
  explanation: "Without greenhouse gases trapping heat, Earth's average surface temperature would be about -18 degrees Celsius (0 degrees Fahrenheit). The natural greenhouse effect raises it to about +15 degrees Celsius (59 degrees Fahrenheit) — a 33-degree difference that makes liquid water, and therefore life, possible. The greenhouse effect is not the problem; the problem is the enhanced greenhouse effect from human emissions."

- question: "Explain how adding more CO2 to the atmosphere leads to warming."
  type: short-answer
  answer: "More CO2 molecules in the atmosphere absorb more of the infrared radiation (heat) emitted by Earth's surface. This absorbed energy is re-radiated in all directions, including back toward the surface. More CO2 means more heat is returned to the surface instead of escaping to space, raising the surface temperature. It is like adding an extra blanket — the Sun provides the same amount of heat, but less of it escapes."
  explanation: "This is a direct, well-understood physical mechanism. CO2 molecules vibrate at frequencies that match infrared radiation, allowing them to absorb and re-emit it. Doubling CO2 concentration does not double the warming (the relationship is logarithmic), but it does produce significant additional warming, amplified by feedback mechanisms like increased water vapor."

- question: "The greenhouse effect works the same way as a glass greenhouse — by trapping warm air inside."
  type: true-false
  answer: false
  explanation: "Despite the name, the mechanisms are different. A glass greenhouse works by preventing convection — warm air cannot rise and escape through the glass roof. The atmospheric greenhouse effect works through radiation: greenhouse gas molecules absorb outgoing infrared radiation and re-emit it in all directions, returning some heat to the surface. The name 'greenhouse effect' is a metaphor, not a precise description of the physics."
```
