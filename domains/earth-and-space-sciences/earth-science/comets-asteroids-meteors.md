...
- asteroids-composition-and-properties
tags:
- comets
- asteroids
- meteors
...
- Shooting stars are actual stars. Meteors are tiny particles (often grain-of-sand sized) burning up in Earth's atmosphere. They have nothing to do with stars.
- The asteroid belt is a dense field of rocks that would be dangerous to fly through. The asteroid belt is mostly empty space — the total mass of all asteroids is less than 4% of Earth's Moon.
- Comets are on fire. The tail is not fire — it is gas and dust released as the comet's ice sublimates (goes directly from solid to gas) when heated by the Sun. Comet tails always point away from the Sun, pushed by solar wind and radiation pressure.

## Questions

```yaml
- question: "What is the difference between a meteor, a meteoroid, and a meteorite?"
  type: multiple-choice
  options:
    - "They are three different names for the same thing"
    - "A meteoroid is a small rocky body in space; a meteor is the streak of light when it enters the atmosphere; a meteorite is the piece that reaches the ground"
    - "A meteor is in space; a meteoroid is in the atmosphere; a meteorite is on the ground"
    - "Meteors are made of ice; meteoroids of rock; meteorites of metal"
  answer: 1
  explanation: "The same object has three different names depending on where it is. In space, it is a meteoroid. When it enters Earth's atmosphere and creates a streak of light (a shooting star), it becomes a meteor. If any piece survives the fiery trip through the atmosphere and lands on Earth's surface, that piece is a meteorite."

- question: "Why do comet tails always point away from the Sun, even when the comet is moving away from it?"
  type: short-answer
