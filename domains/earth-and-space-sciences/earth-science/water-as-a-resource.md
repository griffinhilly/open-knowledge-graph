...
- groundwater-aquifers-flow-properties
tags:
- water
- freshwater
- groundwater
...
- Earth has unlimited water. While the total amount of water does not change, the amount of clean, accessible freshwater is very limited and unevenly distributed.
- The water cycle always provides enough freshwater. The water cycle provides a relatively fixed amount of freshwater. When populations grow or climate patterns shift, demand can exceed local supply.
- Groundwater is an underground river or lake. Groundwater fills tiny spaces (pores) between rock and sediment particles, like water in a saturated sponge. It moves very slowly — often just meters per year.

## Questions

```yaml
- question: "What percentage of Earth's water is easily accessible freshwater in rivers, lakes, and shallow groundwater?"
  ...
  options:
    ...
    - "Less than 1%"
  answer: 3
  explanation: "Less than 1% of all water on Earth is easily accessible freshwater. About 97.5% is saltwater. Of the 2.5% that is freshwater, most is frozen in ice caps and glaciers or locked deep underground. The rivers, lakes, and shallow aquifers that we depend on represent a tiny fraction of Earth's total water."

- question: "Why can groundwater be considered nonrenewable in some areas even though water is part of the renewable water cycle?"
  type: short-answer
  answer: "Some deep aquifers were filled over thousands to millions of years and receive very little recharge from current rainfall. When these aquifers are pumped faster than they are replenished, they are being depleted like a nonrenewable resource. The Ogallala Aquifer in the central United States, for example, is being drained much faster than it recharges, and some regions may exhaust their supply within decades."
...
- question: "Most of Earth's freshwater is in rivers and lakes."
  type: true-false
  answer: false
  explanation: "Most of Earth's freshwater (about 68%) is locked in ice caps, glaciers, and permanent snow cover — primarily in Antarctica and Greenland. About 30% is groundwater. Rivers and lakes contain less than 1% of all freshwater. The sources we rely on most are actually a very small part of the freshwater picture."
```
