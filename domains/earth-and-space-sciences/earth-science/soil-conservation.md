...
- Soil is just "dirt" with no value. Soil is a complex living ecosystem containing billions of microorganisms per gram. It takes centuries to form and is essential for all terrestrial food production.
- Soil cannot be lost permanently. While the water cycle continuously provides new water, soil formation is extraordinarily slow. Topsoil lost to erosion is effectively gone for human purposes.
- Modern farming has solved soil erosion. While conservation practices have improved enormously since the Dust Bowl, soil erosion remains a global problem. Many agricultural areas are losing topsoil faster than it is being replaced.

## Questions

```yaml
- question: "Why does removing vegetation (like plowing up prairie grassland) dramatically increase soil erosion?"
  type: multiple-choice
  options:
    - "Vegetation blocks sunlight from reaching the soil"
    - "Plant roots hold soil in place, leaves break the impact of raindrops, and stems slow wind at the surface — without vegetation, soil is directly exposed to erosive forces"
    - "Vegetation makes the soil heavier so it cannot blow away"
    - "Plants absorb all the rainfall, leaving none to cause erosion"
  answer: 1
  explanation: "Vegetation protects soil in multiple ways. Roots bind soil particles together like a net. Leaf canopy intercepts raindrops, reducing their impact energy when they hit the soil. Stems and low-growing plants slow wind speed at the surface. Dead leaves and organic matter (mulch) cover the soil surface. Remove the vegetation and the soil is fully exposed to rain impact, water flow, and wind — all of which can rapidly strip away topsoil."
