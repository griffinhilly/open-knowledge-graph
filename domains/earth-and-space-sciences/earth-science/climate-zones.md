...
- Climate zones have sharp boundaries. Climate changes gradually between zones — the borders on maps are simplifications of gradual transitions.
- The tropics are always wet. Some tropical areas are extremely dry (Sahara Desert is near the tropics). The tropical zone refers to temperature, not necessarily precipitation.
- Temperate means "mild." Temperate climates can include harsh winters and hot summers — "temperate" refers to being between tropical and polar extremes, not to being consistently comfortable.

## Questions

```yaml
- question: "Why is it generally warmer near the equator and colder near the poles?"
  type: multiple-choice
  options:
    - "The equator is closer to the Sun than the poles are"
    - "Sunlight hits the equator at a direct angle, concentrating energy on a smaller area, while sunlight hits the poles at a low angle, spreading energy over a larger area"
    - "The equator has more volcanoes that heat the surface"
    - "The poles are covered in ice, which blocks the Sun's heat"
  answer: 1
  explanation: "The curved shape of Earth means sunlight hits the equator nearly straight on (direct angle), concentrating solar energy on a relatively small area. Near the poles, the same amount of sunlight strikes at a low, glancing angle and is spread over a much larger area, delivering less energy per unit of surface. This geometric effect is the primary reason for Earth's temperature gradient from equator to poles."

- question: "Name the three main climate zones and briefly describe each."
  type: short-answer
