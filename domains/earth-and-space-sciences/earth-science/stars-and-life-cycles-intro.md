...
title: Introduction to Stars and Their Life Cycles
...
- Stars live forever. Stars have finite lifespans — massive stars burn out in millions of years, while small stars can last trillions of years.
- All stars are the same. Stars vary enormously in size, color, temperature, and mass. Some are hundreds of times larger than the Sun; others are smaller than Earth.
- Stars burn like fire. Stars produce energy through nuclear fusion, not chemical combustion. Fusion is millions of times more energetic than burning.
- The Sun is an average or unremarkable star. The Sun is actually larger and brighter than about 85% of stars in the galaxy (most stars are small red dwarfs).

## Questions

```yaml
- question: "What is the source of a star's energy?"
  type: multiple-choice
  options:
    - "Stars burn fuel like a campfire"
    - "Stars are heated by friction from spinning"
    - "Nuclear fusion — hydrogen atoms are fused into helium in the star's core, releasing enormous energy"
    - "Stars reflect light from other, brighter stars"
  answer: 2
  explanation: "Stars produce energy through nuclear fusion. In the core, temperatures and pressures are so extreme that hydrogen nuclei are forced together (fused) to form helium. This process converts a tiny amount of mass into a huge amount of energy (following Einstein's E=mc²). The Sun fuses about 600 million tons of hydrogen every second."

- question: "Why do more massive stars have shorter lifespans than less massive stars?"
  type: short-answer
  answer: "More massive stars have more fuel (hydrogen) but burn through it much faster because they need much higher core temperatures and fusion rates to support their enormous weight. A star 10 times the Sun's mass might have 10 times the fuel but burns it 10,000 times faster, lasting only millions of years instead of billions."
  explanation: "This is counterintuitive — you would expect more fuel to last longer. But the relationship between mass, luminosity, and lifetime is non-linear. Luminosity increases roughly as mass to the 3.5 power. So a star with 10x the Sun's mass is about 3,000x more luminous and burns through its fuel roughly 300x faster."

- question: "The Sun will eventually explode as a supernova."
  type: true-false
  answer: false
  explanation: "Only stars significantly more massive than the Sun (roughly 8+ solar masses) end as supernovae. The Sun is a medium-sized star. In about 5 billion years, it will expand into a red giant (engulfing Mercury and Venus), shed its outer layers as a planetary nebula, and its core will collapse into a white dwarf — a small, dense remnant that slowly cools over billions of years. No explosion."
```
