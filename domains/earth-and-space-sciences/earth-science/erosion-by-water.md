...
- Rivers only erode downward. Rivers also erode sideways, widening their valleys and creating floodplains over time.
- Erosion happens only during floods. Rivers erode constantly, but erosion is dramatically faster during floods when water volume and speed increase.
- The Grand Canyon was created by a single catastrophic event. It was carved gradually over roughly 5-6 million years by the persistent action of the Colorado River.

## Questions

```yaml
- question: "Why does a fast-moving river carry larger rocks than a slow-moving river?"
  type: multiple-choice
  options:
    - "Fast rivers are deeper, so there is more room for big rocks"
    - "Fast-moving water has more energy, so it can lift and carry heavier particles that slower water would leave behind"
    - "Fast rivers have special chemicals that dissolve large rocks"
    - "Big rocks only exist near fast rivers"
  answer: 1
  explanation: "The speed (velocity) of water determines its carrying power. Faster water has more kinetic energy, enabling it to lift larger and heavier particles from the riverbed. When a river slows down (at a bend, in a wide section, or where it enters a lake or ocean), it drops the heaviest sediment first because it no longer has enough energy to carry it."
