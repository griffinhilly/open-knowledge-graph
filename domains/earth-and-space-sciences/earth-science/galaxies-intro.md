...
- Stars are scattered randomly through space. Stars are organized into galaxies, and galaxies are organized into clusters and superclusters, creating a large-scale structure.
- Our galaxy is at the center of the universe. There is no center — the universe is expanding everywhere equally. Every galaxy sees all other galaxies moving away from it.
- We can see the entire universe. The observable universe (the part whose light has had time to reach us) has a radius of about 46 billion light-years. The full universe may be much larger or even infinite.

## Questions

```yaml
- question: "About how many stars does the Milky Way galaxy contain?"
  ...
  options:
    ...
    - "About one trillion"
  answer: 2
  explanation: "Current estimates place the Milky Way's star count at roughly 200-400 billion stars. Our Sun is just one ordinary star among this vast number. The Milky Way is a large galaxy, but not the largest — some elliptical galaxies contain over a trillion stars."
...
- question: "The Milky Way band of light across the night sky is a distant galaxy far away from us."
  type: true-false
  answer: false
  explanation: "The milky band of light across the sky IS our own galaxy — we are inside it. Because the Milky Way is a flat disk and we are located within that disk, we see the combined light of billions of distant stars when we look along the plane of the disk. We are looking through the galaxy edge-on. We cannot see the spiral shape from inside — just as you cannot see the shape of a forest when you are standing among the trees."
```
