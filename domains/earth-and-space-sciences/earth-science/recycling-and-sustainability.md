---
id: recycling-and-sustainability
title: Recycling and Sustainability
domain: earth-and-space-sciences
course: earth-science
prerequisites:
- id: renewable-vs-nonrenewable-resources
  type: hard
- id: fossil-fuels-basics
  type: soft
...
- Recycling solves all waste problems. Recycling is important but has limitations — not all materials can be recycled efficiently, contamination reduces recyclability, and the process itself uses energy. Reducing consumption is more effective.
- Plastic recycling is just as effective as metal or glass recycling. Most plastics can only be recycled once or twice before degrading (downcycling), while metals and glass can be recycled indefinitely without quality loss.
- Individual actions do not matter because industry creates most pollution. While industrial emissions are large, individual choices (energy use, transportation, consumption patterns) collectively drive demand and represent a significant share of total impact. Both individual and systemic changes are needed.

## Questions

```yaml
- question: "Why is 'reduce' considered more effective than 'recycle' for protecting the environment?"
  type: multiple-choice
  options:
    - "Because recycling is too expensive"
    - "Because reducing means using less in the first place — no resource extraction, no manufacturing energy, no waste to manage. Recycling still uses energy and resources."
    - "Because recycling does not actually work"
    - "Because reducing is easier than recycling"
  answer: 1
  explanation: "The three R's are in order of effectiveness: reduce, reuse, recycle. Reducing consumption prevents the entire chain of environmental impacts — no mining, no manufacturing, no transportation, no waste. Reusing extends the life of products that already exist. Recycling is valuable but still requires energy for collection, processing, and remanufacturing. A product that is never made has zero environmental footprint."

- question: "Recycling one aluminum can saves enough energy to run a TV for about 3 hours. Why does recycling aluminum save so much energy?"
  type: short-answer
