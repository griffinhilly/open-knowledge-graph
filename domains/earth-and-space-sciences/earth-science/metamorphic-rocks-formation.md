...
title: How Metamorphic Rocks Form
...
- Metamorphic rocks are melted and reformed. If melting occurs, the result is igneous rock, not metamorphic. Metamorphism happens in the solid state.
- Only one kind of change produces metamorphic rock. Both heat and pressure can cause metamorphism, and they often act together.
- Metamorphic rocks always look layered. Some, like marble and quartzite, have no visible layering because their minerals are equidimensional rather than flat and platy.

## Questions

```yaml
- question: "What is the key difference between how metamorphic rocks form and how igneous rocks form?"
  type: multiple-choice
  options:
    - "Metamorphic rocks form at the surface; igneous rocks form underground"
    - "Metamorphic rocks form from changes caused by heat and pressure without melting; igneous rocks form from melted rock that cools"
    - "Metamorphic rocks are always harder than igneous rocks"
    - "There is no difference — they form the same way"
  answer: 1
  explanation: "The critical difference is melting. Metamorphic rocks change while still solid — minerals rearrange without the rock becoming liquid. Igneous rocks require melting first and then cooling. If a metamorphic rock gets hot enough to actually melt, the resulting rock would be igneous, not metamorphic."

- question: "Limestone that is metamorphosed becomes marble. What changed and what stayed the same?"
  type: short-answer
