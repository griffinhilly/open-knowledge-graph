...
title: Deposition and Landforms
...
- Deposition only happens at the mouths of rivers. It happens anywhere an erosive agent slows down — on the inside of river bends, at the base of cliffs, on floodplains, and wherever glaciers melt.
- Deposited sediment stays put forever. Deposited material can be eroded again and re-deposited elsewhere. Sediment may go through many cycles of erosion and deposition before being buried and lithified into rock.
- Beaches are permanent. Beaches are constantly shifting — sand is delivered by rivers and longshore currents and removed by waves and storms. Many beaches would disappear without a continuous supply of new sediment.

## Questions

```yaml
- question: "When a fast-moving mountain river reaches a flat valley and slows down, what determines which sediment is deposited first?"
  type: multiple-choice
  options:
    - "The color of the sediment"
    - "The age of the sediment"
    - "The size and weight of the particles — the heaviest and largest are deposited first"
    - "All particles are deposited at the same time"
  answer: 2
  explanation: "When water slows down, it loses carrying power. The largest, heaviest particles (boulders, gravel) are dropped first because they require the most energy to transport. Smaller particles (sand) are carried farther before being deposited. The finest particles (silt and clay) travel the farthest and are the last to settle. This sorting by size is a fundamental feature of deposition."

- question: "How does a river delta form?"
  type: short-answer
