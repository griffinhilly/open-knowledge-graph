...
- Fossil fuels come from dinosaurs. Most fossil fuels formed from ancient plants (coal) and microscopic marine organisms like plankton (oil and gas), not dinosaurs. The name "fossil fuel" is about geological age, not dinosaur remains.
- Oil exists in underground lakes. Oil fills the tiny pore spaces in rocks (like water in a sponge), not open caverns. You cannot drain an oil deposit like draining a swimming pool.
- We will immediately run out of fossil fuels. Known reserves will last decades to over a century depending on the fuel type. The more pressing concern is the environmental impact of burning them, not immediate depletion.

## Questions

```yaml
- question: "How did coal form?"
  type: multiple-choice
  options:
    - "Dinosaurs were buried and compressed into coal over millions of years"
    - "Ancient swamp plants died, were buried under sediment, and were slowly transformed by heat and pressure over millions of years"
    - "Coal is a type of volcanic rock formed from lava"
    - "Coal is manufactured from other rocks by grinding them up"
  answer: 1
  explanation: "Coal formed during the Carboniferous Period (about 360-300 million years ago) when vast swamps covered much of the land. Dead plant material accumulated in swamps faster than it could decompose. Over millions of years, this material was buried under sediment and transformed by heat and pressure into increasingly carbon-rich forms: peat, lignite, bituminous coal, and eventually anthracite."

- question: "Why does burning fossil fuels contribute to climate change?"
  type: short-answer
  answer: "Fossil fuels contain carbon that was removed from the atmosphere by ancient organisms millions of years ago and stored underground. Burning them releases this carbon back into the atmosphere as CO2, a greenhouse gas. This adds carbon to the atmosphere much faster than natural processes can remove it, strengthening the greenhouse effect and warming the planet."
  explanation: "The key insight is the timescale mismatch. Ancient organisms took hundreds of millions of years to remove this carbon from the atmosphere. Humans are releasing it back in a few centuries — roughly a million times faster. The atmosphere and climate cannot adjust that quickly, which is why temperatures are rising."

- question: "Oil is found in large underground caves or pools."
  type: true-false
  answer: false
  explanation: "Oil does not exist in underground lakes or caverns. It fills the tiny pore spaces between grains in porous rock (like sandstone or limestone), much like water fills the pores of a sponge. An oil reservoir is a section of porous rock saturated with oil, capped by an impermeable layer that prevents the oil from escaping upward. Extracting oil involves drilling into this rock and pumping it out."
```
