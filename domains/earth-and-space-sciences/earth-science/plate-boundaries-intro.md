...
- Plates and continents are the same thing. Many plates include both continental and oceanic crust. The North American plate, for example, includes part of the Atlantic Ocean floor.
- Plate boundaries are narrow lines. They are actually zones that can be hundreds of kilometers wide, with many smaller faults and deformation features.
- Only convergent boundaries have volcanoes. Volcanoes also occur at divergent boundaries (mid-ocean ridges) and over hot spots far from any boundary (like Hawaii).

## Questions

```yaml
- question: "At which type of plate boundary is new oceanic crust being created?"
  type: multiple-choice
  options:
    - "Convergent boundary"
    - "Transform boundary"
    - "Divergent boundary"
    - "No new crust is ever created — Earth has always had the same crust"
  answer: 2
  explanation: "At divergent boundaries, plates move apart and magma rises from the mantle to fill the gap, cooling and solidifying into new oceanic crust. This process is called seafloor spreading. The Mid-Atlantic Ridge is a famous example — it is literally building new ocean floor as the Americas and Europe/Africa move apart."

- question: "Why do most earthquakes and volcanoes occur along plate boundaries rather than in the middle of plates?"
  type: short-answer
  answer: "Plate boundaries are where plates interact — pushing together, pulling apart, or grinding past each other. These interactions create the forces that trigger earthquakes (sudden releases of built-up stress) and volcanoes (magma rising through cracks and weak zones). The interiors of plates are relatively stable because they are far from these zones of interaction."
  explanation: "When you plot earthquake and volcano locations on a map, they clearly outline the plate boundaries, especially the Ring of Fire around the Pacific. This pattern was one of the key pieces of evidence that led to the acceptance of plate tectonics theory."

- question: "The San Andreas Fault in California is a transform boundary where two plates slide past each other."
  type: true-false
  answer: true
  explanation: "The San Andreas Fault is where the Pacific Plate and the North American Plate slide horizontally past each other. This is a transform boundary. The plates are not creating or destroying crust — they are grinding sideways, which produces earthquakes but generally not volcanoes."
```
