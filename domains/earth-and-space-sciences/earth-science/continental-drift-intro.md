...
title: Introduction to Continental Drift
...
- Continents move quickly enough that we could notice. They move only a few centimeters per year — about as fast as your fingernails grow.
- Wegener's idea was accepted immediately. It was rejected for nearly 50 years because he could not explain the mechanism. Only when seafloor spreading was discovered in the 1960s did scientists accept it.
- The continents float on liquid lava. Continents "float" on the denser but mostly solid mantle rock, which flows extremely slowly.

## Questions

```yaml
- question: "What was the strongest evidence that the continents were once joined together?"
  type: multiple-choice
  options:
    - "The continents are all the same shape"
    - "Matching coastline shapes, identical fossils on separate continents, and matching rock formations across ocean basins"
    - "Ancient maps showed the continents connected"
    - "Sailors reported seeing the continents move"
  answer: 1
  explanation: "Wegener compiled multiple independent lines of evidence: the jigsaw fit of continents (especially South America and Africa), identical fossils of land animals found on continents now separated by thousands of kilometers of ocean, matching rock types and mountain chains that align when continents are reassembled, and glacial evidence in currently tropical locations."

- question: "Why was Wegener's continental drift hypothesis rejected by most scientists for decades?"
  type: short-answer
  answer: "Wegener could describe the evidence that continents had moved but could not explain what force was powerful enough to move entire continents. Without a plausible mechanism, most scientists found his idea unconvincing, even though his evidence was strong."
  explanation: "This changed in the 1960s when scientists discovered seafloor spreading and mapped the system of mid-ocean ridges. This provided the mechanism Wegener was missing: the continents are carried on tectonic plates that are pushed and pulled by forces in the mantle. Wegener's observations were vindicated, but the explanation was different from what he had proposed."

- question: "Continents move at a rate of several meters per year."
  type: true-false
  answer: false
  explanation: "Continents typically move only a few centimeters per year — about the speed fingernails grow. This is why the movement is undetectable without precise instruments. Over millions of years, however, a few centimeters per year adds up to thousands of kilometers."
```
