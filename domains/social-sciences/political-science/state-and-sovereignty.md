...
- 'State' and 'nation' are not synonymous: a nation is a cultural/ethnic community, while a state is a political-legal entity. Many states contain multiple nations; some nations lack a state.
- Sovereignty is not absolute in practice: international law, treaties, and global institutions constrain state behavior even while affirming formal sovereignty.

## Questions

```yaml
- question: "Max Weber's definition of the modern state centers on which of the following?"
  type: multiple-choice
  options:
    - "The state's ability to collect taxes from a defined population"
    - "The monopoly on the legitimate use of physical force within a territory"
    - "A government that derives its authority from popular consent"
    - "The capacity to enter into binding treaties with other states"
  answer: 1
