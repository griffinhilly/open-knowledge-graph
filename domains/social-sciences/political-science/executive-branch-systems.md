---
id: executive-branch-systems
title: Executive Power and Governmental Systems
...
- In parliamentary systems, the prime minister is a weak executive; in practice, prime ministers often wield substantial power over their parties and governments, especially under single-party majorities.
- The head of state and the head of government are always the same person; in parliamentary systems they are routinely separate roles, with heads of state often serving ceremonial functions.
...
```yaml
- question: "In a parliamentary system, a governing party loses a vote of no confidence in the legislature. What happens next, and how does this differ from a presidential system facing a similar political crisis?"
  type: short-answer
  answer: "In a parliamentary system, a lost vote of no confidence triggers either the resignation of the government (the prime minister and cabinet step down, allowing for formation of a new government or new elections) or a dissolution of parliament and fresh elections. The executive's tenure depends on maintaining legislative confidence, so losing it ends the government. In a presidential system, there is no equivalent mechanism for routine political removal: a president who has lost political support, faces a hostile legislature, or is deeply unpopular continues to serve out the fixed term unless an extraordinary process (impeachment and conviction) is successfully completed. The difference reflects the underlying logic: parliamentary systems fuse executive and legislative authority, making the executive accountable to the legislature at all times; presidential systems separate them, giving the executive an independent mandate."
  explanation: "The core distinction is accountability mechanism: in parliamentary systems, loss of legislative confidence directly triggers executive removal; in presidential systems, the executive's tenure is fixed by election, not by ongoing legislative support. This difference has major implications for governmental stability, accountability, and the handling of political crises."

- question: "What is 'cohabitation' in a semi-presidential system, and what conditions produce it?"
  type: short-answer
  answer: "Cohabitation occurs when the directly elected president and the prime minister (who must command a parliamentary majority) come from opposing political parties or coalitions. The president retains the powers assigned to the executive presidency under the constitution (typically foreign policy, defense, and some appointments), while the prime minister leads the parliamentary majority and controls domestic legislative agenda. This divides executive authority along partisan lines and can produce policy conflict. Cohabitation occurs when presidential and parliamentary elections are held at different times and produce different electoral majorities — or when mid-term elections shift the parliamentary balance. France addressed this vulnerability by aligning the lengths of presidential and parliamentary terms, reducing (though not eliminating) the opportunity for divergent majorities."
  explanation: "Cohabitation is the semi-presidential system's distinctive vulnerability: it can produce a split executive that lacks the clear lines of authority present in either pure presidential or pure parliamentary arrangements. Understanding it requires applying the logic of both systems — the president's independent electoral mandate and the prime minister's parliamentary dependence — to the scenario where they pull in opposite directions."
```
