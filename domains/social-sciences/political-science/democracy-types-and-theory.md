...
title: 'Democracy: Types and Theory'
...
- Democracy is not simply majority rule; constitutional protections and rights constrain what majorities can do.
- Holding elections does not by itself make a system democratic — elections must be free, fair, and competitive.

## Questions

```yaml
- question: "Which of the following best captures Robert Dahl's concept of 'polyarchy'?"
  type: multiple-choice
  options:
    - "A system in which all citizens vote directly on every law, with no elected representatives"
    - "A set of empirically observable institutional conditions — competitive elections, civil liberties, and minority rights — that approximate democracy in the real world"
    - "A government in which multiple ethnic or religious groups share power through formal quotas"
    - "An ideal form of democracy in which all citizens deliberate and reach rational consensus"
  answer: 1
  explanation: "Dahl coined 'polyarchy' to describe actually existing democracies as opposed to an ideal-type democratic theory. Polyarchy is defined by observable conditions: the right to vote, free and fair elections, freedom of expression, access to alternative information, and associational autonomy. Option A describes direct democracy; Option C describes consociationalism; Option D describes deliberative democracy as an ideal."

- question: "A country that holds regular elections automatically qualifies as a democracy, even if civil liberties are restricted."
  type: true-false
  answer: false
  explanation: "Scholars distinguish between electoral authoritarianism and democracy. Holding elections is a necessary but not sufficient condition for democracy under most definitions. Elections must be free (no coercion of voters), fair (level playing field for parties), and competitive (genuine opposition). Countries like Hungary and Venezuela hold elections but restrict press freedom, judiciary independence, and opposition activity — making them electoral autocracies rather than democracies under richer definitions."

- question: "What is the core difference between aggregative and deliberative theories of democracy?"
  type: short-answer
  answer: "Aggregative theories treat democracy as a mechanism for summing or aggregating pre-existing preferences — the winning policy is whichever satisfies the most citizens, typically through voting. Deliberative theories argue that preferences should be formed and transformed through public reasoning and rational debate, and that legitimate decisions require justification that all could in principle accept, not just a majority vote."
