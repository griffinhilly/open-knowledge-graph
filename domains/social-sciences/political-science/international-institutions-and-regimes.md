...
title: International Institutions and Regimes
...
- International law has no police force, but it is not toothless — states comply with international obligations most of the time for reputational, reciprocal, and domestic political reasons.
- International institutions are not world government and do not eliminate state sovereignty; they provide forums for coordination while preserving state authority.

## Questions

```yaml
- question: "What distinguishes an 'international regime' from a formal intergovernmental organization like the United Nations?"
  type: multiple-choice
  options:
    - "International regimes are created only by great powers, while intergovernmental organizations include all states."
    - "An international regime is a set of principles, norms, rules, and decision-making procedures around which state expectations converge in an issue area, which may or may not be institutionalized in a formal organization."
    - "International regimes are temporary arrangements that dissolve once a specific dispute is resolved."
    - "Regimes only exist in economic issue areas; security cooperation is handled exclusively by formal organizations."
  answer: 1
  explanation: "The regime concept, developed by Stephen Krasner and others, captures a broader phenomenon than formal organizations. The nuclear nonproliferation regime, for example, includes the NPT treaty, the IAEA, norms about weapon-free zones, and informal expectations about acceptable behavior — together constituting a regime even where no single organization oversees all of it. Options A, C, and D describe real features of some regimes but do not capture the general definition."

- question: "Because international law lacks a central enforcement authority, states rarely comply with their international legal obligations."
  type: true-false
  answer: false
  explanation: "Compliance with international law is actually quite high in most domains. States comply for reputational reasons (a reputation for keeping commitments makes future agreements more credible), reciprocal reasons (violating an obligation invites retaliation), and domestic political reasons (treaty commitments can be enforced by domestic courts and create political costs for defection). The absence of a world police force does not mean the absence of enforcement mechanisms."

- question: "According to regime theory, how do international institutions help states cooperate even under anarchy — the absence of a world government?"
  type: short-answer
