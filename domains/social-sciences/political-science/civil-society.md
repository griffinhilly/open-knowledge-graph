...
- Civil society is not always pro-democratic; right-wing nationalist movements and anti-democratic organizations are also part of civil society.
- Civil society and social movements overlap but are distinct: civil society is the organizational infrastructure; social movements are episodes of contentious collective action.

## Questions

```yaml
- question: "An authoritarian government passes a law requiring all NGOs to register with a government ministry and restricting their receipt of foreign funding, while allowing registered organizations to continue operating. This strategy is best understood as:"
  type: multiple-choice
  options:
    - "Suppressing civil society by banning all civic organizations"
    - "Colonizing civil society — maintaining its outward form while stripping its organizational autonomy"
    - "Strengthening civil society by creating a legitimate regulatory framework"
    - "Separating the civil society sphere from the market sphere"
  answer: 1
  explanation: "Authoritarian regimes have learned that outright banning associations is often counterproductive (it radicalizes opposition). The more effective strategy is to retain the appearance of civil society while removing its substance — requiring registration (enabling revocation), restricting foreign funding (cutting off resources), and creating pro-regime GONGOs that crowd out independent alternatives. Russia's 'foreign agent' laws and Hungary's NGO restrictions follow exactly this logic. The key concept is associational autonomy: what makes civil society politically potent is its independence, not its mere existence."

- question: "Tocqueville's central argument about voluntary associations in early American democracy was that they:"
  type: multiple-choice
  options:
    - "Competed with government agencies to deliver public services more efficiently"
    - "Aggregated narrow economic interests into broader public demands"
    - "Trained citizens in the habits of cooperation and self-governance that sustained democracy"
    - "Prevented factional conflict by providing neutral forums for deliberation"
  answer: 2
  explanation: "Tocqueville's insight was that democratic citizenship is a skill — participating, cooperating, compromising, accepting legitimate outcomes — and that voluntary associations were where Americans practiced and developed these skills. This is distinct from interest aggregation (which is how pluralists describe interest groups) or service delivery. The 'school of democracy' metaphor captures his view: associations teach people how to be democratic citizens, not just what policy outcomes to prefer."

- question: "Civil society is, by definition, pro-democratic, since it represents organized citizens acting independently of the state."
  type: true-false
  answer: false
  explanation: "Civil society includes all voluntary, non-state, non-market organizations — including nationalist movements, religious extremist groups, militia networks, and anti-pluralist organizations. Weimar Germany had extremely dense associational life, much of which was captured or mobilized by the Nazi movement. The 'dark side of civil society' is real: the organizational capacity and legitimacy that make civil society valuable for democracy can equally serve anti-democratic ends. Civil society is a structural space, not an ideological category."

- question: "Authoritarian regimes tend to fear independent civil society primarily because of the specific policy demands that civil society organizations make, rather than because of the organizational capacity and normative legitimacy they represent."
  type: true-false
  answer: false
  explanation: "Authoritarian regimes can often manage or deflect specific policy demands through negotiation, co-optation, or limited concessions. What they cannot easily manage is the existence of organizations with genuine organizational capacity and legitimacy that exist outside state control. These represent a structural threat: they can mobilize at scale, resist co-optation, and provide credible alternatives to regime narratives. This is why control strategies target the organizational infrastructure (funding, registration, leadership) rather than simply negotiating on policy."

- question: "Why is associational autonomy — civil society organizations being genuinely independent of state control — essential to civil society's accountability function?"
  type: short-answer
  answer: "Civil society holds governments accountable by monitoring state behavior, publishing credible findings, mobilizing public pressure, and contesting government actions. Each of these functions requires organizational capacity the state did not create and cannot easily destroy. If civil society organizations are dependent on the state for their registration, funding, or legal protection, the state can threaten or withdraw these to suppress critical reporting or mobilization. Independence is what transforms an organization from a critic into a genuine check: a captured press cannot investigate corruption, and a state-registered NGO cannot credibly oppose the government that controls its legal status."
  explanation: "The accountability function of civil society is structurally similar to judicial independence: the institution can only perform its function if it is insulated from the entity it is supposed to check. This is why the same features that make civil society valuable — autonomous organization, independent funding, legal standing — are precisely what authoritarian regimes attack."
```
