...
- Anarchy does not mean chaos or perpetual war; states regularly cooperate under anarchy through repeated interaction, institutions, and shared norms.
- IR is not only about great power politics; international organizations, NGOs, multinational corporations, and transnational advocacy networks are also major actors.

## Questions

```yaml
- question: "The 'security dilemma' in international relations refers to which of the following?"
  type: multiple-choice
  options: ["States always prefer war to negotiation", "One state's defensive build-up makes other states feel less secure, triggering a cycle of armament", "International institutions are too weak to prevent conflict", "Nuclear weapons guarantee mutual destruction"]
  answer: 1
...
- question: "What is the central puzzle that motivates the study of international relations, and how do realism and liberalism differently explain it?"
  type: short-answer
  answer: "The central puzzle is how states behave under anarchy — why wars occur and how cooperation is possible without a world government. Realism holds that anarchy forces states to prioritize self-help and power; conflict is the natural outcome. Liberalism argues that institutions, trade, and repeated interaction create incentives to cooperate even without enforcement."
  explanation: "IR theories are competing frameworks for explaining the same facts. Identifying the core puzzles — war despite its costs, cooperation despite anarchy — reveals what each theory must explain and where they disagree."
```
