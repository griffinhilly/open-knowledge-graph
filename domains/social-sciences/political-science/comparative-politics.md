...
title: 'Comparative Politics: Method and Approach'
...
- Comparison is not simply description of multiple countries side by side; it requires a research design that controls for confounding variables.
- No single method — quantitative or qualitative — is inherently superior; mixed-methods approaches often provide more robust causal inference.

## Questions

```yaml
- question: "A researcher wants to explain why Chile and Argentina both democratized in the 1980s despite having very different economies, cultures, and geographic sizes. Which comparative design does this illustrate?"
  type: multiple-choice
  options:
    - "Most-similar systems design (MSSD), because both countries are in South America"
    - "Most-different systems design (MDSD), because the cases differ on many variables but share the outcome"
    - "A natural experiment, because the timing of democratization was determined by an external shock"
    - "A case study, because only two countries are examined"
  answer: 1
...
- question: "Comparative politics is essentially just describing political systems in multiple countries side by side."
  type: true-false
  answer: false
