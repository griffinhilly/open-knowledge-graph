...
- Anthropology is not merely the study of ancient or 'primitive' peoples — cultural anthropologists study Wall Street trading floors and Silicon Valley just as they study Amazonian villages.
- The four subfields are not always practiced together; many anthropologists specialize entirely in one.

## Questions

```yaml
- question: "Which of the following best describes anthropology's 'holistic' approach?"
  type: multiple-choice
  options:
    - "Studying all world cultures without favoring any one tradition"
    - "Treating human biology, culture, language, and history as interconnected rather than separate"
    - "Using multiple research methods such as interviews and surveys simultaneously"
    - "Comparing as many societies as possible before drawing conclusions"
  answer: 1
...
- question: "What is the significance of anthropology's origins in colonial encounters, and why does it matter for how the discipline is practiced today?"
  type: short-answer
  answer: "Anthropology developed partly as a tool of colonial administration, which created power imbalances between researchers and the communities they studied. This history has pushed the discipline toward reflexive ethics—researchers now attend carefully to consent, representation, and who benefits from the research—and has informed critiques of earlier claims about 'primitive' societies."
  explanation: "The colonial origins are not merely historical footnote; they explain why anthropology developed specific ethical guidelines (such as IRB review and community collaboration) and why critiques of ethnocentrism and cultural hierarchy are central to the discipline's self-understanding."
```
