---
id: settlement-archaeology-patterns
title: Settlement Patterns and Landscape Archaeology
...
- Settlement locations are determined solely by resource availability; they reflect culturally specific land use and organizational preferences.
- All settlements with similar size and distribution represent similar social organization; size and spacing alone are insufficient indicators of complexity.
...
```yaml
- question: "An archaeologist surveys a region and finds one site ten times the size of any other, surrounded by a ring of medium sites, with small sites filling the gaps. What social or political inference is most supported?"
  type: multiple-choice
  options:
    - "The region had roughly equal-status communities that occasionally gathered at the large site for rituals"
    - "The large site was probably a political or economic center exercising authority over secondary and tertiary settlements"
    - "The large site is an outlier caused by natural resource concentration; political organization was egalitarian"
    - "Settlement size correlates poorly with political organization, so no inference is warranted"
  answer: 1
  explanation: "A three-tier settlement hierarchy — large center, medium secondary sites, small villages — is a classic signature of centralized political complexity. Central place theory and comparative ethnographic data both support the inference that the dominant site functioned as a capital, market center, or tribute-collection point. Option C misapplies the caution against environmental determinism: resource concentration may explain *why* the center grew there, but the hierarchical structure of the surrounding settlement system is itself evidence of political organization. Option D is overly skeptical; settlement hierarchy is one of the most reliable indicators archaeologists use."

- question: "In a given region, settlement patterns shift over two centuries from 50 small dispersed sites to 5 large nucleated sites. What two explanations should an archaeologist test, and how would you distinguish between them?"
  type: short-answer
  answer: "The two leading explanations are (1) increased conflict driving defensive nucleation, and (2) political consolidation drawing population to administrative or market centers. To distinguish them: conflict-driven nucleation typically produces sites on defensible terrain (hilltops, peninsulas), with evidence of fortifications (walls, ditches), and weapons caches. Political consolidation tends to produce centrally located sites on good agricultural land or trade routes, with evidence of craft specialization, storage facilities, and unequal burials indicating status differentiation. Both can produce nucleation, but the site location, internal organization, and material assemblages differ."
  explanation: "This question tests whether you can use settlement pattern data diagnostically rather than just descriptively. The key is knowing that the same macroscopic pattern (nucleation) can have different causes, and that the evidence to distinguish causes lies in site selection, internal site organization, and associated material culture — not just in the pattern of distribution itself."
```
