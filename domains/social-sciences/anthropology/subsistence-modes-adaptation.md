...
title: Subsistence Modes and Ecological Adaptation
...
- Subsistence modes form a linear evolutionary progression from 'primitive' to 'advanced'.
- Modern foragers represent unchanged remnants of prehistoric life; they have also adapted and changed over millennia.
...
```yaml
- question: "Why do foraging societies tend to have lower levels of wealth inequality than agricultural societies, even when foragers have access to abundant resources?"
  type: short-answer
  answer: "Because mobility constrains accumulation — you cannot store and transport significant wealth when you must move regularly. Additionally, foragers typically have strong sharing norms and social leveling mechanisms that prevent surpluses from converting into durable hierarchies."
  explanation: "This is a key example of how material conditions create incentive structures that shape social institutions. It is not that foragers lack the desire for status; it is that the adaptive pressures of their subsistence mode make inequality structurally costly."

- question: "Why is it misleading to call foragers 'remnants of prehistoric life'?"
  type: short-answer
  answer: "Because all contemporary societies have continued adapting and changing throughout their histories. Modern foragers have responded to states, trade networks, epidemics, and colonial pressures — they are not unchanged. They cannot serve as direct windows into the Paleolithic."
  explanation: "This misconception often serves ideological functions — either romanticizing foragers as 'noble primitives' or dismissing them as backward. Both framings deny historical agency. Contemporary foraging communities are products of their own histories, not frozen representatives of the past."
```
