...
title: Democratic Institutions and the Democratic Peace
...
```yaml
- question: "Country A is a liberal democracy. Based on democratic peace theory, which prediction is best supported by the evidence?"
  type: multiple-choice
  options:
    - "Country A will go to war less often than non-democracies overall, regardless of its opponent"
    - "Country A will never initiate military conflict under any circumstances"
    - "Country A is dramatically less likely to go to war with other liberal democracies, though it fights non-democracies at roughly normal rates"
    - "Country A's democratic institutions prevent its military from taking offensive action"
  answer: 2
  explanation: "The Democratic Peace is a dyadic finding, not a monadic one. Democracies fight non-democracies at rates comparable to other states — the special pacific relationship is specifically between two democracies. Options A and B are the most common misconceptions: interpreting democratic peace as a general pacifism of democracies rather than a specific dyadic phenomenon. The evidence consistently shows the effect is conditional on both states being democratic."

- question: "Which of the following best describes the 'institutional mechanism' through which democratic institutions reduce war between democracies?"
  type: multiple-choice
  options:
    - "Democratic leaders have morally superior values and refuse to order military attacks on fellow democracies"
    - "Democratic constitutions legally prohibit military aggression against other states"
    - "Domestic constraints like legislative approval and public visibility make bluffing costly, increasing the credibility of signals and reducing miscalculation"
    - "Democratic publics vote out any leader who starts a war, so leaders are deterred by future electoral consequences"
  answer: 2
