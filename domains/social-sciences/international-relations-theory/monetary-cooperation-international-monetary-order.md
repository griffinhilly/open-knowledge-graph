...
title: International Monetary Cooperation and Exchange Rates
...
```yaml
- question: "A small open economy pegs its currency to a major trading partner's currency and allows full capital mobility for foreign investors. According to the Impossible Trinity, what must it sacrifice?"
...
- Floating exchange rates eliminate the need for monetary cooperation; even floating-rate systems require coordination to prevent competitive devaluations, manage crises, and provide emergency liquidity.
- The IMF is a neutral technical institution; its voting structure and conditionality policies reflect the interests of major shareholders, particularly the United States.
- Currency dominance is purely a market outcome; dollar hegemony is sustained by network effects, political alliances, financial infrastructure, and US power, not just market efficiency.
