...
title: Urban Geography and City Structure
...
- The concentric zone model is an ideal type derived from 1920s Chicago, not a universal law of city structure.
- Suburbanization does not always reflect wealth; in many cities globally, poor residents are displaced to peripheral areas lacking services.
- Informal settlements are often described deficit-narratively without recognizing their complex social organization and economic vitality.

## Questions

```yaml
- question: "Which urban structure model best describes a city organized around multiple distinct focal points — an airport district, a university area, and a central business district — rather than a single center?"
