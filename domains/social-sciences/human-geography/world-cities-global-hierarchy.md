...
title: World Cities and the Global Urban Hierarchy
...
- World cities are not simply the largest cities by population; they are defined by global connectivity and command functions, not demographic size.
