...
title: 'Economic Geography: Location, Agglomeration, and Uneven Development'
...
- Economic geography is not merely about mapping economic data; it seeks causal explanations for spatial patterns.
- Agglomeration economies create self-reinforcing regional advantages that market forces alone will not naturally redistribute.
- Uneven development is not simply a reflection of natural resource endowments; colonial history, institutions, and policy choices are at least as important.

## Questions

```yaml
- question: "According to agglomeration theory, why do competing firms in the same industry often locate close to each other rather than spreading out to avoid competition?"
  type: multiple-choice
  options:
    - "Government zoning laws force them into the same districts"
    - "Clustering creates shared benefits — skilled labor pools, specialized suppliers, and knowledge spillovers — that outweigh competitive costs"
    - "Transport costs are always minimized when firms are adjacent"
    - "Weber's model predicts that all firms locate at the geographic center of the country"
  answer: 1
