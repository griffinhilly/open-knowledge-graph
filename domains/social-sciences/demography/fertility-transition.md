...
- Contraception access alone does not drive fertility decline — demand for smaller families must exist first. In many historical transitions, fertility declined before modern contraception was widely available, through marriage delay, withdrawal, and abstinence.
- The fertility transition is not solely caused by economic development; ideational change (new norms about family size, spread through social networks) plays an independent role, as the European Fertility Project demonstrated.

## Questions

```yaml
- question: "In the European Fertility Project, researchers found that fertility declined at similar times within linguistically and culturally similar regions, even when those regions differed substantially in economic development. What does this finding suggest about the causes of fertility transition?"
  type: multiple-choice
  options:
    - "Economic development is the sole driver of fertility decline; the cultural patterns are coincidental"
    - "Ideational change — the diffusion of new norms and knowledge about family limitation — plays an independent role alongside economic factors"
    - "Linguistic similarity caused the fertility decline through shared genetic predispositions"
    - "The finding is an artifact of poor economic data collection in the 19th century"
  answer: 1
  explanation: "The European Fertility Project (Princeton) found that cultural and linguistic boundaries predicted the timing of fertility decline better than economic indicators alone. This suggests that the diffusion of ideas about family limitation — through shared language, media, social networks — operates as an independent causal factor. Economic development creates conditions favorable to fertility decline, but the spread of new reproductive norms can trigger or accelerate the transition independently."

- question: "In the Bongaarts proximate determinants framework, contraception is the only mechanism through which fertility can be reduced below natural levels."
  type: true-false
  answer: false
  explanation: "Bongaarts identifies four principal proximate determinants: marriage/union patterns (delayed marriage reduces exposure to conception), contraceptive use, induced abortion, and postpartum infecundability (prolonged breastfeeding suppresses ovulation). Any of these can substantially reduce fertility below natural levels. Historically, delayed marriage was the primary fertility-regulating mechanism in Western Europe for centuries before modern contraception existed."

- question: "Distinguish between demand-side and supply-side explanations of fertility decline, and explain why both are necessary for a complete account."
  type: short-answer
  answer: "Demand-side explanations focus on why couples want fewer children — declining child mortality (fewer births needed to achieve desired family size), rising costs of children (education, opportunity costs of women's time), urbanization (children less economically productive), and changing aspirations. Supply-side explanations focus on the availability and accessibility of means to limit fertility — contraceptive technology, family planning programs, and information about methods. Both are necessary because demand without supply leaves couples with unwanted births (unmet need), while supply without demand leads to low contraceptive uptake despite availability."
  explanation: "The demand-supply framework helps explain variation in transition timing and pace. In some settings (e.g., Bangladesh in the 1970s-80s), strong family planning programs supplied contraception to populations where latent demand existed, producing rapid decline. In others (e.g., sub-Saharan Africa in the same period), high desired family size limited the impact of supply-side interventions. The most successful programs operate on both sides simultaneously."
```
