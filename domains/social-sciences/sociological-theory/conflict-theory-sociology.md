...
title: Conflict Theory in Sociology
...
```yaml
- question: "A conflict theorist examining the criminal justice system would most likely argue that:"
  type: multiple-choice
  options: ["Laws reflect broad social consensus about which behaviors harm society", "Punishment deters crime by making its costs exceed its benefits for individuals", "Laws primarily protect dominant group interests and enforce existing inequalities", "The justice system is a neutral institution that applies rules consistently across groups"]
  answer: 2
  explanation: "Conflict theory holds that laws and institutions are not neutral — they reflect the interests of those with the power to create and enforce them. Dominant groups shape legal definitions of crime, enforcement priorities, and sentencing in ways that protect their position and disadvantage subordinate groups. The other options reflect functionalist or rational-choice assumptions that conflict theory explicitly rejects."

- question: "According to conflict theory, social order is maintained primarily through shared values and voluntary cooperation among members of society."
  type: true-false
  answer: false
  explanation: "This describes the functionalist view (associated with Durkheim and Parsons). Conflict theory, rooted in Marx, holds that apparent social order is maintained through coercion, ideological control, and the power of dominant groups to suppress or marginalize dissent — not through genuine consensus. Stability reflects power asymmetry, not agreement."

- question: "How does conflict theory differ from functionalist theory in explaining why social inequality persists across generations?"
  type: short-answer
  answer: "Functionalism argues inequality persists because it serves social functions — differential rewards motivate people to fill important, demanding roles (Davis-Moore thesis). Conflict theory argues inequality persists because dominant groups actively use power, ideology, and coercion to reproduce their advantages, not because inequality is functionally necessary. What functionalism calls 'functional,' conflict theory calls 'legitimation of domination.'"
  explanation: "The disagreement is about whether existing social arrangements serve society as a whole or primarily the interests of those on top. Conflict theory insists the question of 'who benefits?' must always be asked, and the answer is typically the dominant group — which is why change requires challenging power, not just reforming individuals."
```
