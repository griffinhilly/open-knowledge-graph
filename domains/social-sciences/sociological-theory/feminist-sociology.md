...
```yaml
- question: "Dorothy Smith argues that sociology was developed from a specific standpoint. What does this mean, and what is the consequence for sociological knowledge?"
  type: short-answer
  answer: "Smith argues that classical sociology took the perspective of men in public institutions as its starting point and then presented that perspective as universal and objective. The consequence is that women's experiences, particularly in the domestic sphere, were systematically absent from or distorted in sociological theory. Standpoint theory holds that all knowledge is situated — produced from a particular social location — and that making the standpoint explicit is necessary for honest and complete knowledge."
  explanation: "This critique applies to methodology as well as theory: research questions, data collection instruments, and interpretive frameworks all carry standpoint assumptions that can systematically exclude or misrepresent the experiences of less powerful groups."

- question: "Feminist sociology argues that gender is a social construction. Does this mean biological differences between sexes are irrelevant?"
  type: short-answer
  answer: "No. Social construction means that what societies do with biological differences — which ones are amplified, which ignored, what meanings are attached, what institutional arrangements follow — is socially produced rather than biologically determined. Biological differences may exist, but they do not mechanically generate the specific forms of inequality, division of labor, or cultural norms associated with gender. These arrangements vary historically and cross-culturally in ways that biology alone cannot explain."
  explanation: "The constructionist argument is about the gap between biological variation and social outcomes. It shifts the explanatory question from 'what are men and women like?' to 'how and why do societies produce gender inequality?'"
```
