...
- question: "The sociology of knowledge implies that power determines truth — that whoever controls dominant institutions determines what counts as knowledge, so knowledge claims cannot be evaluated on epistemic grounds."
  type: true-false
  answer: false
