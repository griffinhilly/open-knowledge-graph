...
title: Reference Groups and Social Comparison
...
```yaml
- question: "During WWII research, American soldiers in units with high promotion rates reported lower satisfaction than soldiers in units with low promotion rates. Reference group theory explains this because:"
  type: multiple-choice
  options:
    - "Soldiers in high-promotion units worked harder and were therefore more exhausted and dissatisfied"
    - "High-promotion units had more competitive cultures that reduced camaraderie"
    - "In high-promotion units, most peers have been promoted, making one's own non-promotion more salient and frustrating by comparison"
    - "Soldiers in low-promotion units had lower expectations, which are always easier to satisfy"
  answer: 2
  explanation: "This is the classic relative deprivation paradox. The reference group in a high-promotion unit includes many promoted soldiers, so the non-promoted soldier compares himself to peers who *did* advance. That gap — not the objective promotion rate — drives dissatisfaction. In a low-promotion unit, the reference group is mostly non-promoted, so not being promoted feels normal. The absolute outcome matters less than the subjective gap between one's position and one's comparison standard. This is the central insight reference group theory was developed to explain."

- question: "A person earning $70,000 per year is most likely to feel financially satisfied when their immediate social circle earns:"
  type: multiple-choice
  options:
    - "$70,000 — people feel best when they are exactly average"
    - "$100,000 — higher peers motivate aspirational satisfaction"
    - "$50,000 — their income exceeds the comparison standard, producing positive relative standing"
    - "Income doesn't matter for satisfaction — only meeting basic needs does"
  answer: 2
