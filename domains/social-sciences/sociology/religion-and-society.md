...
- Sociological analysis of religion does not require taking a position on whether religious beliefs are true; it analyzes religion's social causes and consequences.
- Secularization is not inevitable; the relationship between modernization and religiosity is empirically contested and varies by country.

## Questions

```yaml
- question: "For Durkheim, what is the primary social function of religious ritual such as communal worship or ceremony?"
  type: multiple-choice
  options:
    - "To transmit theological doctrines and cosmological knowledge to the next generation"
    - "To generate collective effervescence — heightened emotional states that reinforce group solidarity and attachment to shared sacred symbols"
    - "To provide individual members with a sense of personal meaning and consolation in the face of suffering"
    - "To legitimate the authority of priests and religious specialists over lay members of the community"
  answer: 1
  explanation: "Durkheim's key insight was that religion's social function is fundamentally about the *group*, not the individual or the theology. Collective rituals produce effervescence — an emotional heightening from synchronized participation — which bonds participants to each other and to the group's shared symbols. The religious content (gods, cosmologies) is secondary to this social mechanism. Any collective ritual capable of producing this state — a sports championship, a political rally — operates through the same mechanism."

- question: "The United States has remained highly religious despite being among the world's most technologically and economically advanced societies. Which theoretical framework best explains this pattern?"
  type: multiple-choice
  options:
    - "The secularization thesis — modernization inevitably reduces religiosity, so American religiosity must be declining even if slowly"
    - "Weber's Protestant Ethic thesis — American Protestantism drives continued economic development, and the two reinforce each other"
    - "Religious market theory — pluralism and competition among religious denominations sustains high levels of demand for religious goods"
    - "Durkheim's functionalism — the United States lacks strong secular substitutes for religion's solidarity functions"
  answer: 2
