...
- 'Race is a social construct' does not mean racial inequality is not real — the social construct has very real consequences.
- Ethnicity and race are related but distinct concepts; they should not be used interchangeably.

## Questions

```yaml
- question: "A student argues: 'Since race is just a social construct and not biologically real, claims about racial inequality in wealth or health are exaggerated or fabricated.' What is wrong with this argument?"
  type: multiple-choice
  options:
    - "Nothing — if race is not biological, then racial differences in outcomes must reflect individual choices, not social forces"
    - "It conflates the biological basis of race with the social consequences of racial categorization — constructed categories can produce very real material outcomes"
    - "The argument is correct in theory, but exaggerated because some racial health differences do have biological causes"
    - "It misunderstands that race is partly biological and partly social, so the inequality is partly real"
  answer: 1
