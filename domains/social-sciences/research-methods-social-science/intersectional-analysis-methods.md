...
- question: "Intersectional methodology requires qualitative methods only, because quantitative analysis cannot capture the complexity of overlapping social identities."
  type: true-false
  answer: false
