...
- question: "A credit spread of 120 basis points means the corporate bond's yield includes 1.20 percentage points of compensation that reflects only the market's estimate of the probability the issuer will default."
  type: true-false
  answer: false
