...
- question: "When the Federal Reserve raises the federal funds rate, all points on the yield curve shift upward proportionally, keeping the curve's shape unchanged."
  type: true-false
  answer: false
