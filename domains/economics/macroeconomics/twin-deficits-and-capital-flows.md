---
id: twin-deficits-and-capital-flows
title: Twin Deficits and Capital Flows
domain: economics
...
```yaml
- question: "A government cuts taxes and increases spending, running a large fiscal deficit. According to the twin deficits mechanism, what is the expected effect on the current account, and through what channels does it operate?"
  type: multiple-choice
  options:
    - "The current account improves because fiscal stimulus raises domestic production, boosting exports"
    - "The current account deteriorates because fiscal expansion raises income (increasing imports) and domestic interest rates (attracting foreign capital inflows that equal a current account deficit by identity)"
    - "The current account is unaffected because private saving automatically rises to offset the government deficit (Ricardian equivalence)"
    - "The current account improves as higher interest rates make domestic assets attractive, strengthening the exchange rate and boosting net exports"
  answer: 1
