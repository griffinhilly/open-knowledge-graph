...
- question: "Standard neoclassical growth theory predicts that poor countries will typically converge to rich-country income levels if they have access to the same technology."
  type: true-false
  answer: false
