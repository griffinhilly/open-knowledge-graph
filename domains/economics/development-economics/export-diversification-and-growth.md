---
id: export-diversification-and-growth
title: Export Diversification and Long-Run Growth
domain: economics
...
```yaml
- question: "A copper-dependent developing country fully liberalizes trade. Five years later, its export basket is still dominated by copper. Which explanation best captures why diversification did not occur automatically?"
  type: multiple-choice
  options:
    - "Trade liberalization reduces incentives to diversify because imported goods become cheaper substitutes for domestically produced manufactures"
    - "Breaking into new export sectors requires capabilities — skilled labor, infrastructure, credit markets, and coordination among many actors — that the country lacks and that trade openness alone does not provide"
    - "Diversification requires a large domestic market, which small developing countries do not have"
    - "Copper-exporting countries always have a comparative advantage in copper, making diversification economically irrational"
  answer: 1
