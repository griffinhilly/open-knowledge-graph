...
title: Corruption as a Drag on Development
domain: economics
...
```yaml
- question: "A country spends 20% of GDP on education — more than most OECD nations — yet consistently produces poorly educated workers and ranks near the bottom on international assessments. Which corruption mechanism best explains this?"
  type: multiple-choice
  options:
    - "High education spending crowds out private investment in human capital development"
    - "Education spending has diminishing returns and is ineffective above a certain threshold regardless of governance quality"
    - "Corruption hollows out public goods delivery: budget allocations are recorded but funds are diverted, leaving actual services underfunded even as spending figures appear adequate"
    - "Teachers and administrators are simply less skilled in high-corruption environments due to adverse selection in the labor market"
  answer: 2
