...
- id: consumer-theory-utility
  type: soft
builds-toward:
- gdp-limitations-alternative-metrics
...
- question: "Because GDP growth increases the total resources available for investment in health and education, higher GDP per capita usually leads to better human development outcomes if given enough time."
  type: true-false
  answer: false
