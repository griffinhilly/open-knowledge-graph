...
- question: "On-the-job search, where employed workers continue looking for better matches while working, tends to compress the wage distribution over time as most workers converge to the same wage."
  type: true-false
  answer: false
