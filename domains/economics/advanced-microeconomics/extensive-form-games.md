...
- question: "In a game of perfect information, nearly every information set contains exactly one node, so the extensive form and normal form yield identical Nash equilibria."
  type: true-false
  answer: false
