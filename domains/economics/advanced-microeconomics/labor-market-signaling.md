...
- question: "In Spence's signaling model, if education genuinely increases worker productivity (creates human capital), then the model no longer applies and education can rarely simultaneously function as a signal."
  type: true-false
  answer: false
