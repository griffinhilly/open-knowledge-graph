...
- question: "Prospect theory's probability weighting function implies that people systematically overweight all probabilities that differ from the extremes of 0 and 1."
  type: true-false
  answer: false
