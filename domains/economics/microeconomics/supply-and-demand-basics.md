...
- Students frequently say 'demand increased because price fell,' which reverses the causal direction; price changes cause movement along the demand curve, not a shift.
- Confusing supply with quantity supplied is a persistent source of error on assessments.

## Questions

```yaml
- question: "Consumer incomes rise significantly. What happens to the demand curve for a normal good?"
  type: multiple-choice
  options:
    - "It shifts leftward — higher income reduces the need to buy this good"
    - "It shifts rightward — consumers want more of it at every price"
    - "Nothing changes — income is not a determinant of demand"
    - "Quantity demanded increases along the existing curve as income rises"
  answer: 1
...
- question: "When the price of gasoline rises, the demand for gasoline decreases."
  type: true-false
  answer: false
  explanation: "This is the most common misconception in supply-demand analysis. A price change causes a *movement along* the demand curve — quantity demanded falls, but demand (the curve itself) has not changed. 'Demand' refers to the entire schedule of price-quantity combinations. Demand only *shifts* when a non-price factor changes (income, tastes, prices of related goods, etc.). The correct statement is: 'When the price of gasoline rises, the quantity demanded of gasoline decreases.'"

- question: "What is the difference between 'supply' and 'quantity supplied,' and why does the distinction matter?"
  type: short-answer
  answer: "'Supply' refers to the entire supply curve — the relationship between all possible prices and the quantities producers are willing to offer. 'Quantity supplied' is a specific number: the amount offered at one particular price. A price change moves along the curve (changes quantity supplied); a non-price factor like input costs shifts the entire curve (changes supply)."
