...
title: 'Market Equilibrium: Supply Meets Demand'
domain: economics
...
```yaml
- question: "The price of a concert ticket is set below the market equilibrium price. According to market equilibrium theory, what sequence of events follows?"
  type: multiple-choice
  options:
    - "A surplus develops; sellers lower prices further to clear their excess inventory"
    - "A shortage develops; buyers compete for scarce tickets and bid prices upward"
    - "The market stays at the below-equilibrium price indefinitely since sellers control the price"
    - "A shortage develops; the government must intervene to restore the equilibrium price"
  answer: 1
  explanation: "Below equilibrium, quantity demanded exceeds quantity supplied — a shortage. Buyers who cannot get tickets at the current price are willing to pay more; sellers realize they can charge more without losing buyers. This upward pressure from competing buyers drives prices toward equilibrium. No external intervention is required — the adjustment arises entirely from the decentralized incentives of individual buyers and sellers responding to scarcity signals."

- question: "At the equilibrium price, buyers wish they could pay less and sellers wish they could charge more. Why doesn't the price change?"
  type: multiple-choice
  options:
    - "Both sides have negotiated and agreed to accept the equilibrium price"
    - "The equilibrium price is the only price where neither surplus pressure (pushing prices down) nor shortage pressure (pushing prices up) exists"
    - "Government regulations prevent prices from moving once equilibrium is reached"
    - "The equilibrium price represents the average of all buyers' willingness to pay"
  answer: 1
