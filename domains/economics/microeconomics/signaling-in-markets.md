...
- question: "In a pooling equilibrium where most workers get college degrees, employers cannot distinguish high-ability from low-ability workers, so most workers earn the high-ability wage."
  type: true-false
  answer: false
