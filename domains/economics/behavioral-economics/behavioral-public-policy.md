...
```yaml
- question: "The UK Behavioural Insights Team found that including the sentence 'Nine out of ten people in your area pay their taxes on time' in tax reminder letters significantly increased compliance. This intervention leverages which behavioral principle?"
  type: multiple-choice
  options:
    - "Loss aversion — people fear losing money to penalties"
    - "Social norms — descriptive information about others' behavior increases conformity"
    - "Anchoring — the number 'nine out of ten' anchors the expected compliance rate"
    - "Hyperbolic discounting — the letter makes future penalties feel more immediate"
  answer: 1
  explanation: "This is a social norm intervention. Descriptive social norms (what most people actually do) are powerful behavioral motivators — people tend to conform to perceived majority behavior. By informing taxpayers that most of their neighbors comply, the letter activates conformity motivation and makes non-compliance feel deviant rather than normal. The intervention is cheap, scalable, and effective, generating millions in additional tax revenue for the UK government at minimal cost."

- question: "Behavioral public policy can fully replace traditional regulatory approaches (laws, taxes, and mandates) as a governance tool."
  type: true-false
  answer: false
  explanation: "Behavioral interventions (nudges) are complements to, not substitutes for, traditional policy tools. Nudges are effective for problems driven by inertia, cognitive biases, or information gaps, but they are insufficient for problems requiring structural change — climate change, systemic inequality, financial regulation. A nudge to reduce energy consumption is useful but cannot replace carbon pricing or emissions standards. The strongest policy approach combines behavioral insights with traditional instruments: use nudges where biases are the bottleneck and regulation/taxation where structural incentives are the bottleneck."

- question: "What is the 'EAST' framework developed by the Behavioural Insights Team, and how is it applied?"
  type: short-answer
  answer: "EAST stands for Easy, Attractive, Social, and Timely. It provides a practitioner-friendly framework for designing behavioral interventions. Easy: reduce friction and simplify actions (use defaults, simplify forms). Attractive: make messages and actions salient and appealing (personalize, use incentives). Social: leverage social norms and commitments (show what others do, use group commitments). Timely: deliver interventions at the moment when people are most receptive (prompt action when motivation peaks, use implementation intentions)."
  explanation: "EAST distills academic behavioral economics into actionable design principles for policymakers. Each element addresses a specific behavioral barrier: difficulty causes inertia (Easy), lack of salience causes neglect (Attractive), isolation causes norm-blindness (Social), and poor timing causes missed opportunities (Timely). The framework has been applied to increase organ donation registrations, improve tax collection, boost employment program take-up, and reduce hospital no-shows — typically through small, low-cost changes that produce measurable improvements."
```
