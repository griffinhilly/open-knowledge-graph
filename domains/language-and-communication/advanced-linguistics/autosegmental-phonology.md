...
- question: "The Obligatory Contour Principle (OCP) prohibits identical adjacent features from appearing anywhere on any tier, requiring that all adjacent segments differ in at least one feature."
  type: true-false
  answer: false
