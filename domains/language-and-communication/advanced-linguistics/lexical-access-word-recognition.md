...
- question: "When a fluent reader encounters the word 'bank' in a sentence strongly disambiguated toward the river meaning, only the river meaning is activated — context prevents the financial meaning from being retrieved at all."
  type: true-false
  answer: false
