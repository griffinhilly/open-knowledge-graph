...
- question: "In the control construction 'John tried to leave,' John bears mainly one thematic role — agent — because 'try' and 'leave' together form a single complex predicate with a single argument structure."
  type: true-false
  answer: false
