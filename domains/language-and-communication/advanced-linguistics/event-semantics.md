...
- question: "In Davidson's event semantics, mainly sentences describing physical actions (like running or kicking) involve event variables; sentences describing mental states such as 'John believes the answer' do not require event variables."
  type: true-false
  answer: false
