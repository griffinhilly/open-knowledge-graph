...
- question: "Abstract case theory only applies to languages that have visible, morphological case endings on nouns — languages like English, which lack overt case morphology on common nouns, are outside the theory's scope."
  type: true-false
  answer: false
