...
- No dialect is linguistically inferior to any other; prescriptive hierarchies reflect social power, not linguistic complexity.
- Variation is not a sign of language decay; all languages at all times exhibit variation as a normal condition.
- 'Standard' varieties are prestige dialects — they are not more correct or more expressive than other dialects.

## Questions

```yaml
- question: "Labov's department store study found that the pronunciation of post-vocalic /r/ varied across store employees. What best explains this pattern?"
  type: multiple-choice
  options:
    - "Employees in different stores had different regional origins."
    - "Pronunciation varied randomly with no systematic pattern."
    - "Pronunciation correlated with the social prestige of each store, reflecting social stratification."
    - "Employees were consciously imitating the speech of customers."
  answer: 2
...
- question: "What is style-shifting, and why does it demonstrate that speakers have linguistic competence beyond a single fixed dialect?"
  type: short-answer
  answer: "Style-shifting is the practice of adjusting one's language — vocabulary, phonology, grammar, formality — depending on audience, setting, or social context. It shows that speakers command a range of linguistic registers and deploy them strategically, demonstrating that sociolinguistic behavior is dynamic and audience-sensitive, not a fixed property of a speaker."
  explanation: "If language use were simply a marker of social group membership, speakers would use the same variety in all contexts. Instead, the same speaker talks differently in a job interview than with close friends. This code-switching and style-shifting reveals active, socially aware linguistic agency."
```
