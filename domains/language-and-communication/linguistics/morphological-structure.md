...
- Syllables and morphemes are different things — 'button' has two syllables but is one morpheme.
- Morphemes are not always phonetically transparent; suppletive forms like 'go/went' are still related morphemes.
- Not every sequence of familiar characters is a morpheme (the 'un-' in 'uncle' is not a prefix).
