...
- question: "A paradigm showing no alternation — all forms of a word use the same consonant or vowel throughout — is proof that no historical sound change affected that paradigm."
  type: true-false
  answer: false
