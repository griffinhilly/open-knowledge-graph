...
- Coherence is not just logical consistency — it also depends on shared world knowledge and inferential processes that go beyond linguistic form.
- Conversation is highly organized by implicit rules that speakers follow without explicit instruction — apparent 'chaos' is rule-governed at a finer level of analysis.
- Written and spoken discourse follow different organizational principles and should not be analyzed with identical frameworks.
