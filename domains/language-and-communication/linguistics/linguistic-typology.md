...
- Morphological types are tendencies, not rigid categories; most languages are mixed.
- SOV being the most frequent order does not make it 'more natural' — frequency partly reflects demographic and historical contingencies.
- Typological universals are statistical tendencies, not inviolable laws; genuine exceptions are analytically informative, not embarrassing.
