...
- question: "Typological implicational universals state that most human languages share nearly every grammatical property, leaving no room for cross-linguistic variation."
  type: true-false
  answer: false
