...
- Dialects are not 'accents' — dialect encompasses grammar, vocabulary, and phonology, not just pronunciation.
- Young people's language is not corrupting the language; linguistic innovation has always been concentrated in younger cohorts.
- Code-switching is not confusion; it is rule-governed and competent communicative behavior.

## Questions

```yaml
- question: "An apparent-time study finds that 70% of speakers under 30 use a new vowel variant, while only 15% of speakers over 60 do. What is the most linguistically sound interpretation?"
  type: multiple-choice
  options:
    - "Older speakers are losing the variant as they age."
    - "The variant is spreading through the community and represents change in progress."
    - "The variant has always existed at these proportions across age groups."
    - "Young speakers will eventually abandon the variant and converge toward older norms."
  answer: 1
  explanation: "In apparent-time methodology, differences across age cohorts are interpreted as reflecting the state of language at different points in time — younger speakers represent the more recent state. A variant concentrated among younger speakers is likely spreading. Option D describes age-grading (temporary stylistic features of youth speech), which is a rival hypothesis, but apparent-time studies are specifically designed to distinguish these by tracking whether the pattern persists as cohorts age."

- question: "Code-switching — alternating between two languages or dialects mid-conversation — indicates that a speaker lacks full competence in at least one of the languages involved."
  type: true-false
  answer: false
...
- question: "What is the difference between a dialect and an accent, and why does the distinction matter?"
  type: short-answer
  answer: "An accent refers specifically to phonological differences in pronunciation. A dialect encompasses phonological, grammatical, and lexical differences — it is the full linguistic variety of a community. The distinction matters because labeling a full dialect system as 'just an accent' minimizes its systematic grammatical structure and reinforces the false idea that only pronunciation differs between regional varieties."
  explanation: "Every dialect has an accent, but a dialect is much more than an accent. African American English, for example, has distinctive syntactic features (habitual 'be', copula deletion) that are not merely phonological — reducing it to an accent would mischaracterize its linguistic structure."
```
