...
- Phonemes are mental categories, not physical sounds — the same phoneme can be pronounced differently in different contexts.
- Allophones are not 'wrong' pronunciations; they are systematic, rule-governed variants.
- A language's phoneme inventory is not determined by its writing system.
