...
title: Using Evidence in Speeches
...
- Citing a source is not the same as using it effectively — the speaker must explain what the evidence shows and why it matters.
