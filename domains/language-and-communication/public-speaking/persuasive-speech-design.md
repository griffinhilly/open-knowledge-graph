...
title: Persuasive Speech Design
...
- Persuasion is not manipulation — ethical persuasion uses accurate evidence and honest appeals, not deception or exploitation.
- More evidence does not always equal more persuasion; emotional resonance often drives attitude change more than logical accumulation.
- Preaching to the choir is easy but low-value; real persuasive skill is measured against skeptical or resistant audiences.

## Questions

```yaml
- question: "Monroe's Motivated Sequence has five steps. Which of the following is the correct order?"
  type: multiple-choice
  options: ["Attention, Need, Satisfaction, Visualization, Action", "Need, Attention, Satisfaction, Action, Visualization", "Attention, Satisfaction, Need, Visualization, Action", "Visualization, Need, Attention, Satisfaction, Action"]
  answer: 0
  explanation: "The sequence follows the psychological arc of persuasion: first capture Attention, then establish the Need (the problem), then offer Satisfaction (your solution), then help the audience Visualize the future with and without the solution, then issue a specific call to Action. Scrambling the order disrupts this arc — for instance, offering Satisfaction before establishing Need gives an answer before the audience feels the question."

- question: "A persuasive speech aimed at a resistant audience should open by presenting your strongest evidence immediately to overcome skepticism."
  type: true-false
  answer: false
  explanation: "Resistant audiences who feel attacked or dismissed will reject evidence reflexively. The more effective strategy is to begin by establishing common ground — shared values, acknowledged complexity, genuine concession — before introducing your position. This is why audience analysis is a prerequisite: the same evidence that convinces a sympathetic audience may backfire with a hostile one if delivered without first building rapport."

- question: "Why does the same persuasive argument often need to be structured differently for a sympathetic audience versus a resistant one?"
  type: short-answer
  answer: "A sympathetic audience already shares your position, so the goal is reinforcing commitment and motivating action — emotional amplification and a strong call to action work well. A resistant audience does not yet accept your premises, so you must establish credibility, acknowledge their concerns, and build common ground before presenting your argument, or they will dismiss the evidence before engaging with it."
  explanation: "Persuasion is a function of the gap between the audience's starting position and your target position. The strategies that close that gap depend entirely on where the audience begins. Audience analysis is not a pre-speech formality — it is the primary design constraint for every structural and strategic choice in the speech."
```
