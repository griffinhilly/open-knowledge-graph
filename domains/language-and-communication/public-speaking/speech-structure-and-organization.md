...
- More main points does not mean a more complete speech — five points with shallow support are weaker than three with depth.
- Transitioning from one main point to the next requires explicit verbal signposting ('My second point...'), unlike in writing where readers can re-scan.
- The rule 'tell them what you'll say, say it, tell them what you said' is not formulaic padding — it reflects how oral communication is processed.

## Questions

```yaml
- question: "A speaker is explaining how a bill becomes a law, moving step by step through the legislative process. Which organizational pattern is most appropriate?"
  type: multiple-choice
  options: ["Spatial order", "Topical order", "Chronological order", "Problem-solution order"]
  answer: 2
  explanation: "Chronological order organizes content by time sequence, making it ideal for processes that unfold in stages — such as a bill moving from introduction, to committee, to floor vote, to presidential action. Spatial order works for physical or geographic relationships. Topical order suits discrete, independent subtopics. Problem-solution is for persuasive arguments structured around identifying a problem and proposing a remedy."

- question: "In a well-delivered speech, explicitly repeating your main points is generally a sign of poor preparation or a weak outline."
  type: true-false
  answer: false
  explanation: "Repetition is a feature of effective oral communication, not a flaw. Unlike readers who can scroll back, listeners process speech in real time with no opportunity to reread. Verbal signposting ('My first main point is...', 'To review what we've covered...') and strategic repetition help audiences track the structure and retain information. The advice to 'tell them what you'll say, say it, and tell them what you said' reflects how the auditory channel works, not a lack of sophistication."

- question: "What is the difference between a preparation outline and a speaking outline, and why does public speaking instruction recommend using both?"
  type: short-answer
  answer: "A preparation outline is written in complete sentences and fully develops every main point, sub-point, and transition, ensuring the speaker has thought through logic, evidence, and structure. A speaking outline uses only keywords or brief phrases as memory triggers during delivery. Using both serves different stages: the preparation outline ensures intellectual rigor during drafting; the speaking outline enables natural, audience-focused delivery without reading verbatim."
