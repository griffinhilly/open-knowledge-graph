...
- Covering more material is not the same as being more informative — depth on fewer points beats shallow coverage of many.
- Informative speeches should not be opinion-free; interpretation and perspective help audiences understand, not just receive, information.
- Reading from notes is a sign of under-preparation, not thoroughness.

## Questions

```yaml
- question: "A speaker gives a 10-minute informative speech covering 12 distinct facts about climate change. The audience can recall only 2 facts afterward. What is the most likely cause?"
  type: multiple-choice
  options:
    - "The speaker did not cite enough credible sources."
    - "The topic was too controversial for an informative speech."
    - "Covering too many points prevented deep encoding; depth on fewer points would have been more effective."
    - "The audience was not paying attention because the topic was uninteresting."
  answer: 2
...
- question: "What does 'bridging from known to unknown' mean in informative speaking, and why is it essential when explaining unfamiliar concepts?"
  type: short-answer
  answer: "Bridging from known to unknown means connecting a new or unfamiliar concept to something the audience already understands — through analogy, comparison, or example — so they have a cognitive hook to attach the new information to. It is essential because learners cannot absorb entirely alien concepts without a point of entry; the familiar provides scaffolding for the unfamiliar."
  explanation: "Audience analysis (a hard prerequisite) informs what the audience already knows, which determines what 'known' elements to bridge from. Without this bridge, speakers suffer from the 'curse of knowledge' — assuming the audience shares background they do not have — which is one of the most common failures in informative speaking."
```
