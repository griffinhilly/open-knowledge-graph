...
- Matching the verb to the nearest noun rather than the true subject.
- Treating collective nouns (team, committee) as always singular or always plural without considering context.
...
- question: "Which sentence demonstrates correct subject-verb agreement?"
  ...
  options:
    - "The stack of old newspapers were blocking the door."
    - "The stack of old newspapers was blocking the door."
    - "The newspapers in the stack were blocking the door, as was the stack."
    - "Old newspapers, along with the stack, was blocking the door."
  answer: 1
  explanation: "The subject is 'stack' (singular), not 'newspapers.' The prepositional phrase 'of old newspapers' modifies the subject but does not change it. Because 'stack' is singular, the verb must be 'was.' This is the classic trap: the noun closest to the verb ('newspapers') is plural, but it is not the subject."

- question: "In the sentence 'Neither the manager nor the employees were notified,' the verb agrees with 'employees' because it is the subject closest to the verb."
  type: true-false
  answer: true
  explanation: "When subjects are joined by 'or' or 'nor,' the verb agrees with the subject closest to it — this is called the proximity rule. Since 'employees' (plural) is closer to the verb than 'manager' (singular), the plural verb 'were' is correct. This is a genuine rule, not a misconception, though many writers are unaware of it."

- question: "Explain how to find the true subject of a sentence when a prepositional phrase comes between the subject and verb."
  type: short-answer
  answer: "Mentally cross out or bracket the prepositional phrase to isolate the noun before it. That noun — not the object of the preposition — is the subject, and the verb must agree with it."
  explanation: "Prepositional phrases (starting with 'of,' 'with,' 'between,' etc.) modify a noun but are never the subject of a sentence. Removing the phrase exposes the subject clearly: 'The box [of chocolates] is open' — the subject is 'box,' singular, so the verb is 'is.'"
```
