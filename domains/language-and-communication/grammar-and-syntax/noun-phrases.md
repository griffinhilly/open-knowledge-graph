...
- A noun phrase is just a noun with an adjective — noun phrases can include determiners, multiple adjectives, prepositional phrases, and even embedded clauses.
- Every noun in a sentence heads its own noun phrase — nouns inside prepositional phrases or relative clauses are part of a larger noun phrase, not independent units.

## Questions

```yaml
- question: "In the sentence 'The exhausted runner near the finish line collapsed,' which of the following is the complete noun phrase that serves as the subject?"
  type: multiple-choice
  options:
    - "The exhausted runner"
    - "runner near the finish line"
    - "The exhausted runner near the finish line"
    - "the finish line"
  answer: 2
...
- question: "Describe the pronoun replacement test and explain what it tells you about noun phrases."
  type: short-answer
  answer: "Replace the candidate phrase with a pronoun (he, she, it, they). If the substitution produces a grammatical sentence with the same structural meaning, the candidate is a complete noun phrase. It works because pronouns substitute for entire noun phrases, not for nouns alone or for partial phrases."
  explanation: "This test is useful because it relies on a grammatical fact: pronouns are noun-phrase-level substitutes. If you replace 'the exhausted runner near the finish line' with 'she' and the sentence remains grammatical, that confirms the entire string functions as a single noun phrase unit."
```
