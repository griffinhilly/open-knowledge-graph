...
- Students often miss abstract nouns (happiness, justice) because they cannot be touched or seen.
- Proper nouns require capitalization, which students sometimes apply inconsistently.
...
- question: "What is the difference between a common noun and a proper noun? Give one example of each."
  type: short-answer
  answer: "A common noun names a general category of person, place, or thing (e.g., city, river, dog). A proper noun names a specific, unique entity within that category and is always capitalized (e.g., Paris, Amazon, Fido)."
  explanation: "The key distinction is specificity: 'city' could refer to any city, while 'Paris' refers to one particular city. Capitalization is the written marker of proper nouns in English, which is why inconsistent capitalization is a reliable sign that a student is still developing this distinction."
```
