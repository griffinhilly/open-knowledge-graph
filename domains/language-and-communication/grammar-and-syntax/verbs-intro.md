---
id: verbs-intro
title: 'Verbs: Actions and States of Being'
...
- Students conflate linking verbs (She seems happy) with action verbs, missing that linking verbs connect the subject to a descriptor rather than expressing an action.
- Infinitive forms (to run) are often misidentified as the verb in a sentence.

## Questions

```yaml
- question: "In the sentence 'She seems exhausted,' what kind of verb is 'seems'?"
  type: multiple-choice
  options: ["An action verb, because it describes something she is doing", "A linking verb, because it connects the subject to a descriptive word", "An infinitive, because it cannot stand alone", "A helping verb, because it modifies another verb"]
  answer: 1
...
- question: "Why is the verb considered the grammatical core of a sentence?"
  type: short-answer
  answer: "Every complete sentence requires a verb because verbs establish the action or state that all other sentence elements relate to — the subject performs or is described by the verb, and objects, complements, and modifiers extend from it."
  explanation: "Without a verb, a group of words cannot make a complete predication. Even the simplest sentence ('He ran.') is built around the verb. All other sentence parts — subject, object, complement — exist in relationship to that verbal core."
```
