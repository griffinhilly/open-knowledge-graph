---
id: capitalization-conventions-english
title: Capitalization Conventions in English
...
- question: "Which of the following sentences is correctly capitalized?"
  ...
  options:
    - "Every summer, we visit aunt Rosa in New york."
    - "Every Summer, we visit Aunt Rosa in New York."
    - "Every summer, we visit Aunt Rosa in New York."
    - "Every summer, we visit aunt Rosa in new york."
  answer: 2
  explanation: "Seasons (summer) are not capitalized. 'Aunt Rosa' is capitalized here because 'Aunt' is used as part of her name (a title functioning as a proper noun). 'New York' is a proper noun (specific place) and is always capitalized."

- question: "Why is 'I' always capitalized in English but 'me,' 'my,' and 'mine' are not?"
  type: short-answer
  answer: "The capitalization of 'I' is a historical convention — in medieval manuscript writing, a solitary lowercase 'i' was easy to miss, so scribes began capitalizing it for visibility. The convention became standard. Other first-person pronouns (me, my, mine) are not solitary letters and did not need the same treatment."
  explanation: "Understanding that 'I' is a convention (not a logical rule) helps students avoid overgeneralizing — they sometimes capitalize 'Me' or 'My' by analogy with 'I,' which is incorrect."
```
