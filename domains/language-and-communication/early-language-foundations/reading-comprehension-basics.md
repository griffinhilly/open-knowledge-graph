...
- That comprehension is an all-or-nothing skill -- it exists on a spectrum, and a child may comprehend literal details without grasping inferences or themes.
- That rereading is a sign of weakness -- rereading for understanding is a sophisticated comprehension strategy that skilled readers use deliberately.

## Questions

```yaml
- question: "A student reads a passage about the water cycle aloud perfectly, with no errors or hesitations. When asked 'What is the main message the author wants you to understand?' she cannot answer. What does this reveal?"
  type: multiple-choice
  options:
    - "She needs more phonics practice to improve her decoding"
    - "She has strong decoding but may lack the background knowledge or vocabulary needed for comprehension"
    - "Reading fluency and reading comprehension are the same skill, so this situation is impossible"
    - "She is not trying hard enough"
  answer: 1
  explanation: "According to the Simple View of Reading, comprehension = decoding × language comprehension. This student has demonstrated strong decoding. The comprehension gap points to the second factor — language comprehension, including vocabulary and background knowledge — as the likely limitation. Option C reflects the most common misconception: fluency and comprehension are distinct skills, and a student can have one without the other."

- question: "A passage begins: 'Have you ever wondered why dogs are called man's best friend?' The main idea of this passage is most likely..."
  type: multiple-choice
  options:
    - "Dogs — because that is the topic the passage is about"
    - "The opening question itself — because main ideas always appear in the first sentence"
    - "The author's most important claim about dogs, developed across the whole passage"
    - "Whatever the longest paragraph is about — since length signals importance"
  answer: 2
  explanation: "The topic (what a passage is about) is not the same as the main idea (the most important claim the author makes about that topic). The opening question is an attention-getter, not a summary. The main idea emerges from the whole passage. Option A confuses topic with main idea; option B reflects the misconception that main ideas always appear first."

- question: "A student who reads actively — predicting, asking questions, and connecting to prior knowledge — is more likely to comprehend a text deeply than one who reads passively."
  type: true-false
  answer: true
