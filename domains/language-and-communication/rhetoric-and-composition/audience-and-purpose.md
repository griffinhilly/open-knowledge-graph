...
title: Audience and Purpose in Writing
...
- Audience is only about age or reading level; in reality it includes values, prior knowledge, and stake in the topic.
- Purpose is always obvious; often a text has a primary purpose (inform) and a secondary one (persuade) operating simultaneously.

## Questions

```yaml
- question: "A student writes a complaint about cafeteria food. They use slang, make jokes, and assume the reader already knows the specific problems. Their teacher says the writing is technically correct but ineffective. What is the most likely cause?"
  type: multiple-choice
  options:
    - "The student used too many paragraphs"
    - "The student ignored their audience — the complaint is written for peers but would go to an administrator who expects formal, specific language"
    - "The student's purpose was unclear because complaints should always be informal"
    - "The student wrote too much detail about the food itself"
  answer: 1
  explanation: "Rhetorical effectiveness depends on matching tone, diction, and evidence to the actual audience. A school administrator expects formal register, specific evidence, and a clear request — not in-jokes and assumptions of shared frustration. The writing may be grammatically correct, but rhetoric is about achieving an effect on a reader, and that requires knowing who the reader is."
...
- question: "A writer is preparing a report on climate change, one version for a scientific journal and one for a general-audience magazine. What specific changes should they make, and why does audience require these changes?"
  type: short-answer
  answer: "For the scientific journal: use technical terminology, cite primary research, assume statistical literacy, and focus on methodology and findings. For the magazine: define key terms, use analogies, foreground real-world implications rather than data, and adopt a more narrative structure. Audience includes prior knowledge, values, and stake in the topic — a general reader needs different scaffolding than an expert, and the same evidence that convinces a scientist may alienate or confuse a non-specialist."
  explanation: "This question tests the full scope of audience analysis beyond surface-level adjustments. Audience is not just about reading level — it includes what the reader already knows, what they care about, and what kind of evidence they find credible. Effective writers anticipate these dimensions and make deliberate choices at the level of word choice, structure, and evidence selection."
```
