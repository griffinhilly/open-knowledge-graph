...
- Pathos is always manipulative or fallacious; emotional appeals are legitimate and necessary when relevant to the issue.
- Logos only means using statistics; it encompasses all forms of reasoning, including analogy, definition, and causal argument.

## Questions

```yaml
- question: "A politician references her twenty years of military service before arguing for a defense policy. Which rhetorical appeal is she primarily deploying?"
  type: multiple-choice
  options: ["Pathos — she is invoking emotions tied to military sacrifice", "Logos — she is providing evidence that her policy will work", "Ethos — she is establishing credibility and trustworthiness", "None — this is a logical fallacy, not a legitimate appeal"]
  answer: 2
...
- question: "Why is it generally more effective to balance all three rhetorical appeals rather than relying on only one?"
  type: short-answer
  answer: "Each appeal addresses a different dimension of the audience's response: logos satisfies the demand for reasons and evidence, ethos builds the trust needed to take the speaker seriously, and pathos connects the argument to what the audience values and cares about. Over-relying on any single appeal creates gaps — an argument that is all logic but no credibility may be dismissed; one that is all emotion but no reasoning may persuade momentarily but not durably."
  explanation: "The three appeals are not redundant — they work on different faculties. Audiences simultaneously ask 'Is this well-reasoned?' (logos), 'Can I trust this person?' (ethos), and 'Does this matter to me?' (pathos). A rhetorically complete argument must address all three questions."
```
