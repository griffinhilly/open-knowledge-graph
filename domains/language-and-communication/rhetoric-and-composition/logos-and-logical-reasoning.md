...
title: Logos and Logical Reasoning in Writing
...
- If evidence is true, the argument is logically valid; an argument can be invalid even when every premise is factually accurate.
- Using technical terms like 'therefore' or 'it follows that' makes reasoning sound; the logical connection still must be genuinely present.

## Questions

```yaml
- question: "A writer argues: 'Countries with stricter gun laws tend to have lower rates of gun violence. Therefore, stricter laws cause lower violence.' Which logical problem is present?"
  type: multiple-choice
  options: ["False dichotomy — only two options are presented when more exist", "Hasty generalization — the sample of countries is too small to draw conclusions", "Confusing correlation with causation — the evidence shows association, not a demonstrated causal mechanism", "Ad hominem — the argument attacks a person rather than their position"]
  answer: 2
