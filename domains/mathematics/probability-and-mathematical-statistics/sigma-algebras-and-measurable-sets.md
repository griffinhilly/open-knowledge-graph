...
- question: "For probability on the real line, the standard practice is to use the power set of most subsets of ℝ as the sigma-algebra, since it is the largest possible collection."
  type: true-false
  answer: false
