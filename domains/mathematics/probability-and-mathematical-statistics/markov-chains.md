...
- question: "A time-homogeneous Markov chain is expected to have the same transition probabilities at most of the time step — this is part of the basic definition of a Markov chain."
  type: true-false
  answer: false
