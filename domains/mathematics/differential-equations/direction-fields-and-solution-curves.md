...
- Thinking a direction field determines a unique solution; actually, it determines a family of solutions (one through each point). - Confusing the direction of the arrows with the actual trajectory of a solution.
