...
- question: "If ∂M/∂y ≠ ∂N/∂x, the equation M dx + N dy = 0 cannot be solved exactly but can generally be made exact by multiplying through by an appropriate integrating factor."
  type: true-false
  answer: false
