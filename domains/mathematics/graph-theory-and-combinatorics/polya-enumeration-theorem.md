...
- question: "The Pólya Enumeration Theorem counts most possible colorings of a structure with k colors and then divides by the group order to correct for symmetry."
  type: true-false
  answer: false
