...
- question: "Iterative methods are typically preferable to direct methods (like Gaussian elimination) for solving large linear systems, since direct methods are too slow for any system of practical size."
  type: true-false
  answer: false
