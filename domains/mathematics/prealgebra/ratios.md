...
- Confusing part-to-part ratios with part-to-whole ratios (e.g., 3 boys and 5 girls: the ratio of boys to girls is 3:5, not 3:8).
- Thinking the order of a ratio doesn't matter — 3:5 is not the same as 5:3.
- Not simplifying ratios, or simplifying incorrectly because students treat the two numbers independently.

## Questions

```yaml
- question: "A class has 12 boys and 8 girls. What is the ratio of boys to all students in the class?"
  type: multiple-choice
  options: ["3:2", "2:3", "3:5", "2:5"]
  answer: 2
  explanation: "There are 12 + 8 = 20 students total. The ratio of boys to all students is 12:20. Simplifying by dividing both by 4 gives 3:5. This is a part-to-whole ratio, not a part-to-part ratio (which would be 12:8 = 3:2)."

- question: "The ratio 4:6 is equivalent to the ratio 6:4."
  type: true-false
  answer: false
  explanation: "Order matters in a ratio. 4:6 means 4 for every 6 (for example, 4 cups of one ingredient per 6 of another), while 6:4 is the reverse proportion. Reversing the terms gives a different comparison. Both can be simplified (4:6 = 2:3, and 6:4 = 3:2), but they represent different relationships."

- question: "A lemonade recipe uses a ratio of 2 cups of lemon juice to 5 cups of water. If you want to make enough to use 8 cups of lemon juice, how many cups of water do you need?"
  type: short-answer
  answer: "20 cups"
  explanation: "The ratio 2:5 means for every 2 cups of lemon juice you use 5 cups of water. Scaling up by a factor of 4 (since 8 ÷ 2 = 4) gives 5 × 4 = 20 cups of water. Ratios scale proportionally — multiply both parts by the same factor."
```
