...
- Confusing rays and segments (not attending to whether an endpoint exists).
- Thinking lines have to be horizontal.
- Not understanding that a line extends forever (it cannot be "drawn" completely).
