...
title: Measurement Conversions (Customary)
domain: mathematics
course: 4th-grade
prerequisites:
...
- Multiplying when you should divide (or vice versa) -- not keeping track of whether you are going to a larger or smaller unit.
- Confusing conversion factors (mixing up how many cups in a quart vs. quarts in a gallon).
- Thinking that converting units changes the actual quantity rather than just the way it is expressed.

## Questions

```yaml
- question: "A recipe calls for 3 quarts of broth. How many cups is that?"
  type: multiple-choice
  options: ["6 cups", "8 cups", "12 cups", "16 cups"]
  answer: 2
  explanation: "1 quart = 2 pints = 4 cups, so 3 quarts = 3 × 4 = 12 cups. A common error is using the pints-per-quart conversion (2) instead of cups-per-quart (4), giving the wrong answer of 6."

- question: "When you convert 5 feet into 60 inches, the actual length of the object has changed."
  type: true-false
  answer: false
  explanation: "Converting units changes how a measurement is expressed, not the physical quantity itself. 5 feet and 60 inches describe the exact same length. This is one of the deepest ideas in measurement: a quantity exists independently of the unit used to describe it."

- question: "You need to convert 2.5 pounds to ounces. Should you multiply or divide by 16, and why?"
  type: short-answer
  answer: "Multiply by 16. You are converting to a smaller unit (ounces are smaller than pounds), so more of them are needed to represent the same amount. 2.5 × 16 = 40 ounces."
  explanation: "The rule is: going to a smaller unit means multiplying (more pieces needed), going to a larger unit means dividing (fewer pieces needed). Since 1 pound = 16 ounces and ounces are smaller, you multiply."
```
