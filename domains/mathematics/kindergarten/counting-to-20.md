...
- Mixing up 'teen' numbers (e.g., confusing 16 and 60 in name).
- Losing track after 10 and restarting from 1.

## Questions

```yaml
- question: "A child counts out 13 blocks. Which description best explains what 13 means?"
  type: multiple-choice
  options: ["A name that comes after 12", "Ten blocks and three more blocks", "Three groups of four plus one", "A teen number with a 1 and a 3"]
  answer: 1
  explanation: "13 means one group of ten plus three more. Understanding teen numbers as 'ten and some more' builds place-value intuition. The other options are either purely positional (order in sequence) or arithmetically wrong."

- question: "The number names 'eleven' and 'twelve' follow the same 'teen' pattern as thirteen through nineteen."
  type: true-false
  answer: false
  explanation: "Eleven and twelve are irregular — they come from Old English words and do not follow the '-teen' suffix pattern. This is why children often need extra practice with 11 and 12 specifically, as those names give no clue about their 'ten and one more' / 'ten and two more' structure."

- question: "Why is counting from 11 to 20 harder for young children than counting from 1 to 10?"
  type: short-answer
  answer: "The number names for 11–20 are irregular and must be memorized — they do not transparently say 'ten and one,' 'ten and two,' etc. the way some languages do. Children cannot predict the names from a pattern alone."
  explanation: "Languages like Mandarin say 'ten-one, ten-two' for 11 and 12, making the structure obvious. English names like 'eleven' and 'thirteen' obscure the ten-and-some-more structure, requiring rote learning in addition to counting practice."
```
