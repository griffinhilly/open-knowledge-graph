...
- question: "Green's theorem primarily helps when the line integral is difficult and the double integral is easy — if the double integral is harder, you cannot apply the theorem in reverse."
  type: true-false
  answer: false
