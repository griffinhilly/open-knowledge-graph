...
- question: "Maya has 9 stickers. She gives 4 to her friend. Which operation solves this?"
  ...
  options:
    ...
    - "Subtraction, because stickers are being taken away"
    - "Addition, because two numbers appear in the problem"
    - "Either operation works equally well"
  answer: 1
...
- question: "There are 6 apples in a bowl. After some are eaten, 2 remain. How many were eaten? Explain how you know which operation to use."
  type: short-answer
  answer: "Subtraction (or a missing-addend approach): 6 minus some number equals 2, so 6 - 4 = 2, meaning 4 were eaten."
  explanation: "The situation describes a starting amount, a change (eating), and a remaining amount — a removal context. Even though the unknown is the amount removed rather than the result, the structure is still subtraction. Students who recognize the situation type rather than hunting for keywords can handle this kind of 'missing change' problem correctly."
```
