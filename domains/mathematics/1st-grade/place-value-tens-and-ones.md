...
```yaml
- question: "The number 47 means ___."
  type: multiple-choice
  options: ["4 ones and 7 tens", "4 tens and 7 ones", "47 ones", "47 tens"]
  answer: 1
  explanation: "In 47, the digit 4 is in the tens place (worth 40) and the digit 7 is in the ones place (worth 7). Position determines value — the same digit means something different depending on where it sits."

- question: "In the number 36, the digit 3 stands for the number 3."
  type: true-false
  answer: false
  explanation: "The digit 3 is in the tens place, so it stands for 3 tens, which equals 30. Only a digit in the ones place represents its face value directly. This is the core misconception place value is designed to correct."

- question: "How many tens and ones make up the number 52?"
  type: short-answer
  answer: "5 tens and 2 ones"
  explanation: "52 = 50 + 2, so there are 5 groups of ten and 2 leftover ones. Being able to decompose a number this way is the foundation of all multi-digit arithmetic."
```
