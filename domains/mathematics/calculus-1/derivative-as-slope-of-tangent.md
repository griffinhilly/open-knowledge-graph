...
- question: "A tangent line to a smooth curve can only intersect the curve at the single point of tangency — it cannot cross or touch the curve anywhere else."
  type: true-false
  answer: false
