...
- Reading 4 × 5 as '4 plus 5' instead of '4 groups of 5.'
- Not seeing that the two factors can switch order (commutative property).
- Believing multiplication always 'makes things bigger' — true for whole numbers, but building only this intuition creates problems later.

## Questions

```yaml
- question: "Which multiplication equation correctly represents 5 + 5 + 5 = 15?"
  type: multiple-choice
  options: ["5 × 15", "3 × 5", "5 × 5", "15 × 3"]
  answer: 1
...
- question: "Why does 4 × 3 give the same result as 3 × 4?"
  type: short-answer
  answer: "Both equal 12. You can think of 4 × 3 as 4 groups of 3 and 3 × 4 as 3 groups of 4 — rearranging the same total number of objects into rows and columns gives the same count either way."
  explanation: "This is the commutative property of multiplication. An array model shows it clearly: a 4-row, 3-column grid has 12 squares whether counted by row or by column."
```
