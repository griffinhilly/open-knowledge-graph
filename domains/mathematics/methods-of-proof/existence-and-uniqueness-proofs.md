...
- question: "A uniqueness proof must begin by assuming that there is only one solution to the problem being proved."
  type: true-false
  answer: false
...
- question: "A proof that establishes existence automatically establishes uniqueness — if you can construct a specific object, it must be the only one."
  type: true-false
  answer: false
