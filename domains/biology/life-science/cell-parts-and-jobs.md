...
- Thinking the nucleus is the "brain" that thinks — it holds instructions (DNA) but does not think or process information the way a brain does.
- Believing mitochondria are only in animal cells — both plant and animal cells have mitochondria.
- Confusing the cell wall with the cell membrane — the wall provides structural support (plants only), while the membrane controls transport (all cells).

## Questions

```yaml
- question: "Which cell part is responsible for converting food into energy the cell can use?"
...
- question: "Describe the job of the cell membrane and explain why it is important for keeping the cell alive."
  type: short-answer
  answer: "The cell membrane controls what enters and leaves the cell. It lets in nutrients and water that the cell needs while keeping out harmful substances and preventing important molecules from leaking out. Without it, the cell could not maintain the right internal conditions to survive."
  explanation: "The cell membrane acts as a selective barrier. This function is critical because cells need specific concentrations of molecules to carry out life processes. A cell without a functioning membrane would lose its contents and die."
```
