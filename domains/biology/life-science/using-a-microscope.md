...
- Thinking higher magnification always gives a better view — higher magnification narrows the field of view and can make focusing harder.
- Not realizing the image is inverted — students are confused when the object moves the "wrong" direction.
- Believing the microscope makes things brighter — it magnifies, and adequate light must be supplied separately.

## Questions

```yaml
- question: "When using a compound microscope, you should always begin focusing at which magnification?"
  type: multiple-choice
  options: ["The highest available", "Medium (10x objective)", "The lowest available", "It does not matter"]
  answer: 2
...
- question: "If a microscope's eyepiece is 10x and the objective lens is 40x, what is the total magnification?"
  type: short-answer
  answer: "400x. You multiply the eyepiece magnification (10x) by the objective magnification (40x) to get the total: 10 × 40 = 400x."
  explanation: "Total magnification is always the product of the two lens magnifications, not the sum. This is because each lens magnifies the image produced by the other, so the effects multiply."
```
