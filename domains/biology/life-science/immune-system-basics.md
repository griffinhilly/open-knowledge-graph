...
- Thinking antibiotics work against viruses — antibiotics only kill bacteria; viral infections must be fought by the immune system (or antiviral drugs).
- Believing fever is the disease — fever is an immune response that makes the body less hospitable to germs; it is part of the defense, not the attack.
- Thinking the immune system is one organ — it involves many organs (bone marrow, thymus, lymph nodes, spleen) and cells throughout the body.

## Questions

```yaml
- question: "Why can't you usually catch the same illness (like chickenpox) twice?"
  type: multiple-choice
  options: ["The germs die out permanently after the first infection", "Your skin becomes resistant to that specific germ", "Your immune system remembers the germ and responds faster and more effectively the second time", "Antibiotics in your body kill the germ before it can infect you again"]
  answer: 2
