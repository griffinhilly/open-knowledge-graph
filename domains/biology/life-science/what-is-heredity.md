...
- id: what-is-a-life-cycle
  type: soft
builds-toward:
- dominant-and-recessive-traits-intro
- mendelian-genetics
tags:
- heredity
- genetics
...
- Thinking offspring are exact copies of one parent — in sexual reproduction, each offspring inherits a unique combination of genes from both parents.
- Believing that only physical traits are inherited — behaviors, disease susceptibility, and other characteristics also have genetic components.
- Confusing inherited traits with learned behaviors — you inherit your eye color, but you learn to ride a bike; heredity only passes genetic information.

## Questions

```yaml
- question: "Why do children resemble their parents but are not identical to them?"
  type: multiple-choice
  options: ["Because children eat different food than their parents", "Because children receive a mix of DNA from both parents, creating a unique combination", "Because children's traits are determined by the environment, not genes", "Because DNA changes completely every generation"]
  answer: 1
  explanation: "In sexual reproduction, each child receives half of their DNA from their mother and half from their father. The specific combination of genes each child gets is unique (except in identical twins), which is why siblings share family resemblances but look different from each other. The mixing of parental DNA creates variation."

- question: "Learned behaviors like speaking a language are passed from parents to children through DNA."
  type: true-false
  answer: false
  explanation: "DNA passes on inherited traits like eye color, blood type, and hair texture — not learned behaviors. A child born to English-speaking parents but raised by Spanish-speaking parents will speak Spanish. Language is learned from the environment, not inherited through genes. However, the capacity for language (the ability of the brain to learn language) is inherited."

- question: "What is DNA, and what role does it play in heredity?"
  type: short-answer
  answer: "DNA is a molecule found in the nucleus of every cell that contains the genetic instructions for building and running the organism. In heredity, DNA is passed from parents to offspring, carrying the instructions that determine the offspring's traits. Each parent contributes DNA, and the combination of instructions creates a unique individual."
  explanation: "DNA is the physical basis of heredity — it is the molecule that stores genetic information and gets copied and passed on during reproduction. Understanding that traits are carried by a physical molecule (not by blood, spirit, or abstract 'inheritance') is a key conceptual shift in learning biology."
```
