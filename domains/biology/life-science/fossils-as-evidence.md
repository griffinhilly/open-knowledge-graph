...
title: Fossils as Evidence of Change
domain: biology
course: life-science
prerequisites:
...
- Thinking fossils are just old bones — fossils include shells, teeth, petrified wood, footprints, impressions, and even preserved insects in amber.
- Believing that every organism that dies becomes a fossil — fossilization is extremely rare; it requires specific conditions (rapid burial, mineral-rich water).
- Assuming the fossil record is complete — only a tiny fraction of organisms that ever lived became fossils, so the record has many gaps.

## Questions

```yaml
- question: "Why are fossils found in the deepest rock layers generally simpler than those found in upper layers?"
  type: multiple-choice
  options: ["Because simple organisms are heavier and sink deeper", "Because deeper layers are older, and life started simple and became more complex over time through evolution", "Because complex organisms dissolve faster in rock", "Because scientists arrange them that way for display"]
  answer: 1
...
- question: "What is a transitional fossil, and why is it important as evidence for evolution?"
  type: short-answer
  answer: "A transitional fossil shows features of both an ancestral group and a descendant group. For example, Tiktaalik is a fossil that has features of both fish (scales, fins) and land-dwelling amphibians (flat head, primitive wrist bones). Transitional fossils are important because they provide direct evidence that one group of organisms evolved into another over time."
  explanation: "Transitional fossils fill in the 'gaps' between major groups of organisms, showing the intermediate steps of evolution. They demonstrate that evolutionary change happens gradually rather than in sudden jumps, with organisms displaying mixtures of old and new features."
```
