...
course: life-science
prerequisites:
- id: why-scientists-classify
  type: hard
- id: single-celled-organisms
  type: soft
- id: animal-groups
  type: soft
builds-toward:
...
- Thinking mushrooms and other fungi are plants — fungi do not photosynthesize; they absorb nutrients from dead or living organic matter.
- Believing all single-celled organisms are bacteria — protists are also often single-celled but have a nucleus and are more complex.
- Confusing kingdoms with species — a kingdom is the second-broadest grouping (after domain) and contains thousands or millions of species.

## Questions

```yaml
- question: "A mushroom is often mistaken for a plant. Which kingdom does it actually belong to, and why?"
  type: multiple-choice
  options: ["Plantae, because it grows in soil", "Animalia, because it consumes nutrients", "Fungi, because it absorbs nutrients from dead matter and does not photosynthesize", "Protista, because it is simple in structure"]
  answer: 2
  explanation: "Mushrooms belong to kingdom Fungi. Unlike plants, fungi cannot photosynthesize — they have no chloroplasts or chlorophyll. Instead, fungi release enzymes that break down dead organic matter (or parasitize living organisms) and absorb the nutrients. Growing in soil does not make something a plant — the key distinction is how the organism obtains energy."

- question: "Bacteria and archaea are both single-celled organisms without a nucleus, so they belong to the same kingdom."
  type: true-false
  answer: false
  explanation: "Although bacteria and archaea share some features (single-celled, no nucleus), they are fundamentally different at the molecular level — their cell membranes, cell walls, and genetic machinery differ significantly. They are placed in separate kingdoms AND separate domains (Domain Bacteria and Domain Archaea), reflecting the depth of their differences."

- question: "Name two characteristics that separate kingdom Plantae from kingdom Animalia."
  type: short-answer
  answer: "Plants make their own food through photosynthesis using chloroplasts, while animals must consume other organisms for food. Plants have cell walls made of cellulose, while animal cells have only a cell membrane and no cell wall."
  explanation: "These two differences — energy source (photosynthesis vs. consumption) and cell structure (cell wall vs. no cell wall) — are among the most fundamental distinctions between the two kingdoms. They reflect entirely different survival strategies: plants are stationary producers; animals are mobile consumers."
```
