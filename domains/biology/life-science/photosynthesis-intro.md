...
- Thinking plants get their food from the soil — plants get minerals from soil, but their food (glucose) is made through photosynthesis using sunlight, CO₂, and water.
- Believing plants do not perform respiration — plants both photosynthesize (make glucose) AND respire (break down glucose for energy), but photosynthesis dominates during daylight.
- Assuming photosynthesis only benefits plants — photosynthesis produces the oxygen that almost all other organisms breathe and creates the base of the food chain.

## Questions

```yaml
- question: "What are the raw materials (inputs) needed for photosynthesis?"
  type: multiple-choice
  options: ["Glucose and oxygen", "Carbon dioxide, water, and sunlight", "Soil, minerals, and water", "Oxygen and glucose"]
  answer: 1
  explanation: "Photosynthesis uses three inputs: carbon dioxide (from the air, entering through leaf pores called stomata), water (absorbed by roots from the soil), and sunlight (captured by chlorophyll in chloroplasts). These are converted into glucose (the plant's food) and oxygen (released as a byproduct). Glucose and oxygen are the OUTPUTS, not inputs."

- question: "Plants get their food by absorbing it from the soil through their roots."
  type: true-false
  answer: false
  explanation: "Plants absorb water and minerals from the soil, but their actual food — glucose — is made inside the plant through photosynthesis. The carbon in glucose comes from carbon dioxide in the air, not from the soil. This is one of the most common misconceptions in biology: plants make their own food using light energy."

- question: "Explain why photosynthesis is important not just for plants but for almost all life on Earth."
  type: short-answer
  answer: "Photosynthesis produces glucose, which is the energy source at the base of nearly every food chain — herbivores eat plants, carnivores eat herbivores, and so on. It also produces oxygen, which most organisms (including animals and the plants themselves) need for cellular respiration. Without photosynthesis, there would be almost no food and very little oxygen on Earth."
  explanation: "Photosynthesis connects to two fundamental requirements of life: food (energy) and oxygen. It is the process that makes Earth habitable — the oxygen in our atmosphere was produced by photosynthetic organisms over billions of years."
```
