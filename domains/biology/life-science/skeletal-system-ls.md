...
- Thinking bones are dry, dead, and solid — bones are living tissue with blood vessels, nerves, and a soft interior (marrow).
- Believing babies have the same number of bones as adults — babies have about 270 bones; many fuse together during growth.
- Thinking the skeleton only provides structure — it also protects organs (skull protects brain, ribs protect lungs and heart) and produces blood cells.
...
- question: "Which of the following is NOT a function of the skeletal system?"
  ...
  options: ["Supporting the body's shape", "Producing blood cells in bone marrow", "Digesting food", "Protecting internal organs"]
  answer: 2
...
- question: "Explain why the skull and rib cage are shaped differently and how their shapes relate to their functions."
  type: short-answer
  answer: "The skull is a hard, rounded case that completely surrounds and protects the brain. The rib cage is a flexible, cage-like structure that protects the heart and lungs while still allowing the chest to expand and contract for breathing. Their shapes match their jobs — the skull needs to be solid because the brain cannot tolerate impact, while the ribs need to be flexible to allow lung expansion."
  explanation: "This connects structure to function — a key theme in biology. Rigid enclosure protects the brain; flexible enclosure protects organs that need to move. Different functions require different shapes."
```
