...
- Confusing breathing with cellular respiration — breathing is the mechanical process of moving air; cellular respiration is the chemical process inside cells that uses oxygen to release energy from glucose.
- Thinking only animals perform cellular respiration — ALL organisms that use oxygen perform cellular respiration, including plants, fungi, and most bacteria.
- Believing cellular respiration is the opposite of photosynthesis in the sense that they cancel each other out — both occur simultaneously in plant cells; they serve different purposes.
...
- question: "What is the relationship between photosynthesis and cellular respiration?"
  ...
  options: ["They are the same process", "They are reverse processes — the outputs of one are the inputs of the other", "Photosynthesis occurs only in plants, and cellular respiration occurs only in animals", "They have no relationship"]
  answer: 1
  explanation: "Photosynthesis takes in CO₂ and H₂O and produces glucose and O₂. Cellular respiration takes in glucose and O₂ and produces CO₂ and H₂O. The outputs of one are the inputs of the other, forming a cycle. However, they are NOT opposites that cancel out — photosynthesis stores energy (from sunlight) in glucose, while cellular respiration releases that stored energy for cells to use."

- question: "Plants perform photosynthesis but do not perform cellular respiration."
  type: true-false
  answer: false
  explanation: "Plants perform BOTH photosynthesis and cellular respiration. During the day, photosynthesis dominates — plants produce more oxygen and glucose than they use. But plant cells have mitochondria and continuously perform cellular respiration to release energy from glucose for their own growth and life processes, day and night."

- question: "Explain why cellular respiration is not the same as breathing, even though the two are related."
  type: short-answer
  answer: "Breathing is the mechanical process of moving air in and out of the lungs — inhaling oxygen and exhaling carbon dioxide. Cellular respiration is the chemical process inside cells where glucose is broken down using oxygen to release energy, with carbon dioxide and water produced as waste. Breathing supplies the oxygen that cellular respiration needs and removes the CO₂ it produces, but they are different processes at different levels."
  explanation: "This distinction is important because cellular respiration happens in every cell of the body, not just in the lungs. The lungs handle gas exchange with the environment; mitochondria handle the energy-releasing chemistry. Organisms without lungs (like plants and single-celled organisms) still perform cellular respiration."
```
