...
builds-toward:
- digestive-system-ls
- respiratory-system-ls
- circulatory-system-ls
...
- Confusing tissues with organs — a tissue is one type of cell doing one job; an organ contains multiple tissue types.
- Thinking organs work alone — every organ is part of a system, and systems depend on each other.
- Believing the hierarchy stops at organs — the organ system level is important for understanding how the body coordinates complex functions.

## Questions

```yaml
- question: "What is the correct order of organization in a living thing, from simplest to most complex?"
  type: multiple-choice
  options: ["Organ → tissue → cell → organ system", "Cell → tissue → organ → organ system", "Tissue → cell → organ system → organ", "Organ system → organ → tissue → cell"]
  answer: 1
  explanation: "The levels of organization go from smallest to largest: cells are the basic units; similar cells group into tissues; different tissues form organs; and organs that work together make up organ systems. This hierarchy builds complexity step by step."

- question: "A tissue is made of many different types of cells working together."
  type: true-false
  answer: false
  explanation: "A tissue is made of similar cells that perform the same function — for example, muscle tissue is made of muscle cells. It is an organ that is made of different types of tissues working together. The heart, for instance, contains muscle tissue, nerve tissue, and connective tissue."

- question: "Give an example of how cells, tissues, organs, and organ systems are connected in the human body."
  type: short-answer
  answer: "Muscle cells group together to form muscle tissue. Muscle tissue, along with nerve tissue and connective tissue, forms the heart (an organ). The heart works with blood vessels to form the circulatory system (an organ system), which delivers oxygen and nutrients throughout the body."
  explanation: "This traces the hierarchy through a specific example, showing that each level builds on the one below it. Any organ system could serve as the example — the key is demonstrating the cell → tissue → organ → organ system progression."
```
