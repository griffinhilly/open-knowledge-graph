...
- Thinking organisms choose to adapt or change themselves — natural selection acts on existing variation; individuals cannot change their traits on purpose.
- Believing natural selection means "survival of the fittest" in terms of physical strength — "fitness" in biology means reproductive success, not physical power.
- Thinking evolution happens to individuals — evolution happens to populations over many generations; an individual organism does not evolve during its lifetime.

## Questions

```yaml
- question: "What does 'fitness' mean in the context of natural selection?"
  type: multiple-choice
  options: ["Physical strength and speed", "The ability to survive and reproduce successfully in a given environment", "Being the largest organism in the population", "The ability to change traits to match the environment"]
  answer: 1
  explanation: "In biology, fitness refers to an organism's ability to survive AND reproduce in its environment. A 'fit' organism is one that passes its genes to the next generation — not necessarily the strongest or fastest. A small, camouflaged insect may be more 'fit' than a large, visible one if it avoids predators and reproduces more successfully."

- question: "Individual organisms can evolve during their lifetime in response to environmental changes."
  type: true-false
  answer: false
  explanation: "Individuals do NOT evolve. Evolution is a change in the inherited traits of a POPULATION over many generations. An individual organism is born with its genes and cannot change them. Natural selection acts on variation that already exists — organisms with advantageous traits survive and reproduce more, shifting the population's traits over time."

- question: "Explain the three conditions necessary for natural selection to occur."
  type: short-answer
  answer: "First, there must be variation — individuals in the population must differ in their traits (for example, some moths are darker and some are lighter). Second, those traits must be heritable — they can be passed from parents to offspring through DNA. Third, there must be differential survival and reproduction — some trait variations must give an advantage in the current environment, making those individuals more likely to survive and reproduce."
  explanation: "Without variation, there would be nothing to select. Without heritability, advantageous traits could not be passed on. Without differential survival, all traits would be equally likely to appear in the next generation. All three conditions must be present for natural selection to drive evolutionary change."
```
