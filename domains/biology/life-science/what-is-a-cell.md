...
- Thinking cells are only found in animals, not plants or fungi.
- Believing that cells are too small to matter or that they are just "blobs of stuff" with no internal structure.
- Confusing cells with atoms — cells are biological units of life, not chemical units of matter.
...
- question: "What is the smallest unit of life?"
  ...
  options: ["An atom", "A molecule", "A cell", "An organ"]
  answer: 2
  explanation: "A cell is the smallest structure that can carry out all the functions of life — taking in nutrients, producing energy, and reproducing. Atoms and molecules are smaller but are not alive on their own. Organs are made of many cells working together."

- question: "All living things are made of cells."
  type: true-false
  answer: true
  explanation: "This is one of the key ideas in biology, known as cell theory. Every living organism — from bacteria to blue whales — is composed of one or more cells. Non-living things like rocks and water are not made of cells."

- question: "In your own words, explain why a cell is considered the basic unit of life."
  type: short-answer
  answer: "A cell is the smallest structure that can perform all life functions on its own — it can take in energy, get rid of waste, grow, and reproduce. Nothing smaller than a cell can do all of these things."
  explanation: "The key idea is that life's essential processes happen at the cellular level. Molecules and atoms are important parts of cells, but they cannot independently carry out all life functions the way a complete cell can."
```
