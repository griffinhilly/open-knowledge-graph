...
title: Seed Plants vs. Spore Plants
domain: biology
course: life-science
prerequisites:
...
- Thinking spores are seeds — they are fundamentally different; a spore is a single cell, while a seed is a multicellular structure with an embryo.
- Believing spore plants are extinct — ferns and mosses are very much alive; they just occupy different niches than seed plants (moist, shady environments).
- Assuming all seed plants produce flowers — gymnosperms (conifers) produce seeds in cones, not flowers.

## Questions

```yaml
- question: "What advantage do seeds have over spores for plant reproduction?"
  type: multiple-choice
  options: ["Spores are larger and easier to spread", "Seeds contain an embryo and food supply protected by a seed coat, giving the new plant a head start", "Seeds are lighter than spores and travel farther", "Spores require more water to develop than seeds"]
  answer: 1
  explanation: "A seed contains a baby plant (embryo) with a built-in food supply, all wrapped in a protective coat. This means the new plant has nutrients available to begin growing even before its roots can absorb water and minerals. A spore is just a single cell with no food supply — it must land in exactly the right conditions to develop. Seeds can also survive harsh conditions (drought, cold) that spores cannot."

- question: "Ferns and mosses are extinct because they could not compete with seed plants."
  type: true-false
  answer: false
  explanation: "Ferns and mosses are very much alive today. While seed plants dominate most land ecosystems, ferns and mosses thrive in moist, shady environments like forest floors, streambeds, and tropical understories. They are less common than seed plants, but they have found niches where their spore-based reproduction works well."

- question: "Explain why spore plants are more dependent on moist environments than seed plants."
  type: short-answer
  answer: "Spore plants need moisture for two reasons: their spores are more vulnerable to drying out than seeds (they lack a protective coat and food supply), and their reproductive process requires water for the sperm cells to swim to the egg cells. Seed plants do not need water for fertilization because pollen carries the sperm to the egg through wind or animal transport."
  explanation: "This water requirement explains the ecological distribution of spore plants — they dominate in moist, humid habitats and are rare in deserts. The evolution of pollen and seeds freed plants from dependence on water for reproduction, allowing them to colonize drier environments."
```
