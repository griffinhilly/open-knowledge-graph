...
- Thinking cells grow larger indefinitely instead of dividing — cells have a size limit; they divide rather than keep growing.
- Believing cell division creates cells from nothing — new cells always come from existing cells.
- Confusing cell division with organism reproduction — cell division is one mechanism of reproduction in single-celled organisms, but in multi-celled organisms it mainly serves growth and repair.

## Questions

```yaml
- question: "Why must a cell copy its DNA before it divides?"
  type: multiple-choice
  options: ["So the cell can grow larger", "So each new cell gets a complete set of instructions", "Because DNA dissolves during division", "To make the cell divide faster"]
  answer: 1
  explanation: "DNA contains the instructions for everything the cell needs to build and do. If a cell divided without copying its DNA, one or both new cells would be missing critical instructions and could not function properly. Copying first ensures both daughter cells get a full set."

- question: "New cells are created from non-living materials, not from other cells."
  type: true-false
  answer: false
  explanation: "One of the core principles of cell theory is that all new cells come from existing cells. No cell has ever been observed arising from non-living matter. Cell division is the process by which existing cells produce new ones."

- question: "Describe two reasons why a multi-celled organism needs cell division."
  type: short-answer
  answer: "First, cell division allows the organism to grow — a child's body adds new cells to become an adult. Second, cell division repairs damage — when you cut your skin, cells near the wound divide to produce new cells that close the gap."
  explanation: "Growth and repair are the two main reasons multi-celled organisms need cell division. A third reason is the replacement of worn-out cells — your body constantly replaces skin cells, blood cells, and the cells lining your intestines."
```
