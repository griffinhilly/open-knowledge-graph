...
title: Pollination and Fertilization in Plants
domain: biology
course: life-science
prerequisites:
- id: seed-plants-vs-spore-plants
  type: hard
- id: parts-of-a-plant
  type: hard
...
- Confusing pollination with fertilization — pollination is the transfer of pollen to the stigma; fertilization is the fusion of sperm and egg, which happens after pollination.
- Thinking only bees pollinate — many animals pollinate, including butterflies, moths, hummingbirds, bats, and even some lizards; wind and water also pollinate many plants.
- Believing flowers exist to be beautiful for humans — flower colors, scents, and shapes evolved to attract specific pollinators, not for human enjoyment.
...
- question: "What is the difference between pollination and fertilization?"
  ...
  options: ["They are the same process", "Pollination is the transfer of pollen to the stigma; fertilization is the fusion of sperm and egg inside the ovule", "Pollination happens inside the seed; fertilization happens on the flower surface", "Pollination occurs only in wind-pollinated plants; fertilization occurs only in animal-pollinated plants"]
  answer: 1
  explanation: "Pollination and fertilization are two separate steps. Pollination is the physical transfer of pollen (which contains sperm cells) from the anther to the stigma. Fertilization happens afterward, when a pollen tube grows down to the ovule and a sperm cell fuses with the egg cell. Pollination must happen first for fertilization to follow."

- question: "Flowers evolved their colors and scents to be beautiful for humans."
  type: true-false
  answer: false
  explanation: "Flower colors, scents, and shapes evolved to attract pollinators, not to please humans. Bright red flowers attract hummingbirds. White, fragrant flowers that open at night attract moths. Flowers with strong, sweet scents attract bees. Humans happen to find many of these features attractive, but the evolutionary pressure was pollinator attraction, not human aesthetics."

- question: "Explain why the decline of bee populations is a concern for food production."
  type: short-answer
  answer: "Bees are the most important pollinators for many crops, including fruits, vegetables, and nuts. Without bees to transfer pollen from flower to flower, these plants cannot produce seeds or fruits. If bee populations decline significantly, many food crops would produce far less, threatening food supplies worldwide."
  explanation: "About 75% of the world's flowering plants and about 35% of food crops depend on animal pollinators, especially bees. The relationship between flowering plants and their pollinators is a form of mutualism — both benefit — and disrupting it has direct consequences for human food systems."
```
