...
- Thinking all plants produce flowers — only angiosperms do; conifers, ferns, and mosses do not.
- Believing conifers are flowering plants because pine cones look like they could be flowers — pine cones are seed structures, not flowers.
- Confusing "vascular" with "having blood" — in plants, vascular means having tube-like tissues (xylem and phloem) for transporting water and nutrients.

## Questions

```yaml
- question: "Which plant group is the most diverse and produces seeds inside fruits?"
  type: multiple-choice
  options: ["Mosses", "Ferns", "Gymnosperms (conifers)", "Angiosperms (flowering plants)"]
  answer: 3
  explanation: "Angiosperms (flowering plants) are the most diverse plant group, with over 300,000 known species. They produce flowers, and their seeds develop inside fruits. This includes grasses, oak trees, roses, and most of the crops humans eat. Mosses have no seeds, ferns reproduce with spores, and gymnosperms produce seeds but not enclosed in fruits."

- question: "Ferns reproduce using seeds, just like flowering plants."
  type: true-false
  answer: false
  explanation: "Ferns are seedless vascular plants — they reproduce using tiny spores, not seeds. You can often see the spore cases as small brown dots on the underside of fern fronds. Ferns were among the first plants to develop vascular tissue (tubes for water transport), but seeds evolved later in plant history."

- question: "Explain what 'vascular' means in the context of plants and why it matters for plant size."
  type: short-answer
  answer: "Vascular means having tube-like tissues (xylem and phloem) that transport water, minerals, and sugars throughout the plant. This matters because vascular tissue allows plants to grow tall — water can be pulled up from roots to leaves high above the ground. Nonvascular plants like mosses lack these tubes, which is why they stay small and close to the ground."
  explanation: "Vascular tissue is a key innovation in plant evolution. Without it, plants are limited to getting water through direct absorption, which only works for small plants in moist environments. Vascular tissue enabled plants to colonize drier habitats and grow into trees."
```
