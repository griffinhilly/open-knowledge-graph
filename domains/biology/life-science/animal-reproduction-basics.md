...
title: Animal Reproduction Basics
domain: biology
course: life-science
prerequisites:
...
- Thinking all animals reproduce the same way — reproductive strategies vary enormously, from egg-laying to live birth to budding.
- Believing sexual reproduction always requires mating — some animals fertilize externally (fish release eggs and sperm into the water).
- Assuming asexual reproduction is inferior — it is actually very efficient when conditions are stable; the offspring are perfectly adapted to the current environment.
...
- question: "What is the main advantage of sexual reproduction over asexual reproduction?"
  ...
  options: ["It is faster", "It requires fewer resources", "It produces genetically diverse offspring, increasing the population's ability to survive changing conditions", "It always produces more offspring"]
  answer: 2
  explanation: "Sexual reproduction combines genes from two parents, creating offspring with unique genetic combinations. This diversity means that if the environment changes or a disease strikes, some individuals may have traits that help them survive — the population does not rely on one set of genes. Asexual reproduction is faster and simpler, but all offspring are genetically identical, making the entire population vulnerable to the same threats."

- question: "In asexual reproduction, the offspring are genetically different from the parent."
  type: true-false
  answer: false
  explanation: "In asexual reproduction, there is only one parent, and the offspring are genetically identical to that parent (they are clones). All the DNA comes from a single individual, so there is no mixing of genetic material. Genetic diversity only arises through rare mutations. In sexual reproduction, by contrast, each offspring is genetically unique because it receives a mix of DNA from two parents."

- question: "Explain why a population that reproduces only asexually might be at greater risk from a new disease than a sexually reproducing population."
  type: short-answer
  answer: "In an asexually reproducing population, all individuals are genetically identical. If a new disease can infect one individual, it can likely infect all of them because they all share the same genetic vulnerabilities. In a sexually reproducing population, individuals are genetically diverse — some may have natural resistance to the disease and survive, allowing the population to continue."
  explanation: "This is one of the main evolutionary arguments for sexual reproduction. Despite being slower and more energy-intensive than asexual reproduction, the genetic diversity it produces provides a population-level 'insurance policy' against threats like disease, parasites, and environmental change."
```
