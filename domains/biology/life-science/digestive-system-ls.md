...
- Thinking digestion happens only in the stomach — the stomach is important, but most nutrient absorption occurs in the small intestine.
- Believing the small intestine is small — it is called "small" because of its narrow width, but it is about 20 feet long in adults.
- Confusing the roles of the liver and stomach — the liver produces bile for fat digestion and detoxifies the blood; it does not store food.

## Questions

```yaml
- question: "Where does most nutrient absorption happen in the digestive system?"
  type: multiple-choice
  options: ["Mouth", "Stomach", "Small intestine", "Large intestine"]
  answer: 2
  explanation: "The small intestine is where most nutrients are absorbed into the bloodstream. Its inner surface is covered with tiny finger-like projections called villi that increase the surface area for absorption. The mouth begins digestion, the stomach breaks food down further, and the large intestine absorbs water."

- question: "The stomach is where most nutrients are absorbed into the blood."
  type: true-false
  answer: false
  explanation: "The stomach primarily breaks down food through acid and enzymes, but it absorbs very few nutrients. Most absorption happens in the small intestine, which has a huge surface area thanks to its length and the villi lining its walls."

- question: "Explain the difference between mechanical digestion and chemical digestion, and give one example of each."
  type: short-answer
  answer: "Mechanical digestion is the physical breaking of food into smaller pieces, like chewing in the mouth or churning in the stomach. Chemical digestion is the use of chemicals like acids and enzymes to break food molecules into simpler substances, like stomach acid breaking down proteins."
  explanation: "Both types work together — mechanical digestion increases the surface area of food so that chemical digestion can work more efficiently. This is similar to how crushing a sugar cube helps it dissolve faster in water."
```
