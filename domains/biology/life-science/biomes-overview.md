...
- Thinking deserts are always hot — some deserts (like the Gobi and Antarctica) are very cold; the defining feature is low precipitation, not high temperature.
- Believing biomes have sharp boundaries — biomes transition gradually into each other, with blended zones at the edges.
- Assuming tropical rainforests have rich soil — rainforest soil is actually nutrient-poor because decomposition is so fast that nutrients are immediately absorbed by plants rather than building up in the soil.

## Questions

```yaml
- question: "What two factors most determine which biome exists in a given location?"
  type: multiple-choice
  options: ["Altitude and longitude", "Temperature and precipitation", "Soil type and wind speed", "Latitude and ocean currents"]
  answer: 1
...
- question: "Explain why tropical rainforests have the greatest biodiversity of any terrestrial biome."
  type: short-answer
  answer: "Tropical rainforests have warm temperatures year-round and receive heavy rainfall, providing abundant energy (sunlight) and water for plant growth. The dense vegetation creates many different habitats — from the forest floor to the canopy — supporting a huge variety of species. The stable, warm climate also means organisms do not need to survive harsh winters, allowing more species to thrive."
  explanation: "High energy input (sunlight) and high water availability drive high productivity, which supports complex food webs and many ecological niches. The vertical structure of the forest (floor, understory, canopy, emergent layer) multiplies the available habitats within a small area."
```
