...
- Thinking veins carry "blue blood" — blood is always red; diagrams use blue to show deoxygenated blood, but real deoxygenated blood is dark red, not blue.
- Believing the heart is on the left side — it is slightly left of center but mostly in the middle of the chest.
- Thinking blood travels to a body part and stays there — blood circulates continuously in a loop.

## Questions

```yaml
- question: "What is the main job of capillaries?"
  type: multiple-choice
  options: ["To pump blood through the body", "To carry blood away from the heart at high pressure", "To exchange oxygen, nutrients, and waste between blood and cells", "To carry blood back to the heart"]
  answer: 2
  explanation: "Capillaries are the smallest blood vessels, with walls just one cell thick. This thinness allows oxygen and nutrients to pass from the blood into surrounding cells, and waste products like carbon dioxide to pass from cells into the blood. Arteries carry blood away from the heart, veins return it, and the heart pumps it — but the actual exchange happens in the capillaries."

- question: "Deoxygenated blood in your veins is blue."
  type: true-false
  answer: false
  explanation: "Blood is never blue inside the body. Oxygenated blood is bright red, and deoxygenated blood is dark red. Textbook diagrams use blue for deoxygenated blood only as a visual convention to make the two types easy to distinguish. Veins may appear blue through your skin because of how light penetrates skin and reflects back."

- question: "Describe the path blood takes from the heart to the lungs and back, and explain why this trip is necessary."
  type: short-answer
  answer: "The right side of the heart pumps deoxygenated blood to the lungs, where it picks up oxygen and releases carbon dioxide. The oxygen-rich blood then returns to the left side of the heart, which pumps it out to the rest of the body. This trip is necessary because blood must be resupplied with oxygen to deliver it to cells."
  explanation: "This describes pulmonary circulation — the loop between the heart and lungs. It connects the circulatory and respiratory systems: the lungs reload the blood with oxygen, and the heart pumps it to the body. Without this loop, cells would run out of oxygen."
```
