---
id: body-systems-working-together
...
- id: respiratory-system-ls
  type: hard
- id: circulatory-system-ls
  type: hard
- id: skeletal-system-ls
  type: soft
- id: muscular-system-ls
  type: soft
...
- Thinking each body system operates independently — every system depends on at least one other system.
- Believing the nervous system only controls voluntary movement — it also regulates heart rate, breathing, digestion, and immune responses.
- Assuming the body only coordinates during exercise — even at rest, systems are constantly communicating and adjusting.

## Questions

```yaml
- question: "When you eat a meal and then walk to class, which systems are working together?"
  type: multiple-choice
  options: ["Only the digestive and muscular systems", "Only the skeletal and muscular systems", "The digestive, circulatory, respiratory, muscular, skeletal, and nervous systems", "Only the nervous system"]
  answer: 2
  explanation: "The digestive system is breaking down the meal into nutrients. The circulatory system is carrying those nutrients (and oxygen from the respiratory system) to muscle cells. The muscular system moves your legs, pulling on bones of the skeletal system. The nervous system coordinates the walking motion and regulates digestion, breathing rate, and heart rate. All these systems work simultaneously."

- question: "The circulatory system can function normally without the respiratory system."
  type: true-false
  answer: false
  explanation: "The circulatory system depends on the respiratory system to supply oxygen to the blood and remove carbon dioxide. Without the lungs performing gas exchange, the blood circulating through the body would carry no oxygen to the cells, and cells would die within minutes. These two systems are deeply interdependent."

- question: "Explain what would happen to the body's cells if the circulatory system stopped working, and why other systems could not compensate."
  type: short-answer
  answer: "If the circulatory system stopped, cells would no longer receive oxygen or nutrients, and waste products like carbon dioxide would build up. Cells would begin to die within minutes. Other systems cannot compensate because the circulatory system is the only delivery network — the respiratory system can bring oxygen into the lungs, and the digestive system can absorb nutrients, but without blood flow, those supplies cannot reach the cells."
  explanation: "This highlights the interdependence of body systems. The circulatory system is the bridge connecting the respiratory and digestive systems to every cell. Without it, intake systems still work but delivery fails — showing that the body's design requires cooperation, not independence."
```
