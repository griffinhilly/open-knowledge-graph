...
- Thinking an ecosystem only includes animals — plants, fungi, bacteria, and non-living factors are all part of the ecosystem.
- Believing ecosystems have clear boundaries — in reality, ecosystems blend into each other at their edges (transition zones are called ecotones).
- Confusing "ecosystem" with "habitat" — a habitat is where an organism lives; an ecosystem includes the habitat plus all the interactions among organisms and their environment.

## Questions

```yaml
- question: "Which of the following is an abiotic factor in a forest ecosystem?"
  type: multiple-choice
  options: ["A mushroom growing on a log", "A deer drinking from a stream", "The temperature of the air", "A bird building a nest"]
  answer: 2
...
- question: "Explain the difference between a habitat and an ecosystem."
  type: short-answer
  answer: "A habitat is the specific place where an organism lives — its 'address' in nature (like a pond or a forest floor). An ecosystem is broader — it includes the habitat plus all the living organisms in the area and all the non-living factors, along with the interactions among them."
  explanation: "Habitat describes where; ecosystem describes the full web of what lives there, what non-living factors are present, and how everything interacts. A pond is a frog's habitat, but the pond ecosystem includes the frog, the algae it eats, the heron that eats the frog, the water, the sunlight, and all their interactions."
```
