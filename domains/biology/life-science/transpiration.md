...
- Thinking plants "pump" water up from the roots — there is no pump; transpiration creates a pulling force (like suction through a straw) that draws water upward.
- Believing transpiration is wasteful — while water is lost, transpiration is essential for water transport and cooling; plants have evolved ways to minimize excess water loss.
- Confusing transpiration with evaporation — transpiration is evaporation specifically from living plant surfaces through stomata, not just any evaporation.

## Questions

```yaml
- question: "What drives water movement upward from the roots to the leaves of a plant?"
  type: multiple-choice
  options: ["A pump in the roots pushes water up", "Gravity pulls water up from the ground", "Water evaporating from the leaves through transpiration creates a pulling force that draws water up", "The leaves squeeze water up through the stem"]
  answer: 2
  explanation: "Transpiration — the evaporation of water from leaf surfaces — creates a continuous pulling force. As water molecules evaporate from the stomata, they pull on the water molecules below them (because water molecules stick to each other), drawing water up through the stem from the roots. There is no pump — the evaporation at the top drives the entire flow."

- question: "Stomata can be permanently open without any cost to the plant."
  type: true-false
  answer: false
  explanation: "When stomata are open, the plant can take in CO₂ for photosynthesis, but it also loses water through transpiration. If stomata stay open too wide or too long — especially in hot, dry conditions — the plant can lose water faster than roots can absorb it, leading to wilting. Plants regulate their stomata, opening them when CO₂ is needed and closing them to conserve water."

- question: "Explain the tradeoff plants face with their stomata during photosynthesis."
  type: short-answer
  answer: "Plants need to open their stomata to let carbon dioxide in for photosynthesis, but when the stomata are open, water vapor escapes through transpiration. In dry or hot conditions, plants may close their stomata to conserve water, but this limits photosynthesis because CO₂ cannot enter. Plants must balance the need for CO₂ with the need to prevent excessive water loss."
  explanation: "This tradeoff is a central challenge in plant biology. Desert plants have evolved special adaptations (thick waxy coatings, opening stomata only at night, storing CO₂ as acid) to minimize water loss while maintaining photosynthesis. The stomatal tradeoff also explains why plants wilt on hot, dry days."
```
