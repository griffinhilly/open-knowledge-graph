...
- Thinking organisms develop adaptations during their lifetime in response to need — adaptations arise through natural selection over many generations, not by individual effort.
- Believing adaptations are perfect solutions — adaptations are "good enough" compromises shaped by available variation and evolutionary history.
- Confusing adaptation with acclimation — your body adjusting to high altitude is acclimation (temporary, individual); a population of Tibetans having genetic changes for high altitude is adaptation (permanent, population-level).

## Questions

```yaml
- question: "Arctic foxes have white fur in winter and brown fur in summer. What type of adaptation is this, and what advantage does it provide?"
  type: multiple-choice
  options: ["Behavioral — they choose to change color", "Structural — their fur color changes seasonally to provide camouflage in each season", "Physiological — they produce different hormones in winter", "It is not an adaptation — it is a coincidence"]
  answer: 1
...
- question: "Organisms develop new adaptations during their lifetime when they need them."
  type: true-false
  answer: false
  explanation: "Adaptations do not develop on demand. They arise over many generations through natural selection. Organisms are born with their traits — they cannot grow a new structure or develop a new ability because they need it. What changes over time is the population: individuals with advantageous traits survive and reproduce more, so those traits become more common in future generations."

- question: "Give one example each of a structural, behavioral, and physiological adaptation."
  type: short-answer
  answer: "Structural: A duck's webbed feet help it swim efficiently. Behavioral: Birds migrating south for winter to find food and warmer temperatures. Physiological: A camel's ability to tolerate body temperature fluctuations without sweating, conserving water in the desert."
  explanation: "These three categories cover the range of how organisms can be adapted. Structural adaptations involve body parts, behavioral adaptations involve actions, and physiological adaptations involve internal body processes. Many organisms combine all three types to survive in their environment."
```
