...
- Thinking "symbiosis" only means mutualism — symbiosis includes all three types (mutualism, commensalism, parasitism); it just means "living together."
- Believing parasites always kill their host — most parasites benefit from keeping the host alive; killing the host would destroy the parasite's food source.
- Assuming commensalism has no effect on the second organism — by definition, the second organism is unaffected, though in practice the line between commensalism and mutualism can be blurry.

## Questions

```yaml
- question: "Clownfish live among the stinging tentacles of sea anemones. The anemone's stings protect the clownfish from predators, and the clownfish drives away fish that would eat the anemone. What type of symbiosis is this?"
  type: multiple-choice
  options: ["Parasitism", "Commensalism", "Mutualism", "Competition"]
  answer: 2
  explanation: "This is mutualism because both species benefit. The clownfish gets protection from predators (the anemone's tentacles don't harm it due to a special mucus coating), and the anemone gets protection from its own predators plus nutrients from the clownfish's waste. Both organisms are better off together than apart."

- question: "Symbiosis means the same thing as mutualism."
  type: true-false
  answer: false
  explanation: "Symbiosis is the broader term — it refers to any close, long-term relationship between two different species. Mutualism is one type of symbiosis (both benefit), but parasitism (one benefits, one is harmed) and commensalism (one benefits, one is unaffected) are also forms of symbiosis."

- question: "Why do most parasites NOT kill their host?"
  type: short-answer
  answer: "A parasite depends on its host for food, shelter, or other resources. If the parasite kills the host, it loses its own source of survival and must find a new host — which may not be possible. Parasites that keep their host alive can feed for a longer time, so natural selection tends to favor parasites that harm but do not kill."
  explanation: "This is an example of evolutionary logic. A parasite that kills quickly would be less successful than one that keeps its host alive, because the slow-killing parasite gets more total resources. Over many generations, this dynamic selects for moderate virulence — a concept important in disease ecology."
```
