...
title: Dominant and Recessive Traits Introduction
domain: biology
course: life-science
prerequisites:
- id: what-is-heredity
...
- Thinking dominant means "more common" — a trait can be dominant but rare in a population; dominance refers to how alleles interact, not how common they are.
- Believing dominant traits are "better" or "stronger" — dominance is simply about which allele is expressed; it has nothing to do with fitness or quality.
- Expecting that a dominant trait will always appear in every generation — if both parents are heterozygous carriers (Bb), each child has a 25% chance of being homozygous recessive (bb) and showing the recessive trait.

## Questions

```yaml
- question: "Two parents both have brown eyes, but they have a child with blue eyes. How is this possible?"
  type: multiple-choice
  options: ["It is not possible — at least one parent must have blue eyes", "Both parents carry a hidden recessive allele for blue eyes (Bb), and the child inherited the recessive allele from each parent (bb)", "The child's eye color was determined by the environment, not genes", "Blue eyes are dominant over brown"]
  answer: 1
...
- question: "What is the difference between homozygous and heterozygous?"
  type: short-answer
  answer: "Homozygous means having two identical alleles for a gene (BB or bb). Heterozygous means having two different alleles (Bb). A heterozygous individual shows the dominant trait but carries the recessive allele and can pass it to offspring."
  explanation: "This distinction is crucial for predicting trait inheritance. Homozygous dominant (BB) and heterozygous (Bb) individuals both show the dominant trait, but only heterozygous individuals carry the recessive allele. Two heterozygous parents can produce homozygous recessive offspring — this is how 'hidden' traits appear in families."
```
