...
- Thinking muscles can push and pull — muscles can only contract (pull); movement in the opposite direction requires a different muscle.
- Believing the only muscles are the ones you can flex — smooth and cardiac muscles work constantly without conscious control.
- Thinking bigger muscles are always stronger — muscle strength depends on fiber type, training, and neural activation, not just size.
...
- question: "Why do skeletal muscles work in pairs?"
  ...
  options: ["Because the body has a left and right side", "Because muscles can only pull, so one pulls the bone one way and the other pulls it back", "Because one muscle provides energy and the other provides movement", "Because having two muscles makes them twice as strong"]
  answer: 1
  explanation: "Muscles can only contract (pull) — they cannot push. So to move a bone in two directions, you need two muscles pulling in opposite directions. The biceps bends the elbow by pulling the forearm up; the triceps straightens it by pulling the forearm down. They take turns contracting and relaxing."

- question: "Cardiac muscle is a type of voluntary muscle because you can choose to make your heart beat faster."
  type: true-false
  answer: false
  explanation: "Cardiac muscle is involuntary — it contracts automatically without conscious control. While exercise or emotions can increase your heart rate, this happens through automatic nervous system signals and hormones, not through a deliberate decision to speed up your heartbeat. You cannot stop or start your heart by thinking about it."

- question: "Name the three types of muscle tissue and give one example of where each is found in the body."
  type: short-answer
  answer: "Skeletal muscle is attached to bones and moves the body (example: biceps in the upper arm). Smooth muscle is found in the walls of organs (example: the stomach or intestines). Cardiac muscle is found only in the heart."
  explanation: "Each type is specialized for its role: skeletal muscle is strong and voluntary for body movement, smooth muscle provides slow, sustained contractions for organ function, and cardiac muscle never tires because it must beat continuously throughout life."
```
