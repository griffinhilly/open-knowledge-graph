---
id: vertebrates-vs-invertebrates
...
- Thinking all invertebrates are small — giant squid can be over 40 feet long, and some jellyfish have tentacles over 100 feet.
- Believing invertebrates are less "advanced" — invertebrates include incredibly complex organisms like octopuses, which are among the most intelligent animals.
- Thinking snakes are invertebrates because they are flexible — snakes have a backbone with many vertebrae, which is why they are so flexible.

## Questions

```yaml
- question: "Approximately what percentage of all animal species are invertebrates?"
  type: multiple-choice
  options: ["About 25%", "About 50%", "About 75%", "About 97%"]
  answer: 3
  explanation: "About 97% of all known animal species are invertebrates. Insects alone account for a huge proportion — there are more species of beetles than there are species of all vertebrates combined. Vertebrates (fish, amphibians, reptiles, birds, mammals) make up only about 3% of animal species, though they tend to be the most visible and familiar."

- question: "Snakes are invertebrates because they do not have legs."
  type: true-false
  answer: false
  explanation: "Having legs is not the defining characteristic of a vertebrate — having a backbone is. Snakes have a backbone (spine) with many vertebrae, making them vertebrates. In fact, snakes are so flexible precisely because they have many vertebrae (up to 400 in some species), each connected by flexible joints."

- question: "Name the five main classes of vertebrates and give one example of each."
  type: short-answer
  answer: "Fish (salmon), Amphibians (frog), Reptiles (lizard), Birds (eagle), Mammals (dog). Each class is defined by specific characteristics like body temperature regulation, body covering, and how they reproduce."
  explanation: "These five classes represent the major divisions within vertebrates. Fish breathe with gills and live in water. Amphibians live in water and on land. Reptiles have scaly skin and lay hard-shelled eggs. Birds have feathers and most can fly. Mammals have hair or fur and feed young with milk."
```
