...
- question: "Once activated, the coagulation cascade propagates throughout the bloodstream until most circulating fibrinogen is consumed; the body relies on clot formation being fast enough to seal the injury before this runaway process occurs."
  type: true-false
  answer: false
