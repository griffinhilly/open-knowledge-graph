...
- question: "Long-term potentiation (LTP) is a purely postsynaptic phenomenon — changes in synaptic strength during LTP involve mainly the postsynaptic cell's receptor number and conductance."
  type: true-false
  answer: false
