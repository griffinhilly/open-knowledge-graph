...
- question: "Once a motor unit is recruited, the only way to further increase force is to recruit additional motor units — changing the firing frequency of already-active units has no effect on force output."
  type: true-false
  answer: false
