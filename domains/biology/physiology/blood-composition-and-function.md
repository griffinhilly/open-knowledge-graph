...
- Mature human erythrocytes have no nucleus and cannot divide; they survive approximately 120 days and are recycled in the spleen and liver.
- Most leukocytes reside in tissues, not circulating blood — white blood cell counts in a blood draw represent only the circulating fraction.

## Questions

```yaml
- question: "A patient has very low albumin levels in their blood. Which consequence would you most directly expect?"
  type: multiple-choice
  options: ["Reduced oxygen-carrying capacity because albumin transports O₂", "Fluid leaking from blood vessels into surrounding tissues (edema), because osmotic pressure holding fluid in the vessels is reduced", "Increased clotting time because albumin is a clotting factor", "Elevated blood glucose because albumin normally signals insulin release"]
  answer: 1
  explanation: "Albumin is the primary plasma protein responsible for maintaining colloid osmotic (oncotic) pressure — the osmotic force that draws water back into capillaries from surrounding tissues. Without sufficient albumin, this force is reduced and fluid accumulates in tissues, causing edema. This is a clinically important consequence of liver disease (which synthesizes albumin) or severe malnutrition. Albumin does not carry O₂ (hemoglobin does), is not a clotting factor, and does not regulate insulin."

- question: "Mature human red blood cells contain a nucleus, which is why they can continuously produce hemoglobin throughout their 120-day lifespan."
  type: true-false
  answer: false
  explanation: "Mature human erythrocytes eject their nucleus during development in the bone marrow. The resulting anucleate cells cannot divide, repair themselves, or synthesize new proteins — they contain a fixed amount of hemoglobin from the time of maturation. This is actually a functional adaptation: removing the nucleus and other organelles maximizes the internal space available for hemoglobin and makes the cell highly deformable (able to squeeze through narrow capillaries). After ~120 days, worn-out erythrocytes are recycled by the spleen and liver."

- question: "Why is it misleading to equate 'white blood cell count' directly with the total number of leukocytes in the body?"
  type: short-answer
