...
- question: "Brainstem vital functions — breathing rhythm, heart rate, blood pressure — are largely autonomous and cannot be overridden or modified by higher brain centers like the cortex or hypothalamus."
  type: true-false
  answer: false
