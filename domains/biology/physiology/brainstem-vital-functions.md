...
- question: "Brainstem vital functions — breathing rhythm, heart rate, blood pressure — are largely autonomous and can rarely be overridden or modified by higher brain centers like the cortex or hypothalamus."
  type: true-false
  answer: false
