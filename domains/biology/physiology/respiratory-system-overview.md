...
- Breathing is not driven by 'suction' — the diaphragm enlarges the chest cavity and atmospheric pressure pushes air in; the lungs do not actively expand.
- Tidal volume during quiet breathing (~500 mL) uses only a fraction of lung capacity; large reserve volumes remain even at end of normal expiration.
- Respiratory bronchioles are part of the respiratory zone, not the conducting zone.

## Questions

```yaml
- question: "Which of the following best explains why air moves into the lungs during inspiration?"
  type: multiple-choice
  options: ["The lungs actively expand by contracting their smooth muscle walls", "The diaphragm contracts and increases thoracic volume, lowering intrapulmonary pressure below atmospheric pressure so air flows in", "The trachea dilates and creates a low-pressure zone that draws air inward", "Surfactant in the alveoli generates a pressure gradient that pulls air into the airways"]
  answer: 1
  explanation: "Inspiration is driven by Boyle's Law: when the diaphragm contracts and flattens, thoracic volume increases, which drops intrapulmonary pressure below atmospheric. Air then flows down its pressure gradient — from high (atmosphere) to low (lungs). The lungs themselves are passive; they expand because the chest wall pulls them outward."

- question: "The diaphragm actively 'sucks' air into the lungs during inspiration, similar to how a vacuum draws in fluid."
  type: true-false
  answer: false
  explanation: "The diaphragm does not suck air in — it contracts to enlarge the thoracic cavity, which reduces intrapulmonary pressure. Atmospheric pressure (external) then pushes air into the lungs to equalize the pressure difference. The mechanism is driven by a pressure gradient created by volume change, not by any active 'pulling' force from inside the lungs."

- question: "Why does pulmonary surfactant reduce the work of breathing?"
  type: short-answer
  answer: "Surfactant reduces surface tension in the alveolar fluid, which prevents alveoli from collapsing at the end of expiration and lowers the pressure needed to reinflate them during inspiration."
  explanation: "Without surfactant, the high surface tension of the liquid lining the alveoli would cause them to collapse (atelectasis) and require enormous effort to reopen. By lowering surface tension, surfactant makes the lungs more compliant — easier to inflate — and keeps alveoli partially open, preserving functional residual capacity between breaths."
```
