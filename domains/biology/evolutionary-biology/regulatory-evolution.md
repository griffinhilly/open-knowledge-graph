...
- question: "The near-identical protein-coding sequences of humans and chimpanzees (~99% similar) indicate that phenotypic differences between the two species is expected to arise primarily from differences in gene copy number rather than from gene regulation."
  type: true-false
  answer: false
