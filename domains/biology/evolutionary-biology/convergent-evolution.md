...
- question: "When two distantly related species share a similar trait, that trait must be the result of convergent evolution rather than inheritance from a common ancestor."
  type: true-false
  answer: false
