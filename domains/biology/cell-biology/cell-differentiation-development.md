...
- question: "Once a cell differentiates (e.g., into a liver cell), its gene expression pattern is permanently fixed — it can seldom be altered under any circumstances in the adult organism."
  type: true-false
  answer: false
