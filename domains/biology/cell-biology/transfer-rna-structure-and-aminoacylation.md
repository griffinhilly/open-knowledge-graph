...
- question: "Because each aminoacyl-tRNA synthetase should charge tRNAs with one specific amino acid, the error rate in aminoacylation is roughly 1 in 100 reactions — comparable to the error rate of DNA polymerase without proofreading."
  type: true-false
  answer: false
