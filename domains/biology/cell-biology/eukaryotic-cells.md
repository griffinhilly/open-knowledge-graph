...
- Not all eukaryotic cells have all organelles; red blood cells lack a nucleus and mitochondria at maturity.
- The endosymbiotic theory (mitochondria and chloroplasts as captured prokaryotes) is well-supported, not speculative.

## Questions

```yaml
- question: "Which feature most fundamentally distinguishes eukaryotic cells from prokaryotic cells?"
  type: multiple-choice
  options: ["Eukaryotic cells are always larger", "Eukaryotic cells have a membrane-bound nucleus", "Eukaryotic cells have ribosomes", "Eukaryotic cells have a cell wall"]
  answer: 1
