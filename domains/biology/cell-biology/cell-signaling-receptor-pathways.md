...
- question: "Some signaling receptors are located inside the cell rather than on the plasma membrane, but these primarily respond to signals synthesized within the cell."
  type: true-false
  answer: false
