...
- Children may not realize that plants need air too, not just sunlight and water.
- Some children think animals only need food and forget about water, air, and shelter.
- Children sometimes think toys or stuffed animals have needs like real living things.
...
- question: "What do all living things need to survive?"
  ...
  options: ["Only food", "Only sunlight", "Food, water, and air", "Toys and games"]
  answer: 2
  explanation: "All living things need food (or sunlight for plants), water, and air to survive. Some also need shelter. No living thing can survive on just one of these alone."

- question: "Plants do not need air to live."
  type: true-false
  answer: false
  explanation: "Plants do need air. They take in a gas from the air called carbon dioxide and use it to make their food. Even though they do not breathe like we do, air is important for plants."

- question: "What might happen to a plant if it does not get any water for a long time?"
  type: short-answer
  answer: "The plant would wilt, turn brown, and eventually die because it needs water to stay alive and grow."
  explanation: "Water is one of the basic needs of all living things. Without it, a plant cannot move nutrients through its body or make food. It will dry out, droop, and die."
```
