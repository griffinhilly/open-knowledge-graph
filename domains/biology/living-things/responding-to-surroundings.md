...
title: Responding to Surroundings
domain: biology
...
- Children may think only animals respond to things, not plants.
- Some children think a thermostat or motion-sensor light is "responding" like a living thing.
- Children may not realize that responding can be slow (a plant turning) or fast (a cat jumping).

## Questions

```yaml
- question: "A sunflower turns its face to follow the sun across the sky. What does this show?"
  type: multiple-choice
  options: ["The sunflower is confused", "The sunflower is responding to sunlight", "Someone is turning the sunflower", "The wind is pushing the sunflower"]
  answer: 1
...
- question: "Only animals can respond to their surroundings. Plants cannot."
  type: true-false
  answer: false
...
- question: "Give an example of an animal responding to something in its surroundings."
  type: short-answer
  answer: "A rabbit hearing a loud noise and running away to hide, or a dog wagging its tail when it sees its owner."
  explanation: "Animals are constantly responding to what happens around them. They react to sounds, sights, smells, temperature, and danger. These responses help them survive — running from danger, finding food, or staying warm."
```
