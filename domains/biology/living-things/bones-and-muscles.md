...
- Children may think bones are dead and dry (living bones are alive, with blood flowing through them).
- Some children think muscles only exist in your arms (muscles are everywhere in your body).
- Children may not understand that bones meet at joints, which is what lets you bend.

## Questions

```yaml
- question: "What would happen if you had no bones?"
  type: multiple-choice
  options: ["Nothing — you would be the same", "You would be floppy like a jellyfish because bones give your body its shape", "You would be stronger without bones", "You could still walk and run normally"]
  answer: 1
  explanation: "Without bones, your body would have no frame to hold it up. You would be soft and floppy and could not stand, walk, or even sit up. Bones are the hard structures that give your body its shape and let you stand upright."

- question: "Muscles push bones to make you move."
  type: true-false
  answer: false
  explanation: "Muscles pull on bones, not push them. When a muscle gets shorter (contracts), it pulls the bone it is attached to, which makes that body part move. That is why muscles work in pairs — one muscle pulls a bone one way, and another muscle pulls it back."

- question: "What do your ribs protect?"
  type: short-answer
  answer: "Your ribs protect your heart and lungs. They form a cage around these important organs in your chest."
  explanation: "The rib cage is a set of curved bones in your chest that surround and protect your heart and lungs — two organs you cannot live without. The skull does the same job for your brain. Many important bones exist not for movement but for protection."
```
