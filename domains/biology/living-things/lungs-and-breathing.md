...
- Children may think they breathe in only oxygen (air is mostly nitrogen; oxygen is about 21%).
- Some children think they breathe out oxygen too (they breathe out mostly carbon dioxide and nitrogen).
- Children may not realize that breathing happens automatically even when they are not thinking about it.

## Questions

```yaml
- question: "What gas does your body need from the air you breathe in?"
  type: multiple-choice
  options: ["Carbon dioxide", "Nitrogen", "Oxygen", "Helium"]
  answer: 2
  explanation: "Your body needs oxygen from the air. When you breathe in, air goes into your lungs, and the lungs pull out the oxygen and put it into your blood. Your blood then carries the oxygen to every part of your body."

- question: "You have to think about breathing or it will stop."
  type: true-false
  answer: false
  explanation: "Breathing happens automatically. Your brain controls your breathing without you having to think about it. That is why you keep breathing while you sleep, while you are distracted, and even when you are not paying attention to it at all."

- question: "Why do you breathe faster when you exercise?"
  type: short-answer
  answer: "When you exercise, your muscles need more oxygen for energy. You breathe faster to bring in more air so your lungs can give your blood more oxygen to deliver to your muscles."
  explanation: "Exercise makes your muscles work harder, and working muscles burn through oxygen quickly. Breathing faster brings more air into your lungs, which means more oxygen gets into your blood, which means more oxygen reaches your muscles. Your heart also beats faster to pump that oxygen-rich blood more quickly."
```
