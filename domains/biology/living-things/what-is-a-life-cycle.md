...
- Children may think a life cycle is only about one individual growing up (it includes producing the next generation).
- Some children think only animals have life cycles (plants do too).
- Children may not see the connection between the ending and beginning of a life cycle.

## Questions

```yaml
- question: "What makes a life cycle a 'cycle' instead of a straight line?"
  type: multiple-choice
  options: ["Because animals walk in circles", "Because the stages repeat — adults produce offspring that go through the same stages", "Because life cycles always take exactly one year", "Because every animal ends up back where it started"]
  answer: 1
...
- question: "What do all life cycles have in common?"
  type: short-answer
  answer: "All life cycles include being born or starting life, growing and developing, reaching adulthood, and producing offspring that start the cycle again."
  explanation: "Despite looking very different, every life cycle follows the same basic pattern: begin life, grow, reach maturity, reproduce. A sunflower and a whale have very different life cycles, but both go through these same core stages. That shared pattern is what makes them all 'life cycles.'"
```
