...
- Children often think flowers exist only to look pretty or smell nice.
- Some children think bees are only stinging pests and do not know they help plants.
- Children may not realize that pollen needs to travel between flowers for seeds to form.
...
- question: "Why do bees visit flowers?"
  ...
  options: ["To sting the flowers", "To collect sweet nectar and spread pollen", "To sleep inside the petals", "To eat the leaves"]
  answer: 1
...
- question: "What is pollination?"
  type: short-answer
  answer: "Pollination is when pollen moves from one flower to another, usually carried by bees, butterflies, or wind, so the flower can make seeds."
  explanation: "Pollination is a key step in a plant's life. Without it, most flowers cannot make seeds, and without seeds, no new plants can grow. Pollinators like bees are essential helpers in this process."
```
