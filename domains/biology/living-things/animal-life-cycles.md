...
- Children may think a life cycle is a straight line, not a circle that repeats through generations.
- Some children think all animals are born the same way (some hatch from eggs, some are born live).
- Children may not realize that growing up takes different amounts of time for different animals.

## Questions

```yaml
- question: "What are the basic stages in most animal life cycles?"
  type: multiple-choice
  options: ["Egg, baby, death", "Birth or hatching, growing up, becoming an adult, having babies", "Born, eating, sleeping", "Baby, playing, working"]
  answer: 1
...
- question: "Why is an animal's life cycle drawn as a circle instead of a straight line?"
  type: short-answer
  answer: "Because when an adult animal has babies, those babies grow up and have their own babies, starting the cycle over again. It keeps repeating across generations."
  explanation: "A life cycle is a circle because it does not really end. The adult has babies, those babies grow into adults, and those adults have babies. Each generation repeats the same stages. Drawing it as a circle shows that life continues from one generation to the next."
```
