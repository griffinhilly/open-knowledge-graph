...
- Children may think all eggs look like chicken eggs (eggs vary enormously in size and appearance).
- Some children think the baby animal is fully formed inside the egg from the start (it develops over time).
- Children may not realize that some eggs are laid in water (fish, frogs) while others are on land (birds, reptiles).

## Questions

```yaml
- question: "A frog lays eggs in a pond and a bird lays eggs in a nest. Why do they lay their eggs in different places?"
  type: multiple-choice
  options: ["Because frogs are messy", "Because frog eggs need water to keep them moist, and bird eggs have hard shells that protect them on land", "Because birds are afraid of water", "Because frogs cannot build nests"]
  answer: 1
...
- question: "A sea turtle lays about 100 eggs at once, but a bald eagle usually lays only 1-3 eggs. Why might there be such a big difference?"
  type: short-answer
  answer: "The sea turtle does not take care of her eggs or babies, so most will not survive — she needs to lay many for a few to make it. The eagle sits on her eggs, feeds her chicks, and protects them, so more of her few babies survive."
  explanation: "There is a trade-off between the number of offspring and the care given to each one. Animals that provide a lot of parental care can afford to have fewer offspring because each one has a good chance of surviving. Animals that provide no care must produce many offspring to ensure that at least some survive on their own."
```
