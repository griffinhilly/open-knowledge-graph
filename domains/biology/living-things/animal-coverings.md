...
- Children may think fur and hair are different things (they are the same material).
- Some children think all scales are the same (fish scales and reptile scales are quite different).
- Children may think feathers are only for flying (they also keep birds warm and dry).

## Questions

```yaml
- question: "A polar bear has thick white fur. How does this help it survive?"
  type: multiple-choice
  options: ["The fur makes it look pretty", "The thick fur keeps it warm in the freezing cold", "The fur helps it swim faster", "The fur helps it see in the dark"]
  answer: 1
  explanation: "Polar bears live in the Arctic where it is extremely cold. Their thick fur acts like a warm coat, trapping heat close to their body. The white color also helps them blend in with the snow, but staying warm is the main job of all that thick fur."

- question: "Fish scales and bird feathers do the same job."
  type: true-false
  answer: false
  explanation: "Fish scales and bird feathers are both body coverings, but they do different jobs. Fish scales protect the fish's body and help it slide smoothly through water. Bird feathers keep birds warm, help them fly, and keep water off their skin. Different coverings for different needs."

- question: "What body covering do all birds have that no other animal group has?"
  type: short-answer
  answer: "Feathers. Only birds have feathers."
  explanation: "Feathers are unique to birds. No mammals, reptiles, fish, or insects have feathers. Feathers help birds fly, stay warm, and stay dry. Even birds that cannot fly, like penguins, still have feathers."
```
