...
- Children may think "herb" only means cooking herbs like basil and rosemary.
- Some children think all tall plants are trees (bamboo is actually a giant grass).
- Children may not realize that trees start as tiny seedlings and grow over many years.

## Questions

```yaml
- question: "What is the main difference between a tree and an herb?"
  type: multiple-choice
  options: ["Trees are green and herbs are brown", "Trees have hard, woody trunks and herbs have soft, green stems", "Trees have leaves and herbs do not", "Trees are always taller than buildings"]
  answer: 1
  explanation: "The big difference is the stem. Trees have thick, hard, woody trunks that last for many years. Herbs have soft, bendable, green stems. Both have leaves, and both can be green — the stem type is the key difference."

- question: "A rosebush is a tree because it has woody stems."
  type: true-false
  answer: false
  explanation: "A rosebush has woody stems, but it is a shrub, not a tree. Shrubs are shorter than trees and have many stems coming from the ground instead of one main trunk. Trees have a single thick trunk."

- question: "Give one example of a tree, one example of a shrub, and one example of an herb."
  type: short-answer
  answer: "Tree: oak or maple. Shrub: rosebush or blueberry bush. Herb: grass, daisy, or tomato plant."
  explanation: "Trees like oaks have one thick trunk and grow very tall. Shrubs like rosebushes have multiple woody stems and stay shorter. Herbs like daisies have soft green stems and are usually the smallest. All three are plants, but they grow in different ways."
```
