...
- Children may think all animals that live in water swim the same way (some use fins, some use tentacles, some use flippers).
- Some children think snakes cannot move without legs (they use their muscles and scales).
- Children may not realize some animals move in more than one way (ducks walk, swim, and fly).

## Questions

```yaml
- question: "A duck can walk on land, swim in a pond, and fly through the air. How many ways can it move?"
  type: multiple-choice
  options: ["One way", "Two ways", "Three ways", "Ducks cannot fly"]
  answer: 2
...
- question: "How does the way a fish moves differ from the way a bird moves?"
  type: short-answer
  answer: "A fish swims through water by moving its fins and tail back and forth. A bird flies through air by flapping its wings up and down."
  explanation: "Fish and birds move through different environments — water and air — so their bodies are built differently. Fish have streamlined bodies and fins for pushing through water. Birds have lightweight bodies and wings with feathers for pushing through air. Both are beautifully adapted to their surroundings."
```
