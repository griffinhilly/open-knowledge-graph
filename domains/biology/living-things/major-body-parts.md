...
- Young children may not know where internal organs are located (like the heart or lungs).
- Some children think their stomach is anywhere on their front side, not a specific organ.
- Children may not realize their body parts work together as a team.

## Questions

```yaml
- question: "Which body part do you use to pump blood all through your body?"
  type: multiple-choice
  options: ["Your brain", "Your lungs", "Your heart", "Your stomach"]
  answer: 2
  explanation: "Your heart is a muscle in your chest that pumps blood to every part of your body. The blood carries oxygen and nutrients to your muscles, brain, and everywhere else. Your heart beats all day and all night without stopping."

- question: "Your brain is in your chest."
  type: true-false
  answer: false
  explanation: "Your brain is in your head, protected by your skull (the hard bones of your head). Your chest holds your heart and lungs, not your brain."

- question: "Name three parts of your body and tell what each one does."
  type: short-answer
  answer: "Eyes let you see, hands let you grab and hold things, and legs let you walk and run."
  explanation: "Every body part has a job. Eyes take in light so you can see the world. Hands have fingers that can grip, pinch, and hold things. Legs have strong muscles and joints that let you stand, walk, run, and jump. All the parts work together to help you do everything you do each day."
```
