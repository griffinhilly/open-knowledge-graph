...
title: Fruits and Seed Dispersal
domain: biology
...
- Children may not realize that fruits like tomatoes, cucumbers, and peppers are actually fruits (they contain seeds).
- Some children think seeds just fall straight down beneath the parent plant.
- Children may think only sweet, tasty things are fruits.

## Questions

```yaml
- question: "Why is it helpful for seeds to travel far from the parent plant?"
  type: multiple-choice
  options: ["So the seeds can see new places", "So the baby plants have more room, sunlight, and water", "So the parent plant can be alone", "So animals can eat all of them"]
  answer: 1
  explanation: "If all the seeds fell right under the parent plant, the baby plants would be crowded together and would have to compete for sunlight, water, and soil. Spreading out gives each new plant a better chance to get what it needs to grow."

- question: "A tomato is not a fruit because it is not sweet."
  type: true-false
  answer: false
  explanation: "A tomato is a fruit because it grows from a flower and has seeds inside. In science, a fruit is any part of a plant that holds seeds. Sweetness does not matter — tomatoes, peppers, and cucumbers are all fruits even though we eat them like vegetables."

- question: "Name two ways that seeds can travel away from the parent plant."
  type: short-answer
  answer: "Seeds can travel by wind (like dandelion fluff floating through the air) and by sticking to animal fur (like burrs on a dog's coat)."
  explanation: "Seeds have many ways of traveling. Wind carries light, fluffy seeds like dandelions. Animals carry seeds that stick to fur or that are eaten in fruits and dropped elsewhere. Water carries seeds that float. Some seed pods even pop open and fling seeds outward."
```
