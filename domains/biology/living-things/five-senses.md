...
- Children may think they use only one sense at a time (most experiences involve multiple senses working together).
- Some children think the tongue only tastes sweet things.
- Children may not realize that touch happens with skin all over the body, not just the hands.

## Questions

```yaml
- question: "Which sense tells you that a fire truck is loud?"
  type: multiple-choice
  options: ["Sight — your eyes", "Hearing — your ears", "Touch — your skin", "Smell — your nose"]
  answer: 1
...
- question: "You are eating an apple. Which senses are you using?"
  type: short-answer
  answer: "You use sight to see the apple, touch to feel its smooth skin, taste to know it is sweet, smell to notice its scent, and hearing to hear the crunch when you bite it."
  explanation: "Eating an apple uses all five senses at once! Most experiences involve more than one sense working together. Your brain combines information from all your senses to give you a complete picture of what is happening."
```
