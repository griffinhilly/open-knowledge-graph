...
- Children may think all water habitats are the same (salt vs. fresh water makes a huge difference).
- Some children think ponds are just small oceans.
- Children may not realize that many pond creatures (like tadpoles) eventually leave the water.

## Questions

```yaml
- question: "What is the main difference between ocean water and pond water?"
  type: multiple-choice
  options: ["Ocean water is blue and pond water is green", "Ocean water is salty and pond water is fresh (not salty)", "Pond water is deeper than ocean water", "There is no difference"]
  answer: 1
  explanation: "Ocean water contains a lot of salt, which is why it tastes salty if you accidentally swallow some. Pond water is fresh water — it has no salt. This difference is very important because most animals can only live in one type of water, not both."

- question: "A goldfish from a pet store could survive if you put it in the ocean."
  type: true-false
  answer: false
  explanation: "Goldfish are freshwater fish — their bodies are designed for water without salt. Ocean water is very salty, and putting a freshwater fish in salt water would harm it. Fish are adapted to the specific type of water in their habitat."

- question: "Name one animal you might find in an ocean and one you might find in a pond."
  type: short-answer
  answer: "Ocean: a sea turtle or a clownfish. Pond: a frog or a dragonfly."
  explanation: "Oceans and ponds each have their own sets of animals. Oceans are home to sea turtles, sharks, whales, jellyfish, and coral. Ponds are home to frogs, tadpoles, dragonflies, turtles, fish like bass and bluegill, and many insects."
```
