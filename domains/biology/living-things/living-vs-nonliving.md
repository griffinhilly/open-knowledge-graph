...
- Children often think cars are alive because they move.
- Fire can seem alive because it grows, moves, and "eats" wood.
- Some children think dead leaves are nonliving because they are no longer growing.
...
- question: "Which of these is a living thing?"
  ...
  options: ["A rock", "A flower", "A toy truck", "A puddle of water"]
  answer: 1
  explanation: "A flower is alive because it grows, needs water and sunlight, and can make seeds to create new flowers. Rocks, toys, and water do not grow or need food."

- question: "A car is alive because it moves."
  type: true-false
  answer: false
  explanation: "A car moves, but it is not alive. It does not grow, eat, or make baby cars on its own. A person has to drive it and put gas in it. Moving does not mean something is alive."

- question: "Name two things that living things do that nonliving things do not."
  type: short-answer
  answer: "Living things grow and need food and water. They can also have babies or make seeds."
  explanation: "Living things share certain needs and abilities: they grow bigger over time, they need food and water to survive, and they can reproduce. Nonliving things like rocks and chairs do none of these things on their own."
```
