...
- Children may think individual animals choose or decide to adapt (adaptations develop over many generations, not during one lifetime).
- Some children think adaptations are only physical features (behaviors like migration are adaptations too).
- Children may think all animals in the same habitat look the same.

## Questions

```yaml
- question: "A duck has webbed feet. How does this adaptation help it?"
  type: multiple-choice
  options: ["Webbed feet help it fly faster", "Webbed feet help it dig burrows", "Webbed feet work like paddles to help it swim", "Webbed feet keep it warm"]
  answer: 2
  explanation: "A duck's webbed feet spread out wide in the water and work like paddles, pushing water backward so the duck can swim forward. This is an adaptation for living in water — ducks spend a lot of time in ponds and lakes, so having built-in paddles makes them excellent swimmers."

- question: "A giraffe grew a long neck during its own lifetime by stretching to reach tall trees."
  type: true-false
  answer: false
  explanation: "Giraffes do not grow long necks by stretching. Long necks developed over many, many generations. Giraffes that happened to have slightly longer necks could reach more food and survived better, and they passed that trait to their babies. Over thousands of generations, the necks got longer. Adaptations happen over generations, not within a single lifetime."

- question: "What is camouflage, and how does it help an animal survive?"
  type: short-answer
  answer: "Camouflage is when an animal's color or pattern blends in with its surroundings, making it hard to see. This helps it hide from predators or sneak up on prey."
  explanation: "Camouflage is one of the most common adaptations. A green frog in green grass is hard for a snake to spot. A brown moth on tree bark is nearly invisible to birds. A tiger's stripes break up its outline in tall grass. Blending in helps prey hide and helps predators sneak up on food."
```
