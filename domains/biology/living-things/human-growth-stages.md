---
id: human-growth-stages
title: Human Growth Stages
domain: biology
...
- Children may think growth only means getting taller (it also includes gaining new abilities and changes in how the body works).
- Some children think adults never change (adults age and their bodies continue to change).
- Children may not realize that people grow at different speeds — some children are taller at age 8 and some are shorter, and both are normal.

## Questions

```yaml
- question: "Which of these can a 5-year-old do that a baby cannot?"
  type: multiple-choice
  options: ["Breathe", "Walk, talk, and feed themselves", "Sleep", "Cry"]
  answer: 1
  explanation: "Both babies and 5-year-olds breathe, sleep, and cry. But a 5-year-old can walk, talk, and feed themselves — skills that develop as the child grows. Babies need to be carried, cannot speak in words yet, and need someone to feed them. Growth brings new abilities."

- question: "Once you become an adult, your body stops changing."
  type: true-false
  answer: false
  explanation: "Adults continue to change throughout their lives. Hair may turn gray, skin develops wrinkles, and bodies may become less flexible. Adults also continue to learn and change on the inside — gaining wisdom, new skills, and memories. Change is part of every stage of life."

- question: "Name three things that change as a person grows from a baby to an adult."
  type: short-answer
  answer: "They get taller and heavier, they learn to walk and talk, and their body grows stronger with bigger bones and muscles."
  explanation: "Growth involves many kinds of change. Physical changes include getting taller, heavier, and stronger. Skill changes include learning to walk, talk, read, and solve problems. Social changes include making friends, going to school, and eventually being able to take care of yourself and others."
```
