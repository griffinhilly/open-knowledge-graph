...
- Children may think the brain only does thinking and does not control physical movement.
- Some children think messages travel instantly (they are fast but not instant — that is why reaction time exists).
- Children may not realize the brain works even when they are asleep (it controls breathing, heartbeat, and dreaming).

## Questions

```yaml
- question: "You touch a hot stove and pull your hand away quickly. What sent the message from your hand to your brain?"
  type: multiple-choice
  options: ["Your blood", "Your bones", "Your nerves", "Your muscles"]
  answer: 2
  explanation: "Nerves in your hand felt the heat and sent a fast message to your brain saying 'this is hot!' Your brain then sent a message back through nerves to your arm muscles saying 'pull away!' This all happens in a split second."

- question: "Your brain stops working when you fall asleep."
  type: true-false
  answer: false
  explanation: "Your brain keeps working while you sleep. It keeps your heart beating, your lungs breathing, and your body temperature steady. It also processes memories and creates dreams. Your brain never fully stops — it is always on duty."

- question: "What do nerves do in your body?"
  type: short-answer
  answer: "Nerves carry messages between your brain and the rest of your body, like wires carrying signals. They tell your brain what you are sensing and carry your brain's instructions to your muscles."
  explanation: "Nerves are like a communication network. Sensory nerves carry information from your eyes, ears, skin, and other sense organs to your brain. Motor nerves carry instructions from your brain to your muscles, telling them when and how to move. Without nerves, your brain would be disconnected from your body."
```
