...
- Children may think seeds need sunlight to germinate (most do not — they need light after sprouting).
- Some children think bigger seeds make bigger plants.
- Children may not realize there is a tiny plant already inside the seed.
...
- question: "What does a seed need to start growing?"
  ...
  options: ["Sunlight and soil only", "Water, warmth, and air", "Nothing — seeds grow on their own", "Fertilizer and a pot"]
  answer: 1
  explanation: "Seeds need water, warmth, and air to germinate. Sunlight is not needed until after the seed sprouts and the little plant needs to make food with its leaves. The seed has its own food supply packed inside."

- question: "A seed has a tiny baby plant inside it."
  type: true-false
  answer: true
  explanation: "Inside every seed is a tiny baby plant called an embryo, along with stored food to help it start growing. When conditions are right, this baby plant breaks out of the seed coat and begins to grow."

- question: "What happens first when a seed germinates — does the root or the stem come out first?"
  type: short-answer
  answer: "The root comes out first. It pushes downward into the soil to anchor the plant and start soaking up water."
  explanation: "During germination, the root always emerges first because the baby plant needs water right away. The root grows down into the soil, and then the stem pushes up toward the surface to reach the light."
```
