---
id: seasons-and-animal-behavior
title: Seasons and Animal Behavior
domain: biology
...
- Children may think all animals hibernate in winter (only some do).
- Some children think hibernating animals are just sleeping normally (hibernation is much deeper than regular sleep).
- Children may think birds fly south because they do not like the cold (they leave because food disappears).

## Questions

```yaml
- question: "Why do many birds fly south in the fall?"
  type: multiple-choice
  options: ["Because they get bored in one place", "Because the bugs and seeds they eat disappear in winter, so they fly to where food is still available", "Because they want to see different places", "Because other birds tell them to"]
  answer: 1
  explanation: "Birds migrate mainly because of food, not temperature. When winter comes, insects die or hide, plants stop producing seeds, and the ground freezes. Birds fly to warmer areas where food is still plentiful. In spring, they fly back when food returns."

- question: "Hibernation is just like regular sleep."
  type: true-false
  answer: false
  explanation: "Hibernation is very different from normal sleep. During hibernation, an animal's body temperature drops dramatically, its heart rate slows way down, and its breathing becomes very slow. The animal barely uses any energy at all. A hibernating bear might breathe only once every few minutes. Normal sleep is nothing like this."

- question: "Name two different ways animals deal with winter."
  type: short-answer
  answer: "Some animals migrate to warmer places (like geese flying south), and some hibernate through the cold months (like bears sleeping in their dens)."
  explanation: "Animals have different strategies for surviving winter. Migration means traveling to a warmer area with more food. Hibernation means going into a deep, energy-saving sleep until spring. Other strategies include storing food in advance (like squirrels), growing thicker fur (like rabbits and deer), and changing color to blend in with snow (like arctic hares)."
```
