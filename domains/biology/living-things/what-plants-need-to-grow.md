...
- Children may think soil is the plant's food (soil provides minerals, but the plant makes its own food from sunlight).
- Some children forget that plants need air.
- Children may think watering more always means the plant grows faster (too much water can kill a plant).

## Questions

```yaml
- question: "A plant is kept in a dark closet with plenty of water and soil. What will happen?"
  type: multiple-choice
  options: ["It will grow normally", "It will grow but look pale and weak because it needs sunlight", "Nothing will change", "It will grow faster in the dark"]
  answer: 1
  explanation: "Without sunlight, a plant cannot make food in its leaves. It may sprout and stretch toward any light it can find, but it will be pale, thin, and weak. Plants need sunlight to grow healthy and strong."

- question: "Soil is the food that plants eat."
  type: true-false
  answer: false
  explanation: "Plants do not eat soil. They make their own food using sunlight, water, and air inside their leaves. Soil provides minerals and nutrients that help the plant, and it holds the roots in place, but it is not the plant's food."

- question: "Why do plants need sunlight?"
  type: short-answer
  answer: "Plants need sunlight because they use it as energy to make food inside their leaves."
  explanation: "Sunlight powers the food-making process in a plant's leaves. Without sunlight, the plant cannot produce the sugars it needs to grow, build new leaves, and stay healthy. That is why plants near windows grow toward the light."
```
