...
- Children often forget about roots because they are hidden underground.
- Some children think the stem is just for holding the plant up, not for carrying water.
- Children may not know that not all plants have flowers.

## Questions

```yaml
- question: "Which part of a plant soaks up water from the soil?"
  type: multiple-choice
  options: ["The leaves", "The flower", "The roots", "The stem"]
  answer: 2
  explanation: "The roots are underground and their job is to soak up water and nutrients from the soil. The water then travels up through the stem to the rest of the plant."

- question: "Leaves are where a plant catches sunlight to make food."
  type: true-false
  answer: true
  explanation: "Leaves are like little food factories. They use sunlight, water, and air to make the food the plant needs to grow. That is why most leaves are flat and wide — to catch as much sunlight as possible."

- question: "What is the job of the stem?"
  type: short-answer
  answer: "The stem holds the plant up and carries water from the roots to the leaves and flowers."
  explanation: "The stem is like a highway for the plant. It keeps the plant standing tall so the leaves can reach the sunlight, and it has tiny tubes inside that carry water and nutrients up from the roots to every part of the plant."
```
