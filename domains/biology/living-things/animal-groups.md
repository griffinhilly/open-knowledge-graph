...
- Children often think whales and dolphins are fish because they live in water (they are mammals).
- Some children think all animals that fly are birds (bats are mammals, butterflies are insects).
- Children may think snakes are slimy (reptile scales are actually dry).

## Questions

```yaml
- question: "A penguin has feathers and lays eggs. What animal group does it belong to?"
  type: multiple-choice
  options: ["Fish, because it swims", "Mammal, because it is cute", "Bird, because it has feathers", "Reptile, because it waddles"]
  answer: 2
  explanation: "Penguins are birds because they have feathers and lay eggs. Even though they cannot fly and they swim very well, having feathers is the key feature that makes an animal a bird."

- question: "A whale is a fish because it lives in the ocean."
  type: true-false
  answer: false
  explanation: "Whales live in the ocean, but they are mammals, not fish. Whales breathe air with lungs (they come to the surface to breathe), they are warm-blooded, they have a little bit of hair, and mother whales feed milk to their babies. Fish breathe through gills and have scales."

- question: "How can you tell if an animal is an insect?"
  type: short-answer
  answer: "An insect has six legs and a body divided into three parts (head, middle, and back). Most insects also have wings."
  explanation: "The easiest way to identify an insect is to count its legs — insects always have exactly six. Their body has three sections: the head, the thorax (middle), and the abdomen (back). Spiders have eight legs, so they are not insects."
```
