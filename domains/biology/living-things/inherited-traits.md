...
prerequisites:
- id: animal-babies-and-parents
  type: hard
- id: comparing-life-cycles
  type: soft
builds-toward:
- mendelian-genetics
tags:
...
- Children may think they should look exactly like one parent (traits come from both parents in a mix).
- Some children confuse inherited traits with learned behaviors (speaking English is learned, eye color is inherited).
- Children may think siblings should look identical since they have the same parents (siblings get different combinations of traits).

## Questions

```yaml
- question: "A mother dog has brown fur and a father dog has black fur. Their puppy has brown fur. Where did the puppy get its brown fur?"
  type: multiple-choice
  options: ["It chose brown because it is a nicer color", "It inherited the brown fur trait from its mother", "Someone painted the puppy brown", "Brown fur comes from eating certain foods"]
  answer: 1
  explanation: "The puppy inherited its brown fur from its mother. Traits like fur color are passed from parents to offspring. The puppy got traits from both parents, and in this case, the brown fur trait showed up instead of the black fur trait."

- question: "Speaking English is an inherited trait."
  type: true-false
  answer: false
  explanation: "Speaking a language is learned, not inherited. A baby born to English-speaking parents who is raised by Japanese-speaking parents will speak Japanese. Inherited traits are physical features like eye color, hair type, and body shape — things you are born with and did not learn."

- question: "Why do brothers and sisters sometimes look different from each other even though they have the same parents?"
  type: short-answer
  answer: "Each child gets a different combination of traits from their parents. One child might get the mother's eye color and the father's hair color, while another child gets a different mix."
  explanation: "Parents have many traits to pass on, and each child gets a unique combination. Think of it like shuffling a deck of cards — the same cards are available, but each hand dealt is different. That is why siblings can look similar but not identical (unless they are identical twins)."
```
