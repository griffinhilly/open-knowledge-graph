...
- Children may think predators are "bad" and prey are "good" (predators are necessary for keeping nature balanced).
- Some children think an animal is always a predator or always prey (many animals are both).
- Children may not realize that predators do not always catch their prey — many hunts fail.

## Questions

```yaml
- question: "A hawk has sharp talons, a hooked beak, and eyes that face forward. What do these features help it do?"
  type: multiple-choice
  options: ["Swim in rivers", "Catch and eat prey", "Build a nest", "Hide from danger"]
  answer: 1
  explanation: "A hawk's sharp talons grab prey, its hooked beak tears meat, and its forward-facing eyes help it judge distance accurately when diving at prey. These are all predator features — body parts designed for hunting."

- question: "Predators are mean animals that should be removed from nature."
  type: true-false
  answer: false
  explanation: "Predators are an important part of nature. Without them, prey animals like rabbits and deer would multiply too fast and eat all the plants. Predators keep the populations of other animals in balance. They are not mean — they are just eating what they need to survive."

- question: "How do the eyes of a predator and the eyes of a prey animal differ, and why?"
  type: short-answer
  answer: "Predator eyes face forward to focus on prey and judge distance. Prey eyes are on the sides of the head to see in almost every direction and spot danger coming."
  explanation: "Forward-facing eyes give predators depth perception — the ability to judge how far away something is, which is crucial for pouncing or diving accurately. Side-facing eyes give prey a wide field of vision so they can watch for danger coming from almost any direction, even behind them."
```
