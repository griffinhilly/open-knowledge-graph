...
- Children may think deserts are always hot (some deserts, like the Gobi, are very cold).
- Some children think nothing lives in deserts (many animals and plants are adapted to desert life).
- Children may think all forests look the same (tropical rainforests and snowy pine forests are very different).

## Questions

```yaml
- question: "Why do many desert animals come out mostly at night?"
  type: multiple-choice
  options: ["Because they are afraid of the sun", "Because the desert is cooler at night, so they save water and energy", "Because they cannot see during the day", "Because there is more food at night"]
  answer: 1
  explanation: "Deserts can be scorching hot during the day. Many desert animals, like foxes and mice, come out at night when it is cooler. This helps them avoid the extreme heat and lose less water from their bodies. Staying cool is a survival strategy in the desert."

- question: "Deserts have no living things because they are too dry."
  type: true-false
  answer: false
  explanation: "Deserts have many living things that are adapted to dry conditions. Cactuses store water inside their thick stems. Camels can go long periods without drinking. Lizards and snakes have scaly skin that holds in moisture. Desert life is tough but not impossible."

- question: "Name one way that forests and deserts are different and one way they are the same."
  type: short-answer
  answer: "Different: forests get lots of rain and have many tall trees, while deserts get very little rain and have few trees. Same: both are habitats where plants and animals live and find what they need to survive."
  explanation: "The biggest difference is water — forests are wet and deserts are dry. This affects everything else: what plants grow, what animals live there, and how they survive. But they are the same in being habitats that support communities of living things adapted to their conditions."
```
