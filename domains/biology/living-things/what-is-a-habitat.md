...
- Children may think animals can live happily in any habitat (a fish cannot survive in a desert).
- Some children confuse habitat with home (a habitat is the whole area, not just a nest or burrow).
- Children may not realize that a habitat can be very small (like under a log) or very large (like an ocean).

## Questions

```yaml
- question: "A polar bear lives in the Arctic. Why would it not survive in a desert?"
  type: multiple-choice
  options: ["Because it is too big", "Because deserts do not have the cold temperatures, ice, and prey that polar bears need", "Because polar bears do not like sand", "Because deserts have no animals"]
  answer: 1
  explanation: "A polar bear is adapted to its Arctic habitat — it has thick fur for extreme cold, white coloring to blend in with snow, and it hunts seals in icy water. A hot desert has none of these things. Every animal needs the specific conditions of its own habitat to survive."

- question: "A habitat is just another word for an animal's nest or burrow."
  type: true-false
  answer: false
  explanation: "A habitat is much bigger than a nest or burrow. It is the whole area where the animal lives and finds everything it needs — food, water, shelter, and space. A bird's habitat might be the whole forest; the nest is just one small part of it."

- question: "What are the four things a habitat must provide for a living thing to survive?"
  type: short-answer
  answer: "A habitat must provide food, water, shelter, and space."
  explanation: "Every living thing needs these four things from its habitat. Food provides energy, water keeps the body working, shelter protects from weather and predators, and space gives room to move, find food, and raise young. If any one of these is missing, the habitat cannot support that living thing."
```
