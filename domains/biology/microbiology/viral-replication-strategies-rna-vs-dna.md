...
- question: "HIV achieves persistent lifelong infection by integrating into the host chromosome as a provirus; antiretroviral drugs that block reverse transcription will eliminate the integrated provirus from most infected cells."
  type: true-false
  answer: false
