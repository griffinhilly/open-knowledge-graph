...
- question: "Transformation, like conjugation, requires direct cell-to-cell contact — naturally competent bacteria is expected to touch the donor cell to take up DNA through specialized surface structures."
  type: true-false
  answer: false
