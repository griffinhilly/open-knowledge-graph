...
- Thinking bacteria have no organization because they lack organelles — they have highly organized internal structure, just no membrane-bound compartments.
- Confusing the cell wall with the cell membrane — the wall provides structural rigidity, while the membrane controls what enters and exits.
- Believing all bacteria have flagella — many species are non-motile.
- Assuming Gram-negative bacteria have no peptidoglycan — they do, just a thinner layer sandwiched between two membranes.

## Questions

```yaml
- question: "Which of the following best describes what the Gram stain reveals about bacterial cell structure?"
  type: multiple-choice
  options:
    - "Whether the bacterium has flagella for motility"
    - "The thickness of the peptidoglycan layer and presence of an outer membrane"
    - "Whether the bacterium carries plasmids"
...
- question: "What is the functional difference between the bacterial cell wall and the cell membrane?"
  type: short-answer
  answer: "The cell wall provides structural rigidity and protects against osmotic lysis; the cell membrane (plasma membrane) controls selective transport of molecules into and out of the cell."
  explanation: "These are two distinct layers with different roles. The peptidoglycan wall is a structural scaffold — it gives the bacterium its shape and resists bursting under osmotic pressure. The lipid bilayer membrane beneath it is the true permeability barrier, regulating what enters (nutrients) and exits (waste, secreted proteins) via channels, pumps, and passive diffusion."
```
