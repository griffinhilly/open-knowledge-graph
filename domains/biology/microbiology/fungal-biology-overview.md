...
- Classifying fungi as plants — fungi lack chlorophyll and cannot photosynthesize; they are a separate kingdom.
- Thinking all fungi are multicellular — yeasts are single-celled fungi.
- Assuming all molds are harmful — many are essential decomposers and some produce antibiotics.
- Confusing fungal spores with bacterial endospores — fungal spores are reproductive structures, while bacterial endospores are survival structures.

## Questions

```yaml
- question: "A patient has a serious fungal infection. The physician prescribes an antibiotic that works by inhibiting peptidoglycan synthesis. What will happen?"
  type: multiple-choice
  options:
    - "The infection will clear because all microorganisms have cell walls"
    - "The treatment will fail because fungi use chitin, not peptidoglycan, in their cell walls"
    - "The treatment will partially work because fungi share some bacterial cell wall components"
    - "The treatment will work but only against yeast forms, not mold forms"
  answer: 1
  explanation: "Fungi build their cell walls from chitin, not peptidoglycan — the polymer that bacterial cell wall antibiotics (like penicillin and vancomycin) specifically target. An antibiotic that disrupts peptidoglycan synthesis has no target in a fungal cell. This is precisely why antifungal drugs must exploit other vulnerabilities unique to fungi, such as ergosterol in the fungal membrane. Mixing up the cell wall chemistry leads directly to treatment failure."

- question: "Which of the following correctly describes how fungi differ from both bacteria AND plants?"
  type: multiple-choice
  options:
    - "Fungi are unicellular and reproduce by binary fission, unlike both bacteria and plants"
    - "Fungi are eukaryotes that cannot photosynthesize and use absorptive nutrition instead of ingestion"
    - "Fungi have no cell wall, which is what distinguishes them from the walled cells of bacteria and plants"
    - "Fungi reproduce exclusively sexually, which sets them apart from the asexual reproduction of bacteria and plants"
  answer: 1
  explanation: "Fungi are eukaryotic (unlike bacteria, which are prokaryotic) but cannot photosynthesize (unlike plants). They are heterotrophs that digest food externally and absorb the products — a strategy called absorptive nutrition. Option A is wrong (fungi can be multicellular and don't divide by binary fission). Option C is wrong (fungi have cell walls — made of chitin). Option D is wrong (fungi reproduce both sexually and asexually)."

- question: "Fungal spores and bacterial endospores serve fundamentally different biological functions."
  type: true-false
  answer: true
