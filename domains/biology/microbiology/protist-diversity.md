...
title: Protist Diversity and Classification
domain: biology
course: microbiology
prerequisites:
...
- Assuming protists are "simple" organisms because they are single-celled — many protists have extraordinarily complex internal organization, including contractile vacuoles, multiple nuclei, and photosynthetic organelles acquired through serial endosymbiosis.
- Treating protists as a coherent evolutionary group (a single kingdom) — molecular evidence shows they are polyphyletic, meaning the category is a convenience label for eukaryotes that don't fit elsewhere, not a clade with a single common ancestor.
- Believing all protists are microscopic — giant kelp (brown algae) can exceed 45 meters in length and is classified among the protists, not the plants.
