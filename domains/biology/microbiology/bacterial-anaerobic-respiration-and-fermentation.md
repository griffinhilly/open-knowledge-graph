...
- question: "Anaerobic respiration and fermentation are two names for the same process — both generate ATP in the absence of oxygen, differing mainly in which molecules accept electrons."
  type: true-false
  answer: false
