...
- question: "Autotrophy is defined by how an organism obtains energy — autotrophs make their own energy from sunlight or inorganic compounds, while heterotrophs should consume energy from organic compounds."
  type: true-false
  answer: false
