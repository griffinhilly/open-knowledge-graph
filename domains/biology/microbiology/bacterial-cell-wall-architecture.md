...
- question: "Gram-negative bacteria are harder to treat with many antibiotics than gram-positive bacteria because they have a thicker peptidoglycan layer that antibiotics should penetrate."
  type: true-false
  answer: false
