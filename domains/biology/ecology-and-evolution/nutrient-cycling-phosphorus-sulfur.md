...
title: 'Nutrient Cycling: Phosphorus and Sulfur Cycles'
domain: biology
...
```yaml
- question: "A freshwater lake near intensive farmland develops severe algal blooms after years of agricultural runoff. The limiting nutrient responsible is most likely:"
  type: multiple-choice
  options:
    - "Nitrogen — because nitrogen fixation makes it highly mobile and easily transported from agricultural soils to lakes"
    - "Phosphorus — because it is the limiting nutrient in most freshwater ecosystems and has no atmospheric reservoir, so agricultural runoff delivers phosphate that was previously scarce, triggering explosive algal growth"
    - "Carbon — because agricultural CO₂ emissions dissolve in the lake and fertilize photosynthesis"
    - "Sulfur — because acid rain from SO₂ emissions destroys competitors of algae and releases sulfur nutrients"
  answer: 1
...
- question: "Why can't terrestrial ecosystems replenish phosphorus the same way they replenish nitrogen after phosphorus is exported to deep ocean sediments?"
  type: multiple-choice
  options:
    - "Phosphorus is chemically inert and cannot be processed by soil bacteria the way nitrogen can"
    - "There is no atmospheric reservoir for phosphorus and no biological process equivalent to nitrogen fixation — phosphorus locked in deep sediment can only return via tectonic uplift over millions of years"
    - "Phosphorus bonds irreversibly with calcium in ocean water and can never be recycled under any conditions"
    - "Decomposers cannot break down phosphorus compounds, so phosphorus is lost at every trophic level"
  answer: 1
...
- question: "Unlike the nitrogen cycle, the phosphorus cycle has no significant atmospheric phase, making phosphorus unavailable through atmospheric deposition in most ecosystems."
  type: true-false
  answer: true
