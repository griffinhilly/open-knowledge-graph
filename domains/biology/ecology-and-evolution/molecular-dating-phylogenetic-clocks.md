...
- question: "When molecular dating estimates disagree with paleontological divergence dates, the molecular clock estimate should always be trusted over the fossil record, because molecules provide more direct evidence of evolutionary time."
  type: true-false
  answer: false
