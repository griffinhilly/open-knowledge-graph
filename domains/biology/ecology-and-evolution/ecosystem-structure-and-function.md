...
```yaml
- question: "Which of the following best explains why decomposers are as essential to ecosystem function as primary producers?"
  type: multiple-choice
  options:
    - "Decomposers convert sunlight into chemical energy, supporting all other trophic levels"
    - "Decomposers recycle nutrients from dead organic matter back into forms that producers can absorb, preventing permanent nutrient lock-up"
    - "Decomposers are the most abundant organisms by biomass in all ecosystems"
    - "Decomposers regulate consumer population sizes by removing diseased individuals"
  answer: 1
