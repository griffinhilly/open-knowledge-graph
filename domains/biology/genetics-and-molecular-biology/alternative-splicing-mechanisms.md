...
- question: "Because humans and roundworms (C. elegans) have roughly the same number of protein-coding genes (~20,000), the molecular complexity of their proteomes must also be roughly comparable."
  type: true-false
  answer: false
