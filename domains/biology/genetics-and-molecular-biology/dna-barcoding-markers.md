...
- question: "DNA barcoding has confirmed that morphologically distinct species always correspond to genetically distinct lineages, validating traditional taxonomy's species boundaries."
  type: true-false
  answer: false
