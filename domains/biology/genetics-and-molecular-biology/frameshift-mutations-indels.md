...
- question: "A frameshift mutation affects primarily the amino acid encoded at the position of the insertion or deletion; downstream amino acids remain encoded by the original sequence."
  type: true-false
  answer: false
