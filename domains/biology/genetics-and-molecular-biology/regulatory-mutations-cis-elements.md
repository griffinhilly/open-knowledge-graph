...
- question: "Regulatory mutations are generally easier to predict in phenotypic severity than coding mutations, because they affect mainly expression level rather than protein structure."
  type: true-false
  answer: false
