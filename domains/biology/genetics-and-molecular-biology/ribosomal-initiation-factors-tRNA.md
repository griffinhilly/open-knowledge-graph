...
- question: "Initiator tRNA is functionally interchangeable with elongator tRNAs that carry methionine — the primary distinction is that initiator tRNA carries formyl-methionine in prokaryotes rather than unmodified methionine."
  type: true-false
  answer: false
