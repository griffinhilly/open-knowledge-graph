...
- question: "In Illumina sequencing, each cluster on the flow cell contains copies of many different original DNA fragments that were all amplified together in the same spot."
  type: true-false
  answer: false
