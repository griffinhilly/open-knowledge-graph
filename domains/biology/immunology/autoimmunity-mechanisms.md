...
- question: "Central tolerance in the thymus eliminates most self-reactive T cells, making peripheral tolerance merely a redundant backup that is rarely needed in healthy individuals."
  type: true-false
  answer: false
