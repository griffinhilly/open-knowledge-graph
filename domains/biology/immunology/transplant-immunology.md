...
- question: "Immunosuppressive drugs used to prevent transplant rejection can be targeted specifically to suppress primarily anti-donor T cell responses, leaving most other immune functions intact."
  type: true-false
  answer: false
