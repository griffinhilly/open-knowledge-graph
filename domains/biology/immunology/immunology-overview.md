...
- question: "Adaptive immunity is typically superior to innate immunity for fighting infections; innate immunity is just a backup system that matters mainly when adaptive immunity has not yet responded."
  type: true-false
  answer: false
