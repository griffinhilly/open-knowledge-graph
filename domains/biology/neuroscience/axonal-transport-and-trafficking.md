...
- question: "Because the neuron soma is the primary site of protein synthesis, essentially all proteins used at the synapse must be transported from the soma to the terminal via axonal transport."
  type: true-false
  answer: false
