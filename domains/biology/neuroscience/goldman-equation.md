...
- question: "If the concentrations of K⁺ and Na⁺ were suddenly equalized across the membrane (same inside and outside), while most permeabilities remained unchanged, the resting membrane potential would be unaffected."
  type: true-false
  answer: false
