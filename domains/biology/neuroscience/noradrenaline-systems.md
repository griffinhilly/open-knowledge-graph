...
- question: "Medications for ADHD that target the noradrenergic system work by maximally stimulating most adrenergic receptors to produce the highest possible arousal state, which improves sustained attention."
  type: true-false
  answer: false
