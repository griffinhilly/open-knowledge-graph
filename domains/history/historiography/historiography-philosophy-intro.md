...
title: 'Historiography and Philosophy of History: An Introduction'
domain: history
...
```yaml
- question: "Which of the following best describes the central concern of the philosophy of history?"
  type: multiple-choice
  options: ["Cataloguing the dates and events of significant historical occurrences", "Examining the epistemological and metaphysical foundations of historical knowledge", "Determining which primary sources are most reliable for a given period", "Comparing the methods used by historians in different national traditions"]
  answer: 1
  explanation: "Philosophy of history asks foundational questions about the nature and limits of historical knowledge: What is historical truth? Can historians achieve objectivity? What makes a historical explanation valid? These are epistemological and metaphysical questions, not empirical questions about specific events, sources, or traditions. The other options describe tasks of empirical history or source criticism, not philosophical inquiry about history's foundations."

- question: "Historiography is simply another word for the writing of history — it refers to the narrative accounts historians produce about the past."
  type: true-false
  answer: false
  explanation: "Historiography specifically refers to the study of how history is written — the methods, theoretical assumptions, schools of thought, and interpretive frameworks historians employ. A historiographical essay analyzes how different historians have approached a topic and why their accounts differ, not the topic itself. Confusing historiography with 'history writing' is one of the most common errors students make when first encountering the term."

- question: "Why might a philosopher of history argue that complete objectivity in historical writing is impossible in principle, not merely difficult in practice?"
  type: short-answer
  answer: "Because historical accounts inevitably require selecting which evidence matters, framing causes and effects, and interpreting the past through present-day concepts — choices that are never theory-neutral and always reflect the historian's standpoint and values."
  explanation: "Even a historian with complete access to all sources must decide what counts as relevant, which causal chains are significant, and how to narrate events in language that resonates today. These decisions embed assumptions about what matters and why. This is not a failure of individual historians but a structural feature of historical inquiry: unlike a controlled experiment, the past cannot be observed directly, only reconstructed through evidence that was itself produced by partial agents. The impossibility is in-principle, not merely practical."
```
