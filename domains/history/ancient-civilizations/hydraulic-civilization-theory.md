...
title: 'Hydraulic Civilization Theory: Rivers and State Power'
domain: history
...
- Hydraulic theory is not consensus; most contemporary historians treat it as a suggestive but flawed framework.
- Geographic determinism generally overpredicts: the same river environment can produce very different political outcomes depending on contingent factors.
