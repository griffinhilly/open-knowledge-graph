...
## Core Idea
Establishing timelines for ancient civilizations relies on multiple methods: radiocarbon dating, dendrochronology, stratigraphy, king lists, and written records. Different civilizations developed writing and recorded history at different times, creating gaps and overlaps in our knowledge. Understanding these methods and their limitations is crucial for constructing reliable chronologies.

## How It's Best Learned
Work through a specific example—trace how Egyptian king lists align with radiocarbon dates from a pyramid, or compare different dating methods for the same artifact.
