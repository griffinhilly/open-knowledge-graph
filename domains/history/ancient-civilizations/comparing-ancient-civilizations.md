---
id: comparing-ancient-civilizations
title: Comparative Analysis of Ancient Civilizations
domain: history
...
- Comparing civilizations does not require a single evolutionary sequence (hunting → farming → city → empire); development was multidirectional and contingent.
- 'Civilization' is a value-laden term; its traditional use excluded many complex non-urban societies from serious historical consideration.

## Questions

```yaml
- question: "What does the 'jigsaw fallacy' refer to in comparative historical analysis?"
  type: multiple-choice
  options:
    - "Selecting only the evidence that confirms a pre-existing narrative while ignoring contradictions"
    - "Forcing diverse societies into a single predetermined developmental template, as if they are pieces of one puzzle"
    - "Comparing civilizations that were geographically too distant to have meaningfully influenced each other"
    - "Overstating the role of individual leaders at the expense of structural and environmental factors"
  answer: 1
