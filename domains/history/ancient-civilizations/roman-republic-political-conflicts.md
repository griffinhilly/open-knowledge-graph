...
```yaml
- question: "The Roman plebeians' most effective leverage during the Conflict of the Orders was their ability to do what?"
  type: multiple-choice
  options:
    - "Vote in the centuriate assembly to override senatorial decisions"
    - "Secede from Rome and refuse to serve in the army"
    - "Appeal to foreign allies to pressure the patrician Senate"
    - "Elect tribunes who could veto any patrician magistrate"
  answer: 1
  explanation: "The plebs used secession — physically leaving Rome and refusing to fight — as their primary weapon, because the Roman army depended on citizen-soldiers who were overwhelmingly plebeian. Without plebeian soldiers, Rome could not defend itself or conduct wars. This leverage was real and immediate. While tribunes (option D) became an important institution, they emerged as a result of successful plebeian pressure, not the source of it. The centuriate assembly was dominated by property owners, giving wealthier citizens disproportionate voting power."

- question: "The Law of the Twelve Tables (450 BCE) was significant primarily because it did what?"
  type: multiple-choice
  options:
    - "Gave plebeians equal political representation in the Senate"
    - "Abolished debt slavery for all Roman citizens"
    - "Made law public and written, ending the patrician monopoly on legal interpretation"
    - "Established the office of tribune as a permanent constitutional institution"
  answer: 2
...
- question: "The Lex Hortensia (287 BCE) was significant because it made decisions of the plebeian assembly (plebiscites) legally binding on all Romans, including patricians."
  type: true-false
  answer: true
  explanation: "The Lex Hortensia marked the formal end of the Conflict of the Orders. Before it, plebiscites bound only plebeians; patricians could ignore them. After it, plebiscites carried the force of law for all Romans. This was the culmination of nearly two centuries of constitutional struggle. However, even after 287 BCE, the underlying distribution of land and wealth remained concentrated among the elite — political rights were won without economic redistribution."

- question: "How does the development of the Roman Republic illustrate the difference between constitutional form and constitutional reality?"
  type: short-answer
  answer: "The Republic developed genuine constitutional innovations — divided consular power, tribunes with veto authority, written law, term limits — but these structures emerged from class conflict rather than principled design, and they primarily served to manage plebeian discontent while preserving aristocratic control of land, wealth, and the Senate. The democratic form (assemblies, elections, vetoes) coexisted with oligarchic substance (property-weighted voting, senatorial dominance, patrician monopoly on key priesthoods). Constitutional arrangements can look egalitarian while structurally protecting inequality."
  explanation: "Later societies that invoked Roman precedent often cited the constitutional forms without acknowledging the class dynamics embedded in them. The Republic's 'balance' was between competing elite factions accommodating popular pressure — not a blueprint for equal citizenship. Recognizing this gap between form and reality is central to reading constitutional history critically."
```
