...
title: Urbanization in the Ancient World
domain: history
...
- Ancient cities were not necessarily dirty, chaotic, or unhealthy by design; Indus Valley cities had sophisticated sanitation that many later cities lacked.
- Urban life was the minority experience throughout antiquity; most ancient people lived in rural agricultural communities.

## Questions

```yaml
- question: "Ancient cities emerged independently in Mesopotamia, the Indus Valley, China, and Mesoamerica. What does this pattern most strongly suggest?"
  type: multiple-choice
  options: ["Urban forms spread through trade contact across these regions", "Urbanization was triggered by a shared climate event around 3000 BCE", "Cities arise under recurring structural conditions rather than from a single diffusion source", "Each civilization invented cities by copying an earlier Mesopotamian model"]
  answer: 2
  explanation: "The independent emergence of cities across geographically separated regions — before those regions had documented contact with each other — is the primary evidence that urbanization results from recurring conditions (surplus agriculture, population density, administrative need) rather than cultural diffusion from one origin. If cities had spread by contact, we would expect a clear chronological gradient radiating from a single source, which the archaeological record does not consistently show."

- question: "Ancient cities were fundamentally different from large villages primarily because of their much larger populations."
  type: true-false
  answer: false
  explanation: "Size is not the defining difference. Ancient cities were qualitatively distinct in their functional complexity: they concentrated specialized labor (scribes, priests, soldiers, merchants), enabled administrative coordination of surrounding hinterlands, and created new social formations (classes, legal statuses, ethnic communities). A large agricultural village without these features is not a city in the historical sense, regardless of population."

- question: "Why were ancient cities fundamentally dependent on the surrounding rural population, despite being centers of power and wealth?"
  type: short-answer
  answer: "Ancient cities did not produce their own food. Urban populations of specialists (administrators, priests, craftspeople, soldiers) were sustained by the agricultural surplus extracted from surrounding rural territories. Without that surplus, cities could not feed themselves."
