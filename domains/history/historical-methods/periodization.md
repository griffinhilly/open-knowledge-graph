...
- Periods are not objective features of the past; they are analytical constructs imposed by historians and always subject to revision.
- 'The Middle Ages' is a meaningful category for European history but may be meaningless or misleading when applied globally.

## Questions

```yaml
- question: "A historian argues that 'the Middle Ages ended in 1453 with the fall of Constantinople.' This claim is best understood as which of the following?"
  type: multiple-choice
  options: ["An objective fact recorded in the historical record", "An interpretive choice that foregrounds certain events and obscures others", "A consensus too well-established to question", "A description of a universal shift experienced across all cultures simultaneously"]
  answer: 1
  explanation: "Choosing any specific date or event as a period boundary is an interpretive act. 1453 is meaningful in European political history but carries no particular significance for West African, Chinese, or pre-Columbian American history. All periodization choices foreground certain changes while obscuring continuities and the experiences of those for whom the boundary was less meaningful."

- question: "The concept of 'the Middle Ages' is a useful and neutral organizing category for historians studying any part of the world."
  type: true-false
  answer: false
  explanation: "'The Middle Ages' was coined by European Renaissance scholars to describe the period between classical antiquity and their own era. It reflects European chronology and experience. Applying it globally imposes a Eurocentric framework that can distort the history of societies — in Africa, Asia, or the Americas — that experienced no equivalent transition and for whom the label carries no meaningful referent."

- question: "What do a historian's periodization choices reveal about their assumptions?"
  type: short-answer
  answer: "Periodization choices reveal which events or processes the historian treats as decisive turning points, whose experiences they consider historically representative, and which theoretical frameworks — national, civilizational, economic — they are working within."
  explanation: "Since periods are analytical constructs rather than objective features of the past, the boundaries a historian draws reflect their interpretive priorities and intellectual context. Whose experience defines the turning point, which changes count as transformative, and which continuities are obscured — all of these are embedded in periodization decisions. Reading those choices critically is itself a form of historiographical analysis."
```
