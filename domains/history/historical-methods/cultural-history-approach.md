...
- Cultural history does not argue that material conditions don't matter; it argues that material conditions are always mediated by cultural meanings that must be analyzed in their own right.
- Attention to language and discourse is not the same as claiming that 'nothing is real' — cultural historians study how discursive frameworks shape, enable, and constrain real actions and real experiences.
