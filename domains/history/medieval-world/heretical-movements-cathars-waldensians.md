...
title: 'Heretical Movements: Cathars and Waldensians'
domain: history
...
```yaml
- question: "What theological claim made Catharism a more radical challenge to the Church than the Waldensian movement?"
  type: short-answer
...
- question: "The Albigensian Crusade was directed against a region, not just a religious group. What does this suggest about the relationship between heresy and political power in medieval Europe?"
  type: short-answer
  answer: "It suggests that heresy and political autonomy were intertwined: the southern French nobility tolerated or protected Cathars partly because suppressing them would mean submitting to northern French (and papal) authority. The Crusade served both religious and territorial purposes, allowing the French crown to extend its control southward while claiming to serve the Church."
  explanation: "This point is crucial for understanding why the Church sometimes resorted to crusade rather than inquisition alone: heretics often had noble protectors whose political interests aligned with religious dissent. The Crusade broke the political coalition protecting Catharism before the Inquisition could systematically eliminate individual believers."
```
