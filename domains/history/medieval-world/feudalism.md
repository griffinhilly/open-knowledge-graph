---
id: feudalism
title: Feudalism and the Medieval Social Order
domain: history
...
- Feudalism was never a uniform system — arrangements varied enormously by region and period, and many historians now prefer to avoid the term.
- Serfs were not slaves; they had legal protections and customary rights, though their mobility was severely restricted.

## Questions

```yaml
- question: "Which of the following best describes the legal condition of serfs under medieval manorialism?"
  type: multiple-choice
  options: ["Serfs were property who could be bought and sold at will, like slaves", "Serfs were free laborers who chose to work on manor estates in exchange for protection", "Serfs were bound to the land with customary rights and legal recognition, but severely restricted in mobility", "Serfs were full citizens with property rights equivalent to those of free peasants"]
  answer: 2
  explanation: "Serfdom differed from slavery in important ways: serfs had legal standing, customary rights (such as access to common lands), and could not typically be separated from the land they worked. If the land changed hands, the serf went with it — but they could not simply be sold apart from the land. Their condition was deeply constrained, but the legal distinction from slavery was real and recognized in medieval law."

- question: "Feudalism was a uniform, well-defined system practiced consistently across medieval Western Europe."
  type: true-false
  answer: false
  explanation: "'Feudalism' is a retrospective category invented by early modern lawyers and systematized by later scholars — it is not a system medieval people named or designed. Arrangements between lords and vassals, and between lords and serfs, varied enormously by region and period. Many historians now question whether the term is coherent enough to be analytically useful, preferring more specific concepts like 'lordship' or 'the seigneurial system.'"

- question: "Why do historians distinguish among the political, economic, and legal dimensions of feudalism rather than treating it as a single unified system?"
  type: short-answer
  answer: "Because the political (lord-vassal bonds), economic (manorial agriculture), and legal (serfdom and customary rights) components operated somewhat independently and appeared in different combinations across regions, making it misleading to treat them as a single package."
  explanation: "A region might have strong lord-vassal political bonds without a fully developed manorial economy, or tight serfdom without the formal vassalage hierarchy. Separating the three dimensions allows for more precise comparison across regions and time periods, and avoids the false impression that 'feudalism' was a designed, uniform system rather than a retrospective label applied to varied local arrangements."
```
