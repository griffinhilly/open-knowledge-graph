...
- 'Trans-Saharan trade' was not a single route but a network of dozens of routes that shifted over time with political changes and oasis water availability.
- The slave trade across the Sahara predated and ran parallel to the later Atlantic slave trade, and was enormous in scale.
