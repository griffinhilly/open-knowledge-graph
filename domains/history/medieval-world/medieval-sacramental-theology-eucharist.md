...
title: Sacramental Theology and Eucharistic Doctrine
domain: history
...
```yaml
- question: "A skeptic argues: 'After consecration, the Eucharist still looks, tastes, and smells like bread — therefore nothing has actually changed.' How would the doctrine of transubstantiation respond?"
  type: multiple-choice
  options:
    - "It would agree — the Eucharist is a symbolic memorial, not a literal transformation"
    - "It would argue that the senses are entirely unreliable and should not be trusted"
    - "It would distinguish substance from accident: accidents (sensory properties) remain unchanged while the substance — what the thing fundamentally is — transforms into Christ's body and blood"
    - "It would deny that bread and wine retain any properties whatsoever after consecration"
  answer: 2
  explanation: "Transubstantiation uses Aristotle's substance/accident distinction precisely to explain why the Eucharist appears unchanged. 'Substance' is what a thing fundamentally is; 'accidents' are its sensory properties. The doctrine holds that substance changes while accidents remain — which is why the Eucharist still tastes like bread. Option A describes Protestant memorial theology (Zwingli), which the doctrine explicitly rejects. Option B is too extreme; the point is not that senses lie, but that accidents can persist after substance changes."

- question: "Why was the doctrine of transubstantiation theologically significant beyond its metaphysical content?"
  type: multiple-choice
  options:
    - "It made reception of the Eucharist optional for salvation, freeing laypeople from dependence on priests"
    - "It justified the Church's monopoly on sacramental access, giving excommunication devastating power over spiritual life"
    - "It proved that Aristotelian philosophy was fully compatible with Christian scripture"
    - "It allowed trained laypeople to consecrate the Eucharist when priests were unavailable"
  answer: 1
