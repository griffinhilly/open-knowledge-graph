---
id: subsistence-agriculture-famine-crisis
title: Subsistence Agriculture and Famine Crisis
domain: history
...
```yaml
- question: "Medieval yield ratios of 3:1 to 5:1 (bushels harvested per bushel sown) meant that a single bad harvest was catastrophic primarily because:"
  type: multiple-choice
  options:
    - "Medieval peasants lacked knowledge of how to store grain safely across seasons"
    - "After setting aside seed grain and paying obligations, the survival buffer for a family was extremely thin or nonexistent"
    - "Bad harvests were always caused by plague, which also killed the labor needed for recovery"
    - "Medieval lords would confiscate all grain in a bad year to sell at elevated market prices"
  answer: 1
  explanation: "At a 4:1 yield ratio, planting 1 bushel produces 4. Subtract 1 bushel for next year's seed: net gain is 3 bushels. From this, the peasant must pay dues to the lord and feed the family for a year. At bad ratios (approaching 3:1 or below), the arithmetic simply doesn't work — there is no buffer. The structural problem is the thin margin. Knowledge of storage (option A) is not the limiting factor; obligations (option D) compound the vulnerability but aren't its sole cause."

- question: "The Great Famine of 1315–1322 was self-reinforcing across multiple years primarily because:"
  type: multiple-choice
  options:
    - "Seven years of bad weather permanently depleted the soil's nutrients"
    - "Starving families ate seed grain in the first years, guaranteeing subsequent harvests would also be smaller"
    - "Medieval peasants had no knowledge of crop rotation and could not adapt to changed conditions"
    - "The Black Death arrived simultaneously, compounding the mortality from the start"
  answer: 1
  explanation: "When a harvest fails and people are starving, seed grain — normally set aside as sacrosanct — gets eaten for survival. But seed grain is the input for next year's crop. Eating it guarantees the following harvest will also be smaller (less was planted), perpetuating and deepening the famine. This trap was understood at the time, yet starvation leaves no choice. Three-field rotation (option C) was widely practiced; the Black Death (option D) arrived 25 years after the famine began, not simultaneously."

- question: "Medieval subsistence agriculture was primarily limited by ignorance of farming techniques; better knowledge would have solved the famine problem."
  type: true-false
  answer: false
  explanation: "Medieval farmers were highly skilled within the constraints of their technology and resources. They used three-field rotation, selected seeds, and applied manure strategically. The problem was structural, not ignorance: yield ratios were constrained by medieval grain varieties and limited land availability. The thin survival margins came from operating near carrying capacity — too many people relative to available productive land — combined with obligations that transferred surplus away from the peasantry. The agricultural revolution you studied as a prerequisite represents genuine technological progress, not a correction of ignorance."

- question: "The Black Death killed roughly one-third of Europe's population partly because the preceding decades of famine had weakened immune function across the population."
  type: true-false
  answer: true
  explanation: "Correct. While Yersinia pestis was genuinely lethal, the devastation was amplified by prior famine. Malnutrition compromises immune function, and the population the Black Death encountered in 1347 had been subjected to periodic famine since 1315. Weakened immune systems meant higher mortality rates than a well-nourished population would have experienced. The famine crisis is part of the causal story of plague mortality — not just an unrelated preceding event. Understanding subsistence agriculture explains why the demographic shock was as catastrophic as it was."

- question: "Why did the serfdom system compound the structural vulnerability of subsistence agriculture rather than providing stability?"
  type: short-answer
  answer: "Serfdom required peasants to transfer a substantial portion of their harvest to the lord regardless of how much was produced. In a good year, this obligation was manageable. In a bad year, the same absolute or proportional obligation stripped away the very buffer that might have allowed survival. Lords' interests lay in extracting obligations in all conditions; serfs had no legal recourse to reduce payments during crop failures. The obligation was structurally regressive: it claimed a fixed share of an already insufficient harvest, hitting those with the thinnest margins — the peasantry — first and hardest."
  explanation: "The key structural insight is that multiple claims competed on a thin surplus: seed grain preservation, lord's dues, and family subsistence. Any one being non-negotiable jeopardized the others. Serfdom made the lord's claim near non-negotiable legally, so when something had to give, it was the family's survival margin. A more flexible or redistributive system might have shifted obligations to those with greater surplus capacity, but the feudal structure specifically prevented this adjustment. This is why serfdom appears as a soft prerequisite: understanding it clarifies why agricultural vulnerability translated so directly into mass mortality."
```
