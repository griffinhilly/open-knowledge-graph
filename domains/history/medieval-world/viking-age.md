...
- Vikings did not wear horned helmets — this is a 19th-century Romantic invention with no archaeological basis.
- 'Viking' was an activity (raiding at sea), not an ethnic identity — most Norsemen were farmers; 'going viking' was a seasonal occupation for some.

## Questions

```yaml
- question: "A history student argues: 'The Viking Age was primarily characterized by Norse raids on European monasteries and towns.' What is most misleading about this claim?"
  type: multiple-choice
  options:
    - "Norse people never raided monasteries — this is a later historical myth"
    - "It overstates the destructive dimension and understates the Norse role as traders, settlers, and cultural intermediaries who connected Atlantic and Mediterranean trade networks"
    - "The Norse were not feared by contemporary Europeans; they were welcomed as trading partners"
    - "The claim is accurate — raiding was the dominant Norse activity throughout this period"
  answer: 1
  explanation: "Norse raiding was real and often brutal, but it was one activity within a much larger pattern of expansion that was primarily commercial in scale and consequence. Norse merchants founded cities along Russian rivers, established Dublin as a major trading center, settled Iceland and Normandy, and served as Varangian guards in Constantinople. A characterization focused only on raids misses that the same technology and mobility driving raids also drove the trade and settlement that had more lasting historical impact."

- question: "Which feature of Norse maritime technology was most critical to the extraordinary geographic reach of Viking expansion?"
  type: multiple-choice
  options:
    - "Very large cargo capacity, enabling long-distance bulk trade across the Atlantic"
    - "Deep keels and reinforced hulls designed to withstand North Atlantic storms"
    - "Shallow draft enabling river navigation and coastal beaching, combined with light enough construction to be portaged overland between river systems"
    - "Superior navigational instruments derived from Islamic and Byzantine astronomy"
  answer: 2
