---
id: nuclear-age
title: The Nuclear Age and Deterrence
domain: history
...
- Deterrence is not a natural law; it depends on both sides having reliable second-strike capability, accurate information, and rational leadership — conditions that are never perfectly met.
- Hiroshima and Nagasaki are debated: whether use was necessary to end the war, and what moral framework should govern weapons of mass destruction.
- The arms race was not purely about numbers; accuracy, delivery systems, and command-and-control architecture mattered more than warhead count.
