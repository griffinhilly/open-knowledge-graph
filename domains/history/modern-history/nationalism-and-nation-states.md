...
title: Nationalism and the Rise of Nation-States
domain: history
...
- Nation-states are not the natural or inevitable form of political organization; they are a specific modern construction.
- Nationalism is not inherently progressive or reactionary — it has powered both liberation movements and genocides.
- The borders drawn by nationalism were rarely clean; most 'national' territories contained significant minorities.

## Questions

```yaml
- question: "What is the key distinction between civic nationalism and ethnic nationalism?"
  type: multiple-choice
  options:
    - "Civic nationalism is found only in republics; ethnic nationalism only in hereditary monarchies"
    - "Civic nationalism defines membership by shared political values and legal status; ethnic nationalism defines it by descent or cultural heritage"
    - "Civic nationalism seeks territorial expansion; ethnic nationalism seeks independence from empire"
    - "Civic nationalism emerged in the twentieth century; ethnic nationalism is older"
  answer: 1
...
- question: "How did the French Revolution's concept of popular sovereignty help create the conditions for nineteenth-century nationalism?"
  type: short-answer
  answer: "The Revolution established the principle that legitimate political authority derives from 'the people,' not from a monarch's divine right. Nationalist movements then asked: who are 'the people'? They answered in cultural and ethnic terms — each distinct national community (defined by language, culture, or heritage) should exercise that sovereignty by governing itself in its own state."
