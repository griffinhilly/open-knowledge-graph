...
- The Cold War was not a simple US-Soviet bilateral relationship; it was a global system involving dozens of non-aligned states, revolutionary movements, and regional conflicts.
- 'Containment' was not a unified strategy; Kennan's original formulation was different from the military buildup Acheson and Nitze pursued.
- The Cold War was not exclusively about ideology; geostrategic interests and domestic politics shaped decisions on both sides.

## Questions

```yaml
- question: "What was the core logic of US 'containment' policy as originally formulated by George Kennan?"
  type: multiple-choice
  options:
    - "Military encirclement and rollback of Soviet-controlled territory"
    - "Preventing Soviet communism from spreading to new territories without directly attacking it"
    - "Liberating Eastern European countries already under Soviet control"
    - "Building a formal military alliance to deter Soviet nuclear attack"
  answer: 1
...
- question: "Why do historians debate whether the US or the Soviet Union bears primary responsibility for the Cold War's onset?"
  type: short-answer
  answer: "Because both sides made decisions between 1945 and 1950 that the other could plausibly interpret as threatening. Soviet consolidation of Eastern Europe alarmed Western powers; the US atomic monopoly and Truman Doctrine alarmed the Soviets. Each side's defensive moves looked offensive to the other, making it genuinely difficult to assign unilateral blame."
  explanation: "This question targets the reductive view that the Cold War was simply Soviet aggression met by American defense (or vice versa). Historical causation in international conflicts is typically interactive — decisions by each party shape the environment in which the other decides. Tracing the 1945–1950 sequence reveals how quickly mutual mistrust became self-reinforcing."
```
