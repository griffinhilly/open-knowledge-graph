---
id: chinese-communist-revolution
title: Chinese Communist Revolution and Mao's Rise
domain: history
...
```yaml
- question: "A Marxist theorist in 1920s China argues that communist revolution must wait until the country develops a large urban industrial proletariat, as orthodox Marxist theory predicted. Why did Mao's actual strategy succeed where this approach would have failed?"
  type: multiple-choice
  options:
    - "China already had a large urban working class, but the theorist underestimated its revolutionary readiness"
    - "Mao recognized that China's revolutionary base had to be the peasantry — the vast majority of the population — combined with nationalist anticolonial appeals that orthodox Marxism ignored"
    - "Mao received superior Soviet military support that compensated for the absence of an urban working class"
    - "Urban proletarian revolution succeeded elsewhere in Asia and would have worked in China eventually"
  answer: 1
  explanation: "China's urban working class was tiny — a small fraction of a population that was overwhelmingly rural and peasant. Orthodox Marxism had no strategy for this situation. Mao's theoretical innovation was twofold: first, making the peasantry the revolutionary base through land reform and the mass line; second, fusing communist ideology with anticolonial nationalism, giving the revolution an appeal that transcended class analysis. The CCP's promise of land redistribution and national dignity mobilized millions who had little interest in industrial class struggle."

- question: "What made Mao's 'mass line' strategy distinctive as a method of revolutionary organization?"
  type: multiple-choice
  options:
    - "It relied on Soviet-trained military officers to direct the revolutionary movement from urban centers"
    - "Party cadres went to villages, learned peasant grievances, synthesized them into a revolutionary program, and returned it to the people — integrating bottom-up concerns with communist ideology"
    - "It focused on seizing industrial cities first to disrupt the KMT's economic base"
    - "It avoided land redistribution to prevent alienating moderate landlords who might support the revolution"
  answer: 1
  explanation: "The mass line was explicitly bidirectional: not just top-down dissemination of party ideology but bottom-up absorption of peasant concerns, then synthesis and return. Cadres had to understand what peasants actually cared about — land, debt, local exploitation, national humiliation — and incorporate those concerns into the revolutionary program. This distinguished Maoism from both Soviet-style vanguardism (which directed the masses from above) and from pure agrarian populism (which had no ideological framework). The result was a movement that felt locally responsive while pursuing a coordinated national strategy."

- question: "The Chinese Communist Revolution was simultaneously a class struggle against landlords and capitalism, and an anticolonial nationalist movement against foreign domination and imperial humiliation."
  type: true-false
  answer: true
