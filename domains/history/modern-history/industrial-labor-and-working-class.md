...
title: Industrial Labor and the Formation of the Working Class
domain: history
...
- id: industrial-mechanization-factories
  type: hard
builds-toward:
- bolshevism-and-soviet-revolution
tags:
- labor
- class
- working-class
...
```yaml
- question: "A 19th-century factory worker and a pre-industrial artisan both make shoes. What is the most fundamental difference in their economic position, according to the concept of proletarianization?"
  type: multiple-choice
  options:
    - "The factory worker earns a lower wage than the artisan earned from selling products"
    - "The factory worker owns no means of production and must sell labor to survive; the artisan owned tools and sold products directly"
    - "The factory worker is less skilled because machines replaced craft knowledge"
    - "The factory worker works longer hours under worse physical conditions"
  answer: 1
  explanation: "Proletarianization is fundamentally about the *relationship to the means of production*, not wages or conditions (though those followed). The artisan owned tools, set pace, and sold finished goods — retaining economic independence. The factory worker owned nothing; the machinery belonged to the employer, the pace was determined by the machine, and the product was the employer's property. This structural position — having only labor power to sell — defined class in the sociological sense Marx and Engels used."

- question: "The Luddites who destroyed machinery in early 19th-century England are best understood as:"
  type: multiple-choice
  options:
    - "Anti-technology ideologues who opposed industrial progress on principle"
    - "Workers defending their wages and skilled trades against machines used to undercut them"
    - "Political radicals pursuing a broader socialist revolution"
    - "Criminal gangs with no coherent economic grievances"
  answer: 1
