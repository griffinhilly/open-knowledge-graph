...
title: Enlightenment Natural Rights Philosophy
domain: history
course: early-modern-period
prerequisites:
- id: enlightenment-origins
  type: hard
- id: thomas-hobbes-social-contract
  type: soft
builds-toward:
- american-revolution
...
```yaml
- question: "Under the feudal/medieval view versus Locke's natural rights theory, what is the fundamental difference in how rights originate?"
  type: multiple-choice
  options:
    - "Medieval thinkers believed rights were rational; Locke believed they were religious in origin"
    - "Medieval thinkers saw rights as privileges flowing downward from authority; Locke held that rights inhere in persons prior to any government and cannot be legitimately taken away"
    - "Medieval thinkers believed rights applied to all humans; Locke restricted natural rights to property-owning men"
    - "Medieval thinkers grounded rights in natural law; Locke grounded rights entirely in social contract and consent"
  answer: 1
  explanation: "The key reversal: in feudal thinking, rights are grants — a king bestows privileges on lords, lords extend protections to peasants. Rights flow downward from authority. Locke inverts this completely: rights exist prior to government and are not created by it. They inhere in persons by virtue of humanity and reason. Government is created through social contract not to grant rights but to better protect rights that already exist. This reversal is what makes natural rights theory politically radical — it transforms subjects into right-bearers who can hold government accountable."

- question: "What is the logical political consequence of natural rights theory when a government systematically violates the rights it was formed to protect?"
  type: multiple-choice
  options:
    - "Citizens are morally obligated to continue obeying government until a new election can replace it"
    - "The government retains its legitimacy because authority derives from established law, not rights protection"
    - "Resistance or revolution is justified, because the government has forfeited its claim to obedience by violating its foundational purpose"
    - "Citizens may petition for reform but may not take physical action, as natural rights theory is inherently pacifist"
  answer: 2
  explanation: "This is the politically explosive implication of Locke's theory. If government's only legitimate purpose is to protect natural rights, and it instead systematically violates them, it has broken the social contract and forfeited its claim to obedience. Locke wrote the Two Treatises explicitly to justify Parliament's deposition of James II (1688). The American Declaration of Independence applied the same logic directly: the long train of abuses by the Crown justified revolution. This right of resistance distinguishes natural rights theory from mere reform liberalism."

- question: "In Locke's natural rights theory, government authority is legitimate only insofar as it protects the natural rights — to life, liberty, and property — that individuals already possessed in the state of nature, before any government existed."
  type: true-false
  answer: true
...
- question: "Explain the contradiction between natural rights theory's universalist claims and the actual political practice of the states it inspired, and identify its historical significance."
  type: short-answer
  answer: "Natural rights theory claims rights are universal — they inhere in all humans by virtue of their humanity and reason, not rank, nationality, or gender. Yet the governments it inspired initially extended full rights only to propertied men, excluded women from political participation, and (in America) preserved slavery through elaborate rationalizations. This gap became the central contested terrain of the following two centuries. Abolitionists, suffragists, anti-colonial movements, and civil rights activists all drew on the same natural rights vocabulary to expose the contradiction and demand inclusion."
  explanation: "The theory's universalist logic proved impossible to permanently contain. Once rights are grounded in humanity rather than privilege, every exclusion becomes philosophically vulnerable: the excluded can ask, 'Are we not also human?' This dynamic drove the progressive expansion of rights claims from the late 18th century onward, explaining why the language of the American Declaration and French Declaration remained politically potent far beyond their original contexts."
```
