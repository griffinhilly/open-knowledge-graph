...
title: Early Modern Global Trade Networks
domain: history
...
- Global trade networks were not European inventions — the Indian Ocean trading system and Silk Road long predated European expansion. Europeans forced their way into existing networks through violence and monopoly power.
- This system was not free trade — it was built on monopoly franchises, state-backed coercion, and enslaved and coerced labor at every productive node.

## Questions

```yaml
- question: "New World silver from mines like Potosí played which role in the early modern global economy?"
  type: multiple-choice
  options:
    - "It financed the Spanish Armada but had little measurable impact on Asian markets"
    - "It flowed from the Americas through Europe to Asia to pay for luxury goods, integrating Atlantic and Indian Ocean economies"
    - "It was hoarded by the Spanish Crown and never circulated broadly in the global economy"
    - "It displaced gold as the primary currency within European markets but did not reach Asia"
  answer: 1
  explanation: "Potosí silver flowed from the Americas to Spain, across Europe, and ultimately to China and India to pay for silk, porcelain, and spices. China's economy ran on silver and had an enormous appetite for it, making the silver circuit one of the first genuinely global economic linkages — connecting the Atlantic system to the longstanding Indian Ocean trading network."

- question: "The Indian Ocean trading network was created by European maritime expansion in the 15th and 16th centuries."
  type: true-false
  answer: false
  explanation: "Arab, Indian, Chinese, and Southeast Asian merchants had been trading across the Indian Ocean for centuries before Portuguese ships arrived. European powers did not create this trade; they forced their way into existing networks using naval violence and monopoly franchises, redirecting trade flows to serve their interests."

- question: "What made joint-stock trading companies like the VOC a financial innovation, and why did this matter for global trade?"
  type: short-answer
  answer: "Joint-stock companies allowed many investors to pool capital and share risk, enabling the financing of expensive long-distance expeditions that no single merchant or ruler could fund alone. This concentrated capital while distributing risk, making sustained commercial empires financially viable."
  explanation: "Before joint-stock companies, large ventures required individual wealthy patrons or royal sponsorship — both scarce and risk-concentrated. The VOC sold shares to the public, spreading risk across thousands of investors. The capital raised could fund permanent infrastructure (ships, forts, overseas offices) rather than one-off expeditions, enabling multi-decade commercial empires."
```
