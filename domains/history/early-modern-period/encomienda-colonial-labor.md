...
title: The Encomienda System and Colonial Labor
domain: history
...
```yaml
- question: "A Spanish colonial official defends the encomienda: 'Unlike slaves, indigenous workers are legally free Crown subjects; the encomendero holds only a labor grant, not their persons.' Based on the historical record, which response best evaluates this argument?"
  type: multiple-choice
  options:
    - "The distinction is valid and shows the encomienda was a fundamentally humane institution"
    - "The legal distinction was real but largely meaningless in practice — overwork, disease disruption, and violence drove indigenous death rates comparable to chattel slavery"
    - "The argument is fully correct — indigenous survival rates under the encomienda were similar to those of free laborers"
    - "The distinction only mattered in the Caribbean; on the mainland the encomienda was a genuine free labor system"
  answer: 1
