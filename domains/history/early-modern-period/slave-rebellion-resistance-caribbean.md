...
title: Slave Rebellion and Resistance in the Caribbean
domain: history
...
```yaml
- question: "Slaveholders' frequent complaints about enslaved people's 'laziness' and 'unreliability' are best interpreted as:"
  type: multiple-choice
  options:
    - "Evidence that enslaved people were genuinely unproductive due to malnutrition and poor conditions"
    - "Racist rationalizations unconnected to any actual behavior by enslaved people"
    - "Unwitting testimonies to systematic everyday resistance — deliberate slowdowns, tool breakage, feigned illness"
    - "Documentation that Caribbean slavery was less economically productive than North American slavery"
  answer: 2
  explanation: "This is the key interpretive move the topic teaches. Deliberate work slowdowns, feigned illness, and tool breakage were forms of resistance that appeared, from the slaveholder's perspective, as incompetence or laziness. The complaints are evidence of resistance, not of the qualities slaveholders claimed. Enslaved people could not openly resist without severe punishment, so covert resistance that masqueraded as something else was both dangerous and strategically rational. Reading slaveholder documentation against the grain reveals the constant contest of wills that these complaints document."

- question: "What made maroon communities significant beyond simply providing a refuge for escaped individuals?"
  type: multiple-choice
  options:
    - "They served primarily as military bases from which to launch large-scale slave rebellions"
    - "They provided living proof that freedom was achievable and preserved African cultural traditions outside plantation control"
    - "Their existence pressured colonial governments into immediately improving plantation conditions"
    - "They functioned mainly as way stations connecting the Caribbean to West Africa"
  answer: 1
  explanation: "Maroon communities matter for multiple interrelated reasons: they demonstrated the possibility of freedom outside the plantation system (proving the system was not inevitable), they preserved African cultural and religious practices that would otherwise have been destroyed, and — in Jamaica's case — they negotiated formal treaties with the British colonial government, an extraordinary political achievement for people legally defined as property. Option A overstates their military offensive role; most maroon communities defended their freedom rather than attacking plantations."

- question: "Organized slave rebellions in the Caribbean were rare, isolated events that had little broader impact on the slave system."
  type: true-false
  answer: false
  explanation: "Caribbean slave rebellions were frequent and continuously challenged the slave system, even when suppressed. Tacky's War (Jamaica, 1760), the Berbice Rebellion (1763), and dozens of detected conspiracies demonstrate constant organized resistance. These events reflect a continuous underlying tension that required slaveholders to maintain extreme violence to sustain the system. The frequency and scale of rebellions force a revision of any account that treats plantation slavery as stable or consensual — it was maintained by force against persistent active opposition."

- question: "Enslaved people who engaged in everyday resistance (slowdowns, tool breakage, feigned illness) faced little real danger because slaveholders preferred not to damage their 'investments.'"
  type: true-false
  answer: false
  explanation: "Everyday resistance was dangerous. Slaveholders routinely punished enslaved people severely — through whipping, mutilation, sale, and death — for insubordination, even minor. The rationalization that slaveholders would protect their 'investment' is contradicted by abundant historical evidence of brutal punishment for perceived resistance. The fact that everyday resistance was pervasive despite these risks demonstrates the determination of enslaved people. Resistance occurred alongside constant violent repression, not in its absence."

- question: "How does understanding the spectrum of everyday resistance and marronage in the Caribbean help explain why the Haitian Revolution was possible?"
  type: short-answer
  answer: "The Haitian Revolution required knowledge networks, organizational experience, preserved African military and religious traditions, and the demonstrated possibility of freedom. A century of everyday resistance built covert communication practices and solidarities across plantation boundaries. Maroon communities preserved African spiritual practices (particularly Vodou) and demonstrated that collective action against the slave system could succeed. The memory of organized rebellions — even failed ones — created tactical knowledge and a tradition of resistance. The Revolution was the culmination of long preparation, not a spontaneous explosion."
  explanation: "Historians who study only the dramatic events of 1791 sometimes miss the infrastructure that made them possible. The Revolution was unprecedented in scale and success, but it drew on a long tradition of resistance that created the human networks, cultural resources, and organizational capacity needed for sustained military action. Understanding this is about historical causation: what were the necessary antecedents, and how does that change what the Revolution represents? It also permanently reordered the political geography of the Atlantic world, forcing every slaveholding society to reckon with what had been shown to be possible."
```
