...
- question: "In IRT ability estimation, measurement precision (standard error of the theta estimate) is the same for all examinees who take the same test, just as classical test theory's single reliability coefficient applies uniformly across the score range."
  type: true-false
  answer: false
