...
- question: "Because intelligence tests are grounded in a hierarchical factor model with g at the apex, an individual's performance on one composite index reliably predicts their performance on all other indices."
  type: true-false
  answer: false
