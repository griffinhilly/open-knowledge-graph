...
- question: "A test that demonstrates excellent content validity — items that proportionally cover the full domain — is guaranteed to be a valid measure of the underlying construct."
  type: true-false
  answer: false
