---
id: insula-interoception-emotion
title: Insula, Interoception, and Emotional Awareness
domain: psychology
...
```yaml
- question: "A patient with anterior insula damage can recognize a situation as 'frightening' and describe why it is dangerous, but reports feeling no dread or fear. What does this best demonstrate?"
  type: multiple-choice
  options:
    - "The amygdala alone is responsible for generating emotional experience"
    - "Emotional feeling requires interoceptive integration by the anterior insula, separate from cognitive appraisal"
    - "Cognitive appraisal and emotional feeling are the same process and this patient's report is unreliable"
    - "The patient has lost the ability to understand the meaning of emotional situations"
  answer: 1
