...
title: Limbic System and Emotion
domain: psychology
...
- 'The limbic system controls emotion' is an oversimplification; the amygdala, for instance, responds to all salient stimuli, not just negative ones.
- Emotion is not separable from cognition at the brain level; prefrontal–limbic interactions mean the distinction is functional, not anatomical.

## Questions

```yaml
- question: "A patient has bilateral amygdala lesions. Which outcome is most consistent with research findings?"
  type: multiple-choice
  options:
    - "Inability to form any new long-term memories"
    - "Difficulty learning fear responses and reduced recognition of threatening stimuli"
    - "Loss of hunger, thirst, and body temperature regulation"
    - "Impaired spatial navigation and route-learning"
  answer: 1
...
- question: "The limbic system exclusively processes negative emotions like fear and anxiety, with little involvement in positive emotional states or reward."
  type: true-false
  answer: false
  explanation: "The amygdala responds to all emotionally salient stimuli — including positive surprises, rewards, and intense positive experiences — not only threats. 'Emotional salience' (significance and arousal) is the better characterization of amygdalar function than 'negative emotion.' The limbic system also interfaces with dopaminergic reward circuitry, which is central to pleasure and motivation."

- question: "Patient H.M. had his hippocampus surgically removed and afterward could no longer form new declarative memories — yet he could still learn new motor skills like mirror tracing. What does this double dissociation reveal about memory systems in the brain?"
  type: short-answer
  answer: "It reveals that the brain has multiple, anatomically distinct memory systems. Declarative (explicit) memory for facts and events depends critically on the hippocampus. Procedural (implicit) memory for skills and habits is stored in the basal ganglia and cerebellum, which were intact in H.M. Damage to one system leaves the other functional."
  explanation: "A double dissociation — where damage to structure A impairs ability X but not Y, while damage to structure B impairs Y but not X — is powerful evidence for distinct systems. H.M. could improve at mirror tracing across sessions but had no memory of having done it before. This cleanly separates 'knowing how' (procedural) from 'knowing that' (declarative) at the neural level."
```
