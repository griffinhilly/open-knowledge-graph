---
id: drug-classes-and-effects
title: Drug Classes and Their Effects on Behavior
domain: psychology
...
- Alcohol is not simply a social lubricant; GABA enhancement produces sedation, respiratory depression, and motor incoordination that is dose-dependent and potentially lethal.
- Hallucinogens do not 'create' hallucinations by adding signals; they alter sensory gating and prediction mechanisms, causing the brain to amplify its own internal signals.
...
```yaml
- question: "Cocaine and morphine are chemically very different, yet both produce euphoria and addiction. What is the common mechanism?"
  type: short-answer
  answer: "Both ultimately increase dopamine signaling in the mesolimbic pathway (nucleus accumbens). Cocaine does so directly by blocking dopamine reuptake; morphine does so indirectly by suppressing GABAergic interneurons in the VTA, disinhibiting dopamine neurons."
  explanation: "The mesolimbic dopamine pathway is the common reward substrate for most addictive drugs. Understanding this convergence explains why addiction has similar behavioral features (craving, tolerance, withdrawal) across diverse substances, and why treatments targeting dopamine signaling can have broad applicability."

- question: "A patient is prescribed a benzodiazepine for anxiety. What neurotransmitter system does it primarily affect, and what is the key risk of long-term use?"
  type: short-answer
  answer: "Benzodiazepines enhance GABA-A receptor function, increasing inhibitory tone. Long-term use produces tolerance (receptor downregulation) and physical dependence; abrupt withdrawal causes rebound hyperexcitability that can manifest as seizures."
  explanation: "Because GABA-A receptors are broadly distributed, benzodiazepine effects (and withdrawal) are systemic. The tolerance mechanism — receptor downregulation — is the same process that underlies tolerance to all depressants, including alcohol."
```
