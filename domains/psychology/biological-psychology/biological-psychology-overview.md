...
title: Biological Psychology Overview
domain: psychology
...
- 'Biological' does not mean determined: genes and neurons are shaped by experience throughout life.
- Brain regions rarely have one exclusive function; most behavior involves distributed networks.
- Correlation between brain activity and behavior in imaging studies does not establish causation.

## Questions

```yaml
- question: "A neuroimaging study shows that the amygdala is more active when participants view fearful faces than neutral faces. What can we conclude?"
  type: multiple-choice
  options: ["The amygdala is the sole brain region responsible for processing fear", "Amygdala activity is correlated with fear processing, but this does not establish causation or exclusivity", "Removing the amygdala would eliminate fear responses entirely", "Genes fully determine amygdala activity levels"]
  answer: 1
  explanation: "Neuroimaging reveals correlations between brain activity and behavior, not causal or exclusive relationships. The amygdala is involved in fear processing but so are other regions (prefrontal cortex, hippocampus). Lesion studies and other methods are needed to establish causation."

- question: "Biological psychology holds that behavior is ultimately determined by genetics, making experience and environment secondary influences."
  type: true-false
  answer: false
...
- question: "Why do biological psychologists study clinical disorders like Parkinson's disease or major depression?"
  type: short-answer
  answer: "Disorders reveal how specific biological mechanisms (neurotransmitters, brain circuits, genes) relate to behavior and cognition. When a system breaks down in a predictable way, researchers can infer what that system normally does."
  explanation: "This is the lesion-study logic applied broadly: disruptions in biological systems — whether from disease, injury, or pharmacological intervention — create natural experiments. Parkinson's loss of dopaminergic neurons clarifies dopamine's role in movement; depression research illuminates serotonin and prefrontal-limbic circuits."
```
