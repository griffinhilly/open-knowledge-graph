...
- Social identity theory does not claim that all intergroup conflict reduces to identity; material competition (Sherif's realistic conflict theory) is a distinct mechanism.
- In-group favoritism is not the same as out-group hostility; the former is more robust than the latter in minimal group situations.

## Questions

```yaml
- question: "In Tajfel's minimal group paradigm, participants were randomly assigned to groups based on arbitrary criteria (e.g., dot-estimation tasks). What did these studies consistently show?"
  type: multiple-choice
  options: ["Participants showed favoritism toward their in-group even with no history, interaction, or material stakes", "Participants treated both groups equally because the groups were meaningless", "Participants showed hostility toward the out-group more strongly than favoritism toward the in-group", "Participants only showed bias when they believed group membership reflected real ability"]
  answer: 0
...
- question: "According to social identity theory, why do people show favoritism toward arbitrary in-groups even when nothing material is at stake?"
  type: short-answer
  answer: "Because group membership contributes to self-concept, and people are motivated to maintain positive social identity. Favoring the in-group in comparisons with out-groups boosts the group's relative status, which supports a positive self-image."
