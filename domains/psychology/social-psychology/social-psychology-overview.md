...
- Social psychology is not just 'common sense'; its findings routinely violate intuitive predictions.
- Situationism does not deny individual differences — it claims situational forces are systematically underestimated.

## Questions

```yaml
- question: "In Milgram's obedience studies, most participants administered what they believed were severe electric shocks to strangers. What does this finding best illustrate?"
  type: multiple-choice
  options: ["That sadistic personality traits are more common than expected", "That situational pressures can override individual moral convictions", "That participants misunderstood the instructions", "That laboratory settings produce behavior unrelated to real life"]
  answer: 1
  explanation: "The Milgram studies are the canonical demonstration of situationism: ordinary people, under social pressure from an authority figure, behaved in ways that conflicted with their personal values. This finding argues against a purely dispositional explanation of harmful behavior."

- question: "Social psychology's findings frequently confirm what most people would intuitively predict about human behavior."
  type: true-false
  answer: false
...
- question: "Why does social psychology study the 'imagined or implied' presence of others, not just the actual presence?"
  type: short-answer
  answer: "Because people's behavior is shaped by mental representations of social expectations — such as norms, anticipated judgment, or internalized roles — even when no one else is physically present."
