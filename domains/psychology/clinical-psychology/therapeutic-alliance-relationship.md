---
id: therapeutic-alliance-relationship
title: Therapeutic Alliance and the Helping Relationship
domain: psychology
...
```yaml
- question: "A therapist applies CBT techniques with textbook precision, yet their client disengages, misses sessions, and eventually drops out. What does alliance research most strongly suggest?"
  type: multiple-choice
  options:
    - "The therapist should switch to a different evidence-based modality"
    - "The quality of the collaborative relationship may be undermining the effectiveness of the techniques"
    - "The client likely has a personality disorder that prevents engagement"
    - "CBT is not appropriate for this presenting problem"
  answer: 1
  explanation: "Meta-analyses consistently show that alliance quality predicts outcomes more robustly than specific technique or modality. The same technique can be effective in a strong alliance and ineffective in a weak one — the relational container shapes how interventions land. This doesn't mean technique is irrelevant, but when outcomes are poor, examining the alliance is often more diagnostic than switching modalities."

- question: "Which of the following is NOT one of the three components in Bordin's tripartite model of the therapeutic alliance?"
  type: multiple-choice
  options:
    - "Agreement on the goals of therapy"
    - "Collaboration on the tasks of therapy"
