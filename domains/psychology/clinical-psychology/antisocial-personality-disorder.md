...
```yaml
- question: "Which of the following best describes the relationship between ASPD and psychopathy?"
  type: multiple-choice
  options:
    - "ASPD and psychopathy are different names for the same diagnosis"
    - "All individuals with ASPD also meet criteria for psychopathy on the PCL-R"
    - "Most individuals with psychopathy meet criteria for ASPD, but only about one-third of those with ASPD score highly on psychopathy measures"
    - "Psychopathy is a subtype of ASPD defined by greater impulsivity and aggression"
  answer: 2
  explanation: "ASPD is a broad behavioral diagnosis requiring persistent violations of others' rights with a history of conduct disorder. Psychopathy (PCL-R) additionally requires affective and interpersonal features: callousness, shallow affect, grandiosity, superficial charm. The overlap is asymmetric: most psychopaths meet ASPD criteria, but only ~30% of those with ASPD are also psychopathic. Option D inverts the picture — psychopathy is actually associated with reduced reactive aggression and increased predatory behavior alongside an affective deficit, not simply 'more impulsive.'"

- question: "Research on the neurobiology of psychopathy most clearly points to which primary deficit?"
  type: multiple-choice
  options:
    - "Overactive reward circuitry leading to compulsive sensation-seeking"
    - "Impaired fear conditioning and reduced affective response to others' distress"
    - "Excessive cortical arousal causing inability to learn from punishment signals"
    - "Hyperactive amygdala responses to threat leading to preemptive aggression"
  answer: 1
  explanation: "Individuals with psychopathic traits show reduced amygdala activation in response to others' distress cues, impaired passive avoidance learning (failing to learn to avoid actions that were punished), and blunted skin conductance responses to anticipated aversive outcomes. This points to a specific deficit in the circuits that generate anticipatory fear and empathy-based inhibition — the system that normally signals 'this will hurt someone' or 'this will have bad consequences.' Option D is the opposite of what's observed: amygdala reactivity to threat cues is reduced, not increased."

- question: "A DSM diagnosis of ASPD requires a history of conduct disorder before age 15, establishing it developmentally as the adult continuation of an earlier-emerging pattern."
  type: true-false
  answer: true
  explanation: "This developmental criterion distinguishes ASPD from acquired antisocial behavior due to substance use, brain injury, or situational factors. The requirement anchors the diagnosis: ASPD is not a disorder that suddenly appears in adulthood but the adult expression of a pattern typically emerging in childhood and adolescence. Callous-unemotional traits in childhood are especially predictive of severe adult outcomes and may represent a qualitatively distinct developmental subtype."

- question: "Individuals with ASPD typically respond well to insight-oriented psychotherapy, because structured therapeutic relationships provide the empathic modeling they lacked in development."
  type: true-false
  answer: false
  explanation: "ASPD is notoriously treatment-resistant. Insight-oriented therapy presupposes introspective capacity, motivation for change, and some empathic capacity — features substantially reduced in ASPD, especially with psychopathic traits. The interpersonal style characteristic of the disorder (manipulation, superficial compliance, minimization of harm caused) makes the therapeutic relationship a tool for managing the clinician rather than a vehicle for genuine change. More effective approaches focus on concrete behavioral contingencies and skills training."

- question: "What distinguishes the neurobiological profile of psychopathy from ASPD more broadly, and why does this distinction matter for predicting violent behavior?"
  type: short-answer
  answer: "ASPD is defined behaviorally — persistent violations of others' rights, impulsivity, deceitfulness — and its neurobiological correlates overlap with general impulse control deficits. Psychopathy adds specific affective and interpersonal features tied to deficits in amygdala-based fear conditioning and empathic responding: psychopaths fail to generate the anticipatory aversive signal that normally inhibits harmful behavior, not simply because they can't control impulses but because they don't experience the anticipated distress that makes control motivationally compelling. This matters for violence prediction because psychopathic violence tends to be predatory and instrumental (planned, goal-directed), while non-psychopathic ASPD violence tends to be reactive and impulsive. PCL-R scores predict recidivism and predatory violence significantly better than ASPD diagnosis alone."
  explanation: "Two people convicted of identical crimes may have very different underlying profiles and risk trajectories. Risk assessment tools now incorporate psychopathy measures specifically because the ASPD diagnosis, by itself, is too broad to discriminate among individuals with very different mechanisms and prognoses. The neurobiological distinction is clinically load-bearing, not just academically interesting."
```
