...
- question: "Syntax-first models of parsing (like Frazier's garden-path theory) claim that the parser initially uses most available information — including semantic plausibility, discourse context, and word frequency — to build sentence structure."
  type: true-false
  answer: false
