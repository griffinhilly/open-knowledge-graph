...
title: 'Cognitive Psychology: An Overview'
domain: psychology
...
- Cognitive psychology is not the same as cognitive neuroscience — it focuses on functional processes, not brain mechanisms.
- The information-processing metaphor is a useful analogy but does not imply the brain literally works like a digital computer.

## Questions

```yaml
- question: "How do cognitive psychologists typically study mental processes that cannot be directly observed?"
  type: multiple-choice
  options:
    - "By measuring neural firing patterns with fMRI and EEG while participants think."
    - "By inferring internal mental structures from behavioral measures such as reaction time, accuracy, and error patterns."
    - "By collecting self-report surveys about subjective experience and averaging the results."
    - "By observing behavior in naturalistic environments without any experimental manipulation."
  answer: 1
  explanation: "Cognitive psychologists are defined by their focus on mental processes — attention, memory, language — but these cannot be measured directly. The field's methodological signature is using observable behavioral outputs (reaction times, error types, priming effects) as windows into internal processing. This is distinct from neuroscience (which measures brain activity) and from introspection or naturalistic observation."

- question: "Cognitive psychology emerged as a natural extension of behaviorism, inheriting its methods and theoretical commitments."
  type: true-false
  answer: false
  explanation: "Cognitive psychology emerged as a reaction against behaviorism, not an extension of it. Behaviorism had restricted psychology to observable stimulus-response relationships and rejected mental constructs as unscientific. The cognitive revolution argued that mental processes — attention, memory, reasoning — were legitimate and necessary objects of scientific study, fundamentally breaking from the behaviorist program even while retaining experimental rigor."

- question: "What is the information-processing metaphor in cognitive psychology, and what is one important limitation of taking it too literally?"
  type: short-answer
  answer: "The information-processing metaphor treats the mind as analogous to a computer: sensory input is encoded, stored in memory, retrieved, and used to generate output responses. It provides a useful vocabulary (encoding, storage, retrieval, capacity limits) for organizing findings. A key limitation is that brains are not digital computers — they are massively parallel, content-addressable, shaped by emotion and context, and they degrade gracefully rather than crashing. Treating the metaphor as a literal description leads to models that miss distinctively biological features of cognition."
