...
prerequisites:
- id: resilience-and-bouncing-back
  type: hard
...
- Thinking that struggling with change means you are weak; adapting to change is hard for everyone, and discomfort is a normal part of the process.
- Believing you should be able to adjust to any change instantly; healthy adjustment takes time and it is OK to grieve what you lost.
- Assuming that embracing change means you should not value stability; wanting some things to stay the same is natural and healthy.

## Questions

```yaml
- question: "Which is a healthy way to cope with big changes or uncertainty?"
  type: multiple-choice
  options:
    - "Pretend the change isn't happening"
    - "Talk to people you trust about your feelings"
    - "Only focus on things you can't control"
    - "Avoid the situation entirely"
  answer: 1
  explanation: "Talking to trusted people helps you process your feelings, get support, and gain perspective on the change."

- question: "When you're facing uncertainty, it's helpful to focus on things you can control and let go of things you can't."
  type: true-false
  answer: true
  explanation: "True. Spending energy on what you can't control creates stress. Focusing on what you *can* influence helps you feel more grounded and resourceful."

- question: "If you're anxious about a change, staying in your room and avoiding people will help you feel better."
  type: true-false
  answer: false
  explanation: "False. Isolation usually increases anxiety. Connection, activity, and talking to others tend to help more, though taking time alone is also okay in balance."

- question: "You're moving to a new school. What would help you cope with this change?"
  type: multiple-choice
  options:
    - "Decide right now that the new school will be terrible"
    - "Learn about the school, connect with other students before you start, and remember that change takes time"
    - "Avoid thinking about it until the day you start"
    - "Compare yourself to other kids immediately"
  answer: 1
  explanation: "Preparing, connecting with people, and being patient with yourself all help you adjust to big changes."

- question: "What is one way you could manage anxiety about an uncertain future (like college or a big decision)?"
  type: short-answer
  answer: "Examples: Focus on what you can control (studying, skills, interests). Talk to people who've been through it. Break it into smaller, manageable steps. Practice mindfulness or breathing. Remember that you don't need to know everything right now."
  explanation: "Good answers show practical coping strategies that reduce overwhelm by either managing what you can or accepting what you can't."
```
