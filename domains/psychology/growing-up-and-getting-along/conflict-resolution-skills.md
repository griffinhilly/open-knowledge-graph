...
domain: psychology
course: growing-up-and-getting-along
prerequisites:
- id: dealing-with-conflict
  type: hard
- id: communication-skills-assertive
  type: hard
...
- Thinking conflict resolution always ends with both sides happy; sometimes the best outcome is a fair compromise where neither side gets everything.
- Believing the loudest or most powerful person should win a conflict; effective resolution is about understanding and fairness, not dominance.
- Assuming conflict resolution is a one-time event; some conflicts require ongoing communication and revisiting the agreement.

## Questions

```yaml
- question: "What is a healthy first step when you're in conflict with someone?"
  type: multiple-choice
  options:
    - "Get your friends to take your side"
    - "Cool down, then try to talk when you're calmer"
    - "Avoid the person forever"
    - "Post about it on social media"
  answer: 1
  explanation: "Cooling down first helps you think more clearly and communicate better, which actually resolves conflicts faster than jumping into the argument."

- question: "To resolve a conflict, both people have to admit they were wrong."
  type: true-false
  answer: false
  explanation: "False. Resolution doesn't require both people to admit wrongness. Sometimes you agree to disagree, understand each other's perspective, or find a compromise."

- question: "In a conflict, focusing on the other person's flaws is the best way to solve the problem."
  type: true-false
  answer: false
  explanation: "False. Focusing on the other person's flaws usually escalates the conflict. Focusing on specific behaviors and their impact is more productive."

- question: "You and a friend disagree about a plan for the weekend. The best approach is:"
  type: multiple-choice
  options:
    - "Insist your plan is better"
    - "Listen to their idea, share yours, and look for a compromise or find out why each matters"
    - "Let them choose so you don't seem difficult"
    - "Silently resent them for disagreeing"
  answer: 1
  explanation: "This approach honors both perspectives, looks for common ground, and strengthens the friendship by showing you care about their preferences too."

- question: "Describe the steps you would take to resolve a conflict with someone you care about."
  type: short-answer
  answer: "Example: (1) Cool down so I'm not reacting emotionally. (2) Choose a private, calm time to talk. (3) Listen to their perspective without interrupting. (4) Explain my perspective. (5) Look for common ground or compromise. (6) Agree on what to do differently going forward."
  explanation: "Good answers show a structured, respectful approach that prioritizes understanding, calm communication, and finding a workable path forward."
```
