...
- Thinking emotional intelligence means being emotional or overly sensitive; it means being skilled at understanding and using emotions effectively.
- Believing EQ is fixed and cannot be improved; emotional intelligence is a set of learnable skills that develop with practice.
- Assuming high EQ means always being nice or agreeable; emotionally intelligent people can be assertive, set boundaries, and have difficult conversations.
...
- question: "What are the four main parts of emotional intelligence?"
  ...
  options:
    - "Memory, speed, strength, coordination"
    - "Self-awareness, self-management, social awareness, relationship management"
    - "Happiness, sadness, anger, fear"
    - "IQ, athleticism, creativity, luck"
  answer: 1
  explanation: "These four skills — knowing yourself, managing yourself, understanding others, and handling relationships — are the core of emotional intelligence."

- question: "Emotional intelligence is something you're born with and can't improve."
  type: true-false
  answer: false
  explanation: "False. Emotional intelligence is made up of learnable skills. You can get better at recognizing emotions, managing them, and connecting with others through practice."

- question: "Having high emotional intelligence means you never feel angry, sad, or upset."
  type: true-false
  answer: false
  explanation: "False. Emotionally intelligent people feel all emotions. They just understand them better and know how to work with them instead of being overwhelmed."

- question: "Why is emotional intelligence important?"
  type: multiple-choice
  options:
    - "It doesn't matter; just focus on grades"
    - "It helps you understand yourself and others, handle stress, build better relationships, and make wiser decisions"
    - "It's only for adults"
    - "It's the same as IQ"
  answer: 1
  explanation: "Emotional intelligence affects every part of your life — from friendships to school to how you handle problems."

- question: "Choose one of the four EQ skills and describe how you could improve it."
  type: short-answer
  answer: "Examples: Self-awareness (journaling about your feelings), self-management (breathing when you're angry), social awareness (noticing others' body language), relationship management (listening better in conversations)."
  explanation: "Good answers show concrete practices that target a specific EQ skill and are realistic for your life."
```
