...
- Thinking emotional regulation means never showing emotions; it means responding to emotions thoughtfully rather than reactively.
- Believing that some people are just naturally good at regulating emotions; it is a skill that takes practice and everyone struggles at times.
- Assuming one regulation strategy works for every situation; effective regulation requires multiple tools and the judgment to know which one fits.

## Questions

```yaml
- question: "What does emotional regulation mean?"
  type: multiple-choice
  options:
    - "Never feeling big emotions"
    - "Having skills to understand and manage your emotions so they don't control you"
    - "Pretending you're fine when you're not"
    - "Getting angry whenever you feel like it"
  answer: 1
  explanation: "Emotional regulation is about developing tools to work with your emotions — feeling them without being overwhelmed or controlled by them."

- question: "Deep breathing and counting to ten are good strategies when you're upset."
  type: true-false
  answer: true
  explanation: "True. These techniques calm your nervous system, giving your brain time to shift out of pure emotion and back into thinking mode."

- question: "The best way to regulate your emotions is to push them away and not think about them."
  type: true-false
  answer: false
  explanation: "False. Pushing emotions away usually makes them stronger. Better strategies include acknowledging the feeling, doing something physical, or talking to someone."

- question: "When you feel like you might explode with anger, a helpful first step is:"
  type: multiple-choice
  options:
    - "Tell everyone exactly what you think right now"
    - "Take a break — go for a walk, listen to music, breathe — before you respond"
    - "Punch a pillow as hard as you can"
    - "Text someone mean stuff"
  answer: 1
  explanation: "Taking a break gives your brain time to calm down so you can respond thoughtfully instead of reacting purely from anger."

- question: "List two emotional regulation strategies you could use when you're anxious or upset."
  type: short-answer
  answer: "Examples: deep breathing, physical exercise, journaling, talking to someone, listening to music, taking a walk, meditation, progressive muscle relaxation, art or creativity."
  explanation: "Good answers show techniques that actually help you calm down — a mix of physical and mental strategies that work for you."
```
