...
title: Understanding Stereotypes and Bias
domain: psychology
course: growing-up-and-getting-along
prerequisites:
- id: respecting-differences
  type: hard
- id: cultural-identity-and-belonging
  type: hard
...
- Thinking that only intentionally prejudiced people have biases; unconscious bias is universal and does not make you a bad person.
- Believing that stereotypes are harmless if they seem positive ('Asians are good at math'); positive stereotypes also reduce individuals to group generalizations.
- Assuming you can eliminate all bias through willpower alone; managing bias is an ongoing practice of awareness and correction, not a one-time fix.
...
- question: "What is a stereotype?"
  ...
  options:
    - "A true fact about a group"
    - "An oversimplified belief about a group that doesn't account for individual differences"
    - "A helpful way to understand people"
    - "Something only other people do"
  answer: 1
  explanation: "Stereotypes are simplified beliefs that ignore the complexity and individuality of people in a group."

- question: "Stereotypes are harmless if they're positive (like 'all Asians are good at math')."
  type: true-false
  answer: false
  explanation: "False. Even 'positive' stereotypes are limiting and harmful. They put pressure on people to fit a mold and ignore who they actually are."

- question: "If you grew up with a bias, that makes you a bad person."
  type: true-false
  answer: false
  explanation: "False. Everyone has biases from how they were raised and what they've been exposed to. What matters is noticing them and working to change."

- question: "A good way to avoid bias is:"
  type: multiple-choice
  options:
    - "Never talk about race or differences"
    - "Notice your assumptions, learn about different groups, get to know people as individuals"
    - "Pretend everyone is the same"
    - "Accept stereotypes as truth"
  answer: 1
  explanation: "Actively questioning assumptions and getting real exposure to different people is how you reduce bias."

- question: "Can you think of a stereotype you've heard? Where did it come from and how is it inaccurate?"
  type: short-answer
  answer: "Examples: 'Quiet kids are shy' — some are private by choice. 'Girls are bad at sports' — depends on the person. 'Teenagers are lazy' — many work hard."
  explanation: "Good answers show recognizing a stereotype and understanding that individual differences matter more than group categories."
```
