...
prerequisites:
- id: self-esteem-what-you-are-good-at
  type: hard
- id: self-compassion
  type: soft
builds-toward:
...
- Thinking you should have your identity completely figured out by a certain age; identity development is a lifelong process.
- Believing your identity must fit neatly into one category or label; most people's identities are complex and multifaceted.
- Assuming that changing your mind about who you are means you were fake before; growth and change are natural parts of identity development.
...
- question: "What is identity?"
  ...
  options:
    - "Your name"
    - "The answer to 'Who am I?' — shaped by your values, interests, culture, relationships, and experiences"
    - "Something you're born with and never changes"
    - "What you look like on the outside"
  answer: 1
  explanation: "Identity is complex and personal — it includes your values, what you care about, your background, your interests, and how you relate to others."

- question: "You should have your entire identity figured out by the time you're 14."
  type: true-false
  answer: false
  explanation: "False. Identity development is a lifelong process. Adolescence is when you start *actively* exploring, but it keeps unfolding through adulthood."

- question: "It's bad if you change your mind about who you are or what you care about."
  type: true-false
  answer: false
  explanation: "False. Changing your mind is part of growth. As you learn more about yourself and try new things, your sense of identity naturally evolves."

- question: "Which of these is an example of exploring your identity in healthy ways?"
  type: multiple-choice
  options:
    - "Completely copying another person"
    - "Trying different activities, asking yourself what you actually value, talking with people about your questions"
    - "Never trying anything new"
    - "Only doing what your family expects"
  answer: 1
  explanation: "Identity exploration means trying things, reflecting on what fits for you, and gradually figuring out who *you* are, not copying someone else."

- question: "Describe three parts of your identity and how they shape who you are."
  type: short-answer
  answer: "Examples: My cultural background makes me value family; my love of art shapes how I express myself; my friendships are how I show up; my values guide my decisions."
  explanation: "Good answers show awareness that identity is multifaceted and that different parts of who we are influence our choices and relationships."
```
