...
title: The Bystander Effect and Taking Action
domain: psychology
...
- Thinking that telling an adult about bullying is snitching; reporting bullying to protect someone is courage, not tattling.
- Believing that one person standing up will not make a difference; research shows that even one bystander intervening can change the outcome.
- Assuming you have to confront the bully directly to be an upstander; supporting the target or getting help are equally valuable actions.
...
- question: "What is the bystander effect?"
  ...
  options:
    - "When someone helps an injured person"
    - "When people are less likely to help because others are present"
    - "When a group plans something together"
    - "When someone stands on the sidelines of a game"
  answer: 1
  explanation: "The bystander effect is a real phenomenon: people are less likely to help in a situation when other people are around, often assuming someone else will handle it."

- question: "You see a younger student being teased by a group, and there are lots of other kids around. You should definitely help because the bystander effect won't apply to you."
  type: true-false
  answer: false
  explanation: "False. The bystander effect can influence you too — the more people present, the easier it is to assume someone else will step in. Recognizing this helps you override it."

- question: "If you witness something wrong happening, you always need to directly confront the situation."
  type: true-false
  answer: false
  explanation: "False. You can help in many ways: get a trusted adult, stand with the person being harmed, speak up, or offer support afterward. The goal is to help, not to put yourself in danger."

- question: "How could you overcome the bystander effect if you see someone being bullied at lunch?"
  type: multiple-choice
  options:
    - "Assume a teacher will handle it"
    - "Sit with them and be a friendly presence"
    - "Tell yourself someone else will help"
    - "Record it on your phone to post later"
  answer: 1
  explanation: "Sitting with the person, being their ally, offering support, or getting a trusted adult are ways to take action instead of just standing by."

- question: "Think of a situation where you could help someone. What would you do?"
  type: short-answer
  answer: "Examples: speak up when someone is being excluded, sit with someone alone at lunch, tell a teacher if you see bullying, include someone new in your group, defend someone's reputation."
  explanation: "Good answers show specific, realistic ways you could take action — from small social gestures to getting an adult involved — depending on the situation."
```
