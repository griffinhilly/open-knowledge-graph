...
- Thinking bullying builds character or toughens kids up; research consistently shows bullying causes lasting psychological harm.
- Believing that ignoring bullying will make it stop; bullying often escalates without intervention.
- Assuming bullying is only physical; verbal, social, and digital bullying can be just as harmful or more so.
...
- question: "What counts as bullying?"
  ...
  options:
    - "Being mean one time"
    - "Repeated, intentional harm with a power imbalance (more powerful person targeting someone they perceive as weaker)"
    - "Two friends having a conflict"
    - "Someone being annoying"
  answer: 1
  explanation: "Bullying involves a pattern, intention to harm, and a power dynamic — not just one mean comment or a conflict between equals."

- question: "If you're being bullied, it's your fault because you probably did something to deserve it."
  type: true-false
  answer: false
  explanation: "False. Bullying is never the target's fault. People bully for many reasons (insecurity, wanting power), but nothing justifies it."

- question: "If you see bullying happening, it's not your responsibility to do anything."
  type: true-false
  answer: false
  explanation: "False. You can't control what bullies do, but you can get an adult involved or be an ally to the person being hurt."

- question: "If you're being bullied, what should you do?"
  type: multiple-choice
  options:
    - "Keep it secret and try to handle it alone"
    - "Tell a trusted adult, document what's happening, and stay connected to supportive friends"
    - "Bully them back"
    - "Assume it will go away on its own"
  answer: 1
  explanation: "Getting adults involved and staying connected to support is how bullying actually stops, not through secrecy or retaliation."

- question: "Describe what you would do if you witnessed someone being bullied."
  type: short-answer
  answer: "Examples: Stand with the person being bullied. Tell a trusted adult. Don't join in. Send the person a message of support. Refuse to laugh at mean jokes."
  explanation: "Good answers show taking some action, whether direct support or getting adult help, rather than staying silent."
```
