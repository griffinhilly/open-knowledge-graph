...
- id: cognitive-reappraisal
  type: hard
- id: mindfulness-and-present-moment
  type: hard
builds-toward:
...
- Thinking that stressed people are weak or cannot handle life; stress is a universal human experience and managing it is a skill, not a character trait.
- Believing that the best way to deal with stress is to avoid stressful situations; avoidance often increases anxiety over time.
- Assuming that asking for professional help with anxiety means something is seriously wrong with you; seeking help is a sign of self-awareness and strength.

## Questions

```yaml
- question: "What is a good first step when you're feeling anxious or stressed?"
  type: multiple-choice
  options:
    - "Avoid the situation completely"
    - "Notice what you're feeling and try a calming strategy like breathing or talking to someone"
    - "Pretend nothing is wrong"
    - "Assume the worst will happen"
  answer: 1
  explanation: "Acknowledging stress and using calming techniques helps your nervous system settle so you can think more clearly."

- question: "Exercise and physical activity make anxiety worse."
  type: true-false
  answer: false
  explanation: "False. Physical activity actually reduces anxiety by burning off nervous energy and releasing calming chemicals in your brain."

- question: "If you're stressed, you have to fix the whole problem right now or you can't relax."
  type: true-false
  answer: false
  explanation: "False. You can relax while something is still unresolved. Taking breaks to calm down actually helps you handle problems better when you return to them."

- question: "Which is a helpful coping strategy for anxiety?"
  type: multiple-choice
  options:
    - "Caffeine and energy drinks"
    - "Deep breathing, talking to someone, physical activity, or spending time on something you enjoy"
    - "Isolating yourself"
    - "Worrying more to solve the problem"
  answer: 1
  explanation: "These strategies calm your nervous system and help you gain perspective on the stress."

- question: "Describe three ways you could manage stress when you're feeling overwhelmed."
  type: short-answer
  answer: "Examples: Take deep breaths or meditate. Go for a walk or exercise. Talk to a friend or trusted adult. Journal about what's worrying me. Do something I enjoy. Break the problem into smaller steps. Ask for help."
  explanation: "Good answers show a mix of physical, emotional, and practical strategies that actually help reduce overwhelm."
```
