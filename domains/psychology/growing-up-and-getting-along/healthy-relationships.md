...
- Thinking that jealousy or possessiveness is a sign of love; in healthy relationships, trust means giving each other freedom.
- Believing that healthy relationships never involve conflict; healthy relationships have conflict but handle it with respect and communication.
- Assuming that you should stay in an unhealthy relationship because you care about the person; caring about yourself is equally important.
...
- question: "What's a sign of a healthy relationship?"
  ...
  options:
    - "Both people have to agree on everything"
    - "Both people can be themselves, respect each other, and talk about problems"
    - "One person controls what the other does"
    - "There's never any conflict"
  answer: 1
  explanation: "Healthy relationships include mutual respect, acceptance, honesty, and the ability to work through disagreements together."

- question: "In a healthy friendship or relationship, it's okay to have different opinions from the other person."
  type: true-false
  answer: true
  explanation: "True. Real relationships can include disagreement and difference. The key is respecting each other even when you don't agree."

- question: "If someone really loves you, they should want to know your password and see all your messages."
  type: true-false
  answer: false
  explanation: "False. Healthy relationships include boundaries and privacy. Love includes trusting someone, not controlling them."

- question: "Your friend constantly puts you down, makes you feel bad about yourself, and acts like they're better than you. This is:"
  type: multiple-choice
  options:
    - "A healthy friendship"
    - "A sign you should think about whether this friendship is good for you"
    - "Your fault"
    - "Just how some friendships are"
  answer: 1
  explanation: "This is not okay. Healthy relationships build you up, not tear you down. You deserve friends who respect and value you."

- question: "List two qualities you want in your close relationships."
  type: short-answer
  answer: "Examples: trust, honesty, respect, acceptance, fun, support, loyalty, someone who listens, someone who makes me feel good about myself."
  explanation: "Good answers show understanding that healthy relationships are based on mutual respect and care, not control or pressure."
```
