...
title: 'Cognitive Reappraisal: Changing How You Think About It'
domain: psychology
course: growing-up-and-getting-along
prerequisites:
- id: emotional-regulation-strategies
  type: hard
builds-toward:
...
- Thinking reappraisal means pretending everything is fine; it means finding a more accurate and helpful way to think about a real situation.
- Believing you should reappraise every negative emotion; sometimes the appropriate response is to feel the feeling fully and then act on it.
- Assuming reappraisal is easy; changing habitual thought patterns takes deliberate practice and does not happen overnight.
...
- question: "What is cognitive reappraisal?"
  ...
  options:
    ...
    - "Thinking about a situation in a new way to change how you feel"
    - "Pretending nothing bad happened"
    - "Asking others to fix your problems"
  answer: 1
  explanation: "Cognitive reappraisal means taking a different perspective on a situation, which can actually change your emotional response to it."

- question: "If you reappraise a situation, your feelings will instantly disappear."
  type: true-false
  answer: false
  explanation: "False. Reappraisal doesn't make feelings vanish instantly, but it can shift your perspective so the feelings become more manageable and less overwhelming."

- question: "Reappraisal means you are lying to yourself or denying the bad parts of a situation."
  type: true-false
  answer: false
  explanation: "False. Reappraisal doesn't deny the truth. It acknowledges the situation while looking for other true aspects — finding opportunity in challenge, growth in difficulty, or compassion in conflict."

- question: "You didn't make the soccer team. A reappraisal of this situation might be:"
  type: multiple-choice
  options:
    - "I'm a failure and I'll never be good at anything"
    - "This is disappointing, but it's a chance to improve my skills or try a different sport"
    - "I should quit trying"
    - "Everyone thinks I'm bad at sports"
  answer: 1
  explanation: "Reappraisal acknowledges the disappointment while seeing opportunity and possibility — a more balanced, helpful way to think about the setback."

- question: "Describe a difficult situation and how you could reappraise it in a more helpful way."
  type: short-answer
  answer: "Example: Getting rejected from a group → I'm not a fit for that group, but maybe I'll find friends elsewhere who share my values. Failing a test → I understand less than I thought, which shows me where to study. Argument with a friend → We both care enough to be honest, so we can work it out."
  explanation: "Good answers acknowledge the difficulty AND find a more constructive way to think about it — without denying the challenge itself."
```
