...
- Thinking growth mindset means anyone can become anything with enough effort; effort matters enormously but so do starting points, resources, and circumstances.
- Believing growth mindset means you should never feel frustrated or want to quit; it means you keep going despite those feelings.
- Assuming you either have a growth mindset or a fixed mindset permanently; most people have a mix, and it varies by domain and situation.

## Questions

```yaml
- question: "What is the difference between a growth mindset and a fixed mindset?"
  type: multiple-choice
  options:
    - "Growth mindset means you're always happy; fixed mindset means you're sad"
    - "Fixed mindset: abilities are unchangeable. Growth mindset: abilities can improve with effort"
    - "They're the same thing"
    - "Fixed mindset is better"
  answer: 1
  explanation: "A growth mindset means you believe you can improve through practice; a fixed mindset means you believe your abilities are locked in place."

- question: "If you have a growth mindset, you will never struggle or fail."
  type: true-false
  answer: false
  explanation: "False. A growth mindset means you expect challenges and failure as part of learning. You struggle *and keep trying* instead of giving up."

- question: "Talent matters more than effort in determining success."
  type: true-false
  answer: false
  explanation: "False. Research shows that effort, practice, and persistence matter as much as (or more than) raw talent for reaching goals."

- question: "A fixed mindset response to struggling with math would be:"
  type: multiple-choice
  options:
    - "I'm just not a math person"
    - "I don't get this yet, but I can improve with help and practice"
    - "I'm stupid"
    - "Everyone's better at math than me"
  answer: 1
  explanation: "A growth mindset response acknowledges the struggle but frames it as temporary and solvable through effort."

- question: "Think of something you find difficult. Write a growth mindset statement about it."
  type: short-answer
  answer: "Example: If you struggle with public speaking: 'I'm nervous about speaking in front of people, AND I can get better with practice. Each time I do it, I'll improve.'"
  explanation: "Good answers acknowledge the difficulty while adding 'yet' or 'and' — opening space for improvement rather than deciding you're just bad at it."
```
