...
```yaml
- question: "Which of the following best describes the central question that distinguishes developmental psychology from other psychology subfields?"
  type: multiple-choice
  options: ["How do people differ from one another in personality and intelligence?", "How and why do people change systematically across the lifespan?", "What are the biological mechanisms underlying mental disorders?", "How does culture shape social behavior in adults?"]
  answer: 1
...
- question: "Developmental psychology treats nature and nurture as opposing explanations for development. What does current research suggest about this distinction?"
  type: short-answer
  answer: "Nature and nurture interact continuously — genes shape how an organism responds to environments, and environments shape which genes are expressed. The question is not 'nature OR nurture' but 'how do genetic predispositions and environmental experiences interact to produce outcomes?'"
