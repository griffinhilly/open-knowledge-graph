...
```yaml
- question: "Talent management differs from traditional HR management primarily because it..."
  type: multiple-choice
  options:
    - "Focuses exclusively on executive compensation and benefits"
    - "Integrates selection, development, and retention into a coherent strategic system aligned with organizational objectives"
    - "Replaces scientific selection methods with intuitive talent identification"
    - "Applies only to organizations in the technology sector"
  answer: 1
  explanation: "Traditional HR management often treats recruitment, training, performance management, and retention as separate functional silos. Talent management integrates these functions into a coordinated system where each component informs the others — selection criteria align with development programs, development programs align with succession needs, and retention strategies target those the organization most needs to keep. The strategic alignment with organizational objectives is what distinguishes talent management from transactional HR administration."

- question: "The practice of identifying and differentially investing in 'high-potential' employees is universally accepted as fair and evidence-based in I-O psychology."
  type: true-false
  answer: false
  explanation: "The high-potential (HiPo) identification practice faces several challenges. Criteria for identifying HiPos often lack empirical validation — organizations may rely on subjective manager nominations that confound potential with current performance, similarity to the nominator, or political considerations. The practice can create a self-fulfilling prophecy (Galatea effect) where labeled HiPos receive more development resources and therefore advance, while unlabeled employees are denied opportunities. There are also equity concerns about whether the identification process systematically advantages certain demographic groups."

- question: "What is the strategic rationale for succession planning, and why do many organizations fail at it despite its obvious importance?"
  type: short-answer
  answer: "Succession planning ensures continuity of leadership and critical capabilities by proactively identifying and developing internal candidates for key positions before vacancies occur. Many organizations fail at it because of short-term focus (current performance pressures crowd out long-term development), political dynamics (discussing successors implies the incumbent will leave), inadequate development investment, and over-reliance on a 'replacement chart' approach that identifies names without actually developing the identified individuals."
