...
- Thinking that feeling angry means you are a bad person; anger is a normal emotion everyone experiences.
- Believing that anger always means you should hit or yell; there are safe ways to express anger.
- Assuming anger comes out of nowhere; there is usually a reason behind the feeling, even if it is hard to name.

## Questions

```yaml
- question: "What is the hot, tight feeling when something seems unfair?"
  type: multiple-choice
  options: ["Angry", "Happy", "Sad", "Excited"]
  answer: 0
  explanation: "Angry is that hot, tight feeling when something is unfair, someone hurts you, or things do not go the way you expected. It is a real feeling that everyone has."

- question: "If you feel angry, it means you are a bad person."
  type: true-false
  answer: false
  explanation: "This is not true. Anger is a normal feeling that everyone experiences. Feeling angry does not make you bad — it is just a feeling. How you handle it is what matters."

- question: "What are safe ways to show you are angry?"
  type: multiple-choice
  options: ["Hit or yell", "Squeeze a stress ball or stomp your feet", "Just keep it inside", "Knock things over"]
  answer: 1
  explanation: "Safe ways to show anger include squeezing a stress ball, stomping your feet, drawing, or saying 'I feel angry because...' These help you express your anger without hurting anyone."

- question: "Anger comes out of nowhere for no reason at all."
  type: true-false
  answer: false
  explanation: "This is not true. There is usually a reason for anger, even if it takes a moment to figure it out. Something unfair happened, or something did not go the way you wanted."

- question: "Tell about a time when you might feel angry and what you could do instead of hitting."
  type: short-answer
  answer: "I feel angry when someone takes my toy. I could say 'I feel angry because...' or squeeze a stress ball"
  explanation: "A good answer describes a real situation and a safe way to show the angry feeling. Talking, squeezing, stomping, or drawing are all safe choices."
```
