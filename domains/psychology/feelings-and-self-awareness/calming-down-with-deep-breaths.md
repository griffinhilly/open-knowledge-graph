...
title: Calming Down with Deep Breaths
domain: psychology
...
# Calming Down with Deep Breaths
...
- Thinking deep breaths will make your feelings disappear instantly; breathing helps you calm your body, but the feeling might still be there — and that is OK.
- Believing you have to take deep breaths perfectly for them to work; any slow breathing helps, even if it is not perfect.
- Assuming deep breathing is only for when you are upset; breathing exercises can help anytime, even when you just want to feel peaceful.

## Questions

```yaml
- question: "When you take slow, deep breaths, what happens to your body?"
  type: multiple-choice
  options: ["Your heart slows down and your muscles relax", "Nothing happens", "You get more upset", "You cannot breathe anymore"]
  answer: 0
  explanation: "Deep breaths tell your body that you are safe. Your heart slows down, your muscles relax, and your whole body feels calmer."

- question: "Deep breathing will make your bad feeling disappear instantly."
  type: true-false
  answer: false
  explanation: "This is not true. Deep breathing helps calm your body, but the feeling might still be there. And that is okay! The breathing helps, and the feeling will get smaller over time."

- question: "What does 'smell the flower, blow out the candle' mean?"
  type: multiple-choice
  options: ["You need flowers and candles nearby", "You breathe in slowly, then breathe out slowly", "You cannot do deep breathing without them", "It is not a real breathing exercise"]
  answer: 1
  explanation: "It is a fun way to remember how to breathe! You breathe in slowly through your nose (like smelling a flower) and out slowly through your mouth (like blowing out a candle)."

- question: "You have to take deep breaths perfectly for them to work."
  type: true-false
  answer: false
  explanation: "This is not true. You do not have to do it perfectly! Any slow breathing helps your body calm down, even if it is not perfect."

- question: "When could you use deep breathing?"
  type: short-answer
  answer: "When I feel upset, when I feel scared, or even when I just want to feel peaceful and calm"
  explanation: "Good answers show that you can use breathing anytime — not just when you are upset. You can breathe anytime you want to feel calm."
```
