...
- Thinking that crying means you are weak or being a baby; crying is a healthy way to express sadness at any age.
- Believing that sadness lasts forever; sad feelings come and then they go away.
- Assuming that if someone is sad, something is wrong with them; sadness is a normal part of life.

## Questions

```yaml
- question: "What is the heavy, slow feeling you get when something sad happens?"
  type: multiple-choice
  options: ["Sad", "Excited", "Angry", "Surprised"]
  answer: 0
  explanation: "Sad is that heavy feeling when something goes wrong or when you lose something you care about. It is a feeling everyone has sometimes, and it is okay."

- question: "It is weak or babyish to cry when you feel sad."
  type: true-false
  answer: false
  explanation: "This is not true. Crying is a healthy way to show sadness, and people of all ages cry sometimes. Crying helps your body express big feelings."

- question: "What might make someone feel sad?"
  type: multiple-choice
  options: ["A friend moving away", "A toy breaking", "Having to say goodbye", "All of these can make you sad"]
  answer: 3
  explanation: "Sad feelings come from many different situations. When we lose something or someone we care about, or when things do not go the way we hoped, sadness is a normal feeling."

- question: "Sadness lasts forever and you will feel sad your whole life."
  type: true-false
  answer: false
  explanation: "This is not true. Sad feelings come, and then they go away. Even when sadness feels big, it will get better. All feelings change over time."

- question: "What could you do if you are feeling sad?"
  type: short-answer
  answer: "You could cry, talk to someone you trust, get a hug, rest, or draw a picture"
  explanation: "There are many ways to help yourself when you feel sad. You can let yourself cry, talk about what is wrong, get comfort from someone you love, or do a calm activity."
```
