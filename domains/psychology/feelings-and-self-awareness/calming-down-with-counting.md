...
title: Calming Down by Counting
domain: psychology
...
- Thinking counting to ten will fix the problem; counting gives you time to calm down, but you may still need to talk about what happened.
- Believing you must always count to exactly ten; sometimes counting to five is enough, and sometimes you need more time.
- Assuming counting is babyish; many adults use this same strategy when they need a moment to think.

## Questions

```yaml
- question: "What does counting slowly help you do?"
  type: multiple-choice
  options: ["Solve math problems", "Give yourself time to calm down and think", "Make the problem go away", "Count all your feelings"]
  answer: 1
  explanation: "Counting slowly gives your body a chance to calm down and your brain a chance to think about what to do next. It is a great way to pause."

- question: "When you count to ten, it will fix the problem you are having."
  type: true-false
  answer: false
  explanation: "This is not true. Counting helps you calm down, but you may still need to talk about what happened or find a solution. Counting is just the first step."

- question: "How many numbers do you have to count to for it to work?"
  type: multiple-choice
  options: ["Always exactly ten", "Sometimes five is enough, sometimes you need more, and that is okay", "You cannot do it with less than twenty", "It does not matter how many you count"]
  answer: 1
  explanation: "You can count to five, ten, or even more. It depends on what you need. Everyone is different, and that is perfect."

- question: "Using counting to calm down is babyish and only for little kids."
  type: true-false
  answer: false
  explanation: "This is not true. Many grown-ups use this same strategy when they need a moment to think. It is smart and helpful at any age."

- question: "When could counting help you?"
  type: short-answer
  answer: "When I feel angry, when I want to say something mean, or when I need to calm down before I act"
  explanation: "Good answers show situations where you might feel upset and need time to calm down before deciding what to do."
```
