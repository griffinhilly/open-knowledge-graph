---
id: my-feelings-are-mine
title: My Feelings Are Mine
domain: psychology
...
- Thinking that if someone tells you not to feel something, you should be able to stop feeling it; feelings do not work that way.
- Believing that your feelings are wrong if other people do not share them; you can feel differently from others and still be right about your own experience.
- Assuming that owning your feelings means acting on every feeling; you can honor your feelings while still choosing wise actions.

## Questions

```yaml
- question: "If someone says 'Do not be sad,' what happens?"
  type: multiple-choice
  options: ["Your sadness goes away immediately", "The sadness stays because you cannot control it with words", "You are a bad person", "You should hide your feelings"]
  answer: 1
  explanation: "The sadness does not go away just because someone says not to feel it. Your feelings are real and belong to you. Words cannot turn them off."

- question: "If you feel something different from your friend, your feelings are wrong."
  type: true-false
  answer: false
  explanation: "This is not true. You can feel differently from others and still be right about your own feelings. Your feelings are real even if your friend feels something else."

- question: "What does it mean to own your feelings?"
  type: multiple-choice
  options: ["You can do anything you want because it is your feeling", "Your feelings are real and important, and they belong to you", "You should never tell anyone about them", "Your feelings control everything you do"]
  answer: 1
  explanation: "Owning your feelings means knowing they are real, knowing they are yours, and knowing they are important. It does not mean you act on every feeling."

- question: "If you own your feelings, you have to act on them right away."
  type: true-false
  answer: false
  explanation: "This is not true. You can honor your feelings and know they are real while still choosing to act wisely. You can feel angry and still choose to be kind."

- question: "Someone says 'You should not be scared,' but you are scared anyway. What could you say?"
  type: short-answer
  answer: "My feelings are real, even if you do not see things the same way. I feel scared, and that is okay."
  explanation: "A good answer shows that you stand up for your own feelings and remind others that your experience is real and important."
```
