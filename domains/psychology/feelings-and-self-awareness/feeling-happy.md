...
- Thinking you should feel happy all the time; all feelings are normal and it is OK to not always be happy.
- Believing that the same things make everyone happy; different people enjoy different things.
- Confusing being quiet or calm with being unhappy; someone can feel content without showing big smiles.

## Questions

```yaml
- question: "What is a warm feeling you get when something good happens?"
  type: multiple-choice
  options: ["Happy", "Angry", "Scared", "Sad"]
  answer: 0
  explanation: "Happy is that warm, light feeling when something good happens, like getting a hug or playing with a friend. The other feelings come from different situations."

- question: "Everyone feels happy all the time, and that is a good thing."
  type: true-false
  answer: false
  explanation: "This is not true. It is OK to not feel happy all the time. All different feelings are normal and healthy, and sometimes we feel sad, angry, or scared instead."

- question: "If your friend likes playing with blocks but you like painting, is that OK?"
  type: multiple-choice
  options: ["No, you should like the same things", "Yes, different people enjoy different things", "Only if you like both", "You should like what they like"]
  answer: 1
  explanation: "Yes! Different people are happy doing different things. What makes one person happy might not make another person happy, and that is perfectly fine."

- question: "You can only be happy if you are smiling big and laughing."
  type: true-false
  answer: false
  explanation: "This is not true. Someone can feel happy and calm without a big smile. They might feel quiet and peaceful, and that can be happiness too."

- question: "What is something that makes YOU feel happy?"
  type: short-answer
  answer: "Playing with a friend, getting a hug, playing with a toy, hearing a favorite song, or eating a favorite snack"
  explanation: "A good answer describes something real from your life that brings you joy. It could be anything — different things make different people happy."
```
