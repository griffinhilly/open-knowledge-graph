...
- Thinking that having a big feeling means you are being bad; big feelings happen to everyone and are not your fault.
- Believing that big feelings will last forever; even the biggest feelings always get smaller with time.
- Assuming you should be able to stop a big feeling immediately; it is OK to take time to calm down.

## Questions

```yaml
- question: "When feelings get really, really big, what does that mean?"
  type: multiple-choice
  options: ["You are being bad", "Your body might shake, you might cry hard, and the feeling feels very strong", "You should hide", "Something is wrong with you"]
  answer: 1
  explanation: "Big feelings are not bad — they just mean the feeling is very strong. Your body might shake or you might cry a lot. This happens to everyone sometimes."

- question: "If you have a big feeling, it will last forever."
  type: true-false
  answer: false
  explanation: "This is not true. Even the biggest feelings always get smaller with time. Big feelings do not last forever. They feel big right now, but they will calm down."

- question: "What can help you when your feelings get big?"
  type: multiple-choice
  options: ["Ignore them", "Use calming tools like deep breathing, and ask a trusted adult for help", "Just wait and do nothing", "Keep the feeling inside"]
  answer: 1
  explanation: "When feelings get big, calming tools like deep breathing help. Talking to a trusted adult also helps. These things help you ride the wave until the feeling gets smaller."

- question: "You should be able to stop a big feeling immediately right away."
  type: true-false
  answer: false
  explanation: "This is not true. It is okay to take time to calm down. Big feelings take a while to get smaller, and that is completely normal. Be patient with yourself."

- question: "Tell about what you could do if your feelings get very big and scary."
  type: short-answer
  answer: "I could take deep breaths, squeeze a stress ball, find a trusted adult, or go to a calm space"
  explanation: "Good answers include specific calming tools or people who can help. The important thing is knowing you have ways to help yourself when feelings get big."
```
