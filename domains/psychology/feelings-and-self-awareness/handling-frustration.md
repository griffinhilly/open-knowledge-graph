...
- Thinking that feeling frustrated means you should give up; frustration often means you are learning something new.
- Believing that other people never feel frustrated; everyone gets frustrated, even adults and experts.
- Assuming that asking for help when frustrated is cheating; asking for help is a smart strategy.
...
- question: "What is frustration?"
  ...
  options: ["A happy feeling", "A hot, stuck feeling when something is hard and you cannot do it yet", "A boring feeling", "Something only bad kids feel"]
  answer: 1
  explanation: "Frustration is that hot, stuck feeling when you are trying to do something and it is hard. It happens to everyone when learning new things."

- question: "When you feel frustrated, you should give up and stop trying."
  type: true-false
  answer: false
  explanation: "This is not true. Frustration often means you are learning something new. It is a sign to keep trying, ask for help, or try a different way."

- question: "Who feels frustrated?"
  type: multiple-choice
  options: ["Only little kids", "Only grown-ups", "Everyone — kids, grown-ups, and even experts", "Nobody really feels frustrated"]
  answer: 2
  explanation: "Everyone feels frustrated! Even grown-ups and experts get frustrated when learning something new. It is a normal feeling everyone has."

- question: "Asking for help when frustrated is the same as cheating."
  type: true-false
  answer: false
  explanation: "This is not true. Asking for help is a smart strategy! People who are smart and strong ask for help when they need it. Asking for help shows you are brave."

- question: "What could you do when you feel frustrated?"
  type: short-answer
  answer: "Take a break, ask for help, try a different way, or take some deep breaths"
  explanation: "Good answers show different strategies you can use. You have choices when you feel frustrated — breaking, asking, trying new ways, and calming down all help."
```
