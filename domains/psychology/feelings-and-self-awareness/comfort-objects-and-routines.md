...
title: Comfort Objects and Routines
domain: psychology
...
- Thinking that needing a comfort object means you are a baby; many people of all ages have things that help them feel calm.
- Believing routines have to be exactly the same every single time; small changes are normal and OK.
- Assuming that everyone finds comfort in the same things; some children like soft things, others like music or movement.

## Questions

```yaml
- question: "What is a comfort object?"
  type: multiple-choice
  options: ["Something you have to have", "Something like a favorite blanket or stuffed animal that helps you feel safe and calm", "A toy you play with all day", "Something that makes you feel upset"]
  answer: 1
  explanation: "A comfort object is something special that helps your body and mind feel calm and safe. It might be soft, or warm, or something special that you love."

- question: "If you need a comfort object, it means you are a baby."
  type: true-false
  answer: false
  explanation: "This is not true. Many people of all ages have things that help them feel calm — even grown-ups! Comfort objects are for everyone."

- question: "What is a routine?"
  type: multiple-choice
  options: ["Things that change every day", "Things you do in the same order, like a bedtime story or morning song", "Something you do just sometimes", "None of these"]
  answer: 1
  explanation: "A routine is a set of things you do in the same order. Knowing what comes next helps you feel safe because you know what to expect."

- question: "Routines have to be exactly the same every single time."
  type: true-false
  answer: false
  explanation: "This is not true. Small changes are normal and okay. The routine does not have to be perfect — it just needs to help you feel safe and calm."

- question: "What is a comfort object or routine that helps YOU feel safe?"
  type: short-answer
  answer: "My stuffed animal, my blanket, my bedtime story, or singing a morning song"
  explanation: "Good answers name something real that brings you comfort. Different things comfort different people, and that is perfect."
```
