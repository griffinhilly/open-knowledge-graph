...
- Confusing excitement with being naughty; having lots of energy from excitement is normal, not bad behavior.
- Thinking excitement and happiness are the same thing; excitement has more energy and is usually about something in the future.
- Believing that excitement means you do not have to follow rules; you can be excited and still be safe and kind.

## Questions

```yaml
- question: "What is the bubbly, can't-sit-still feeling when something wonderful is about to happen?"
  type: multiple-choice
  options: ["Excited", "Calm", "Sleepy", "Lazy"]
  answer: 0
  explanation: "Excited is that bubbly feeling when something fun is coming, like a birthday party or a trip to the park. It makes you want to jump and wiggle with energy."

- question: "When you feel excited, it means you are being naughty or bad."
  type: true-false
  answer: false
  explanation: "This is not true. Having lots of energy from excitement is normal and healthy. Excitement is just a feeling — it is not the same as being bad. You can still be safe and kind while feeling excited."

- question: "How is excitement different from happiness?"
  type: multiple-choice
  options: ["They are exactly the same", "Excitement has more energy and is usually about something in the future", "Happiness is more important", "Only grown-ups feel excited"]
  answer: 1
  explanation: "Both are wonderful feelings! But excitement is bigger and bouncier, and it is usually about something that is going to happen. Happiness is more calm and peaceful."

- question: "If you feel excited, you do not have to listen or follow rules anymore."
  type: true-false
  answer: false
  explanation: "This is not true. Even when you feel excited, you can still follow rules and be safe and kind. You just need to remember to listen even when you are bouncy and full of energy."

- question: "What makes you feel excited?"
  type: short-answer
  answer: "Going to the park, a birthday party, or seeing a friend"
  explanation: "A good answer tells about something that makes you feel bouncy and bubbly inside. Different things excite different people, and that is okay."
```
