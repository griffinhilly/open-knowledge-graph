...
- Thinking there is only one right way to calm down; different strategies work for different people.
- Believing that needing to calm down means something is wrong with you; everyone needs calming strategies, even adults.
- Assuming calming down means you are no longer allowed to feel upset; calming down just means your body is ready to handle the feeling.

## Questions

```yaml
- question: "Which of these is a way to calm down?"
  type: multiple-choice
  options: ["Deep breathing", "Squeezing something soft", "Getting a drink of water", "All of these are calming strategies"]
  answer: 3
  explanation: "All of these are good calming strategies! Deep breaths, squeezing, water, quiet time, and many other things can help calm your body."

- question: "There is only one right way to calm down that works for everyone."
  type: true-false
  answer: false
  explanation: "This is not true. Different strategies work for different people. What helps your friend might not help you, and that is okay. Find what works for YOU."

- question: "What does it mean if you need to use calming strategies?"
  type: multiple-choice
  options: ["Something is wrong with you", "You are being bad", "Everyone needs ways to calm down — even grown-ups", "You are too little to have feelings"]
  answer: 2
  explanation: "Everyone needs calming strategies — kids and grown-ups alike. It is normal to need help calming down. It does not mean anything is wrong with you."

- question: "When you calm down, it means you are not allowed to feel upset anymore."
  type: true-false
  answer: false
  explanation: "This is not true. Calming down just means your body is feeling a little more settled and ready. You can still have feelings after you calm down."

- question: "What is one calming strategy that works for you?"
  type: short-answer
  answer: "Deep breaths, squeezing a stress ball, drinking water, going to a quiet place, or moving around"
  explanation: "A good answer names a real strategy that helps you feel calmer. Everyone has different things that work, and that is perfect."
```
