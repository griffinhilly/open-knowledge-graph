...
title: Financial Independence and Early Retirement Planning
...
- Thinking FIRE requires extreme deprivation; it's about intentional spending on priorities. - Assuming high income is necessary; high savings rate matters more than income level. - Believing FIRE is only for tech sector workers; it's achievable in any profession with discipline and planning.

## Questions

```yaml
- question: "Maria earns $150,000/year and saves 15% of it. Jordan earns $60,000/year and saves 50% of it. All else equal, who is on track to reach financial independence sooner?"
  type: multiple-choice
  options:
    - "Maria, because her higher income means a larger absolute dollar amount saved each year"
    - "Jordan, because a higher savings rate accelerates the path to FI more than raw income"
    - "They will reach FI at the same time, since both invest in the same markets"
    - "Maria, because she can afford a higher lifestyle in retirement and therefore a larger portfolio"
  answer: 1
  explanation: "Savings rate, not income level, is the primary driver of FI timeline. Jordan saves $30,000/year (50% of $60K) while Maria saves only $22,500/year (15% of $150K). More importantly, Jordan's lower spending means a lower FI number (annual expenses × 25) — the target shrinks while investment pace accelerates. This dual effect makes savings rate the dominant variable, which is why moderate earners with high savings rates routinely reach FI before high earners who spend nearly everything."

- question: "A household has annual expenses of $60,000. According to the 25x rule, what is their financial independence number?"
  type: multiple-choice
  options:
    - "$600,000"
    - "$1,000,000"
