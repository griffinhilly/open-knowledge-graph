...
title: Mortgages and Home Buying
...
- Buying is always better than renting because 'rent is throwing money away'; mortgage interest, property taxes, maintenance, and lost investment returns on the down payment are also 'thrown away' — the comparison depends on time horizon, market, and investment alternatives.
- A 30-year mortgage is always the right term; 15-year mortgages typically offer significantly lower rates and build equity far faster, often saving six figures in interest for those who can afford the higher payment.

## Questions

```yaml
- question: "In the early years of a 30-year amortizing mortgage, what is true about how your monthly payment is allocated?"
  type: multiple-choice
  options: ["Most of the payment goes toward principal, with a small fraction to interest", "The payment is split evenly between principal and interest throughout the loan", "Most of the payment goes toward interest, with a small fraction to principal", "The entire payment goes to interest until the loan is half paid off"]
  answer: 2
...
- question: "Why does your credit score have such a large effect on the total cost of a mortgage?"
  type: short-answer
  answer: "Because mortgage interest rates are risk-priced: lenders charge higher rates to borrowers they consider higher risk of default. A higher credit score signals lower risk, which earns a lower interest rate. Over a 30-year loan, even a 0.5–1% difference in rate can translate to $30,000–$70,000 more in total interest paid on a $300,000 loan."
  explanation: "This is compound interest working against you at scale. A small rate difference, applied to a large balance over many years, accumulates into a very large total cost difference. This is why optimizing your credit score — paying down balances, correcting errors on your report — before applying for a mortgage is worth significant effort."
```
