...
title: Insurance Principles and Types
...
- More insurance is always better; over-insuring small risks (like extended warranties on cheap electronics) is a poor use of money.
- Life insurance is primarily an investment vehicle; whole-life and variable-life products carry high fees — term life plus separate investing typically outperforms.

## Questions

```yaml
- question: "You are choosing between two auto insurance plans with identical coverage. Plan A has a $500 deductible and costs $1,200/year. Plan B has a $2,000 deductible and costs $800/year. What is the break-even point — how many years of Plan B savings does it take to offset the higher deductible if you make one claim?"
  type: multiple-choice
  options: ["1.5 years", "3.75 years", "4 years", "You always come out ahead with the lower deductible"]
  answer: 1
...
- question: "Explain why insurance is most valuable for catastrophic risks but often poor value for small, predictable expenses."
  type: short-answer
  answer: "Insurance pools risk across many people; the insurer charges premiums that cover expected payouts plus operating costs and profit. For small, predictable expenses, you pay more in premiums than the expected loss, making it cheaper to pay out of pocket. Catastrophic losses, however, are unaffordable without pooling — that's where insurance provides irreplaceable value."
  explanation: "An extended warranty on a $50 appliance is almost always poor value: you're paying an insurer's overhead and profit margin for a small, predictable risk. But health insurance or homeowners insurance covers events that could cost tens of thousands of dollars — losses that would be financially devastating without pooling. The emergency fund concept from personal budgeting covers the 'self-insure small risks' side of this equation."
```
