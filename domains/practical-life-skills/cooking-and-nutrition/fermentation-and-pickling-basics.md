---
id: fermentation-and-pickling-basics
...
```yaml
- question: "What is the role of salt in lacto-fermentation?"
  type: short-answer
  answer: "Salt draws water out of the vegetables by osmosis, creating a brine. The salty, low-oxygen brine favors the growth of Lactobacillus bacteria while inhibiting many harmful organisms. The bacteria then produce lactic acid, which further preserves the food."
  explanation: "Salt does two jobs: it creates the liquid brine needed for an anaerobic environment, and it provides initial selective pressure that favors beneficial bacteria over spoilage organisms before the acid builds up. Too little salt lets harmful bacteria compete; too much salt slows even the Lactobacillus."

- question: "What is the key difference between lacto-fermentation and vinegar pickling as preservation methods?"
  type: short-answer
  answer: "Lacto-fermentation is a biological process: bacteria produce lactic acid over days to weeks, gradually acidifying the food. Vinegar pickling is chemical: acid is added directly, preserving the food immediately. Fermented foods may contain live probiotic bacteria; vinegar-pickled foods do not."
  explanation: "Both end up as acid-preserved foods, but the mechanism, timeline, flavor, and health implications differ. A ferment must be monitored during its development; a vinegar pickle is preserved from the moment acid is added."

- question: "Why is a pH below 4.6 the critical threshold for vinegar pickling safety?"
  type: short-answer
  answer: "Below pH 4.6, Clostridium botulinum — the bacterium that produces the deadly botulism toxin — cannot grow or produce toxin. This is the standard used by food safety authorities to define 'acid foods' that can be safely canned using water-bath methods. Foods above this pH require pressure canning, which reaches temperatures that kill even heat-resistant spores."
  explanation: "The 4.6 threshold is not arbitrary — it is the inflection point above which dangerous anaerobic organisms can thrive in sealed, low-oxygen environments like canning jars. Acid foods below 4.6 are considered safe for water-bath canning; low-acid foods above 4.6 require the higher temperatures achievable only with pressure canning."
```
