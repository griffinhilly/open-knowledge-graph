...
title: Grocery Shopping and Budgeting
...
- Larger packages always offer better value — unit price must still be checked; some bulk quantities are priced identically or higher per unit.
- Healthy eating is inherently expensive — whole grains, dried legumes, eggs, and frozen vegetables are among the most cost-effective foods per unit of nutrition.

## Questions

```yaml
- question: "A 16 oz jar of peanut butter costs $3.84. A 40 oz jar of the same brand costs $8.80. Which is the better unit-price value?"
  type: multiple-choice
  options: ["The 16 oz jar, because the sticker price is lower", "The 40 oz jar, because larger sizes always have better unit prices", "The 16 oz jar at $0.24/oz versus $0.22/oz for the larger jar", "The 40 oz jar at $0.22/oz versus $0.24/oz for the smaller jar"]
  answer: 3
...
- question: "You're comparing organic apples at $2.49/lb to conventional apples at $0.99/lb. Describe the decision-making process for choosing which to buy."
  type: short-answer
  answer: "Calculate the actual cost difference for the quantity you need, weigh that against your budget and personal priorities (health, environment, taste), and decide whether the premium fits within your total shopping budget for the trip."
  explanation: "The right process is deliberate, not reflexive. Unit prices give you the comparison; your budget and priorities tell you whether the premium is worth it. This models the core skill: gathering accurate per-unit cost information and making conscious trade-offs, rather than buying impulsively or always defaulting to cheapest without considering goals."
```
