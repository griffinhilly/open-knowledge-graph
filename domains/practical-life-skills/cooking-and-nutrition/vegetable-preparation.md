...
- Peeling is always necessary — many vegetables (zucchini, carrots, potatoes) can be cooked with skin intact, retaining more fiber and nutrients.
- All vegetables must be cooked — many are more nutritious raw, and texture variety in a meal is itself beneficial.

## Questions

```yaml
- question: "You are roasting carrots and want them to cook evenly. Which cut is most important to achieve this?"
  type: multiple-choice
  options: ["Cut them into random chunks for a rustic look", "Cut them into uniform-sized pieces", "Leave them whole to preserve nutrients", "Peel them twice to remove the bitter outer layer"]
  answer: 1
...
- question: "Why should leafy greens be dried after washing before being sautéed?"
  type: short-answer
  answer: "Excess water on leafy greens causes the pan to steam rather than sauté, lowering the cooking temperature and producing soggy, watery greens instead of properly cooked ones."
  explanation: "Sautéing works by direct contact with hot fat at high heat. When water hits the hot pan, it instantly turns to steam, which cools the pan and creates a steaming environment. Drying greens first (with a salad spinner or towel) ensures they make direct contact with the hot surface and develop the right texture."
```
