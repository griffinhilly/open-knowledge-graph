...
title: Sautéing and Pan Cooking
...
- Adding more oil prevents sticking — a properly preheated pan with minimal oil is more effective than a cold pan with excess oil.
- You should stir constantly — occasional stirring allows the Maillard reaction to develop; constant movement keeps food pale.

## Questions

```yaml
- question: "You add onions to a cold pan and then turn on the heat. Compared to adding them to a preheated pan, what is the most likely result?"
  type: multiple-choice
  options: ["The onions brown more evenly because they heat up gradually", "The onions release more moisture and soften without browning", "The onions cook faster because they have more contact time with the heat", "The onions will burn because the gradual heat concentrates sugars too quickly"]
  answer: 1
  explanation: "A cold pan gives the onions time to release their water before the surface gets hot enough for browning. The steam from that moisture keeps the temperature below the ~140°C Maillard threshold. The onions soften and become translucent but don't develop the browned, caramelized flavor that comes from a preheated pan."

- question: "Stirring food constantly while sautéing produces better browning because the food stays in contact with the hot pan surface more evenly."
  type: true-false
  answer: false
...
- question: "What happens when you add too much food to a sauté pan at once, and why?"
  type: short-answer
  answer: "The pan temperature drops sharply, and the food releases moisture that cannot evaporate fast enough. This creates steam, causing the food to stew or steam rather than sear, resulting in pale, soft food instead of browned food."
  explanation: "A hot pan has a finite amount of stored heat. Overcrowding absorbs that heat and introduces large amounts of moisture. The steam keeps the surface temperature at 100°C (water's boiling point), which is below the ~140°C Maillard threshold. Cooking in smaller batches maintains pan temperature and achieves browning."
```
