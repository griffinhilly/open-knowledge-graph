...
- Searing 'seals in juices' — this is a myth; searing creates flavor through browning but has no measurable effect on moisture retention.
- All meat must be cooked to 74°C — food-safe temperatures vary by protein (whole beef can be 63°C; ground meat requires 71°C).
...
```yaml
- question: "You are roasting broccoli florets but they are turning gray-green and steaming rather than browning. What is the most likely cause and how do you fix it?"
  type: short-answer
  answer: "Most likely the pan is overcrowded. Crowded vegetables release steam that drops the pan temperature below the browning threshold (around 140°C), causing them to steam instead of roast. Fix: spread the florets in a single layer with space between them, or use two pans. Also ensure florets are dried and tossed in oil."
  explanation: "Browning (Maillard reaction) requires surface temperatures above 140°C and dry conditions. Steam from overcrowding prevents the surface from drying out and reaching temperature. This is one of the most common roasting errors and is easily corrected by using adequate pan space."

- question: "Why does roasting at a lower temperature (say 160°C) produce juicier lean proteins than roasting at 230°C, even if the final internal temperature is the same?"
  type: short-answer
  answer: "At higher temperatures, the exterior cooks much faster than the interior, creating a large temperature gradient. The outer portions of the meat overshoot their ideal temperature while waiting for the center to reach the target. Lower temperatures cook more evenly, minimizing the portion that is overcooked and therefore drier. The final internal temperature being the same doesn't mean the distribution of temperatures through the entire piece is the same."
  explanation: "This principle underlies techniques like reverse searing and low-and-slow cooking. They sacrifice rapid crust development for a more evenly cooked interior. The tradeoff is addressed by adding a high-heat finishing step (sear or blast) to develop surface color after the interior is done."

- question: "Why is searing said to 'seal in juices' — and why is that explanation wrong?"
  type: short-answer
  answer: "The intuition is that the browned crust forms an impermeable seal that traps moisture. This is incorrect: the crust formed by the Maillard reaction is not waterproof, and seared and unseared cuts lose comparable amounts of moisture during cooking. Searing develops flavor through browning chemistry, not moisture management. The correct reason to sear is flavor, not juice retention."
  explanation: "This misconception is widespread but has been tested repeatedly. Studies measuring moisture loss from seared vs. unseared cuts show no significant difference. The juiciness perception from seared meat comes from better flavor development and, separately, from proper resting — not from the sear itself sealing anything."
```
