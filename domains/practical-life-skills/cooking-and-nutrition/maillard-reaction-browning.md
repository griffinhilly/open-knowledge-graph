...
title: The Maillard Reaction and Browning
...
- Browning is just the food burning or drying out. - All browning is the same; caramelization and the Maillard reaction are identical processes.

## Questions

```yaml
- question: "You're searing steak but add too many pieces at once. The pan temperature drops, the meat releases moisture, and the steaks turn gray instead of brown. What is the primary reason browning failed?"
  type: multiple-choice
  options:
    - "The steaks lacked enough reducing sugars to fuel the Maillard reaction"
    - "Surface moisture kept the surface temperature at 212°F — below the Maillard reaction threshold"
    - "The pan was too crowded to allow the amino acids to contact the heat source"
    - "The pan temperature dropped below caramelization threshold, preventing any browning"
  answer: 1
