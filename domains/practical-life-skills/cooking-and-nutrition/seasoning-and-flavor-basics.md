...
title: Seasoning and Flavor Basics
...
- Adding salt at the table is the same as cooking with salt — salt added during cooking penetrates food and integrates with flavor; table salt sits on the surface.
- More seasoning is always better — over-seasoning is as problematic as under-seasoning; the goal is balance.

## Questions

```yaml
- question: "You taste a soup and it seems flat and dull, even though the recipe was followed exactly. Which adjustment is most likely to make the biggest improvement?"
  type: multiple-choice
  options: ["Add more of the main spice (e.g., cumin)", "Add a small amount of salt", "Add extra water to balance the flavors", "Increase the cooking time"]
  answer: 1
...
- question: "Seasoning food with salt at the table gives the same result as seasoning it during cooking."
  type: true-false
  answer: false
  explanation: "Salt added during cooking dissolves into the food and interacts with moisture and proteins throughout — it integrates with and transforms the dish. Salt sprinkled at the table sits on the surface and delivers a sharp burst of saltiness without the same depth. For pasta, salting the cooking water allows the pasta to absorb seasoning throughout, something table salt cannot replicate after the fact."

- question: "A dish tastes rich and savory but slightly 'heavy' or one-dimensional. What single ingredient would most likely brighten it, and why?"
  type: short-answer
  answer: "A squeeze of lemon juice or a small splash of vinegar (acid). Acid adds contrast and brightness, cutting through richness and making the other flavors more distinct and vivid."
  explanation: "Fat carries flavor but can make a dish feel heavy or flat if unbalanced. Acid — the sour taste — provides contrast that makes the palate register other flavors more clearly. This is why a squeeze of lemon over roasted fish or a splash of vinegar in a braise transforms the dish. The goal is not to make the dish taste sour but to use just enough acid to lift the other flavors."
```
