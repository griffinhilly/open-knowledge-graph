...
- Wilted vegetables are spoiled — most wilted greens are simply dehydrated and can be revived in ice water, or cooked into soups and sautés where texture is less important.
- Leftovers are lower-quality meals — many dishes (stews, curries, soups) improve overnight as flavors meld, and leftovers can be intentionally repurposed into new meals.
- Composting solves food waste — composting handles inevitable scraps but does not address the root problem of overbuying and underusing food; prevention is far more impactful.

## Questions

```yaml
- question: "A household consistently buys more produce than they use, then composts what goes bad. A knowledgeable friend says 'composting isn't really solving your waste problem.' Why?"
  type: multiple-choice
  options:
    - "Composting is less environmentally beneficial than throwing food in the trash"
    - "Composting handles inevitable scraps but doesn't address the root cause — overbuying and underusing — which is a planning problem"
    - "The household should be freezing excess produce instead of composting it"
    - "Composting is only appropriate for yard waste and inedible scraps, not food that could have been eaten"
  answer: 1
  explanation: "Composting recovers value from unavoidable scraps, but it doesn't recover the money spent on food that was bought and never eaten, and it doesn't address the planning failure that caused the waste. Prevention — buying only what you'll use, planning meals around perishables — is far more impactful. Composting is the last resort in the waste hierarchy, not the solution to overbuying."

- question: "You open the refrigerator and find a bunch of wilted spinach. According to food waste reduction principles, you should:"
  type: multiple-choice
  options:
    - "Discard it immediately — wilted greens are spoiled and potentially unsafe"
    - "Assess whether it's dehydrated or actually spoiled; if dehydrated, revive in ice water or use in cooked dishes where texture matters less"
    - "Compost it right away to prevent further deterioration"
    - "Freeze it to extend its life for another week"
  answer: 1
  explanation: "Wilted greens are typically dehydrated, not spoiled — a cosmetic change, not a safety issue. They can often be revived in ice water or used in soups, sautés, and smoothies where heat and sauce compensate for texture loss. Understanding the difference between cosmetic imperfection and actual spoilage is a core food waste skill that prevents discarding safe, edible food. Option A is the common misconception this topic directly targets."

- question: "Meal planning around perishables — deciding what you'll cook before shopping, based on what will expire soonest — is more effective at reducing food waste than any post-purchase strategy."
  type: true-false
  answer: true
