...
- More expensive paint is always better — mid-grade paint applied well beats premium paint applied carelessly.
- One coat is enough if it's a similar color — even close color-matches often need two coats for even coverage, especially near windows in raking light.

## Questions

```yaml
- question: "You are painting a kitchen that gets daily grease splatter and needs frequent wiping. Which sheen is most appropriate?"
  type: multiple-choice
  options: ["Flat", "Eggshell", "Semi-gloss", "Primer"]
  answer: 2
  explanation: "Semi-gloss is durable, moisture-resistant, and washable — the right choice for kitchens and bathrooms where surfaces need regular cleaning. Flat paint hides imperfections but cannot be scrubbed. Eggshell/satin are fine for living spaces but less durable in high-moisture, high-traffic areas. Primer is not a finish coat."

- question: "Applying one thick coat of paint is more efficient than two thin coats and produces equivalent results."
  type: true-false
  answer: false
  explanation: "Thick coats are more likely to sag, show brush marks, and dry unevenly. Two thin coats dry faster, adhere better, and produce a smoother, more durable finish. The extra time between coats is worth it for a professional-looking result."

- question: "Why is preparation considered 80% of a paint job?"
  type: short-answer
  answer: "Paint cannot hide surface defects — it follows the contours of whatever is beneath it. Filling holes, sanding rough spots, cleaning the surface, and priming bare or stained areas determines the final appearance. Skipping prep means imperfections remain visible through the finish coat, no matter how carefully it is applied."
  explanation: "The paint layer is thin and translucent to light at oblique angles (raking light). Bumps, cracks, and poor adhesion all telegraph through. A smooth, primed surface gives paint the best possible foundation, which is why experienced painters spend far more time preparing than actually painting."
```
