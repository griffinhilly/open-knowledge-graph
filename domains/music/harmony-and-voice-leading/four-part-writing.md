...
- Doubling the third of a chord instead of the root: the third is the most characteristic 'active' tone of a major triad and is generally not doubled.
- Writing voice crossings accidentally when voicing chords in close position.
- Resolving the leading tone downward in inner voices without justification.

## Questions

```yaml
- question: "In a root-position major triad in SATB writing, which chord tone is the standard choice for doubling?"
  type: multiple-choice
  options: ["The third", "The fifth", "The root", "The seventh"]
  answer: 2
