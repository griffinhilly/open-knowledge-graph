...
- Treating jazz harmony as fundamentally different from classical harmony: it is an extension and elaboration of the same tonal system, not a separate language.
- Thinking tritone substitution only applies in limited contexts: while most natural on dominant chords, the principle extends broadly in jazz practice.
- Neglecting rhythm in favor of chord voicing: jazz harmony is inseparable from its rhythmic placement and comping style.

## Questions

```yaml
- question: "In the key of C, what is the tritone substitution for G7?"
  type: multiple-choice
  options: ["Ab7", "Db7", "F7", "Bb7"]
  answer: 1
  explanation: "A tritone is six semitones. Six semitones above G is Db (G–Ab–A–Bb–B–C–Db). So the tritone substitution for G7 is Db7. The key insight is that G7 and Db7 share the same tritone internally: G7 contains B and F (a tritone apart), and Db7 also contains F (=E#) and Cb (=B) — the same two pitches, just spelled differently. This shared tritone is what makes the substitution harmonically coherent."

- question: "The ii–V–I progression in jazz is harmonically unrelated to the authentic cadence in classical harmony."
  type: true-false
  answer: false
  explanation: "Jazz harmony is an extension of the same tonal system that underlies classical harmony, not a separate language. The ii–V–I is the authentic cadence (V–I, typically preceded by ii or IV) with seventh chords added throughout. The pull of the V7 to I is identical in both traditions. What jazz adds is richer chord extensions, alterations, and substitutions built on top of the same functional foundation."

- question: "Why does tritone substitution create smooth chromatic bass motion when resolving to the tonic?"
  type: short-answer
  answer: "The substitute dominant is rooted a tritone away from the original dominant — in C major, Db7 instead of G7. Db is a half-step above the tonic C, so the bass resolves downward by a semitone (Db → C) rather than the whole step descent (G is a fifth above, but the bass ascends a fourth or descends a fifth). This half-step approach is smoother and more chromatic than the original root motion."
  explanation: "The original V–I motion (G to C) involves a descending fifth or ascending fourth in the bass — a strong but somewhat angular move. The tritone sub (Db to C) replaces this with a descending half-step, the smoothest possible bass motion. This is why tritone substitutions became standard in bebop: they connect chord roots by half-step, creating a more chromatic and sinuous bass line."
```
