...
- Placing suspensions on weak beats in fourth species: the suspension must be prepared on the weak beat but struck as a dissonance on the strong beat.
- Using neighbor tones in first species where only consonances are permitted.
- Treating species counterpoint rules as identical to harmonic voice-leading rules: they are related but represent a distinct tradition.
