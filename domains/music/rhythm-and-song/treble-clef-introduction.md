...
title: Introduction to the Treble Clef
domain: music
...
# Introduction to the Treble Clef
...
- Thinking the treble clef is the only clef; bass clef and other clefs exist for lower-pitched instruments.
- Believing the lines of the staff are the only places notes can go; notes sit on lines and in spaces.
- Assuming you must memorize the whole staff at once; learning a few notes at a time is normal.

## Questions

```yaml
- question: "What does the treble clef tell you?"
  type: multiple-choice
  options: ["How fast to play the music", "How loud to play the music", "Which notes the lines and spaces of the staff represent", "What instrument to play"]
  answer: 2
  explanation: "The treble clef is a symbol at the beginning of the staff that assigns specific letter names to the lines and spaces, telling you which notes they represent."

- question: "The treble clef is the only clef used in music."
  type: true-false
  answer: false
  explanation: "There are other clefs, such as the bass clef, which is used for lower-pitched instruments and voices. The treble clef is just one of several clefs."

- question: "Notes can only be placed on the lines of the staff, not in the spaces."
  type: true-false
  answer: false
  explanation: "Notes sit both on the lines and in the spaces of the staff. Each line and each space represents a different note."

- question: "What mnemonic can help you remember the line notes of the treble clef (E, G, B, D, F)?"
  type: short-answer
  answer: "Every Good Boy Does Fine"
  explanation: "A good answer gives the common mnemonic 'Every Good Boy Does Fine' where each word starts with the letter of a line note from bottom to top: E, G, B, D, F."

- question: "What do the space notes of the treble clef spell?"
  type: multiple-choice
  options: ["BEAD", "FACE", "CAGE", "DEAF"]
  answer: 1
  explanation: "The space notes from bottom to top are F, A, C, E, which spell the word FACE. This makes them easy to remember."
```
