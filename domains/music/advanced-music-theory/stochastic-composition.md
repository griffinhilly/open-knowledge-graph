...
- question: "Stochastic composition achieves maximum musical unpredictability by using uniform (equal-probability) distributions for most musical parameters, since any non-uniform distribution would impose too much structure."
  type: true-false
  answer: false
