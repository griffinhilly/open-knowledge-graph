---
id: jazz-bebop-and-modern-jazz
title: Bebop and the Development of Modern Jazz
domain: music
course: music-history
prerequisites:
- id: jazz-swing-and-big-band
  type: hard
...
- Bebop musicians were not intentionally making music inaccessible — they were exploring new musical possibilities; accessibility simply was not the primary criterion.
- 'Jazz fusion' is a later development (1970s onward) incorporating rock and electric instruments; it emerged from the Miles Davis electric period, not directly from bebop.
