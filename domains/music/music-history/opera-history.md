---
id: opera-history
title: 'Opera History: From Baroque to the Romantic Stage'
domain: music
course: music-history
prerequisites:
- id: baroque-opera-and-oratorio
  type: hard
...
- Wagner and Verdi were exact contemporaries writing simultaneously, not sequentially — they represent competing national approaches to the same problems.
- 'Grand opera' is a specific French genre (Meyerbeer, early Verdi), not a generic term for any large operatic production.
