...
- Students often mix up the treble and bass clef note positions — the same line or space means a different note in each clef.
- Ledger lines are sometimes ignored; remember they extend the same pattern above and below the staff.

## Questions

```yaml
- question: "The treble clef is called the 'G clef.' Which line on the staff does it anchor to G4?"
  ...
  answer: 1
  explanation: "The treble clef symbol curls around the second line from the bottom, fixing that line as G4. This is why treble clef is called the G clef — its shape literally marks the G line. From this anchor, all other notes follow the alphabetical sequence up and down: the first line is E4, the second line is G4, the third line is B4, the fourth line is D5, and the fifth line is F5."

- question: "If you know a note's position on the treble clef staff, you can determine its pitch on the bass clef staff by using the same line or space."
  type: true-false
  answer: false
  explanation: "The clef symbol redefines what each position means. The middle line of the treble staff is B4; the middle line of the bass staff is B2 — two octaves apart. The same spatial position represents completely different pitches depending on which clef is in effect. This is the most common source of confusion when students first encounter both clefs."

- question: "What is a ledger line, and what problem does it solve?"
  type: short-answer
  answer: "A ledger line is a short horizontal line drawn above or below the five-line staff to notate pitches outside its range. Without ledger lines, pitches like middle C (one ledger line below treble clef, or one above bass clef) could not be written using the same consistent system. Ledger lines extend the staff's logic — alternating lines and spaces — indefinitely in both directions."
