...
- question: "The dominant chord (V) is expected to typically appear immediately before tonic (I) — it cannot be followed by any other chord without destroying the progression's functionality."
  type: true-false
  answer: false
