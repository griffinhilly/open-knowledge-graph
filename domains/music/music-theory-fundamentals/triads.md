...
- A chord is not just 'three notes played together' — it requires a specific interval structure; three random notes are not a triad.
- The 'third' of a chord is named for its interval above the root, not its position in the stack.

## Questions

```yaml
- question: "Which of the following correctly describes the interval structure of a diminished triad built on C?"
  type: multiple-choice
  options: ["C-E-G (major third + minor third)", "C-E♭-G (minor third + major third)", "C-E♭-G♭ (minor third + minor third)", "C-E-G♯ (major third + major third)"]
  answer: 2
  explanation: "A diminished triad consists of two stacked minor thirds. From C: up a minor third is E♭, and up another minor third from E♭ is G♭. Option A is a major triad, option B is a minor triad, and option D is an augmented triad. The interval structure — not the note names — defines the triad quality."

- question: "Any three pitches played simultaneously form a triad."
  type: true-false
  answer: false
  explanation: "A triad requires a specific interval structure: two thirds stacked on top of each other (either major or minor in some combination). Three arbitrary pitches — say, C, D, and F♯ — do not form a triad because they are not organized as stacked thirds. A triad is a harmonic structure, not merely a count of notes."

- question: "What is the structural difference between a major and a minor triad, and how does that difference affect the character of each?"
  type: short-answer
  answer: "A major triad has a major third on the bottom and a minor third on top. A minor triad reverses this: minor third on the bottom, major third on top. Lowering the middle note (the third of the chord) by a half step converts a major triad to minor, shifting the character from bright and stable to darker and more somber."
  explanation: "The fifth is the same size in both major and minor triads (a perfect fifth from root to top), so the outer frame is identical. Only the middle note — the chord's third — changes. This is why minor sounds like a 'shadowed' version of major on the same root: the outer structure is shared, but the inner division is inverted."
```
