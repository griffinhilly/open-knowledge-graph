---
id: interval-quality
title: 'Interval Quality: Major, Minor, Perfect, Augmented, Diminished'
domain: music
...
- 'Major' does not mean 'bigger' in all cases — a major second (2 half steps) is smaller than a minor third (3 half steps).
- Perfect intervals cannot be called major or minor; calling a perfect fifth a 'major fifth' is incorrect.

## Questions

```yaml
- question: "Which of the following intervals can correctly be described as 'perfect'?"
  type: multiple-choice
  options: ["Major sixth", "Minor third", "Augmented second", "Perfect fourth"]
  answer: 3
...
- question: "What distinguishes an augmented interval from a diminished interval, and how are they related to major, minor, and perfect intervals?"
  type: short-answer
  answer: "An augmented interval is one half step larger than the major or perfect version of that interval number; a diminished interval is one half step smaller than the minor or perfect version."
  explanation: "For example: a perfect fifth is 7 half steps, so an augmented fifth is 8 and a diminished fifth is 6. A major third is 4 half steps, so an augmented third is 5; a minor third is 3 half steps, so a diminished third is 2. Augmented and diminished are extensions of the quality system beyond its major/minor/perfect core, used when enharmonic spelling requires a different name for the same pitch distance."
```
