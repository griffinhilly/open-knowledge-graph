...
title: 'Cadence Types: Authentic, Plagal, Half, and Deceptive'
domain: music
...
```yaml
- question: "Which cadence type ends on the dominant chord (V) without resolving to the tonic?"
  type: multiple-choice
  options: ["Authentic cadence", "Plagal cadence", "Half cadence", "Deceptive cadence"]
  answer: 2
  explanation: "A half cadence ends on V, leaving the harmony unresolved — it sounds like a musical question or a comma in a sentence. Authentic cadences (V-I) and plagal cadences (IV-I) both resolve to the tonic. A deceptive cadence begins on V but resolves to vi instead of I."

- question: "A deceptive cadence (V-vi) creates a strong sense of resolution and closure."
  type: true-false
  answer: false
  explanation: "This is a misconception based on the word 'cadence.' A deceptive cadence does the opposite of creating closure — it deliberately frustrates the expectation of resolution. The V chord strongly implies I will follow; when vi appears instead, the listener feels surprised and the phrase continues rather than ending."

- question: "Why does the authentic cadence (V-I) produce the strongest sense of finality of all cadence types?"
  type: short-answer
  answer: "The dominant chord (V) contains the leading tone, which has a strong half-step pull toward the tonic. When V resolves to I, the bass moves by a fifth (or fourth), the leading tone resolves upward, and all voices converge on the tonic — creating maximum harmonic closure."
  explanation: "The authentic cadence combines two powerful forces: the functional tension of the dominant (which contains the dissonant tritone in a dominant seventh chord) and the half-step resolution of the leading tone to the tonic. No other cadence type combines both of these, which is why V-I feels so final. Plagal (IV-I) lacks the leading tone; half cadences leave V hanging; deceptive cadences subvert the resolution entirely."
```
