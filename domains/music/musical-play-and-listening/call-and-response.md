...
- Thinking call and response is the same as echoing; the response can be different from the call.
- Believing only one person can be the caller; anyone can lead, and groups can alternate roles.
- Assuming call and response only exists in certain types of music; it appears in folk, gospel, pop, and many traditions worldwide.
