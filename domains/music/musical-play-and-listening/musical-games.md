...
- Thinking musical games are just for fun and have nothing to do with learning; they build listening, timing, and coordination.
- Believing there is only one right way to play each game; games can be adapted and reinvented.
- Assuming musical games require special equipment; most need only voices and bodies.
