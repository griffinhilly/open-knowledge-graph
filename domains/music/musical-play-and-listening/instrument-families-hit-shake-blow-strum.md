...
prerequisites:
- id: instruments-you-shake
  type: hard
- id: instruments-you-hit
  type: hard
...
- Thinking an instrument can only belong to one family; some instruments (like a piano) can be tricky to categorize.
- Believing one family is more important than the others; all families contribute essential sounds to music.
- Confusing how an instrument looks with how it makes sound; a tambourine looks round but it belongs to the shake-and-hit family.
