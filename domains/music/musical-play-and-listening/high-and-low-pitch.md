...
- Confusing pitch with volume; a high sound is not the same as a loud sound.
- Thinking "high" and "low" refer to physical height rather than the quality of the sound.
- Believing only certain instruments can make high or low sounds; most instruments can produce a range of pitches.
