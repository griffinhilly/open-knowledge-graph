...
- Thinking only guitars are string instruments; there are many kinds including violins, harps, and banjos.
- Believing the sound comes from the strings alone; the body of the instrument amplifies the vibration.
- Assuming string instruments are too hard for young children to try; simple strumming is accessible at any age.
