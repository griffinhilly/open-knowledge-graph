...
- Thinking hearing and listening are the same thing; hearing is automatic, but listening requires focus.
- Believing you can only listen to one sound at a time; with practice, you can notice multiple layers.
- Assuming listening is passive; active listening is a skill you build through practice.
