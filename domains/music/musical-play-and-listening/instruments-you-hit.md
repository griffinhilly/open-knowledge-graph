...
- Thinking you have to hit instruments as hard as possible; gentle taps make music too.
- Believing drums can only make one sound; different striking positions and techniques create many sounds.
- Confusing hitting with being rough; playing struck instruments requires control, not force.
