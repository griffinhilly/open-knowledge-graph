...
- Thinking the sound magically appears inside the instrument; there is always something physically vibrating.
- Believing only string instruments vibrate; every instrument, including drums and wind instruments, involves vibration.
- Assuming you can always see the vibration; air vibrating inside a flute is invisible but still real.
