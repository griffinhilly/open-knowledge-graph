...
- Thinking children need to learn brand-new songs every day; repetition of favorites builds confidence and skill.
- Believing songs must be perfectly performed; the joy of singing together matters more than accuracy.
- Assuming all children know the same songs; be ready to teach songs that may be new to some children.
