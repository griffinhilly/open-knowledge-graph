...
- Thinking you have to have a "good voice" to sing; every child can sing and benefit from singing.
- Believing singing must be perfectly in tune to count; approximate pitch matching is a normal first step.
- Assuming singing is only for performing; singing together is mainly about sharing an experience.
