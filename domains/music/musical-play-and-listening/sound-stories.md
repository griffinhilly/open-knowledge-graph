...
- Thinking sounds must be realistic to tell a story; any sound can represent anything if the group agrees on it.
- Believing sound stories need fancy instruments; voices, body percussion, and everyday objects work well.
- Assuming there is one correct set of sounds for each story; different groups will make different choices and all can work.
