...
- Thinking all shakers sound the same; the size, shape, and filling all change the sound.
- Believing shaking instruments are not real instruments; they are essential in many musical traditions.
- Assuming you just shake randomly; controlling how you shake creates different musical effects.
