...
title: Repeating Sounds and Patterns
domain: music
...
## Core Idea
Music is full of patterns that repeat. A rhythm that happens over and over, a melody that comes back again, or a chorus you hear between every verse are all examples of repetition. Repeating patterns give music structure and make it easier to remember and sing along with.

## How It's Best Learned
Clap a short pattern and repeat it several times, then ask children to join in when they recognize it. Listen to songs and raise a hand every time the chorus comes back. Build simple patterns with body percussion (clap-clap-stomp, clap-clap-stomp) and practice repeating them.

## Common Misconceptions
- Thinking repetition is boring; in music, repetition creates familiarity and helps listeners feel at home.
- Believing music is just random sounds; patterns and repetition are what organize sound into music.
- Assuming a pattern must be exact every time; small variations within a repeated pattern are common and interesting.
...
**Repeating patterns in music are sequences of sounds that happen again and again.** A pattern might be a rhythm like clap, clap, snap. It might be a melody that repeats. It might be a combination of high and low sounds that happens over and over. Patterns are everywhere in music!
