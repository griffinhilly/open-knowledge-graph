...
title: Same and Different Sounds
domain: music
...
- Thinking "same" means completely identical; two sounds can be the same in one way (like rhythm) and different in another (like pitch).
- Believing you need special training to compare sounds; everyone can hear differences with practice.
- Assuming different is always better than same; repetition and sameness create structure in music.
