...
title: Interval Recognition by Ear
domain: music
course: ear-training
prerequisites:
- id: intervals-basics
...
- Song mnemonics are training wheels — the goal is to recognize the interval's inherent quality, not recall the song each time.
- Harmonic intervals (played together) have a different perceptual quality than melodic intervals and may need separate training.

## Questions

```yaml
- question: "A student consistently recognizes a perfect 4th when it is played ascending but fails when it is played descending. What is the most likely explanation?"
  type: multiple-choice
  options: ["The student has confused the perfect 4th with a tritone", "Ascending and descending intervals have different perceptual characters and typically require separate practice", "The student does not truly know what a perfect 4th is", "Descending intervals are always harder because they involve lower pitches"]
  answer: 1
