...
title: Chord Quality Identification by Ear
domain: music
course: ear-training
prerequisites:
- id: triads
...
- Chord quality identification is independent of the chord's root — a C minor and an F minor triad have the same quality.
- Voicing and register affect the timbre of a chord significantly; the same chord can sound very different when voiced widely versus closely.

## Questions

```yaml
- question: "A diminished triad is built from which combination of stacked intervals?"
  type: multiple-choice
  options:
    - "A minor third and a perfect fifth (m3 + P5)"
    - "Two minor thirds (m3 + m3)"
    - "A major third and an augmented fifth (M3 + A5)"
    - "A minor third and a major third (m3 + M3)"
  answer: 1
...
- question: "When first learning to identify chord quality by ear, which interval within the triad should you focus on first, and why?"
  type: short-answer
  answer: "The third (major vs. minor third), because it is the primary determinant of the chord's overall color — major third produces the bright/stable feeling of major quality, minor third produces the darker feeling of minor or diminished quality."
  explanation: "The third is the most perceptually salient distinguishing feature. Once you can reliably hear major vs. minor thirds, you can distinguish major from minor and diminished from augmented. The fifth then helps differentiate within those groups: diminished has a compressed (diminished) fifth versus the perfect fifth of minor; augmented has a stretched (augmented) fifth versus the perfect fifth of major."
```
