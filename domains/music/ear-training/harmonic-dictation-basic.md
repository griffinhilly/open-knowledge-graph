...
title: 'Harmonic Dictation: Basic Chord Progressions'
domain: music
course: ear-training
prerequisites:
...
- Do not expect to identify every chord on a single hearing; multiple hearings are standard and encouraged.
- Harmonic dictation is easier when you know the stylistic conventions of the period — common progressions become recognizable as formulaic patterns rather than isolated puzzles.

## Questions

```yaml
- question: "During harmonic dictation, which voice should you prioritize listening to first in order to determine chord root and inversion?"
  type: multiple-choice
  options: ["The soprano (highest voice), because it carries the melody", "The bass (lowest voice), because it reveals the root or inversion", "The tenor voice, because it typically holds the fifth", "All voices simultaneously on the first hearing"]
  answer: 1
...
- question: "In harmonic dictation, if you identify a chord incorrectly on the first hearing, you should erase and start over rather than refine your answer on subsequent hearings."
  type: true-false
  answer: false
  explanation: "Multiple hearings are a normal part of the process. A good strategy is to sketch a rough outline (perhaps just a few chords you are confident about) on the first pass, then refine cadences, fill gaps, and check inversions on later passes. Erasing entirely and restarting wastes time and discards correct guesses."

- question: "How does prior knowledge of Roman numeral analysis and diatonic harmony help make harmonic dictation faster and more accurate?"
  type: short-answer
  answer: "Knowing that certain progressions are common (like I–IV–V–I or ii–V–I) allows you to recognize these patterns as units rather than identifying each chord in isolation. If you hear a strong cadence, you can predict V–I and verify it rather than analyzing from scratch. Roman numeral knowledge reduces the search space at each moment."
  explanation: "Experts in harmonic dictation use top-down pattern recognition alongside bottom-up note identification. A listener who knows tonal conventions can 'fill in' probable harmonies and then verify them — much like reading familiar words rather than decoding each letter. This is why diatonic harmony and Roman numeral analysis are listed as prerequisites."
```
