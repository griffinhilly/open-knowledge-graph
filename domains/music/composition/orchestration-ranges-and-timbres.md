...
title: 'Orchestration: Ranges and Timbres'
domain: music
course: composition
prerequisites:
...
- Writing in the comfortable middle range of an instrument is safe but often colorless; idiomatic orchestration frequently exploits the characteristic extremes of each instrument's range.
- Doubling parts to make them louder is less effective than scoring for instruments whose natural timbres project in that register.
