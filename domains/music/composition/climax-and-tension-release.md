---
id: climax-and-tension-release
title: Climax and Tension-Release
domain: music
course: composition
prerequisites:
- id: harmonic-rhythm
...
- id: melodic-phrase-structure
  type: hard
- id: formal-proportion-and-balance
  type: soft
...
- Maximum dynamics do not automatically create climax — climax requires multiple parameters converging simultaneously.
- A climax too early in a piece leaves nowhere to go; composers must manage tension reserves throughout the formal arc.
