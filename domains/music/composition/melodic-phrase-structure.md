...
title: Melodic Phrase Structure
domain: music
course: composition
prerequisites:
- id: cadences
...
- Phrases are not simply four measures; phrase length is determined by cadences and harmonic motion, not bar count.
- An antecedent does not need to end on the dominant — a deceptive or plagal cadence can fulfill this role depending on context.

## Questions

```yaml
- question: "In a parallel period, what distinguishes the antecedent phrase from the consequent phrase?"
  type: multiple-choice
  options:
    - "The antecedent is always longer than the consequent"
    - "The antecedent ends with a weaker cadence; the consequent ends with a stronger, conclusive cadence"
    - "The antecedent is in the major mode; the consequent is in the relative minor"
    - "The antecedent contains the melodic climax while the consequent is purely cadential"
  answer: 1
...
- question: "What is the functional difference between a half cadence and a perfect authentic cadence in the context of phrase structure?"
  type: short-answer
  answer: "A half cadence ends on the dominant (V), creating harmonic tension and incompleteness — it calls for a continuation. A perfect authentic cadence closes with V→I motion with the tonic in the melody, producing full resolution and closure."
  explanation: "Cadences are the punctuation of tonal music. A half cadence functions like a comma — it pauses without finishing. A perfect authentic cadence functions like a period — it fully closes. In a period, the antecedent's half cadence poses a harmonic 'question' that the consequent's authentic cadence 'answers.' This tension-resolution dynamic depends on scale degree tendencies: the leading tone resolves up to the tonic, and the dominant harmony pulls toward resolution on I."
```
