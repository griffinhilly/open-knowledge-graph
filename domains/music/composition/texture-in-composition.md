...
- Homophony does not require all voices to move in exactly the same rhythm — the melody can move freely over a slower-moving harmonic accompaniment.
- Polyphony does not mean chaotic; each voice must have its own melodic identity while remaining harmonically coordinated.

## Questions

```yaml
- question: "A piece has two fully independent melodic lines playing simultaneously, each with distinct rhythms and contours. What texture is this?"
...
- question: "Why do skilled composers deliberately vary texture throughout a piece rather than maintaining one texture from start to finish?"
  type: short-answer
  answer: "Varying texture creates contrast, shapes energy levels, and directs listener focus. A shift from dense polyphony to a single unaccompanied line (monophony) creates dramatic contrast and can highlight a moment of vulnerability or clarity."
  explanation: "Texture is a primary compositional tool for pacing and drama. Sustained polyphony can become exhausting; sustained homophony can become predictable. Strategic shifts — for instance, reducing to monophony at a climactic moment — make the return to full texture feel like a release of tension."
```
