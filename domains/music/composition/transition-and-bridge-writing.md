...
title: Transition and Bridge Writing
domain: music
course: composition
prerequisites:
...
- A transition is not just a few filler measures; it has its own harmonic direction and contributes to the formal architecture.
- Modulation within a bridge must be purposeful — moving to a distant key requires more preparation and a longer retransition to feel coherent.
