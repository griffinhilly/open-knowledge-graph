...
# Oral Tradition: Transmission and Variation in Retelling
...
questions:
  - type: multiple-choice
    question: "How does formulaic language function in oral tradition?"
    options:
      - "It is a sign of lazy or uncreative storytelling"
      - "It enables memorization and performance while simultaneously permitting variation and adaptation to different audiences and contexts"
      - "It is used only in written literature, not in oral traditions"
      - "It prevents any creative variation and enforces complete textual fidelity"
    correct: "B"
    explanation: "Formulaic language—stock phrases, repeated structures, thematic units—serves dual functions. It provides a scaffold that aids memorization, allowing performers to retain vast narratives without writing. Yet within that scaffold, performers can adapt and vary. A stock opening like 'There was once a man who had three sons' can be repeated reliably while what happens next changes with audience and occasion."

  - type: multiple-choice
    question: "What does it mean to say that oral tradition has no single 'correct' version of a story?"
    options:
      - "Oral stories are too confused to have any reliable form"
      - "Each retelling is a unique variant in a family of related tellings, with flexibility being a feature of oral transmission rather than a flaw"
      - "Oral traditions are completely random and have no coherent structure"
      - "All versions are equally correct and there is no continuity between tellings"
    correct: "B"
    explanation: "Oral tradition does not aim at textual fidelity (getting the words exactly right) but thematic fidelity (preserving the story's essential elements while adapting to audience and occasion). A story exists as a flexible template rather than a fixed text. Variation across tellings is intentional and culturally valued, not evidence of failure."

  - type: true-false
    question: "Oral narratives are inherently inferior to written narratives because they lack the stability and accuracy of fixed texts."
    correct: false
    explanation: "Orality and literacy embody different values and serve different functions. Oral traditions value flexibility, adaptation, and responsive performance; written traditions value textual stability and fixed reference. 'Accuracy' means different things in each mode. Oral performers are highly skilled; variation is intentional."

  - type: true-false
    question: "The goal of oral tradition is to preserve stories unchanged across generations, with each storyteller repeating exactly what they heard."
    correct: false
    explanation: "While some core elements are preserved, oral tradition inherently permits and expects variation. Performers adapt to their audience, to the occasion, to their own skill and preferences. This adaptability is a feature of oral transmission, not a failure of fidelity."

  - type: short-answer
    question: "Explain how formulaic language both enables oral preservation and permits creative variation."
    explanation: "Formulaic language provides a structural scaffold that aids both memory and performance. Stock phrases, repeated structures, and thematic units create a familiar pattern that the performer and audience both know. The performer doesn't have to invent from scratch because the formula provides the structure. Yet within that structure, elements can vary. A formula like 'the hero rode for three days through the dark forest' provides a reliable structure (hero, three days, forest, darkness) while allowing the performer to adapt details (which hero, which forest, what he encountered). The formula becomes a tool for both preservation and variation. This is how oral traditions can maintain continuity over generations while adapting to new audiences and contexts. The formula constrains enough to preserve identity (this is still the 'same' story) but allows enough flexibility to remain alive and responsive."
```
