...
- Not every object in a text is a symbol; over-symbolizing produces weak analysis.
- The meaning of a symbol is not fixed — it shifts with context, and that instability is often itself meaningful.
- Identifying a symbol is not analyzing it; you must explain what it symbolizes and how that meaning is constructed.

## Questions

```yaml
- question: "A student notices a lamp described once in a scene and argues it symbolizes hope. Which response best evaluates this claim?"
  type: multiple-choice
  options: ["It is valid because lamps emit light, which connects to hope.", "It is weak because there is no evidence the text invests the lamp with emphasis, repetition, or thematic significance.", "It is strong as long as the student can connect it to a theme.", "It is valid because hope is a universal literary symbol."]
  answer: 1
  explanation: "Symbolic claims require textual grounding — evidence that the author has singled out the element through repetition, unusual detail, or deliberate framing. A single passing mention lacks that investment. Options A, C, and D describe the reader projecting meaning rather than finding it in the text."

- question: "Once established in a text, a symbol carries a single fixed meaning that does not change."
  type: true-false
  answer: false
  explanation: "The instability of symbolic meaning is often itself significant. A symbol like 'the green light' in The Great Gatsby shifts meaning as context changes — from hope and longing early on, to the unattainability of the American Dream by the end. Part of analyzing a symbol is tracing how its meaning evolves."

- question: "What distinguishes a symbol from a motif?"
  type: short-answer
  answer: "A symbol is a concrete element that carries meaning beyond its literal referent; a motif is a recurring element or pattern. All symbols can function as motifs (through repetition), but not all motifs are symbols — a motif may recur for structural or aesthetic reasons without accumulating deeper figurative meaning."
  explanation: "Understanding this distinction prevents students from treating every repeated image as automatically symbolic. The test is whether the recurrence is doing interpretive work — pointing toward an abstraction — or whether it is serving narrative or structural purposes instead."
```
