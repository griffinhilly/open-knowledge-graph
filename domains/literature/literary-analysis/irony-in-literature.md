...
- Irony is not coincidence; 'it's ironic that it rained on my wedding day' is coincidence unless there is a meaningful conceptual gap.
- Sarcasm is verbal irony, but verbal irony is not always sarcasm; the distinction is one of tone and intent.
- Dramatic irony is not a failure of storytelling; it is a deliberate technique that shifts emotional involvement from suspense to dread or anticipation.

## Questions

```yaml
- question: "In Sophocles' Oedipus Rex, the audience knows Oedipus killed his father while Oedipus himself is actively hunting the murderer. What type of irony is this?"
  type: multiple-choice
  options: ["Verbal irony", "Situational irony", "Sarcasm", "Dramatic irony"]
  answer: 3
  explanation: "Dramatic irony arises specifically when the audience possesses knowledge that a character lacks, creating a sustained gap between what the character believes and what the reader knows. Here, the audience knows Oedipus's identity as the murderer before he does, producing dread rather than suspense. Situational irony describes the outcome (a man hunting himself), but the technique of audience foreknowledge is dramatic irony."

- question: "Verbal irony and sarcasm are the same literary device."
  type: true-false
  answer: false
  explanation: "Sarcasm is a subtype of verbal irony — specifically verbal irony used with contemptuous or mocking intent. All sarcasm is verbal irony (saying something other than what is meant), but not all verbal irony is sarcasm. Swift's 'A Modest Proposal' is verbally ironic throughout without being simply sarcastic; the irony operates at a sustained rhetorical level rather than as personal mockery of a specific target."

- question: "What makes situational irony different from mere coincidence? Give an example that illustrates the distinction."
  type: short-answer
  answer: "Situational irony requires a meaningful conceptual gap between expectation and outcome — the reversal must illuminate something about the character, theme, or situation. Coincidence is random. A fire station burning down is situationally ironic because the institution designed to prevent fires cannot prevent its own destruction. Rain on a wedding day is coincidence unless the narrative has made fair weather symbolically meaningful."
  explanation: "The test is interpretive significance. Ask: does the gap between expected and actual outcome reveal something, or is it merely unexpected? If the reversal exposes a contradiction in a character's values, a theme's logic, or a social institution's claims, it is situational irony. If it is simply unexpected, it is coincidence."
```
