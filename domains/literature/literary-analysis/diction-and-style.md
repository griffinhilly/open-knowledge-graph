...
- 'The author uses descriptive language' is not a diction observation — it says nothing specific about the words chosen.
- Style is not merely ornamentation; stylistic choices are meaning-making decisions.
- Formal/elevated diction is not inherently better than informal/colloquial diction; appropriateness to context and effect is what matters analytically.

## Questions

```yaml
- question: "A critic notes that an author chose the word 'deceased' rather than 'dead.' What kind of analysis is this?"
  type: multiple-choice
  options: ["Figurative language analysis, because both words use a metaphor", "Diction analysis focused on connotation, because 'deceased' carries a more formal and distancing tone than 'dead'", "Structural analysis, because word choice determines sentence length", "Thematic analysis, because death is a major theme"]
  answer: 1
...
- question: "A teacher suggests substituting synonyms for key words in a passage as a method for analyzing diction. What does this exercise reveal?"
  type: short-answer
  answer: "Substituting synonyms exposes the specific connotations, tone, and effects of the author's original word choice — showing precisely what would be lost or changed if a different word had been used."
  explanation: "When you replace a word and the passage feels different — cooler, warmer, more distant, more vivid — you have identified what the original word was doing. The exercise makes visible the meaning-making work of individual word choices that we often read past."
```
