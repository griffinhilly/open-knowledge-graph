...
- 'The theme is friendship' is a topic, not a theme; a theme is a complete statement about the topic.
- Themes are not morals; a text can explore an idea without providing a lesson.
- A text can have multiple valid themes; finding one does not mean others are wrong.

## Questions

```yaml
- question: "A student says the theme of Lord of the Flies is 'civilization.' A second student says the theme is 'Without social structures, human beings revert to violence.' Which statement is a theme and which is a topic?"
  type: multiple-choice
  options: ["Both are themes — they describe the same idea at different levels of detail", "The first is a theme; the second is an over-interpretation", "The first is a topic; the second is a theme", "Neither is a theme — themes must be stated in a single word"]
  answer: 2
...
- question: "How do you test whether a proposed theme is valid rather than merely plausible?"
  type: short-answer
  answer: "Test the proposed theme against at least three separate moments in the text. If each moment can be meaningfully explained or connected to your thematic statement, the theme has textual grounding. If moments contradict or ignore it, the statement needs revision."
  explanation: "A theme is an argument, not a feeling. Like any argument, it must be verified against evidence. Three moments is a practical minimum — it guards against cherry-picking a single scene while overlooking the broader pattern of the text."
```
