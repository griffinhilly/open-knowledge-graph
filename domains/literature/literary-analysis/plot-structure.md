...
- The climax is not necessarily the most dramatic moment — it is the structural turning point after which the outcome becomes inevitable.
- Not all narratives fit the Freytag model; modernist and postmodern texts often use fragmented or circular structures.
- Plot summary is not plot analysis; analysis explains how structure produces meaning.

## Questions

```yaml
- question: "In Freytag's pyramid, what distinguishes the climax from the most dramatically intense moment of a story?"
  type: multiple-choice
  options:
    - "The climax is always the longest scene in the story"
    - "The climax is the structural turning point after which the outcome becomes inevitable, not necessarily the moment of highest tension"
    - "The climax must involve a direct confrontation between the protagonist and antagonist"
    - "The climax always occurs exactly at the midpoint of the text"
  answer: 1
  explanation: "The climax is a structural concept — the point at which the direction of the action shifts and the final outcome becomes determined. A chase scene or battle may feel more tense, but if it doesn't change the trajectory of the narrative, it is rising action, not the climax. Confusing emotional intensity with structural function is the most common error in plot analysis."

- question: "A plot summary and a plot analysis both describe a story's events, so they provide equivalent analytical insight."
  type: true-false
  answer: false
  explanation: "A plot summary recounts what happens in sequence. A plot analysis asks how the arrangement of events — timing, juxtaposition, what is revealed when — creates meaning, controls reader expectations, and produces emotional or thematic effects. Summary answers 'what'; analysis answers 'how' and 'why.'"

- question: "A novel begins in the middle of its climactic battle, then flashes back to explain how events led there. What does this in medias res structure accomplish that a strictly chronological plot would not?"
  type: short-answer
  answer: "Starting mid-action creates immediate tension and raises questions the reader wants answered, making the backstory feel purposeful rather than preparatory. It also controls dramatic irony — the reader may watch events unfold knowing where they lead."
  explanation: "In medias res is a deliberate structural choice that shapes how readers receive information. A chronological plot builds tension gradually from the beginning; in medias res inverts this, creating urgency first and explanation second. Analyzing this choice requires understanding what the structure achieves — the kind of question that separates plot analysis from plot summary."
```
