...
- Third-person narrators are not automatically reliable or objective; limited narrators can be deeply biased.
- The narrator and the author are not the same person; conflating them confuses interpretation.
- Omniscient narrators can still withhold information; omniscience is a potential, not a guarantee.

## Questions

```yaml
- question: "A story told in third person that follows only the thoughts and perceptions of a single character, with no access to other characters' inner lives, is using which narrative mode?"
  type: multiple-choice
  options: ["Third-person omniscient", "First-person", "Third-person limited", "Third-person objective"]
  answer: 2
