...
- Tone and mood are not the same thing — conflating them produces imprecise analysis.
- 'Happy', 'sad', and 'scary' are moods, not tones; tonal vocabulary is more precise: sardonic, elegiac, wry, urgent, reverent.
- Tone is constructed by the text; it is not simply how you personally feel about the subject.

## Questions

```yaml
- question: "A passage describes a funeral using precise, clinical language with no emotional commentary from the narrator. The reader nonetheless feels a sense of unease and grief. Which best describes this situation?"
  type: multiple-choice
  options: ["The tone and mood are both mournful", "The tone is detached and clinical; the mood is grief-like or uneasy", "The tone is grief-like; the mood is detached", "There is no tone because the narrator does not state an opinion"]
  answer: 1
  explanation: "Tone is the narrator's attitude, which here is detached and clinical — there is no overt emotional commentary. Mood is what the reader experiences, which is unease and grief. The gap between them is analytically significant: the clinical detachment is itself a tonal choice that produces an unsettling effect. Conflating tone and mood would prevent you from noticing this tension."

- question: "Tone and mood are essentially the same concept and can be used interchangeably in literary analysis."
  type: true-false
  answer: false
  explanation: "Tone is the author's or narrator's attitude toward the subject, evidenced by specific language choices (diction, syntax, imagery). Mood is the emotional atmosphere experienced by the reader. They are related but distinct: a sardonic tone can produce uncomfortable or darkly humorous mood; a reverent tone applied to something trivial produces ironic mood. Precise analysis depends on distinguishing which is which."

- question: "A student claims a passage has a 'sad tone.' What additional precision does a literary analyst need to provide for this to be a defensible claim?"
  type: short-answer
  answer: "The analyst must identify specific words, phrases, or syntactic patterns that construct the tonal stance, use more precise tonal vocabulary (e.g., 'elegiac,' 'mournful,' 'despondent'), and distinguish whether 'sad' describes the narrator's attitude (tone) or the reader's emotional response (mood)."
  explanation: "Vague emotional labels like 'sad' or 'happy' describe mood, not tone. Tone requires more precise vocabulary (sardonic, wry, elegiac, urgent) and must be grounded in specific textual evidence. Without that grounding, a tonal claim is just a report of the reader's feelings — which may vary — rather than an argument about what the text constructs."
```
