...
- Character description is not characterization; description is raw material that requires interpretive framing.
- 'Flat' and 'round' are analytic terms, not value judgments — flat characters can serve essential narrative functions.
- Students often cite a single piece of evidence for a character claim; strong characterization analysis uses multiple, converging examples.

## Questions

```yaml
- question: "A character repeatedly tells other characters that she values loyalty, but abandons her allies whenever it becomes personally costly. What is the most analytically significant observation a close reader should make?"
  type: multiple-choice
  options: ["The direct characterization establishes her as loyal", "Her speech provides indirect characterization through the STEAL acronym", "The gap between her stated identity and her revealed behavior is the richest site for analysis", "Her actions are flat characterization because they are simple and consistent"]
  answer: 2
  explanation: "The gap between what a character claims and what they do is often the most analytically productive element of indirect characterization. Direct characterization tells us what the character says about herself; her actions contradict it. This tension — not either element alone — generates insight into irony, self-deception, or dramatic purpose."

- question: "Describing a character's physical appearance in detail counts as characterization."
  type: true-false
  answer: false
  explanation: "Description is raw material, not characterization. Listing that a character has cold eyes and a rigid posture is description. Characterization occurs when that description is connected to interpretation — when the analyst explains what those details reveal about the character's nature, psychology, or role. Description without interpretive framing is just inventory."

- question: "Why do literary analysts generally consider indirect characterization more analytically productive than direct characterization?"
  type: short-answer
  answer: "Indirect characterization — revealed through speech, thought, effect on others, actions, and looks — invites inference and can create irony when it contradicts direct statements. It places interpretive demands on the reader and often generates richer meaning because the gap between what is shown and what is said is itself significant."
