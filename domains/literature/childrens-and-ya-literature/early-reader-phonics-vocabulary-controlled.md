...
title: 'Early Reader Conventions: Phonics and Controlled Vocabulary'
domain: literature
...
```yaml
multiple-choice:
  - question: "What is the primary difference between an early reader and a picture book designed for children to be read TO?"
    options:
      - "There is no difference—they're the same thing"
      - "Early readers use controlled vocabulary and phonetic regularity to allow children to decode text independently, while picture books are designed for adult reading aloud"
      - "Early readers contain more sophisticated vocabulary"
      - "Picture books are designed for reading aloud while early readers have no constraints"
    answer: 1
    explanation: "Early readers are specifically designed for children to read independently, requiring controlled vocabulary and phonetically regular words to allow emerging readers to successfully decode. Picture books are designed for adult reading aloud, allowing more complex language."
  - question: "What narrative challenge does a writer of early readers face?"
    options:
      - "There are no challenges—any story works"
      - "Creating engaging, coherent stories while constrained by limited vocabulary and phonetically regular words, which dramatically restricts word choice"
      - "Early readers don't need to have engaging stories"
      - "Writers of early readers don't have constraints"
    answer: 1
    explanation: "Early reader writers must craft narratives using only permitted vocabulary and phonetic patterns—a significant technical constraint. Creating stories that are both engaging and pedagogically sound requires skilled constraint-management."

true-false:
  - question: "True or False: An early reader with extremely simple vocabulary and sentence structure is inherently a lower-quality literary work than a picture book with complex language."
    answer: false
    explanation: "False. Quality in early readers isn't measured by vocabulary complexity but by coherence, engagement, and how effectively the writer works within constraints. A skilled early reader writer achieves narrative satisfaction despite severe constraints."
  - question: "True or False: Controlled vocabulary in early readers directly supports emergent reader success because it allows children to focus on decoding rather than being overwhelmed by unfamiliar words."
    answer: true
    explanation: "True. By limiting vocabulary to words children can sound out or have already learned, early readers allow children to experience successful reading and build confidence, while practicing phonetic decoding skills."

short-answer:
  - question: "Explain why an early reader with a consistent phonetic pattern (like 'The cat sat on the mat') is actually a technically skilled piece of writing despite its apparent simplicity."
    explanation: "While 'The cat sat on the mat' seems simple, writing engaging early reader narratives within severe constraints requires genuine skill. The writer must: select only from an approved vocabulary list, maintain grammatical accuracy while using simple syntax, create narrative coherence despite word limitations, and maintain reader engagement in a story about familiar experiences. Creating variation and interest within these constraints requires as much technical skill as writing complex adult fiction. A skilled early reader author makes readers care about simple characters doing mundane things, all while respecting pedagogical constraints. Conversely, unskilled early reader writing can produce sentences that are grammatically correct and phonetically regular but narratively incoherent or boring. The genre rewards constraint management as much as imagination."
```
