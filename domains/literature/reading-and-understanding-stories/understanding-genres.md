...
title: Understanding Genres
domain: literature
course: reading-and-understanding-stories
prerequisites:
- id: mystery-stories-introduction
  type: hard
- id: adventure-genre
  type: hard
- id: fantasy-stories-introduction
  type: hard
- id: realistic-fiction-genre
  type: hard
builds-toward:
...
- Thinking a book can only belong to one genre; many books blend genres, like a mystery set in a fantasy world.
- Believing some genres are better than others; every genre has well-written books and every genre has something valuable to offer.
- Assuming you will not like a genre just because you have not tried it; keeping an open mind about genres leads to great discoveries.
...
- question: "What is a **genre**?"
  ...
  options: ["The name of the author", "A type or category of story with shared features and styles", "How many pages a book has", "The book's price"]
  answer: 1
  explanation: "A genre is a category of stories that share common elements, like mystery stories or fantasy stories."

- question: "All books in the same genre are exactly the same."
  type: true-false
  answer: false
  explanation: "False. Books in the same genre share some features but can be very different in plot, characters, and how the author tells the story."

- question: "Why is it helpful to know what genre a book is?"
  type: multiple-choice
  options: ["It does not matter", "It tells you what to expect—mystery books have puzzles, fantasy has magic, helping you choose what you want to read", "All genres are the same", "Genre only matters to librarians"]
  answer: 1
  explanation: "Knowing the genre helps you understand what kind of story to expect and choose books that match your mood."

- question: "A book can only belong to one genre."
  type: true-false
  answer: false
  explanation: "False. Some books mix genres—like a funny mystery or a fantasy adventure—and readers might sort them differently."

- question: "What is your favorite genre, and why? Describe what you like about books in that genre."
  type: short-answer
  answer: "Example: I love fantasy because I like magical worlds and heroes. Each book takes me somewhere new and exciting."
  explanation: "Good responses show personal preference and ability to identify what makes a genre appealing."
