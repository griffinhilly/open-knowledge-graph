...
- Thinking the narrator is always the author; the narrator is a voice the author creates, not necessarily the author themselves.
- Believing first person is always more honest; first-person narrators can be unreliable because they only know their own perspective.
- Assuming point of view does not matter; it deeply shapes what you know and how you feel about the events.
...
- question: "What is **point of view** in a story?"
  ...
  options: ["The author's opinion about politics", "Who is telling the story and what they know or see", "Where the story is set", "The book's title"]
  answer: 1
  explanation: "Point of view is whose perspective we see the story through—usually a character or a narrator."

- question: "In first-person point of view, the narrator uses 'I' and tells the story from their own perspective."
  type: true-false
  answer: true
  explanation: "True. First-person ('I' or 'we') means you are reading the story as if that character is telling it."

- question: "What is third-person point of view?"
  type: multiple-choice
  options: ["The author's personal opinions", "A narrator uses 'he,' 'she,' or 'they' and describes what a character experiences", "When multiple characters tell the story equally", "None of the above"]
  answer: 1
  explanation: "Third-person narration uses character names or pronouns like 'she' and 'he' to tell the story."

- question: "All stories are told from the same point of view throughout."
  type: true-false
  answer: false
  explanation: "False. Some stories switch point of view between chapters or characters, or show different characters' perspectives."

- question: "Tell a short story event from two different points of view. How does each one change what you understand?"
  type: short-answer
  answer: "Example: From Cat's POV: Dog is chasing me (scary). From Dog's POV: I want to play with Cat (friendly). Same event, different meanings."
  explanation: "Good responses show how point of view changes what we know and how we feel about events."
