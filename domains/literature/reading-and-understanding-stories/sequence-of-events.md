...
- Thinking you need to remember every tiny detail; sequence is about the main events, not every sentence.
- Believing all stories are told in strict order from beginning to end; some stories include flashbacks or jump around in time.
- Assuming the most exciting event always comes last; the climax usually happens before the ending, which wraps things up.

## Questions

```yaml
- question: "What is **sequence of events**?"
  type: multiple-choice
  options: ["The setting of the story", "The order in which things happen in the story, from first to last", "The characters' names", "A description of weather"]
  answer: 1
  explanation: "Sequence is the order of events—what happens first, second, third, and so on."

- question: "Understanding the sequence of events is not important for understanding a story."
  type: true-false
  answer: false
  explanation: "False. Understanding the order of events helps you follow the plot and see how each event leads to the next."

- question: "Why does sequence matter in a story?"
  type: multiple-choice
  options: ["It does not matter at all", "Because one event often causes the next, and the order makes the story make sense", "Because sentences should be long", "Because the author says so"]
  answer: 1
  explanation: "The order of events shows cause-and-effect and helps the story make sense."

- question: "Stories are always told in the exact order the events happened."
  type: true-false
  answer: false
  explanation: "False. Authors sometimes jump around—starting at the end, using flashbacks, or skipping boring parts."

- question: "Describe the sequence of events from a story: What happened first, next, and last?"
  type: short-answer
  answer: "Example: First: Character finds a map. Next: Follows clues to find treasure. Last: Discovers the real treasure was the friends they made."
  explanation: "Good responses show clear understanding of the order and how each event connects."
