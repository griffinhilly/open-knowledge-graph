...
- Thinking fiction means the story is useless because it is not true; fiction teaches us about feelings, relationships, and the human experience.
- Believing nonfiction is always boring; many nonfiction books are fascinating and beautifully written.
- Assuming a book must be entirely one or the other; some books blend fiction and nonfiction, like historical fiction that mixes real events with made-up characters.

## Questions

```yaml
- question: "What is the main difference between fiction and nonfiction?"
  type: multiple-choice
  options: ["Fiction is shorter than nonfiction", "Fiction is made-up stories; nonfiction is real facts and information", "Fiction has characters; nonfiction does not", "There is no difference"]
  answer: 1
  explanation: "Fiction is imagined stories. Nonfiction is factual information about real people, events, and things."

- question: "Nonfiction books are never interesting to read."
  type: true-false
  answer: false
  explanation: "False. Nonfiction can be fascinating! Learning real facts about dinosaurs, space, animals, or history can be as exciting as any story."

- question: "Which of these is fiction?"
  type: multiple-choice
  options: ["A book about how penguins live", "A story about a penguin who learns to dance", "A book with facts about polar animals", "A biography of a famous scientist"]
  answer: 1
  explanation: "A penguin who learns to dance is not real—it is made up, so it is fiction."

- question: "All fiction has magic or fantasy elements."
  type: true-false
  answer: false
  explanation: "False. Realistic fiction has made-up characters and situations but could happen in real life."

- question: "Name one fiction book and one nonfiction book you like. Explain why you like each one."
  type: short-answer
  answer: "Example: Fiction: *Charlotte's Web* because of the beautiful friendship. Nonfiction: *Guinness World Records* because I love learning amazing facts."
  explanation: "Good responses show understanding that fiction and nonfiction are different and can both be enjoyable."
