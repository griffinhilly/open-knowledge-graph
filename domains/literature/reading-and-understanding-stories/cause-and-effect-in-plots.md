...
title: Cause and Effect in Plots
domain: literature
...
- Thinking cause and effect only applies to science; it is one of the most important tools for understanding stories.
- Believing events in stories happen randomly; most events are connected by cause and effect even if the author does not spell it out.
- Confusing the order of events with cause and effect; just because one event comes after another does not always mean the first caused the second.

## Questions

```yaml
- question: "What is a **cause** in a story?"
  type: multiple-choice
  options: ["The ending of the story", "Why something happens", "A character's favorite food", "The title of the book"]
  answer: 1
  explanation: "A cause is the reason something happens. The effect is what happens as a result."

- question: "Every event in a story has a cause that made it happen."
  type: true-false
  answer: true
  explanation: "True. In well-told stories, things happen because of other things. Characters' actions lead to results."

- question: "If a character is lost in the woods, what might be the cause?"
  type: multiple-choice
  options: ["The author wanted to write something", "The character wandered off the path without paying attention", "The book is too long", "Nothing causes it—it just happens"]
  answer: 1
  explanation: "Characters usually get lost because they made a choice (wandered off, weren't paying attention, etc.). That choice is the cause."

- question: "Effects are always good things for the character."
  type: true-false
  answer: false
  explanation: "False. Effects can be good or bad. A character's action might have a positive effect or a negative effect."

- question: "Tell a cause-and-effect chain from a story: What happened first, and what did it cause to happen next?"
  type: short-answer
  answer: "Example: Cause: The main character didn't listen to a warning. Effect: They walked into danger. That caused another character to have to rescue them."
  explanation: "Good responses show understanding that events connect—one thing causes the next, creating the plot."
