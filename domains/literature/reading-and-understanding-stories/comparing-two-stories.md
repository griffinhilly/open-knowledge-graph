...
- Thinking comparing means deciding which story is better; comparison is about understanding, not ranking.
- Believing you can only compare two stories that seem similar; you can learn a lot from comparing very different stories too.
- Assuming there is one correct way to compare; different readers might focus on different elements and that leads to richer discussions.

## Questions

```yaml
- question: "What is one reason to compare two stories?"
  type: multiple-choice
  options: ["To prove one story is better than the other", "To notice how they are similar and different, and learn more from both", "To avoid reading one of them", "There is no reason to compare stories"]
  answer: 1
  explanation: "Comparing stories helps you notice patterns, learn about storytelling, and deepen your understanding."

- question: "Two stories can have similar characters but different endings."
  type: true-false
  answer: true
  explanation: "True. Stories can share elements like a hero character but tell very different tales about what happens to them."

- question: "What is something you could compare between two stories?"
  type: multiple-choice
  options: ["The author's first name only", "Characters, settings, themes, how problems are solved, the author's style", "Nothing—all stories are unique", "Only the length"]
  answer: 1
  explanation: "You can compare many elements: plot, characters, settings, lessons, tone, and how each author writes."

- question: "Comparing stories is only useful in school assignments."
  type: true-false
  answer: false
  explanation: "False. Comparing stories helps you become a better reader and notice things you might otherwise miss."

- question: "Pick two stories with similar themes. How are they the same? How are they different?"
  type: short-answer
  answer: "Example: Both are about courage. Story A shows courage as facing scary enemies. Story B shows courage as standing up for beliefs. Similar theme, different meanings."
  explanation: "Good responses identify a real similarity and a real difference, showing thoughtful analysis."
