...
title: Problem and Solution in Stories
domain: literature
...
- Thinking every problem has a simple, clean solution; some stories have solutions that are complicated or bittersweet.
- Believing the problem is always stated clearly on the first page; sometimes you have to read further to understand what the real problem is.
- Assuming the solution always makes everyone happy; realistic stories sometimes end with partial solutions or trade-offs.
...
- question: "What is a **problem** in a story?"
  ...
  options: ["A difficult word", "Something that troubles the character and must be solved or overcome", "A page number", "Nothing—problems do not exist in stories"]
  answer: 1
  explanation: "A problem is the challenge or conflict that the character must deal with throughout the story."

- question: "Every story must have a problem that is completely solved by the end."
  type: true-false
  answer: false
  explanation: "False. Some stories have problems that are partially solved, or left open-ended. Not all problems are neat endings."

- question: "What is a **solution**?"
  type: multiple-choice
  options: ["A difficult math equation", "The way the character solves or overcomes the problem", "A type of book", "An opinion"]
  answer: 1
  explanation: "A solution is how the character(s) address and overcome the problem they face."

- question: "Sometimes the best solution to a character's problem is luck or magic happening by accident."
  type: true-false
  answer: false
  explanation: "False. In good stories, characters solve problems through their choices, effort, or cleverness—not pure accident."

- question: "Describe a problem from a story and how the character solved it. Could there have been another solution?"
  type: short-answer
  answer: "Example: Problem: Wolf was after Three Little Pigs. Solution: Built brick house. Alternative: They could have run away or asked for help."
  explanation: "Good responses show understanding of problem-solving and acknowledge multiple possible approaches."
