...
title: Dialogue and What Characters Say
domain: literature
...
# Dialogue and What Characters Say
...
- Thinking quotation marks are just decoration; they signal that a character is speaking.
- Believing the narrator and the characters are the same voice; the narrator tells the story, but dialogue is the characters talking.
- Assuming characters always say exactly what they mean; sometimes characters lie, exaggerate, or hold back in dialogue, just like real people.
...
- question: "What does **dialogue** mean in a story?"
  ...
  options: ["The author's own words", "What characters say to each other", "A description of a place", "The ending of the story"]
  answer: 1
  explanation: "Dialogue is the words characters speak to each other. It is marked with quotation marks."

- question: "You can tell a lot about a character's personality and feelings from what they say."
  type: true-false
  answer: true
  explanation: "True. The way characters speak, the words they choose, and what they talk about reveal who they are."

- question: "What does dialogue help you understand in a story?"
  type: multiple-choice
  options: ["What food characters eat", "How characters feel, what they want, and how they relate to others", "Only sad emotions", "Nothing—it is just filler"]
  answer: 1
  explanation: "Dialogue shows us how characters think, feel, and interact with each other."

- question: "All characters in a story speak in the same way."
  type: true-false
  answer: false
  explanation: "False. Different characters speak differently. A smart character might use fancy words, while a silly character might make jokes."

- question: "Write a dialogue between two characters. Make sure their different personalities show through how they speak."
  type: short-answer
  answer: "Example: Wise character: 'Perhaps we should think before we act.' Silly character: 'Nah, let's just jump in and see what happens!' Shows wisdom vs. recklessness."
  explanation: "Strong responses show characters sounding different and their personalities coming through in their words."
