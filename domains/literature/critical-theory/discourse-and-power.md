...
title: Discourse, Power, and Knowledge
domain: literature
...
- Foucault does not claim that power is simply repressive or that it operates from a single center; power is productive, dispersed, and relational.
- Discourse is not synonymous with text or language in a general sense; it refers to historically specific configurations of language, practice, and institution that produce objects of knowledge.
- Genealogy is not the same as history in the traditional sense—it deliberately emphasizes contingency, rupture, and accident to destabilize the apparent necessity of the present.

## Questions

```yaml
- question: "A Foucauldian reading of a prison reform movement would most likely argue that the reforms:"
  type: multiple-choice
  options:
    - "Simply replaced cruelty with kindness, demonstrating progress toward freedom"
    - "Produced new forms of knowledge about criminals that extended and refined social control"
    - "Were ineffective because power always reasserts itself in the same form"
    - "Proved that discourse is separate from material institutions"
  answer: 1
  explanation: "Foucault's key insight is that power is productive, not merely repressive. Prison reform doesn't just reduce punishment — it generates new discourses (criminology, rehabilitation science) that classify subjects, normalize certain behaviors, and extend surveillance. The reforms are not progress toward freedom but a transformation of the mechanisms of power/knowledge."

- question: "For Foucault, the 'author-function' means that the historical person who wrote a text is the primary source of its meaning."
  type: true-false
  answer: false
  explanation: "The author-function is not the biographical individual but a historically contingent principle that societies use to classify, regulate, and assign responsibility for texts. Foucault asks 'What is an author?' to show that 'the author' is an effect of discourse — a regulatory construct — not a natural origin of meaning. This directly challenges the Romantic notion that interpretation means recovering the author's intent."

- question: "What distinguishes Foucault's genealogy from traditional historical narrative, and why does this distinction matter for literary criticism?"
  type: short-answer
  answer: "Genealogy traces the contingent accidents, conflicts, and ruptures that produced present norms, rather than telling a progressive story of development toward the present. For literary criticism, this matters because it denaturalizes categories like 'literature,' 'authorship,' and 'the canon' — showing them as products of specific power/knowledge formations rather than timeless truths."
  explanation: "Traditional history tends to narrate the past as leading inevitably toward the present, which makes current arrangements seem necessary and natural. Genealogy deliberately fragments this narrative, showing that things could have been otherwise. Applied to literary criticism, this means treating the category of 'literature' itself as a discursive construct with a contingent history, not a neutral label for objectively great texts."
```
