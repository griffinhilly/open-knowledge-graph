...
- Postcolonial criticism is not only about texts from formerly colonized nations; it also examines how Western canonical literature participates in the ideological production of empire.
- Hybridity in Bhabha's sense is not simply cultural mixing—it is the disruptive, ambivalent third space produced by the encounter between colonizer and colonized.
- Postcolonial criticism does not require rejecting all Western literature; it asks that texts be read in their imperial context.

## Questions

```yaml
- question: "According to Said's Orientalism, what is the primary function of Western representations of the 'Orient'?"
  type: multiple-choice
  options: ["To provide accurate ethnographic documentation of Eastern cultures", "To construct the East as an exotic, inferior Other that legitimizes imperial domination", "To celebrate cultural exchange between Western and non-Western societies", "To preserve non-Western oral traditions that might otherwise be lost"]
  answer: 1
  explanation: "Said's central argument is that Orientalism is a discourse of power: Western representations of the 'Orient' are not neutral descriptions but ideological constructions that position the East as backward, irrational, and in need of Western governance. The representation itself is a form of domination."

- question: "In Bhabha's framework, hybridity is essentially the same as cultural mixing or multicultural exchange between two groups."
  type: true-false
  answer: false
  explanation: "Bhabha's hybridity is not simple cultural blending. It describes the ambivalent, disruptive 'third space' produced by colonial encounter — a space where colonial authority is undermined because the colonized subject mimics but never fully becomes the colonizer. This mimicry ('almost but not quite') destabilizes the binary between colonizer and colonized rather than harmoniously mixing them."

- question: "What does Spivak mean when she asks 'Can the subaltern speak?', and why is her answer effectively 'no'?"
  type: short-answer
  answer: "Spivak argues that the subaltern — colonized subjects, particularly women — cannot speak in a way that gets heard within intellectual and institutional frameworks built by and for the colonial elite. Even when subalterns speak, their voices are filtered, translated, or erased by the very structures that claim to represent them."
  explanation: "The question is not whether subalterns can physically speak, but whether they have access to representational frameworks that allow their speech to be received and recognized as legitimate knowledge. Spivak's point is that Western (including Western-trained) intellectuals who claim to 'give voice' to the subaltern often reproduce the colonial erasure they mean to oppose."
```
