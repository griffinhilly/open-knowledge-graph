---
id: narratology
title: Narratology and Narrative Theory
domain: literature
...
- Narratology is not the same as plot summary; it analyzes the formal apparatus through which plot is narrated.
- Focalization (who sees) is distinct from voice (who speaks)—a narrator can tell us only what a character perceives without being that character.
- Narratology's scientific ambitions do not mean it ignores meaning—it provides tools for describing form precisely so that interpretive claims can be grounded.

## Questions

```yaml
- question: "In a novel told by a first-person narrator who reports only what a secondary character sees and feels, which term best describes the narrative situation?"
  type: multiple-choice
  options: ["The narrator has external focalization on the secondary character", "The narrator is the focalizer", "The secondary character is the focalizer; the narrator is the voice", "Focalization and voice are identical here"]
  answer: 2
  explanation: "Genette separates focalization (who perceives — the 'lens') from voice (who speaks — the 'mouth'). The secondary character provides the perceptual filter (focalizer), while the first-person narrator is still the voice that narrates. These can differ, which is why the distinction matters."

- question: "Narratology is essentially a more systematic form of plot summary."
  type: true-false
  answer: false
  explanation: "Narratology analyzes the formal apparatus through which a story is told — temporal ordering, focalization, narrative levels, discourse versus story — not the sequence of events itself. A plot summary reproduces content; narratology examines how form shapes meaning."

- question: "What is the difference between story-time and discourse-time, and why does that difference matter for analysis?"
  type: short-answer
  answer: "Story-time is the chronological duration of the events narrated; discourse-time is the amount of text (or screen time) devoted to those events. A novel might cover thirty years in a sentence (summary) or dwell on one hour across fifty pages (scene). This gap reveals where the narrator directs attention and which events are considered significant."
  explanation: "Genette called this relationship between story-time and discourse-time 'duration.' Analyzing it shows that narrators do not represent events neutrally — the pace of telling is itself a rhetorical act that signals importance, irony, or emotional weight."
```
