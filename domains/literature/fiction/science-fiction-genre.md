...
title: 'Science Fiction: Conventions and Themes'
domain: literature
course: fiction
prerequisites:
- id: world-building
...
- Science fiction is not defined by spaceships and robots; it is defined by speculative extrapolation.
- Not all science fiction predicts the future; much of it uses the future as a lens to examine the present.
- 'Scientifically accurate' is not a requirement; internal consistency and thematic rigor matter more.
