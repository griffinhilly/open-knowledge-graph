...
- Realism is not the absence of style; Flaubert and James are highly stylized realists.
- 'Realistic' is not a synonym for 'good'; realism is one aesthetic choice among many.
- Naturalism is a more extreme, deterministic form of realism, not a synonym for it.

## Questions

```yaml
- question: "Which of the following best distinguishes literary realism from Romantic fiction?"
  type: multiple-choice
  options: ["Realist novels avoid metaphor and poetic language entirely", "Realism represents everyday social and psychological conditions with fidelity, resisting idealization", "Realist fiction depicts only working-class characters", "Realism requires the author to have personally witnessed the events depicted"]
  answer: 1
  explanation: "Realism is defined by its commitment to plausible characters, recognizable social conditions, and cause-and-effect plotting — in contrast to Romanticism's idealization. Realist writers like Flaubert and James are highly stylized; the mode is not about abandoning craft but about directing aesthetic energy toward verisimilitude."

- question: "Naturalism is simply another name for literary realism."
  type: true-false
  answer: false
  explanation: "Naturalism is a more extreme, philosophically deterministic form of realism — not a synonym. Naturalist writers (like Zola) portray characters as products of heredity and environment with little room for agency. Realism allows for greater psychological complexity and individual choice."

- question: "What is free indirect discourse, and why is it a key technique in realist fiction?"
  type: short-answer
  answer: "Free indirect discourse blends the narrator's voice with a character's inner thoughts, presenting the character's perspective without explicit speech tags. It allows realist fiction to convey psychological interiority while maintaining narrative coherence."
  explanation: "Realism prioritizes psychological depth and plausible interior lives. Free indirect discourse (used by Flaubert, Austen, and Tolstoy) is the technique that makes this possible: readers access a character's consciousness without the artifice of direct quotation or omniscient declaration."
```
