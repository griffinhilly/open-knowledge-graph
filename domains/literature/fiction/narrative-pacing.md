---
id: narrative-pacing
title: Narrative Pacing in Fiction
domain: literature
course: fiction
prerequisites:
- id: plot-structure
...
- Fast pacing is not always better; some of the most powerful moments in fiction are achingly slow.
- Pacing is not only about plot speed but about the reader's psychological experience of time.
- Dialogue almost always creates scene, but internal monologue can function as either scene or summary depending on its relationship to the story's timeline.

## Questions

```yaml
- question: "A novelist wants her reader to feel the excruciating tension of a character waiting outside a hospital room for news. Which technique best achieves this?"
  type: multiple-choice
  options: ["A one-sentence summary: 'She waited for three hours.'", "A fully dramatized scene rendering the wait in real time with sensory detail and thought", "Skipping the wait entirely and cutting to when the news arrives", "Providing backstory about the character's relationship to hospitals"]
  answer: 1
