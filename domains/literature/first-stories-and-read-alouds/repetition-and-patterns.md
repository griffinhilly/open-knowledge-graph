...
title: Repetition and Patterns in Stories
domain: literature
...
# Repetition and Patterns in Stories
...
- Thinking repetition means the story is boring; repetition is what makes many stories exciting and memorable.
- Believing you should not say the words out loud during a read-aloud; joining in on repeated phrases is encouraged.
- Assuming every story has the same kind of pattern; some repeat words, some repeat events, and some repeat a rhythmic beat.
...
- question: "What is repetition in a story?"
  ...
  options: ["When a story has no words", "When certain words, phrases, or events happen over and over again", "When a story is about something sad", "When you do not listen"]
  answer: 1
  explanation: "Repetition is when the story says the same thing again and again. It creates a pattern you can remember!"

- question: "Repetition in stories makes them boring and not fun."
  type: true-false
  answer: false
  explanation: "Repetition actually makes stories MORE exciting and memorable! You can say the words along with the reader."

- question: "Can you think of a repeated phrase from a story? What words or sounds repeat?"
  type: short-answer
  answer: "Example: 'Fee, fi, fo, fum' or 'I'll huff and I'll puff' or 'Who will help me?'"
  explanation: "A good answer names a phrase that actually repeats in a story."

- question: "What can you do when a story has a repeated phrase?"
  type: multiple-choice
  options: ["You must sit silently and never speak", "You can join in and say the words with the reader", "You should cover your ears", "You must leave the room"]
  answer: 1
  explanation: "Joining in on repeated phrases is wonderful! It makes you feel part of the story and helps you learn."

- question: "All patterns in stories are the same. Every story repeats words the same way."
  type: true-false
  answer: false
  explanation: "Different stories have different kinds of patterns! Some repeat words, some repeat events, some repeat a rhythm or beat."
```
