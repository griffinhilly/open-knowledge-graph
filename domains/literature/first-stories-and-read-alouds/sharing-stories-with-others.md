---
id: sharing-stories-with-others
title: Sharing Stories with Others
domain: literature
...
- Thinking you need to remember every detail to share a story; sharing the parts you liked most is enough.
- Believing other people will not be interested in your favorite stories; people love hearing about what excites someone else.
- Assuming sharing means giving away your book; sharing a story means telling someone about it so they can enjoy it too.

## Questions

```yaml
- question: "What does it mean to share a story?"
  type: multiple-choice
  options: ["You have to give away your book", "You tell someone about a story you love or show them the pictures", "Only grown-ups can share stories", "You cannot keep the book after sharing"]
  answer: 1
  explanation: "Sharing a story means telling someone else about a book you love or showing them the pictures so they can enjoy it too."

- question: "You need to remember every single detail before you can share a story with someone."
  type: true-false
  answer: false
  explanation: "You just need to share the parts you liked most! You do not have to remember every detail."

- question: "Tell a friend or family member about your favorite story. What would you say?"
  type: short-answer
  answer: "Example: I would say what the story is about, who I liked, and why it made me happy."
  explanation: "A good answer shows you would share the parts that matter to you and why you liked the story."

- question: "Why is it good to share stories with other people?"
  type: multiple-choice
  options: ["Because you have to follow the rules", "Because it helps people discover stories they might enjoy and creates connection", "Because no one cares about stories", "Stories should be kept secret"]
  answer: 1
  explanation: "Sharing stories helps others find new favorites, and it creates special connections between people who love stories!"

- question: "People will not be interested in hearing about your favorite stories."
  type: true-false
  answer: false
  explanation: "People LOVE hearing about what excites someone else! Your excitement about a story is contagious and wonderful."
```
