...
- Thinking characters only feel one way through the whole story; feelings often change as the story moves along.
- Believing you can only tell how characters feel if the words say so; pictures, actions, and what happens all give clues.
- Assuming your feelings about the story have to match the character's feelings; you might feel happy when a character feels nervous, and that is okay.

## Questions

```yaml
- question: "What kinds of feelings do characters in stories have?"
  type: multiple-choice
  options: ["No feelings at all", "Only happy feelings", "Happy, sad, scared, angry, excited, and many other feelings", "Only silly feelings"]
  answer: 2
  explanation: "Characters have feelings just like real people! They can feel happy, sad, scared, angry, excited, surprised, and more."

- question: "Characters feel the same way the entire story from beginning to end."
  type: true-false
  answer: false
  explanation: "Characters' feelings change during the story. A character might feel scared at first but then feel brave or happy later!"

- question: "Describe a time when a character in a story felt a certain way. How could you tell what they felt?"
  type: short-answer
  answer: "Example: The bunny felt scared because the picture showed a worried face, or because something scary happened in the story."
  explanation: "A good answer shows you can recognize feelings from the pictures or the actions in the story."

- question: "How can you tell how a character feels in a story?"
  type: multiple-choice
  options: ["Only from the words on the page", "From the character's face in the pictures, their actions, and what happens to them", "You can never tell", "Only if the character talks"]
  answer: 1
  explanation: "You can tell by looking at faces, what characters do, what happens to them, and what the words say. All these things give you clues!"

- question: "Your feelings have to match the character's feelings while you read a story."
  type: true-false
  answer: false
  explanation: "You might feel happy while reading about a nervous character, or feel scared while finding a story funny. Your feelings can be different from theirs!"
```
