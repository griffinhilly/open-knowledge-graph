---
id: stories-with-songs
title: Stories with Songs
domain: literature
...
- Thinking singing a book is not the same as reading it; song-stories are a real form of literature.
- Believing you need to be a good singer to enjoy these books; singing along at any skill level is the point.
- Assuming stories with songs are only for the very youngest children; many song-based books have clever wordplay that older children enjoy too.

## Questions

```yaml
- question: "What is a story with a song?"
  type: multiple-choice
  options: ["A book with no words", "A story that includes songs or is based on a song you can sing along to", "A book about musicians", "Just a song without a story"]
  answer: 1
  explanation: "A story with a song is a book that combines storytelling with music that you can sing together!"

- question: "Singing a book is not the same as reading it. Singing does not count as real reading."
  type: true-false
  answer: false
  explanation: "Song-stories ARE a real form of literature! When you sing a story, you are reading and experiencing it in a musical way."

- question: "What song-story do you know? How do you sing it together?"
  type: short-answer
  answer: "Example: 'The Wheels on the Bus' or 'Old MacDonald' -- we sing the words and sometimes do hand motions."
  explanation: "A good answer shows you know a song-story and how to enjoy singing it together."

- question: "Do you need to be a really good singer to enjoy stories with songs?"
  type: multiple-choice
  options: ["Yes, only great singers can enjoy them", "No, singing at any skill level is fun and the point is to enjoy it", "Only if you are in a choir", "Only if you practice"]
  answer: 1
  explanation: "You do not have to be a good singer! The point is to have fun singing together, no matter what your voice sounds like."

- question: "Stories with songs are only for very tiny babies."
  type: true-false
  answer: false
  explanation: "Song-stories are for many ages! Even older kids enjoy them because they have clever wordplay and fun music."
```
