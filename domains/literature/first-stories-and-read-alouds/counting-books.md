...
- Thinking counting books are only for learning numbers; they also build vocabulary and observation skills.
- Believing you need to already know how to count to enjoy a counting book; the book is there to help you learn.
- Assuming all counting books go from 1 to 10; some go higher, some count backwards, and some count by twos or fives.

## Questions

```yaml
- question: "What does a counting book help you practice?"
  type: multiple-choice
  options: ["Writing letters", "Counting and numbers", "Singing songs", "Jumping"]
  answer: 1
  explanation: "A counting book has numbers and objects on each page that you can count and practice with."

- question: "You have to already know how to count perfectly before you can read a counting book."
  type: true-false
  answer: false
  explanation: "Counting books are designed to help you learn to count! You do not need to know already -- the book teaches you."

- question: "How do you count the objects in a counting book? Describe what you do."
  type: short-answer
  answer: "Example: I point to each object and say the number, like 1, 2, 3, or I touch each one with my finger."
  explanation: "A good answer shows you understand how to slowly point and count, not rush through the page."

- question: "All counting books go from number 1 to number 10."
  type: multiple-choice
  options: ["True, they all go 1 to 10", "False, some count higher, backwards, or by different numbers", "Only for little kids", "Only at school"]
  answer: 1
  explanation: "Counting books can count 1-10, but some go higher, some count backwards, and some count by twos or fives!"

- question: "Counting books only teach you numbers. They do not teach other things."
  type: true-false
  answer: false
  explanation: "Counting books teach counting AND math, AND vocabulary, AND how to observe and look carefully at pictures!"
```
