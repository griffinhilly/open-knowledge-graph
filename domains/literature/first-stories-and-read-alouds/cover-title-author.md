...
- Thinking the title is the same as the whole story; the title is just the name, like a person's name.
- Confusing the author with the illustrator; the author writes the words and the illustrator draws the pictures.
- Believing that every book is written by the same person; many different people write books.

## Questions

```yaml
- question: "What is the title of a book?"
  type: multiple-choice
  options: ["The picture on the cover", "The name of the story", "The whole book", "A person's job"]
  answer: 1
  explanation: "The title is the name of the story, just like your name is your name. You can find it on the front cover."

- question: "The author and the illustrator do the exact same job in a book."
  type: true-false
  answer: false
  explanation: "The author writes the words of the story. The illustrator draws the pictures. They have different jobs!"

- question: "What information can you find on the front cover of a book? Name two things."
  type: short-answer
  answer: "Example: The title, the author's name, and a picture that shows what the story is about."
  explanation: "A good answer includes at least two things you can find on a book's front cover."

- question: "You can find the title and author's name where in a book?"
  type: multiple-choice
  options: ["Only on the back", "On the front cover and inside", "In the middle of the story", "Only if the book is new"]
  answer: 1
  explanation: "The title and author's name appear on the front cover of the book, and you can also find them inside."

- question: "Every book is written by the same person."
  type: true-false
  answer: false
  explanation: "Many different people write books! Each author writes their own stories, so there are hundreds and thousands of different authors."
```
