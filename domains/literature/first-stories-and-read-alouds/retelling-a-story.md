...
- Thinking you have to remember every single word exactly; retelling is about the big ideas, not word-for-word memory.
- Believing you cannot retell a story unless you can read it yourself; retelling is about what you heard and understood.
- Assuming retelling means just naming what happened last; a good retelling covers the beginning, middle, and end.
...
- question: "What does it mean to retell a story?"
  ...
  options: ["To read the book again without stopping", "To say what happened in the story in your own words", "To pretend you read it", "To only tell the ending"]
  answer: 1
  explanation: "Retelling means saying the story again using your own words, remembering the important parts."

- question: "You have to remember every single word exactly to retell a story correctly."
  type: true-false
  answer: false
  explanation: "Retelling is about the big ideas and important events, not remembering every word perfectly!"

- question: "Tell me a story you know. Cover the beginning, what happened, and the ending."
  type: short-answer
  answer: "Example: A bunny wanted a friend. It looked everywhere. Finally, it found another bunny, and they played together."
  explanation: "A good retelling has a beginning, middle, and end, and shows you understood the story."

- question: "Can you retell a story you heard read out loud, or do you have to be able to read it yourself?"
  type: multiple-choice
  options: ["You must read it yourself", "You can retell any story you heard and understood", "Only if it has pictures", "Only if someone helped you"]
  answer: 1
  explanation: "You can retell any story you heard and understood! You do not have to read it yourself."

- question: "A good retelling is just naming the very last thing that happened in the story."
  type: true-false
  answer: false
  explanation: "A good retelling covers the beginning, what happened in the middle, and how it ended -- not just the ending!"
```
