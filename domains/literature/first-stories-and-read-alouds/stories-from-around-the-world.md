---
id: stories-from-around-the-world
...
- Thinking all good stories come from one country or culture; every culture in the world has a rich tradition of storytelling.
- Believing stories from other places will be too strange to understand; many share the same themes of family, friendship, and adventure.
- Assuming stories from far away are less important than stories about places you know; every story widens your understanding of the world.

## Questions

```yaml
- question: "Where do stories come from?"
  type: multiple-choice
  options: ["Only from one country", "From people all around the world and from many different cultures", "Only from cities", "Stories are made by machines"]
  answer: 1
  explanation: "People everywhere tell stories! Every culture in the world has beautiful stories to share."

- question: "Stories from far-away places are too strange and different for you to understand."
  type: true-false
  answer: false
  explanation: "Even though they might have different settings and clothing, stories from other places often share the same feelings we all have -- love, bravery, and friendship."

- question: "Tell me about a story from a different country or culture you have heard. What made it special?"
  type: short-answer
  answer: "Example: It had different animals/places, or the characters dressed differently, or it taught me something new about another place."
  explanation: "A good answer shows you engaged with a story from another culture and found something interesting about it."

- question: "What can you learn from reading stories from many different cultures?"
  type: multiple-choice
  options: ["Nothing new", "How different people live and think, what makes us all the same, and that the world is big and interesting", "Only facts about geography", "That your culture is the only good one"]
  answer: 1
  explanation: "Stories from around the world help you see different lives, understand different cultures, and discover what people everywhere have in common!"

- question: "Stories from your own country are more important than stories from far away."
  type: true-false
  answer: false
  explanation: "Stories from everywhere are important! Every story helps you understand the world better and see how people live in different places."
```
