...
- Realist drama is not the same as 'realistic' in the colloquial sense — it is a specific theatrical movement with formal conventions (fourth wall, box set, psychologically motivated action) that are themselves artificial.
- Chekhov's plays are often called plotless, but they have carefully structured arcs; the difference is that these arcs do not resolve into conventional climax and resolution.

## Questions

```yaml
- question: "Ibsen's A Doll's House ends with Nora leaving her husband and children — an action shocking to Victorian audiences. In the context of modern realist drama, what is the primary function of this ending?"
  type: multiple-choice
  options: ["To provide a satisfying cathartic resolution to the dramatic conflict", "To expose the social institution of bourgeois marriage and its hypocritical demands on women", "To demonstrate that women are more courageous than men", "To shock the audience through theatrical spectacle and surprise"]
  answer: 1
