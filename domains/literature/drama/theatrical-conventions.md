...
- The 'fourth wall' is not broken only in experimental theatre; Elizabethan drama routinely broke it via soliloquies.
- Theatrical conventions are not the same as stage directions — conventions are implied norms, while stage directions are explicit textual instructions.

## Questions

```yaml
- question: "An actor in a Greek tragedy wears a large mask and speaks in a raised, formal register that no real person uses in daily life. The audience accepts this without confusion. What concept best explains this acceptance?"
  type: multiple-choice
  options: ["Suspension of disbelief, which is unique to Greek theatre", "Theatrical convention — a tacit shared agreement between playwright and audience about the rules of the performance", "Stage directions specifying the performance style", "Method acting techniques that make the artificial feel natural"]
  answer: 1
