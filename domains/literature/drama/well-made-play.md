...
- 'Well-made' is a technical term, not an aesthetic compliment — a well-made play may be dramatically hollow despite its mechanical efficiency.
- The formula is not obsolete; commercial screenwriting and most TV drama still operate on well-made-play principles.

## Questions

```yaml
- question: "A drama professor describes a new play as 'technically well-made.' What does this tell you about the play's artistic quality?"
  type: multiple-choice
  options:
    - "The play is aesthetically accomplished and emotionally resonant"
    - "Nothing — 'well-made' is a technical designation for a specific dramaturgical formula, not a judgment of artistic merit"
    - "The play is probably from the 19th century, since the form is considered obsolete today"
    - "The play follows Ibsen's model of social realism"
  answer: 1
  explanation: "'Well-made' (pièce bien faite) is a technical term naming a specific formula — exposition, withheld secret, obligatory scene, tidy resolution — codified by Eugène Scribe. A play can be a well-made play and be dramatically hollow, or it can deploy the formula brilliantly. The term says nothing about artistic quality. Option C is also wrong: well-made-play principles still dominate commercial screenwriting and television drama."

- question: "A Doll's House follows the well-made play formula almost exactly — it has a withheld secret, escalating misunderstandings, and a direct confrontation scene. What does Ibsen do that breaks with Scribe's formula?"
  type: multiple-choice
  options:
    - "He adds a second obligatory scene that complicates the resolution"
    - "He reveals that Nora's secret was never real, undermining the formula's engine"
    - "He provides a tidy resolution that restores domestic order, as Scribe would have"
    - "He replaces the expected tidy resolution with Nora's departure, leaving the central conflict unresolved"
  answer: 3
  explanation: "Scribe's formula ends with a 'well-tied knot' — restoration of order after the obligatory confrontation. Ibsen honors every step of the formula up to that point, then refuses the resolution: Nora slams the door and leaves. The subversion is only legible against the background of the formula. A student who doesn't know the formula will miss the calculated refusal that makes the ending significant."

- question: "The scène à faire (obligatory scene) is the moment the audience has been anticipating since the withheld secret was established, and its omission in a well-made play would feel like a dramatic cheat."
  type: true-false
  answer: true
