...
- Conflict does not require an explicit antagonist — in many modern plays (Chekhov, Beckett), conflict is internal, social, or existential rather than embodied in a villain.
- The absence of shouting or violence does not mean the absence of dramatic conflict; the most quietly devastating scenes often carry the highest dramatic stakes.

## Questions

```yaml
- question: "Which of the following best describes dramatic conflict in theatre?"
  type: multiple-choice
  options:
    - "A physical or verbal fight between two characters on stage"
    - "The tension between opposing forces that creates suspense and drives the play forward"
    - "The moment when the protagonist defeats the antagonist in the climax"
    - "Any scene in which characters express disagreement"
  answer: 1
...
- question: "What distinguishes dramatic conflict from conflict in other narrative forms like prose fiction?"
  type: short-answer
  answer: "In drama, conflict must be directly embodied in action and dialogue — it cannot be narrated or introspected around. A playwright cannot tell you a character is struggling; the struggle must be visible in what characters do and say on stage."
  explanation: "This is the key formal constraint of theatre. A novelist can enter a character's thoughts to convey internal conflict; a playwright cannot. Conflict must be externalised through behaviour and speech, which is why dramatic conflict tends toward direct confrontation and opposition rather than interior rumination."
```
