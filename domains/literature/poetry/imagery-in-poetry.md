...
- Imagery is not synonymous with metaphor — a concrete factual description is also imagery.
- More imagery is not always better; restraint and negative space can intensify individual images.

## Questions

```yaml
- question: "Which of the following lines is an example of imagery that does NOT use figurative language?"
  type: multiple-choice
  options: ["Her smile was a summer sunrise.", "The wind howled like a wolf through the empty street.", "The bread came out brown and cracked, smelling of char and yeast.", "Time is a thief that steals our years."]
  answer: 2
...
- question: "A poem contains the line: 'The old dog lay on the porch, his gray muzzle resting on his paws.' Identify what sensory modes this image engages and describe what it communicates beyond pure description."
  type: short-answer
  answer: "The line primarily engages sight (gray muzzle, resting posture, paws) and implies touch or weight (the heaviness suggested by 'resting'). Beyond description, it evokes stillness, age, and gentle decline — functioning as an image of patient endurance or impending loss without naming either abstraction."
  explanation: "This is how imagery works in poetry: the concrete sensory detail carries emotional and intellectual weight without stating it directly. The poet trusts the specific image to produce a felt response rather than labeling the feeling. Close readers ask what the image is doing beyond description — what world does it build, and what claim does that world make?"
```
