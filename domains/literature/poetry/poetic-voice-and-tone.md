...
- The 'I' of a poem is not automatically the poet; the speaker is a constructed voice that may differ significantly from the author.
- Tone is not reducible to emotion — a poem can be sad in content but wry in tone.

## Questions

```yaml
- question: "Which statement best describes the relationship between poetic voice and tone?"
  type: multiple-choice
  options: ["Voice and tone are synonyms — both describe the speaker's emotional register", "Voice is the poet's stable sensibility across their work; tone is the speaker's attitude in a specific poem or passage", "Tone determines word choice; voice determines subject matter", "Both voice and tone shift so dramatically from poem to poem that they cannot be traced"]
  answer: 1
