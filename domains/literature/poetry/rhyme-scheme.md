...
- Rhyme schemes are not just decorative — the pairing of rhyming words often signals a conceptual or emotional relationship.
- Slant rhyme (near-rhyme) counts as a rhyme choice and is often more sophisticated than perfect rhyme.

## Questions

```yaml
- question: "A poem's four stanzas each follow this end-word pattern: love / death / above / breath. What is the rhyme scheme of each stanza?"
  type: multiple-choice
  options: ["AABB", "ABAB", "ABBA", "ABCD"]
  answer: 1
...
- question: "How does a poet use the breaking of an established rhyme scheme to create emphasis or meaning?"
  type: short-answer
  answer: "By establishing a regular pattern, the poem creates an expectation. When a line deviates — introducing an unrhymed word, a slant rhyme where a perfect rhyme was expected, or an extra line — the deviation draws attention to itself. The word or idea that breaks the pattern is foregrounded, often marking an emotional turn or the poem's most important claim."
  explanation: "Formal expectation is a kind of promise. Breaking it is a rhetorical act. Readers who have internalized the pattern feel the disruption, which is why deviations at key moments can be more powerful than any amount of explicit statement."
```
