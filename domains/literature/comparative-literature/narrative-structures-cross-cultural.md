...
title: Narrative Structures Across Cultures and Periods
domain: literature
...
- point-of-view-across-traditions
tags:
- narrative
- structure
- form
...
```yaml
- question: "Which of the following best illustrates how narrative structure can encode cultural assumptions rather than being a neutral formal choice?"
  type: multiple-choice
  options:
    - "Using third-person narration instead of first-person"
    - "A tradition that structures stories as cycles returning to their origin point, reflecting a conception of time as recurring rather than progressive"
    - "Employing multiple protagonists rather than a single central hero"
    - "Writing longer chapters toward the end of a novel than at the beginning"
  answer: 1
