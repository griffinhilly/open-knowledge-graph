...
- question: "The gluing condition for a sheaf requires two things: compatible local sections is expected to glue to a global section (existence), and that global section should be unique (uniqueness). A presheaf satisfying mainly the existence part is called a separated presheaf."
  type: true-false
  answer: false
