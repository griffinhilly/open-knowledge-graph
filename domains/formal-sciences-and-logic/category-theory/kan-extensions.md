...
- question: "A left Kan extension Lan_K F generally exists for any pair of functors K: C → D and F: C → E, because the universal property uniquely characterizes what the values should be at most object of D."
  type: true-false
  answer: false
