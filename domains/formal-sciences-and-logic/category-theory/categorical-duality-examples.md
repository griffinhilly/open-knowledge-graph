...
- question: "Categorical duality means that C and C^op are typically equivalent as categories — any theorem true in C is equally true in C^op without needing additional verification."
  type: true-false
  answer: false
