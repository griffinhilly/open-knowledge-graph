...
- question: "Because SAT is NP-complete, any SAT solver that solves real-world instances quickly must be using a fundamentally different computational model than what the NP-completeness proof assumes."
  type: true-false
  answer: false
