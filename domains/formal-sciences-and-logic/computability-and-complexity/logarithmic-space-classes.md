...
- question: "Since NL ⊆ P by Savitch's theorem, most problem in NL can be efficiently solved in practice using the deterministic algorithm implied by the proof."
  type: true-false
  answer: false
