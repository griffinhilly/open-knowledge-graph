...
- question: "Converting a general CNF formula into a 3-SAT instance using auxiliary variables may change whether the formula is satisfiable, so the conversion is only an approximation and not a true polynomial reduction."
  type: true-false
  answer: false
