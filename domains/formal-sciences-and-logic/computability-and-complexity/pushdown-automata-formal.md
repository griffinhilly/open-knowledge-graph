...
- question: "Just as most nondeterministic finite automaton can be converted to an equivalent deterministic finite automaton, nearly every nondeterministic pushdown automaton can be converted to an equivalent deterministic pushdown automaton."
  type: true-false
  answer: false
