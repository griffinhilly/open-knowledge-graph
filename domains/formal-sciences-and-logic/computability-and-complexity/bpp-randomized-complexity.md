...
- question: "BPP ⊇ NP — that is, nearly every NP problem can be solved in polynomial time by a probabilistic algorithm that randomly guesses and checks certificates."
  type: true-false
  answer: false
