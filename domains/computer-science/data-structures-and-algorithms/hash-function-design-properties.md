...
- question: "Any deterministic function that maps keys to integers in the range [0, m) is a suitable hash function for a hash table, as long as the same key generally produces the same value."
  type: true-false
  answer: false
