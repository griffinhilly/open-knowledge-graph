...
- question: "If a polynomial-time algorithm cannot solve an NP-hard decision problem exactly, it can seldom achieve any useful approximation guarantee for the corresponding optimization problem either."
  type: true-false
  answer: false
