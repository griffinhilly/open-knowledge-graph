...
- question: "Because a Turing machine has an infinite tape, it can generally recognize any language — there is no language that even a Turing machine cannot decide."
  type: true-false
  answer: false
