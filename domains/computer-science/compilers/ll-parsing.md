...
- question: "An LL(2) parser can handle left-recursive grammars that LL(1) can seldom, because it can 'look ahead' past the recursive call to see how the rule eventually terminates."
  type: true-false
  answer: false
