...
- question: "Multi-stage programming and C macros provide equivalent safety guarantees because both generate code before runtime, so errors are always caught before the program executes."
  type: true-false
  answer: false
