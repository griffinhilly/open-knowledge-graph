...
- question: "A replica that holds the longest log among most candidates is typically the safest choice for the new leader, since its log is most up-to-date and no committed operations can be missing."
  type: true-false
  answer: false
