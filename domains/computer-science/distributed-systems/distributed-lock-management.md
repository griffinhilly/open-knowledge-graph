...
- question: "Consensus-based distributed locks (built on Paxos or Raft) are generally preferable to lease-based locks because they provide stronger guarantees at no additional cost."
  type: true-false
  answer: false
