...
- Assuming all dichotomies are false — genuine dilemmas with only two options do exist (e.g., 'guilty or not guilty' in certain legal contexts).
- Thinking that adding a third option automatically resolves the underlying issue; the third option still needs to be evaluated.
...
```yaml
- question: "Which of the following is most clearly an example of a false dichotomy?"
  type: multiple-choice
  options:
    - "'Either you study hard or you'll fail this exam.' (Said by a professor to a student with poor study habits.)"
    - "'We must choose between funding education and funding healthcare — we can't afford both.' (Said during a budget debate where a surplus exists.)"
    - "'Either the defendant committed the crime or someone else did.' (Said by a defense attorney.)"
    - "'You're either alive or dead.' (Said by a doctor assessing a patient.)"
  answer: 1
