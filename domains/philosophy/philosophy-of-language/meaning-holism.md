...
- question: "Meaning holism is logically incompatible with the compositionality principle — if holism is true, sentences cannot have meanings composed from the meanings of their parts."
  type: true-false
  answer: false
