...
title: Phenomenal vs Access Consciousness
domain: philosophy
...
- The distinction is not between 'being conscious' and 'being able to talk about it'; A-consciousness involves any rational use of content, not just verbal report.
- Block does not deny that P-consciousness and A-consciousness usually co-occur; the claim is that they are conceptually and possibly empirically separable.

## Questions

```yaml
- question: "According to Ned Block, which of the following best describes access consciousness (A-consciousness)?"
  type: multiple-choice
  options: ["The subjective, 'what it is like' quality of an experience", "The availability of mental content for use in reasoning, verbal report, and behavioral control", "The unconscious processing that occurs below the threshold of awareness", "The capacity to experience emotions rather than purely cognitive states"]
  answer: 1
...
- question: "What is the 'overflow' argument, and what does it claim about the relationship between phenomenal and access consciousness?"
  type: short-answer
  answer: "The overflow argument claims that phenomenal experience is richer than what cognitive access can capture at any moment — we experience more than we can report or reason about, so P-consciousness overflows A-consciousness."
  explanation: "Block draws on Sperling's partial-report experiments, where subjects can report any row of a briefly flashed letter array but quickly lose access to the others. Block argues the subjects phenomenally experienced the full array even though only part of it was cognitively accessible. If true, this shows that phenomenal consciousness can exceed the bottleneck of cognitive access."
```
