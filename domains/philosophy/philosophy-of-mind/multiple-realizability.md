...
- Multiple realizability does not show that mental states are non-physical; it only shows they are not type-identical to specific neural types.
- The argument assumes that pain in humans and pain in octopuses share a common type; critics question whether this assumption is warranted.

## Questions

```yaml
- question: "Multiple realizability is most directly an argument against which view?"
  type: multiple-choice
  options: ["Dualism, because it shows minds are not separate from bodies", "Type identity theory, because it shows there is no one-to-one mapping between mental types and physical types", "Functionalism, because it shows mental states depend on physical substrate", "Epiphenomenalism, because it shows mental states are causally efficacious"]
  answer: 1
