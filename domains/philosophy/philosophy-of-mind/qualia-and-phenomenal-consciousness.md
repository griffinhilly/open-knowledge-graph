...
- Qualia are not simply 'subjective opinions about things'; they are the intrinsic felt character of experience itself.
- Denying qualia (as eliminativists do) is not obviously coherent — it seems to explain away the very phenomenon that needs explaining.

## Questions

```yaml
- question: "What does 'phenomenal consciousness' specifically refer to, as used in philosophy of mind?"
  type: multiple-choice
  options:
    - "The ability to verbally report and reason about one's mental states"
    - "The subjective, felt character of experience — what it is like to be in a mental state"
    - "Unconscious processing that influences behavior without awareness"
    - "The neural correlates of wakefulness and attention"
  answer: 1
