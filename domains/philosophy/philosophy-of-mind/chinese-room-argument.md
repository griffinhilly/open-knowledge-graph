...
- question: "Searle's argument is that computers cannot behave intelligently or pass behavioral tests like the Turing Test."
  type: true-false
  answer: false
...
- question: "If the person in the Chinese Room memorized the entire rulebook and performed all the symbol manipulations in their head, they would, according to Searle, come to understand Chinese — since they have now become the whole system."
  type: true-false
  answer: false
