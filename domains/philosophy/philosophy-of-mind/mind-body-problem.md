...
- The problem is not simply 'how does the brain produce thought?' — it asks the deeper question of why any physical process should produce subjective experience at all.
- Solving the problem neurologically (finding correlates of consciousness) does not dissolve the philosophical question about the nature of that correlation.
