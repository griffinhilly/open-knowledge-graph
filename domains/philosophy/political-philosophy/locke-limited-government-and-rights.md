...
title: 'Locke: Limited Government and Natural Rights'
domain: philosophy
...
- Locke did not invent rights but grounded them in nature rather than sovereign will.
- Locke allows limited government to regulate rights for the common good; rights are not absolute or unlimited.

## Questions

```yaml
- question: "A government seizes private property without compensation to fund a military campaign, citing national security. On Locke's theory, which response is most accurate?"
  type: multiple-choice
  options:
    - "This is bad policy but legitimate government action, since the majority approved the campaign"
    - "This is legitimate as long as the campaign succeeds in protecting citizens' lives and liberty"
    - "This is an act of tyranny that forfeits the government's legitimacy, because protecting property is the very purpose for which government was created"
    - "This violates Locke's principles only if the property owners explicitly withheld consent"
  answer: 2
  explanation: "For Locke, government's sole justification is protecting natural rights to life, liberty, and property. A government that arbitrarily seizes property does not merely act badly within a legitimate role — it undermines the very basis of its authority. The purpose-limitation is absolute: government acting against the rights it was created to protect becomes tyrannical and forfeits legitimacy. The ends (national security) do not justify the means (rights violation) for Locke, because rights precede and constrain government action, not the other way around."

- question: "Why does Locke hold that people had rights even before any government existed?"
  type: multiple-choice
  options:
    - "Because ancient pre-political governments declared rights into existence before dissolving"
    - "Because rights derive from our status as rational, self-owning beings — a status grounded in nature and reason, independent of any sovereign's decree"
    - "Because the social contract creates rights as a byproduct of mutual agreement among equals"
    - "Because rights are purely procedural conventions that emerge spontaneously from repeated social interaction"
  answer: 1
