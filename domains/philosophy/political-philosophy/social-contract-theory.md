...
- The contract is almost never claimed to be an actual historical event.
- 'Tacit consent' (Locke) is philosophically contested — merely residing in a country may not constitute genuine consent.
- Hobbes's contract is not mutual between ruler and ruled — subjects contract with each other to submit to a sovereign.

## Questions

```yaml
- question: "In Hobbes's version of the social contract, what is the structure of the agreement?"
  type: multiple-choice
  options:
    - "Citizens contract with the sovereign to receive protection in exchange for their obedience"
    - "Citizens contract with each other to submit to a common sovereign"
    - "The sovereign contracts with citizens to govern justly in exchange for their compliance"
    - "All citizens collectively agree on a constitution that limits the sovereign's power"
  answer: 1
