...
title: 'Civil Disobedience: Theory and Justification'
domain: philosophy
...
```yaml
- question: "In Rawls's account, why must practitioners of civil disobedience accept legal consequences (arrest and punishment) rather than fleeing or evading them?"
  type: multiple-choice
  options:
    - "To demonstrate suffering, which proves the sincerity of their conviction"
    - "Because accepting consequences signals that the appeal is to shared principles of justice within the legal framework, not a rejection of law's authority as such"
    - "Because fleeing would make the act indistinguishable from ordinary cowardice"
    - "Rawls believed all laws, including unjust ones, must ultimately be obeyed"
  answer: 1
