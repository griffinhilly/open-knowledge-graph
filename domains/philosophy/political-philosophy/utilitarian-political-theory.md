---
id: utilitarian-political-theory
title: Utilitarian Approaches to Politics
domain: philosophy
...
```yaml
- question: "A utilitarian argues for progressive taxation: 'Taking $10,000 from a millionaire reduces their welfare far less than it increases the welfare of someone in poverty receiving that money, so the transfer increases aggregate welfare.' What economic concept supports this argument?"
  type: multiple-choice
  options:
    - "The law of supply and demand — prices adjust to allocate resources efficiently"
    - "Diminishing marginal utility — additional resources produce less additional welfare as total resources increase, so redistribution from rich to poor increases the aggregate"
    - "The Pareto principle — any transfer that makes someone better off without harming others is welfare-improving"
    - "Perfect equality — utilitarianism requires equal distribution of all resources"
  answer: 1
  explanation: "Diminishing marginal utility is the key: the more wealth you have, the less additional welfare any increment produces. The welfare loss to the millionaire is smaller than the welfare gain to someone in poverty, so redistribution increases the aggregate. Crucially, this argument requires no appeal to fairness or desert — it is a purely consequentialist calculation. The Pareto principle (option C) does not support this inference since the transfer harms the millionaire."

- question: "A government proposes punishing an innocent person to prevent riots that would harm thousands. A utilitarian critic argues this would be wrong. Which utilitarian framework provides the most principled response?"
  type: multiple-choice
  options:
    - "Act utilitarianism — since punishing one person produces better aggregate outcomes, it is justified"
    - "Rule utilitarianism — a rule permitting punishment of innocents would destroy trust in justice institutions, producing worse aggregate outcomes than a rule reliably protecting the innocent"
    - "Preference utilitarianism — the innocent person's preference not to be punished automatically outweighs all other preferences"
    - "Utilitarianism simply endorses this action since aggregate benefit to the many outweighs harm to the one"
  answer: 1
