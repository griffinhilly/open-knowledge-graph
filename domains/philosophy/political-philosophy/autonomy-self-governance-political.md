---
id: autonomy-self-governance-political
title: Autonomy and Political Self-Governance
domain: philosophy
...
- Political autonomy is not purely individual freedom; it involves collective participation in self-legislation.
- Respecting autonomy does not forbid all regulation; it requires that citizens have a voice in creating rules.

## Questions

```yaml
- question: "Citizen A lives in a democracy where she voted on a tax law (her side lost). Citizen B lives under a wise, benevolent dictator who set the tax rate optimally. According to the autonomy-based account of political legitimacy:"
  type: multiple-choice
  options:
    - "Both situations are equally legitimate, since both citizens pay fair taxes determined by reasonable authorities"
    - "Citizen B is better off, since the benevolent dictator chose the optimal rate for her welfare"
    - "Citizen A's situation is more legitimate, because she participated in the legislation that binds her and is its co-author"
    - "Neither is legitimate, because taxation always violates individual autonomy"
  answer: 2
  explanation: "The autonomy account grounds legitimacy in authorship, not outcomes. Even an optimal outcome imposed by an alien will fails to respect the citizen as a self-governing agent. Citizen A participated in the collective process of self-legislation — even losing the vote, she was part of the deliberative body that made the law. The benevolent dictator's decrees, however wise, are not authored by those subject to them. This is why the account concludes that democratic legitimacy is not merely about getting good results."

- question: "A citizen voted against a particular law and lost. According to the autonomy-based theory of political obligation, the citizen:"
  type: multiple-choice
  options:
    - "Has no obligation to follow this law, since it was imposed against their will"
    - "Is still obligated, because by participating in democratic self-legislation, they accepted the outcome of collective decision-making as binding"
    - "Should engage in civil disobedience as the appropriate response to an unfavorable outcome"
    - "Is only obligated if they believe the law is just"
  answer: 1
  explanation: "The autonomy account draws an analogy to the Kantian autonomous agent: just as a rational agent is bound by the moral law even when it conflicts with inclination, a democratic participant is bound by the outcome of collective self-legislation even when it conflicts with their preference. Participation in the process — deliberating, voting — is an acceptance of the process's authority. The obligation comes from co-authorship of the system, not agreement with each output."

- question: "According to the autonomy-based account, a wise and benevolent autocrat can create legitimate political obligations, provided the autocrat's decisions genuinely serve the citizens' best interests."
  type: true-false
  answer: false
