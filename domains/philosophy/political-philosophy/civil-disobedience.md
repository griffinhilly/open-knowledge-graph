...
- Civil disobedience is not mere protest — it involves deliberate lawbreaking.
- The requirement to accept punishment is contested — King accepted it to appeal to the conscience of the majority, but some theorists argue accepting punishment is not analytically required.
- Civil disobedience is not revolution — it is addressed to the majority within a constitutional framework and does not seek to overthrow the system.

## Questions

```yaml
- question: "A group of activists illegally occupies a government building to protest a policy they consider unjust, then flees when police arrive to avoid arrest. Which element of civil disobedience, as classically defined, is missing from their action?"
  type: multiple-choice
  options:
    - "Nonviolence — their occupation could be construed as a use of force"
    - "Publicity — covert occupation does not communicate the protest"
    - "Acceptance of legal consequences — fleeing subverts the communicative function of submitting to arrest"
    - "A conscientious motive — their political goal disqualifies them"
  answer: 2
...
- question: "Rawls argues that civil disobedience is justified only within a 'nearly just' society. Why does this qualifier matter?"
  type: multiple-choice
  options:
    - "In a nearly just society, protests are more likely to receive media coverage"
    - "In a fully just society there are no grounds for disobedience; in a thoroughly unjust one, revolution rather than civil disobedience may be warranted — the qualifier defines the context where the practice makes sense"
    - "Nearly just societies have more lenient sentencing, making acceptance of punishment less costly"
    - "Rawls thought civil disobedience was only appropriate where legal channels had never been tried"
  answer: 1
  explanation: "The 'nearly just' qualifier is philosophically essential. In a fully just society, no law would merit disobedience. In a thoroughly tyrannical one, the dissenter's appeal to a shared sense of justice — which civil disobedience presupposes — would be incoherent; armed resistance might be more appropriate. Rawls's framework specifically addresses constitutional democracies that have imperfectly implemented justice, where citizens share enough common ground for a conscientious appeal to have moral force."

- question: "Civil disobedience, as defined by Rawls and exemplified by King, is distinguished from ordinary nonviolent protest primarily by its reliance on persuasion rather than lawbreaking."
  type: true-false
  answer: false
