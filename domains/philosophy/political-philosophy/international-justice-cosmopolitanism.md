---
id: international-justice-cosmopolitanism
title: International Justice and Cosmopolitanism
domain: philosophy
...
```yaml
- question: "A student argues: 'We have special obligations to fellow citizens, just as we have special obligations to family. Neither of these is unjust toward outsiders.' How would a cosmopolitan most directly respond?"
  type: multiple-choice
  options:
    - "The analogy fails because states, unlike families, are held together by coercion rather than genuine bonds of affection"
    - "Special obligations to family are also unjust — cosmopolitanism requires completely impartial treatment of all persons everywhere"
    - "Special obligations may be legitimate, but they cannot override the fundamental equal moral worth of all persons or justify a global order that consigns billions to poverty purely by accident of birthplace"
    - "The comparison is apt — cosmopolitanism supports strong national obligations and imposes no constraints on how states treat non-citizens"
  answer: 2
  explanation: "Cosmopolitanism distinguishes two levels: at the level of fundamental principles, all persons have equal and unconditional moral worth; at the level of special obligations, particular relationships (family, community, nation) can generate additional duties. The cosmopolitan does not deny that we can have special obligations to co-citizens — the question is whether those obligations can justify a global order producing extreme inequality based on the morally arbitrary fact of birthplace. The student's analogy is engaged rather than dismissed; it's subordinated to the fundamental equality claim."

- question: "Thomas Pogge's argument about global poverty is distinctive among cosmopolitan positions because it claims:"
  type: multiple-choice
  options:
    - "We have stronger obligations to help distant strangers than to help our own citizens, since their need is greater"
    - "Global poverty is caused primarily by cultural failures within poor countries, not by international institutions"
    - "Affluent nations are not merely failing to help the global poor — they are actively harming them through global economic institutions that enforce unjust arrangements and extract value from poor countries"
    - "Global poverty should be addressed through voluntary charitable giving rather than institutional reform"
  answer: 2
