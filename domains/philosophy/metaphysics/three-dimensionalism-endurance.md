...
title: Three-Dimensionalism and Endurance
domain: philosophy
course: metaphysics
prerequisites:
...
- Three-dimensionalism implies objects don't change — the opposite: it holds they change by having genuinely different properties across time, not by having different temporal parts.
- "Wholly present" means numerically identical at each time — this is precisely what the view claims and what makes it distinctive: the very same object, not a qualitative duplicate, is present at each time.
