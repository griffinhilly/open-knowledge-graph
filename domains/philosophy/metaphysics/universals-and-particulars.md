...
- Universals are not concepts in minds; the question is whether they exist mind-independently.
- Nominalism doesn't deny that objects share features — it denies those features are grounded in shared abstract entities.

## Questions

```yaml
- question: "Which of the following is best classified as a universal rather than a particular?"
...
- question: "What is the main explanatory argument realists give for positing the existence of universals?"
  type: short-answer
  answer: "Realists argue that universals explain why distinct objects genuinely resemble one another — two red things are both red because they each instantiate the same universal, redness. Without universals, the resemblance appears unexplained or brute."
