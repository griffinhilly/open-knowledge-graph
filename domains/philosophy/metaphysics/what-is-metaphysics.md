...
- Metaphysics is not mysticism or speculation without argument; it applies rigorous philosophical method.
- Metaphysical claims are not automatically unfalsifiable — many have testable downstream commitments.

## Questions

```yaml
- question: "Which of the following questions is most clearly metaphysical rather than empirical?"
  type: multiple-choice
  options: ["What is the boiling point of water at sea level?", "Do abstract objects like numbers exist independently of minds?", "How many species of beetle have been identified?", "What is the average distance from Earth to the Moon?"]
  answer: 1
