...
- question: "A risk with a positive expected value but catastrophic, irreversible downside in the tail (such as a leveraged position in a fat-tailed market) should generally be accepted by a rational expected value maximizer."
  type: true-false
  answer: false
