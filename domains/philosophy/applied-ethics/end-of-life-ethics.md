...
title: End-of-Life Ethics & Euthanasia
domain: philosophy
...
# End-of-Life Ethics & Euthanasia

## Core Idea
End-of-life ethics addresses decisions to withhold, withdraw, or hasten death when individuals face terminal illness or permanent unconsciousness. Central questions include: the distinction between killing and letting die, the role of patient consent, the ethics of physician-assisted death, and how to balance autonomy against the sanctity of life.
...
```yaml
- question: "Which of the following best characterizes the main tension in End-of-Life Ethics & Euthanasia?"
...
- question: "The field of end-of-life ethics & euthanasia emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between end-of-life ethics & euthanasia and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "End-of-Life Ethics & Euthanasia applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in end-of-life ethics & euthanasia?"
  type: short-answer
...
End-of-Life Ethics & Euthanasia brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
