...
title: Genetic Engineering & Modification Ethics
domain: philosophy
course: applied-ethics
prerequisites:
- id: bioethics-foundations
  type: hard
...
# Genetic Engineering & Modification Ethics

## Core Idea
Genetic engineering ethics examines the moral permissibility of altering genes in somatic (body) cells or germline (reproductive) cells. Key concerns include distinguishing therapy (correcting disease) from enhancement (improving beyond normal function), the spectre of eugenics, justice in access, ecological effects, and whether creating genetically modified organisms or humans treats them as objects rather than persons.
...
```yaml
- question: "Which of the following best characterizes the main tension in Genetic Engineering & Modification Ethics?"
...
- question: "The field of genetic engineering & modification ethics emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between genetic engineering & modification ethics and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Genetic Engineering & Modification Ethics applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in genetic engineering & modification ethics?"
  type: short-answer
...
Genetic Engineering & Modification Ethics brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
