---
id: just-war-theory
title: "Just War Theory: Conditions & Limits"
domain: philosophy
...
# Just War Theory: Conditions & Limits

## Core Idea
Just War Theory attempts to establish conditions under which warfare can be morally justified. It addresses jus ad bellum (conditions for going to war: just cause, right intention, legitimate authority), jus in bello (conduct during war: discrimination between combatants and civilians, proportionality), and jus post bellum (justice after war: fair treatment of defeated parties, restoration).
...
```yaml
- question: "Which of the following best characterizes the main tension in Just War Theory: Conditions & Limits?"
...
- question: "The field of just war theory: conditions & limits emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between just war theory: conditions & limits and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Just War Theory: Conditions & Limits applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in just war theory: conditions & limits?"
  type: short-answer
...
Just War Theory: Conditions & Limits brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
