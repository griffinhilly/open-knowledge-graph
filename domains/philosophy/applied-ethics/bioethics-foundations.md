...
## Core Idea
Bioethics applies ethical frameworks to issues arising in biological sciences and medicine, focusing on the relationship between moral principles (respect for persons, beneficence, non-maleficence, justice) and medical practice. The field emerged in response to human rights violations in research and medical experimentation, and now encompasses questions about resource allocation, end-of-life care, genetic modification, and emerging biotechnologies.
...
```yaml
- question: "Which of the following best characterizes the main tension in Bioethics: Foundations?"
...
- question: "The field of bioethics: foundations emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between bioethics: foundations and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Bioethics: Foundations applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in bioethics: foundations?"
  type: short-answer
...
Bioethics: Foundations brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
