...
title: "Research Ethics: Human Subjects Protection"
domain: philosophy
course: applied-ethics
prerequisites:
- id: informed-consent-ethics
  type: hard
...
## Core Idea
Research ethics establishes principles for conducting research with human subjects, enforced through Institutional Review Boards (IRBs). Core requirements include informed consent, minimization of harm, fair subject selection, and special protections for vulnerable populations (children, prisoners, economically disadvantaged). Historical violations like Tuskegee and Nazi experiments drove the development of these protections.
...
```yaml
- question: "Which of the following best characterizes the main tension in Research Ethics: Human Subjects Protection?"
...
- question: "The field of research ethics: human subjects protection emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between research ethics: human subjects protection and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Research Ethics: Human Subjects Protection applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in research ethics: human subjects protection?"
  type: short-answer
...
Research Ethics: Human Subjects Protection brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
