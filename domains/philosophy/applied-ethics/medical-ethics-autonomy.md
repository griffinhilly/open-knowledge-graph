...
title: Medical Ethics & Patient Autonomy
domain: philosophy
...
## Core Idea
Medical ethics centers on respecting patient autonomy—the right of individuals to make decisions about their own bodies and medical care based on their own values. This conflicts with medical paternalism (acting 'in the patient's best interest' without consent) and requires examining when autonomy can be legitimately limited, such as in cases of incompetence, emergency, or danger to others.
...
```yaml
- question: "Which of the following best characterizes the main tension in Medical Ethics & Patient Autonomy?"
...
- question: "The field of medical ethics & patient autonomy emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between medical ethics & patient autonomy and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Medical Ethics & Patient Autonomy applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in medical ethics & patient autonomy?"
  type: short-answer
...
Medical Ethics & Patient Autonomy brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
