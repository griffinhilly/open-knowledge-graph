...
title: Disability Ethics & Social Justice
domain: philosophy
...
## Core Idea
Disability ethics examines the moral status of disability and obligations toward disabled individuals. The social model views disability as created by societal barriers rather than individual deficits; the medical model treats it as individual deficit requiring treatment. The field addresses accessibility, employment discrimination, the ethics of prenatal and therapeutic interventions, and whether disability is a difference or a deficit.
...
```yaml
- question: "Which of the following best characterizes the main tension in Disability Ethics & Social Justice?"
...
- question: "The field of disability ethics & social justice emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between disability ethics & social justice and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Disability Ethics & Social Justice applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in disability ethics & social justice?"
  type: short-answer
...
Disability Ethics & Social Justice brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
