...
title: "Distributive Justice: Applied Questions"
domain: philosophy
...
# Distributive Justice: Applied Questions

## Core Idea
Distributive justice in practice addresses how societies should allocate scarce resources—healthcare, education, wealth, opportunity. This requires choosing criteria (need, merit, equality, contribution) and designing institutions that reflect chosen criteria. Applied questions include progressive taxation, universal healthcare, affirmative action, and resource allocation during crises.
...
```yaml
- question: "Which of the following best characterizes the main tension in Distributive Justice: Applied Questions?"
...
- question: "The field of distributive justice: applied questions emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between distributive justice: applied questions and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Distributive Justice: Applied Questions applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in distributive justice: applied questions?"
  type: short-answer
