---
id: neuroethics
title: "Neuroethics: Brain Modification & Enhancement"
domain: philosophy
course: applied-ethics
prerequisites:
- id: genetic-engineering-ethics
  type: hard
- id: medical-ethics-autonomy
  type: hard
builds-toward: []
tags:
- neuroethics
...
# Neuroethics: Brain Modification & Enhancement

## Core Idea
Neuroethics applies ethics to neurotechnology—interventions affecting the brain. It includes clinical neuroethics (treatment of brain disorders) and enhancement ethics (improving cognitive function beyond normal). Questions include: Can pharmaceutical cognitive enhancement be unjust if only the wealthy access it? Does modifying personality or memory violate personal identity? What counts as therapeutic versus enhancing?
...
```yaml
- question: "Which of the following best characterizes the main tension in Neuroethics: Brain Modification & Enhancement?"
...
- question: "The field of neuroethics: brain modification & enhancement emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between neuroethics: brain modification & enhancement and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Neuroethics: Brain Modification & Enhancement applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in neuroethics: brain modification & enhancement?"
  type: short-answer
...
Neuroethics: Brain Modification & Enhancement brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
