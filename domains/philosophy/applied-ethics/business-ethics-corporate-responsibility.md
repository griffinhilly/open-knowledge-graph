...
prerequisites:
- id: distributive-justice-applied
  type: hard
...
## Core Idea
Business ethics examines whether corporations have obligations beyond profit-maximization. Shareholder theory holds that corporations exist primarily to benefit shareholders; stakeholder theory argues they have obligations to employees, customers, suppliers, and communities. Issues include executive compensation, environmental externalities, labor practices, and the extent to which corporations should advance social causes.
...
```yaml
- question: "Which of the following best characterizes the main tension in Business Ethics & Corporate Responsibility?"
...
- question: "The field of business ethics & corporate responsibility emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between business ethics & corporate responsibility and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Business Ethics & Corporate Responsibility applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in business ethics & corporate responsibility?"
  type: short-answer
...
Business Ethics & Corporate Responsibility brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
