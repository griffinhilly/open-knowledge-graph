...
title: Informed Consent & Research Ethics
domain: philosophy
...
## Core Idea
Informed consent requires that research subjects and patients understand the nature, risks, and benefits of proposed interventions before agreeing. This principle emerged from the Nuremberg Code after Nazi experiments and the Tuskegee syphilis study. It combines three elements: disclosure (full information), comprehension (understanding at an appropriate level), and voluntariness (absence of coercion).
...
```yaml
- question: "Which of the following best characterizes the main tension in Informed Consent & Research Ethics?"
...
- question: "The field of informed consent & research ethics emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between informed consent & research ethics and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Informed Consent & Research Ethics applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in informed consent & research ethics?"
  type: short-answer
...
Informed Consent & Research Ethics brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
