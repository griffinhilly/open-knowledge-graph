---
id: reproductive-ethics
title: Reproductive Ethics & Parenthood
domain: philosophy
course: applied-ethics
prerequisites:
- id: medical-ethics-autonomy
  type: hard
- id: feminist-bioethics
  type: hard
builds-toward: []
tags:
- reproductive-ethics
...
# Reproductive Ethics & Parenthood

## Core Idea
Reproductive ethics examines moral questions around reproduction: abortion, contraception, infertility treatment, surrogacy, and the ethics of genetic selection. Central debates include whether fetuses have moral status, what grounds the right to refuse parenthood, whether reproductive choices are purely individual or have social dimensions, and whether creating a child involves obligations to create a child with good prospects.
...
```yaml
- question: "Which of the following best characterizes the main tension in Reproductive Ethics & Parenthood?"
...
- question: "The field of reproductive ethics & parenthood emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between reproductive ethics & parenthood and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Reproductive Ethics & Parenthood applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in reproductive ethics & parenthood?"
  type: short-answer
...
Reproductive Ethics & Parenthood brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
