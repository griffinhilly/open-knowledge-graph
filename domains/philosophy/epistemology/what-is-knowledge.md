...
- 'Knowledge' is not simply a stronger form of belief; it is a different kind of attitude requiring additional conditions.
- Epistemology is not the same as psychology of belief — it asks normative questions about what we *ought* to believe, not just descriptive ones about what we do believe.

## Questions

```yaml
- question: "Which of the following best illustrates the difference between propositional knowledge and procedural knowledge?"
  type: multiple-choice
  options:
    - "Knowing that Paris is the capital of France vs. knowing how to ride a bicycle"
    - "Believing that evolution is true vs. doubting that evolution is true"
    - "Knowing someone personally vs. reading about them in a biography"
    - "Knowing a fact with certainty vs. knowing a fact with only some probability"
  answer: 0
  explanation: "Propositional knowledge is 'knowing that' — a relationship between a knower and a true proposition. Procedural knowledge is 'knowing how' — a practical skill not reducible to knowing facts. The bicycle example captures this: a paralyzed person could know all the propositional facts about cycling and still be unable to ride."

- question: "Epistemology is primarily concerned with describing what people actually believe, rather than evaluating what they should believe."
  type: true-false
  answer: false
  explanation: "Epistemology is a normative discipline: it asks what constitutes justified or rational belief, not merely what beliefs people happen to hold. The descriptive study of belief formation belongs to psychology and cognitive science. The distinction matters because 'what people believe' and 'what people are epistemically entitled to believe' often diverge."

- question: "Why isn't a lucky true belief sufficient for knowledge?"
  type: short-answer
  answer: "If a belief is true by coincidence — with no reliable connection between the believer and the fact — we don't credit it as knowledge, because knowledge requires more than accidentally getting things right."
  explanation: "Suppose you guess it is raining without any evidence and happen to be correct. Your belief is true, but it is not knowledge — you could just as easily have been wrong, and nothing about your belief was connected to the actual weather. This intuition motivates requiring not just truth but justification: some account of why the believer is entitled to hold the belief."
```
