...
- Basic beliefs are not mere assumptions; they are claimed to have positive epistemic warrant, just not warrant derived from other beliefs.
- Foundationalism does not require that we always consciously trace beliefs back to foundations — the structure is epistemic, not psychological.

## Questions

```yaml
- question: "What is the key difference between classical (Cartesian) foundationalism and modest foundationalism?"
  type: multiple-choice
  options: ["Classical foundationalism permits more basic beliefs; modest foundationalism restricts them to sensory reports", "Classical foundationalism requires basic beliefs to be infallible or incorrigible; modest foundationalism only requires them to have some non-inferential positive epistemic status", "Modest foundationalism denies that basic beliefs exist; classical foundationalism affirms them", "Classical foundationalism is empiricist; modest foundationalism is rationalist"]
  answer: 1
  explanation: "Classical foundationalism sets an extremely demanding bar: basic beliefs must be immune to error (infallible) or impossible to sincerely doubt (incorrigible) — think of Descartes' cogito or beliefs about one's current sensory appearances. Modest foundationalism keeps the two-tier structure but only requires basic beliefs to have some non-inferential warrant (e.g., produced by a reliable perceptual process or self-evident), without demanding certainty. This makes modest foundationalism far more defensible and more widely held today."

- question: "In foundationalist epistemology, basic beliefs are mere assumptions — they are accepted without any justification whatsoever."
  type: true-false
  answer: false
  explanation: "This is a central misconception. Basic beliefs are not unjustified assumptions or axioms taken on blind faith. They are claimed to have genuine epistemic warrant — they are just not justified by other beliefs. Their warrant comes from something non-inferential: direct perceptual experience, self-evidence, incorrigibility, or reliable causal processes. The foundationalist's entire project is to show that justification can terminate without becoming arbitrary."

- question: "What epistemological problem is foundationalism designed to solve, and how does the two-tier belief structure address it?"
  type: short-answer
  answer: "Foundationalism responds to the regress problem: if every belief requires justification by another belief, we face either an infinite chain (implausible), a circle (viciously circular), or unjustified stopping points (arbitrary). Foundationalism resolves this by distinguishing basic beliefs (justified non-inferentially, stopping the regress) from non-basic beliefs (justified by inferential links to basic ones), creating a finite justificatory structure."
  explanation: "The regress problem reveals a structural challenge for any theory of justification. Foundationalism's two-tier answer — basic beliefs provide the floor, non-basic beliefs build upward — is the oldest and most influential solution. Understanding this problem is why the regress problem is listed as a hard prerequisite: foundationalism is unintelligible without the problem it is solving."
```
