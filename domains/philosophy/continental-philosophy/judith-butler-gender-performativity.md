---
id: judith-butler-gender-performativity
title: "Judith Butler: Gender & Performativity"
domain: philosophy
...
## Core Idea
Judith Butler's theory of gender performativity argues that gender is not an essential identity or attribute but an effect of repeated performative acts. We are not born with gender identities that we then express; rather, we constitute ourselves as gendered through stylized, repeated performances—ways of walking, dressing, speaking. Gender appears natural and essential precisely because the performative constitution is naturalized and concealed. This insight opens political possibilities: if gender is performatively constituted, it can be constituted otherwise. Butler's work challenges biological determinism and enables understanding of non-normative gender expressions as creative variations on performativity rather than pathologies. Her theory has been foundational for queer theory and trans politics, though it remains contested whether performativity adequately accounts for gender's material and embodied dimensions.
...
```yaml
- question: "Which of the following best characterizes the main tension in Judith Butler: Gender & Performativity?"
...
- question: "The field of judith butler: gender & performativity emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between judith butler: gender & performativity and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Judith Butler: Gender & Performativity applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in judith butler: gender & performativity?"
  type: short-answer
