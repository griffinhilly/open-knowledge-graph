...
# Nietzsche — Will to Power and Eternal Recurrence
...
```yaml
- question: "Nietzsche's concept of the 'will to power' is best understood as:"
  type: multiple-choice
  options:
    - "The desire for political domination over other people"
    - "A fundamental drive toward self-overcoming, growth, and creative expression in all living things"
    - "The Darwinian drive for survival of the fittest"
    - "The conscious intention to accumulate social influence"
  answer: 1
  explanation: "Will to power is frequently misunderstood as a desire for domination, but Nietzsche's concept is far broader. It names the fundamental dynamic of life itself — the drive to extend, grow, and overcome resistance, including one's own limitations. An artist creating work, a thinker challenging assumptions, a plant growing toward light — all manifest will to power. Political domination is one crude expression of it, but Nietzsche considered creative and intellectual self-overcoming its highest forms."

- question: "Nietzsche's declaration that 'God is dead' is a celebration of atheism and a claim that religion was always false."
  type: true-false
  answer: false
  explanation: "Nietzsche's 'God is dead' (in The Gay Science) is a diagnosis, not a celebration. It describes a cultural event: the collapse of the metaphysical-moral framework that grounded European civilization for two millennia. Nietzsche recognized this as a crisis — without God as the guarantor of meaning and morality, nihilism threatens. The madman who announces God's death in the parable is terrified, not triumphant. Nietzsche's project is to respond to this crisis by creating new values, not to gloat over the old ones."

- question: "What is the thought experiment of eternal recurrence, and what existential function does it serve in Nietzsche's philosophy?"
  type: short-answer
