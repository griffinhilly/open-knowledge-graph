...
# Beauvoir — Ethics of Ambiguity and The Second Sex
...
```yaml
- question: "Beauvoir's claim that 'one is not born, but rather becomes, a woman' means:"
  type: multiple-choice
  options:
    - "Women are biologically identical to men and sex differences are illusory"
    - "Femininity is a social and cultural construction, not a biological destiny — women are made into 'women' through upbringing, expectations, and institutions"
    - "Women must consciously choose to identify as women through existential commitment"
    - "Gender is a matter of personal preference that can be changed at will"
  answer: 1
  explanation: "Beauvoir does not deny biological sex differences. Her claim is that the meaning attached to those differences — the roles, expectations, limitations, and identity of 'woman' — is not determined by biology but constructed by culture and internalized through upbringing. A female infant does not arrive with femininity pre-installed; she is gradually shaped into 'a woman' by a society that treats femininity as her essence. This distinction between biological sex and socially constructed gender was groundbreaking and became foundational for feminist theory."

- question: "Beauvoir argues that authentic freedom can be achieved by an individual in isolation, without concern for the freedom of others."
  type: true-false
  answer: false
  explanation: "This is a crucial point where Beauvoir departs from common misreadings of existentialism. She argues that my freedom is intertwined with the freedom of others: I cannot genuinely will my own freedom while being indifferent to the oppression of others. An oppressor's 'freedom' is inauthentic because it depends on denying freedom to those they oppress. Authentic freedom requires solidarity — recognizing that liberation is a collective project, not a private achievement."

- question: "How does Beauvoir's concept of 'ambiguity' differ from Sartre's account of human freedom?"
  type: short-answer
  answer: "Sartre emphasizes radical, unconditioned freedom — consciousness can always negate and transcend any situation. Beauvoir insists on the ambiguity of human existence: we are both free consciousness and situated, embodied beings constrained by material conditions, social structures, and relationships with others. Freedom is real but always situated — shaped by gender, class, race, and the body. Ethics requires confronting this ambiguity rather than pretending we are purely free or purely determined."
  explanation: "Beauvoir's correction to Sartre is philosophically significant. If freedom is truly absolute, then the prisoner and the oppressor are equally free, which seems to make oppression philosophically unimportant. Beauvoir argues that oppression genuinely limits freedom — not by eliminating it entirely, but by narrowing the range of possibilities available. The woman confined to domestic roles, the colonized person denied education — their freedom is real but systematically constrained. Ethics must address these constraints, not just celebrate abstract freedom."

- question: "In Beauvoir's analysis, women have been historically constructed as 'the Other' — the negative counterpart to male subjectivity."
  type: true-false
  answer: true
  explanation: "Beauvoir's central argument in The Second Sex is that throughout history, man has been defined as the Subject — the default, the essential, the norm — while woman has been defined as the Other: derivative, secondary, defined in relation to man rather than in her own terms. This is not a biological fact but a social structure: women have been made into the Other through myths, institutions, and practices that deny their status as free subjects. Overcoming this requires not just legal equality but a transformation of the cultural frameworks that produce women as Other."
```
