---
id: disability-phenomenology
title: "Disability Phenomenology"
domain: philosophy
course: continental-philosophy
prerequisites:
- id: disability-ethics
  type: hard
builds-toward: []
tags:
- disability
...
# Disability Phenomenology

## Core Idea
Disability phenomenology applies phenomenological analysis to disability experience, challenging medical models that treat disability as individual deficit. Phenomenological approaches examine how disability transforms lived experience, embodiment, and world-engagement. Disabled phenomenologists describe distinctive ways of relating to space (accessibility shapes how space is navigable), time (chronic illness involves different temporal experience), and bodies (living in a body that doesn't conform to norms involves particular existential situation). Rather than treating disability as tragedy or difference to accommodate, disability phenomenology explores its lived reality and the meanings it carries. This work contests normative assumptions about able-bodiedness and questions what capacities and functionings count as essential or deficient. It provides philosophical grounding for the social model of disability while acknowledging disability's embodied reality.
...
```yaml
- question: "Which of the following best characterizes the main tension in Disability Phenomenology?"
...
- question: "The field of disability phenomenology emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between disability phenomenology and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Disability Phenomenology applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in disability phenomenology?"
  type: short-answer
...
Disability Phenomenology brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
