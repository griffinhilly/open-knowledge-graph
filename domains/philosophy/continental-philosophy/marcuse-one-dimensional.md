...
title: "Marcuse: One-Dimensional Society"
domain: philosophy
...
## Core Idea
Herbert Marcuse's concept of the 'one-dimensional society' describes how advanced industrial capitalism creates false needs and repressive desublimation. Unlike traditional repression (outright denial), capitalism allows and encourages consumption of products, sex, and leisure—yet this superficial freedom actually deepens domination. By satisfying immediate desires through commodity consumption, capitalism prevents the development of genuine needs for liberation, autonomy, and human flourishing. The society becomes 'one-dimensional': alternative possibilities and critical consciousness are foreclosed. Media, education, and consumer culture engineer consent by making domination appear natural or inevitable. Yet Marcuse finds liberation possible only through refusal of these false satisfactions and cultivation of a 'repressive desublimation' that opens space for imagination and negation beyond the system.
...
```yaml
- question: "Which of the following best characterizes the main tension in Marcuse: One-Dimensional Society?"
...
- question: "The field of marcuse: one-dimensional society emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between marcuse: one-dimensional society and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Marcuse: One-Dimensional Society applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in marcuse: one-dimensional society?"
  type: short-answer
...
Marcuse: One-Dimensional Society brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
