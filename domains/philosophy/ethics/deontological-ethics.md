...
- Deontology is not simply 'rule-following for its own sake'; it holds that certain rules reflect deep facts about personhood and respect.
- Deontological constraints do not forbid all harmful actions—only those that violate rights or constitute using someone as a mere means.

## Questions

```yaml
- question: "A deontologist is deciding whether to lie to save an innocent person's life. Which response best reflects the deontological approach?"
  type: multiple-choice
  options: ["Lie, because saving a life produces the best overall outcome", "Refuse to lie, because some actions are intrinsically wrong regardless of consequences", "Lie, because duty to protect the innocent overrides the duty not to lie in every case", "Evaluate based on which choice maximizes total well-being"]
  answer: 1
