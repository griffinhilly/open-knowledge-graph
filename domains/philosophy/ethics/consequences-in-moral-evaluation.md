...
title: Consequences and Moral Evaluation
domain: philosophy
course: ethics
prerequisites: []
builds-toward:
...
- Assuming consequences are the only thing that matters morally (many non-consequentialist theories accept that consequences matter, just not exclusively). - Thinking consequentialist evaluation is straightforward (determining all relevant consequences, especially long-term, is often impossible). - Confusing expected consequences with actual consequences (moral evaluation uses different standards depending on what the agent knew).

## Questions

```yaml
- question: "Two doctors each prescribe the same medication in good faith with the same information. One patient recovers; the other has an unforeseeable adverse reaction and dies. Did one doctor act more morally than the other?"
  type: multiple-choice
  options:
    - "Yes — the doctor whose patient died acted less morally because their action caused harm"
    - "No — both acted with the same intentions and knowledge; the divergence in outcomes is a matter of luck, not moral difference"
    - "Yes — the doctor whose patient recovered acted more morally because good consequences validate the choice"
    - "No — because consequences are irrelevant to the moral evaluation of medical decisions"
  answer: 1
  explanation: "This is the moral luck puzzle. When we evaluate agents (rather than outcomes), we hold them responsible for the consequences they could reasonably have anticipated — expected consequences — not the actual consequences that luck produced. Both doctors had identical epistemic situations. The difference in outcomes tells us something about the world but nothing different about the doctors. Option A conflates moral evaluation of the agent with evaluation of the outcome; option D goes too far in the other direction by dismissing consequences entirely."

- question: "A driver runs a red light and happens to make it across safely, with no harm done. How should this action be evaluated morally?"
  type: multiple-choice
  options:
    - "Morally permissible — the actual consequences were fine, and consequences are what matters"
    - "Morally wrong — the expected consequences were bad, and agents are held responsible for what they could reasonably have anticipated"
    - "Morally neutral — the action's status cannot be determined without knowing whether anyone was harmed"
    - "Morally praiseworthy — risk-taking that turns out well demonstrates competence"
  answer: 1
  explanation: "Running a red light creates a predictable risk of serious harm — the driver could and should have anticipated bad consequences. The fact that no harm actually resulted is luck. Morally evaluating the agent means asking: what consequences could a reasonable person in this situation have anticipated? The answer here is: injury or death to other drivers or pedestrians. Option A is the standard consequentialist error of focusing only on actual outcomes; it would have to excuse reckless behavior whenever it luckily turns out well."

- question: "Two people can perform the identical action with identical intentions and knowledge, yet one suffers much worse consequences than the other — a phenomenon that creates pressure to focus moral evaluation on expected rather than actual consequences."
  type: true-false
  answer: true
