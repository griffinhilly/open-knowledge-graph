...
- Contractualism is not the same as contract law or social-contract political theory; it is a normative ethical theory about what makes actions right or wrong.
- The 'reasonable rejection' test in Scanlon is not majority vote; a principle can be reasonably rejected by one person even if most would accept it.

## Questions

```yaml
- question: "Under Rawls's veil of ignorance, choosers do not know their social position. What is the philosophical purpose of this constraint?"
  type: multiple-choice
  options:
    - "To ensure the principles chosen will benefit the majority of people"
    - "To model impartiality by stripping away self-interested bias toward one's actual position"
    - "To make the social contract legally binding on all parties"
    - "To simulate randomness in the distribution of social outcomes"
  answer: 1
...
- question: "In Scanlonian contractualism, a principle is morally impermissible if the majority of affected parties would reasonably reject it."
  type: true-false
  answer: false
  explanation: "Scanlon's test does not use majority vote. A principle can be reasonably rejected by even one individual and thereby rendered impermissible — provided that individual's objection is reasonable given everyone's interests taken seriously. This is precisely what allows contractualism to resist aggregative reasoning: the strong complaint of one person can defeat a principle that benefits many."

- question: "What is the key difference between Rawlsian and Scanlonian contractualism?"
  type: short-answer
  answer: "Rawls grounds morality in principles that self-interested parties would choose behind a veil of ignorance, yielding principles like the difference principle for distributing social goods. Scanlon grounds morality in principles that no one could reasonably reject as a basis for mutual justification, focusing on what individuals owe each other rather than on the design of social institutions."
