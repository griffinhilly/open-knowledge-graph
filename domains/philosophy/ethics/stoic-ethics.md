...
- Stoicism does not advocate suppressing emotions; it advocates replacing false value-judgments (which produce destructive emotions) with correct ones (which produce appropriate emotional responses).
- The Stoic concept of "living according to nature" does not mean returning to a primitive state; it means exercising the rational faculty that is distinctive of human nature.

## Questions

```yaml
- question: "Marcus Aurelius writes that he can remain fully content even if his empire falls. An Aristotelian critic argues this is self-deception — political power and stability are genuine goods necessary for flourishing. What is the Stoic response?"
  type: multiple-choice
  options:
    - "Agree that political stability is genuinely good but argue Marcus already has enough of it to flourish"
    - "Nothing outside rational choice (prohairesis) can be a genuine good or evil — power is a 'preferred indifferent,' and virtue alone constitutes eudaimonia"
    - "Argue that Marcus's flourishing doesn't depend on his emotional reaction to the empire's fate"
    - "Claim that the Stoic sage becomes indifferent to the outcomes of their own actions"
  answer: 1
  explanation: "The Stoics made one radical modification to virtue ethics: virtue is not merely necessary but SUFFICIENT for eudaimonia. External things — wealth, power, health — are 'preferred indifferents': rationally preferable to pursue (and the Stoic sage does pursue them appropriately), but they cannot make a life good or bad. The Stoic response to the Aristotelian critique is exactly this distinction between what is preferred and what is genuinely good. Only the correct exercise of prohairesis constitutes genuine good."

- question: "A person is overcome with grief after losing a close friendship. According to Stoic ethics, what has happened?"
  type: multiple-choice
  options:
    - "They have correctly responded to a genuine loss of something truly good"
    - "They have made a false value-judgment — treating a preferred indifferent as if it were genuinely bad"
    - "They have failed to suppress their emotional responses through an act of will"
    - "They have demonstrated an appropriate emotional response that the Stoic sage would share"
  answer: 1
