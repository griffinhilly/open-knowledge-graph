...
title: Moral Motivation and Internalism
domain: philosophy
course: ethics
prerequisites:
...
- Assuming internalism requires moral facts to be instrumental (they could be intrinsically motivating). - Thinking externalism means morality is optional or merely advisory (an externalist can still say morality is authoritative; motivation just doesn't follow analytically from judgment). - Conflating judgment that 'everyone ought to help' with motivating oneself to help (first-person present-tense judgments seem more directly motivating).
