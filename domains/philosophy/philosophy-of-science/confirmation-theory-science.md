...
- question: "Hempel resolved the ravens paradox by arguing that the green apple definitely does not confirm 'Most ravens are black,' because primarily objects in the relevant reference class (ravens) can confirm claims about that class."
  type: true-false
  answer: false
