...
## Core Idea
Philosophy of physics examines foundational questions about the nature of physical reality, space, time, causation, and the relationship between theories and world. It grapples with puzzles unique to modern physics: the interpretation of quantum mechanics (does the wave function represent physical reality or only knowledge?), the nature of spacetime (is time fundamental or emergent?), and whether physics describes how the world is or merely predicts observations. The field also addresses questions about unification, reductionism, and whether physics can ever produce a complete description of reality.
...
```yaml
- question: "Which of the following best characterizes the main tension in Philosophy of Physics?"
...
- question: "The field of philosophy of physics emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between philosophy of physics and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Philosophy of Physics applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in philosophy of physics?"
  type: short-answer
...
Philosophy of Physics brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
