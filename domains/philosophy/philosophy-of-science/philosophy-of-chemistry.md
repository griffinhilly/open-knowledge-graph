...
## Core Idea
Philosophy of chemistry examines whether chemistry is merely applied physics or an autonomous science with its own fundamental concepts. Central issues include: what is a chemical bond? Can chemical properties be reduced to quantum mechanics? How should we understand aromaticity, molecular structure, and chemical periodicity? The field addresses questions about emergence (chemical properties emerge from but are not reducible to quantum properties), the level of explanation appropriate for chemistry, and the epistemology of chemical modeling. It also explores the nature of molecular identity and individuation.
...
```yaml
- question: "Which of the following best characterizes the main tension in Philosophy of Chemistry?"
...
- question: "The field of philosophy of chemistry emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between philosophy of chemistry and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Philosophy of Chemistry applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in philosophy of chemistry?"
  type: short-answer
...
Philosophy of Chemistry brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
