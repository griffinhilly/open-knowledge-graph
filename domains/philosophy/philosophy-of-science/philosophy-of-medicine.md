...
## Core Idea
Philosophy of medicine examines the conceptual foundations of medical science and practice: what is disease? Is disease an objective biological category or a value-laden social construction? How should medicine distinguish disease from disability or natural variation? The field addresses explanatory questions about health and illness, the role of statistical norms versus functional ability, and whether mental illness is fundamentally different from physical illness. It examines medical reductionism (reducing illness to molecular pathology) versus holistic approaches, the evidence standards appropriate for medicine, and how medicine balances explanation with treatment and care. It also explores the medical model's dominance despite competing frameworks.
...
```yaml
- question: "Which of the following best characterizes the main tension in Philosophy of Medicine?"
...
- question: "The field of philosophy of medicine emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between philosophy of medicine and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Philosophy of Medicine applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in philosophy of medicine?"
  type: short-answer
