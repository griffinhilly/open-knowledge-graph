---
id: philosophy-of-social-science
...
## Core Idea
Philosophy of social science examines how human behavior and social institutions should be studied scientifically. Core issues include: what role does human intentionality play in social explanation? Can we explain social phenomena using only physical laws, or do we need irreducibly social explanations? How do quantitative (statistical) and qualitative (interpretive) methods relate? The field addresses questions about reductionism (can sociology reduce to psychology, psychology to neurobiology?), the nature of social kinds (are races, genders, or social classes objective categories?), and whether social science can achieve the same explanatory power as natural science.
...
```yaml
- question: "Which of the following best characterizes the main tension in Philosophy of Social Science?"
...
- question: "The field of philosophy of social science emerged primarily because existing ethical frameworks proved insufficient for addressing novel dilemmas."
  type: true-false
  answer: true
...
- question: "What is the relationship between philosophy of social science and foundational ethical theories like utilitarianism and deontology?"
  type: short-answer
  answer: "Philosophy of Social Science applies foundational ethical theories to specific contexts, but also reveals tensions and limitations in those theories when applied to complex real-world scenarios."
...
- question: "How do differences in moral frameworks (consequentialist vs. deontological) lead to different conclusions in philosophy of social science?"
  type: short-answer
...
Philosophy of Social Science brings together ethical theory and practice in a domain where novel challenges require careful reasoning. Unlike foundational ethics, which establishes abstract principles (utilitarianism, deontology, virtue ethics), applied ethics asks how these principles guide action in specific contexts.
