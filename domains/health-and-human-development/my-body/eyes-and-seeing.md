...
- question: "What is the black circle in the middle of your eye called?"
  ...
  options:
    ...
    - "The eyebrow"
  answer: 1
  explanation: "The black circle in the center of your eye is the pupil. It is actually an opening that lets light into your eye. The iris is the colored ring around the pupil — it can be brown, blue, green, or other colors."

- question: "Your pupils get bigger in the dark to let in more light."
  type: true-false
  answer: true
  explanation: "When it is dark, your pupils open wider (get bigger) to let in as much light as possible so you can see better. In bright light, your pupils get smaller so too much light does not get in. This happens automatically — you do not have to think about it."

- question: "Name two things that protect your eyes from getting hurt."
  type: short-answer
  answer: "Eyelids close to block things from hitting your eyes, and eyelashes catch dust and small bits before they can get in. Eyebrows also help by keeping sweat from dripping into your eyes."
  explanation: "Your eyes have several built-in protections. Eyelids snap shut when something comes close (you blink without thinking about it). Eyelashes act like tiny filters. Tears wash away dust and germs. Your body takes special care of your eyes because they are so important."
```
