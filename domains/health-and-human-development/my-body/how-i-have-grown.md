...
```yaml
- question: "How does growing usually happen?"
  type: multiple-choice
  options:
    - "You grow all at once in one big jump"
    - "You grow a little bit every day, slowly and steadily"
    - "You only grow on your birthday"
    - "You stop growing after you turn five"
  answer: 1
  explanation: "Growing happens a little bit at a time, every single day. It is so slow that you do not notice it day to day. But if you compare yourself to a photo from a year ago or try on old clothes, you can see how much you have grown."

- question: "You stop growing when you start kindergarten."
  type: true-false
  answer: false
  explanation: "You do not stop growing for a long time. Most people keep growing taller until they are around 16 to 20 years old. Even after you stop getting taller, your body keeps changing and developing in other ways throughout your whole life."

- question: "Name two ways you have grown since you were a baby."
  type: short-answer
  answer: "You have gotten taller and heavier. You can also walk and talk (babies cannot), your teeth have come in, your hair has grown longer, and you can do many things you could not do as a baby — like feed yourself, draw, and run."
  explanation: "Growth is not just about getting bigger. Since babyhood, children have developed new abilities (walking, talking, reading), grown new teeth, and gained strength and coordination. Growth includes both the body getting larger and the body becoming more capable."
```
