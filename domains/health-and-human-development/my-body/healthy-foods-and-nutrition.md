...
title: Healthy Foods and Nutrition Basics
...
```yaml
- question: "Why is it important to eat foods from different groups?"
  type: multiple-choice
  options:
    - "Because eating only one kind of food is boring"
    - "Because different foods give your body different things it needs"
    - "Because restaurants serve different foods"
...
- question: "Name one food from each of the five food groups."
  type: short-answer
  answer: "Examples: Fruit — apple or banana. Vegetable — carrot or broccoli. Grain — bread or rice. Protein — chicken or beans. Dairy — milk or cheese."
  explanation: "The five main food groups are fruits, vegetables, grains, proteins, and dairy. Each group includes many different foods. Being able to name foods in each group helps children understand that healthy eating means choosing from all the groups, not just one or two."
```
