...
```yaml
- question: "Why is skin important for your body?"
  type: multiple-choice
  options:
    - "It only makes you look nice"
    - "It protects what is inside your body and lets you feel things"
    - "It helps you breathe"
    - "It holds your food inside"
  answer: 1
  explanation: "Skin does two big jobs: it protects everything inside your body (like muscles, bones, and organs) from germs and injuries, and it lets you feel things through the sense of touch. It is much more than just a covering."

- question: "Your fingertips can feel more detail than your elbows."
  type: true-false
  answer: true
  explanation: "Your fingertips have many more touch sensors packed close together than your elbows do. That is why you use your fingers to feel things — they are much better at noticing small differences in texture, shape, and temperature."

- question: "Name two things your skin can help you feel."
  type: short-answer
  answer: "Your skin can help you feel hot and cold, rough and smooth, soft and hard, wet and dry, or pain and pressure."
  explanation: "Skin does not just feel one thing — it can sense many different qualities. Temperature (hot or cold), texture (rough or smooth), pressure (light touch or hard push), and pain are all detected by your skin."
```
