---
id: my-stomach-digests-food
title: My Stomach Digests Food
...
```yaml
- question: "What does your stomach do to the food you eat?"
  type: multiple-choice
  options:
    - "It stores food forever"
    - "It breaks food into tiny pieces your body can use"
    - "It sends food straight to your muscles"
    - "It turns food into bones"
  answer: 1
  explanation: "Your stomach breaks food down into much smaller pieces using strong muscles that squeeze and churn, plus special juices that dissolve the food chemically. This process makes the nutrients in food small enough for your body to absorb and use for energy, growth, and repair."

- question: "Digestion starts in your stomach."
  type: true-false
  answer: false
  explanation: "Digestion actually starts in your mouth. When you chew food, your teeth break it into smaller pieces, and saliva (spit) starts dissolving it. By the time food reaches your stomach, digestion has already begun. The stomach continues the work, and then the food moves on to other organs that finish the job."

- question: "Describe the path food takes from your mouth to your stomach."
  type: short-answer
  answer: "You chew food with your teeth and mix it with saliva in your mouth. When you swallow, the food travels down a tube called the esophagus (a long tube connecting your mouth to your stomach). Then it reaches your stomach, where it gets squeezed and mixed with digestive juices."
  explanation: "Food follows a specific path. The mouth chews and begins digestion. The esophagus is a muscular tube that pushes food down to the stomach using wave-like squeezing motions. The stomach churns and chemically breaks down the food further. From there, it continues to the small intestine, where most nutrients are absorbed into the blood."
```
