...
```yaml
- question: "You are facing your friend. Your friend raises their right hand. Which side does their hand appear to be on from where you are looking?"
  ...
  options:
    ...
    - "Behind you"
  answer: 1
  explanation: "When someone faces you, their right side appears on your left side, and their left appears on your right. This is one of the trickiest things about left and right — it depends on which direction you are facing. Your friend's right hand has not changed, but from your point of view it looks like it is on your left."

- question: "If you turn around, your left hand becomes your right hand."
  type: true-false
  answer: false
  explanation: "Your left hand is always your left hand, no matter which direction you face. Turning around does not switch your hands. Left and right are about your body, not about the room you are in."

- question: "Why is it useful to know the difference between left and right?"
  type: short-answer
  answer: "Knowing left from right helps you follow directions (like 'turn left'), describe where things are ('the ball is to your right'), and do activities like tying shoes, playing sports, and crossing the street safely."
  explanation: "Left and right are basic directions tied to your body. People use them constantly — giving directions, describing locations, playing games, and staying safe. Once a child can reliably tell left from right, many everyday tasks become easier to understand and follow."
```
