...
```yaml
- question: "What does your body do while you sleep?"
  type: multiple-choice
  options:
    - "Nothing — everything shuts off"
    - "It grows, repairs itself, and organizes what you learned during the day"
    - "It stops your heart so it can rest"
    - "It only breathes and does nothing else"
  answer: 1
  explanation: "Your body is very busy while you sleep, even though you are not awake to notice. Your bones and muscles grow, your body fixes any bumps or scrapes, and your brain sorts through everything you learned and experienced that day, storing the important things in your memory."

- question: "Children need about 10 to 12 hours of sleep each night."
  type: true-false
  answer: true
  explanation: "Young children need much more sleep than adults because their bodies and brains are growing so quickly. About 10 to 12 hours of sleep each night gives the body enough time to do all the important repair and growth work it needs to do."

- question: "Why do you feel grumpy or have trouble paying attention when you do not get enough sleep?"
  type: short-answer
  answer: "When you do not get enough sleep, your brain does not have time to finish organizing and resting. This makes it harder to think clearly, pay attention, control your emotions, and remember things. Your body also feels tired because it did not finish repairing itself."
  explanation: "Sleep is not optional — your brain and body depend on it. Without enough sleep, the brain's ability to focus, solve problems, and manage feelings is reduced. The body also misses out on repair and growth time. That is why a bad night of sleep makes everything harder the next day."
```
