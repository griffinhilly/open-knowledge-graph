...
```yaml
- question: "Where is most of your ear located?"
  type: multiple-choice
  options:
    - "On the outside of your head only"
    - "Inside your head where you cannot see it"
    - "Behind your neck"
    - "In your mouth"
  answer: 1
  explanation: "The part of your ear you can see and touch is just the outside part that helps collect sound. Most of your ear — the parts that actually turn sound into messages for your brain — is hidden inside your head, protected by bone."

- question: "Very loud sounds can hurt your ears."
  type: true-false
  answer: true
  explanation: "Very loud sounds really can damage your ears. Inside your ear there are tiny, delicate parts that can be harmed by sounds that are too loud. That is why people wear ear protection near loud machinery, and why you should not put headphones on too loud."

- question: "How does sound get from the air into your brain?"
  type: short-answer
  answer: "Sound travels through the air as vibrations. The outer ear catches the sound and sends it down a tube into the inside of your ear. Inside, tiny parts vibrate and send a message along a nerve to your brain, which figures out what the sound is."
  explanation: "Hearing is a chain of events: sound waves in the air get collected by the outer ear, travel through the ear canal, vibrate tiny structures inside, and those vibrations become signals that travel to the brain. Every step matters — if any part is blocked or damaged, hearing is affected."
```
