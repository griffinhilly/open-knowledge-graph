...
```yaml
- question: "Which of these should you NOT touch without an adult?"
  ...
  options:
    ...
    - "Your pillow"
  answer: 2
  explanation: "Medicine can be very dangerous if you take it without an adult helping you. Even medicine that helps you when you are sick can make you very sick if you take the wrong amount or the wrong kind. Always ask a grown-up before touching or taking any medicine."

- question: "A hot stove can burn you even if you do not touch the flame."
  type: true-false
  answer: true
  explanation: "The surface of a stove, the pots and pans on it, and even the air right above it can be hot enough to burn you. You do not have to touch an actual flame to get burned. That is why it is important to stay away from the stove when it is on and to let adults handle cooking."

- question: "What should you do if you hear a smoke alarm going off at home?"
  type: short-answer
  answer: "Get out of the house right away and go to your family's meeting spot outside. Do not stop to grab toys or belongings. Stay low to the ground if there is smoke. Once you are outside, stay there and wait for a grown-up."
  explanation: "A smoke alarm means there could be a fire, and the most important thing is to get out quickly. Smoke rises, so staying low keeps you below the worst of it. Every family should have a plan for where to meet outside so that everyone can be accounted for. Never go back inside a building that might be on fire."
```
