...
- question: "Which body part do you use for the sense of hearing?"
  ...
  options:
    ...
    - "Your mouth"
  answer: 2
  explanation: "Your ears are for hearing. They pick up sounds — music, voices, birds chirping, everything you hear. Your eyes are for seeing, your nose is for smelling, and your mouth (tongue) is for tasting."

- question: "You use all five senses when you eat an apple."
  type: true-false
  answer: true
  explanation: "When you eat an apple, you see its color (sight), hear the crunch (hearing), smell it (smell), taste it (taste), and feel it in your hand and mouth (touch). Most activities use more than one sense at a time, and eating is a great example of all five working together."

- question: "What are the five senses and which body part goes with each one?"
  type: short-answer
  answer: "Seeing uses your eyes, hearing uses your ears, smelling uses your nose, tasting uses your tongue, and touching uses your skin (especially your hands and fingers)."
  explanation: "Each sense has a special body part that does the job. These five senses are how your body collects information about everything around you — what things look like, sound like, smell like, taste like, and feel like."
```
