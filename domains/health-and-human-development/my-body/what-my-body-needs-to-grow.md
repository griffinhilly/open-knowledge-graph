---
id: what-my-body-needs-to-grow
title: What My Body Needs to Grow
...
```yaml
- question: "What are the three main things your body needs every day to grow well?"
  type: multiple-choice
  options:
    - "TV, candy, and toys"
    - "Nutritious food, plenty of sleep, and regular physical activity"
    - "Only water and sunshine"
    - "Medicine, vitamins, and rest"
  answer: 1
  explanation: "Your body needs nutritious food (for building materials and energy), plenty of sleep (for growth and repair), and regular physical activity (for strong bones and muscles). These three things work together — skipping any one of them slows down how well your body can grow."

- question: "Your body does most of its growing while you are awake and active."
  type: true-false
  answer: false
  explanation: "Your body actually does most of its growing while you are asleep. During deep sleep, your body releases growth hormone, which tells your bones and muscles to grow. That is one of the main reasons children need so much sleep — their bodies are growing rapidly and need that sleeping time to do the work."

- question: "Why does your body need all three — food, sleep, and exercise — not just one or two?"
  type: short-answer
  answer: "Food provides the building materials and energy your body needs. Sleep is when your body actually does most of its growing and repairing. Exercise makes your bones and muscles stronger. Each one does a different job, and your body needs all three working together to grow properly."
  explanation: "Think of building a house: you need materials (food), workers who do the building at night (sleep), and stress-testing to make the structure strong (exercise). If you have materials but no workers, nothing gets built. If you have workers but no materials, they have nothing to work with. Growth requires all three inputs."
```
