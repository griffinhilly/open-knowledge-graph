---
id: stages-of-life
title: 'Baby, Child, Teenager, Adult'
...
```yaml
- question: "Which is the correct order of life stages?"
  type: multiple-choice
  options:
    - "Adult, teenager, child, baby"
    - "Baby, child, teenager, adult"
    - "Child, baby, adult, teenager"
    - "Teenager, adult, baby, child"
  answer: 1
  explanation: "Everyone starts as a baby, grows into a child, becomes a teenager, and then becomes an adult. This order is always the same — you cannot skip a stage or go backward. Each stage lasts a different amount of time, but the order never changes."

- question: "Adults stop changing once they are fully grown."
  type: true-false
  answer: false
  explanation: "Adults keep changing throughout their lives. Their hair may turn gray, their skin may wrinkle, and their bodies continue to change in many ways. Even though adults stop getting taller, their bodies are always changing. Aging is a lifelong process that never completely stops."

- question: "What is one thing that changes as a person goes from being a child to being a teenager?"
  type: short-answer
  answer: "Teenagers get taller and their bodies change shape. They may develop deeper voices, grow more body hair, and go through puberty — a time of big physical changes that prepare the body for adulthood."
  explanation: "The transition from child to teenager involves many physical changes, all part of a process called puberty. These changes happen gradually over several years and happen at different times for different people. Understanding that these changes are normal and expected helps children feel prepared."
```
