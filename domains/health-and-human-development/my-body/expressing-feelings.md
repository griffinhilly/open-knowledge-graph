...
- question: "Which is a healthy way to express anger?"
  ...
  options:
    - "Hitting the person who made you angry"
    - "Keeping it inside and pretending you are not angry"
    - "Saying 'I feel angry because you took my turn'"
...
- question: "Name two things you can do to calm down when you are feeling very angry or upset."
  type: short-answer
  answer: "You can take slow, deep breaths. You can count to ten. You can walk away from the situation for a moment. You can squeeze a stress ball. You can talk to a trusted adult about how you feel. You can draw or write about your feelings."
  explanation: "These are all calming strategies that give your brain a moment to slow down before you react. Strong feelings can make you want to act immediately, but pausing — even for a few seconds — helps you choose a better response. Different strategies work for different people, so it helps to try several and find what works best for you."
```
