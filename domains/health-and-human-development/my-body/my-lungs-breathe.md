...
```yaml
- question: "What does your body take from the air when you breathe in?"
  ...
  options:
    ...
    - "Sunlight"
  answer: 1
  explanation: "When you breathe in, your lungs pull oxygen out of the air. Oxygen is a gas that your body needs to turn food into energy. Without oxygen, your cells cannot do their jobs. That is why breathing is so important — it is how your body gets this essential gas."

- question: "You have three lungs."
  type: true-false
  answer: false
  explanation: "You have two lungs — one on the left side of your chest and one on the right. The left lung is slightly smaller than the right one to make room for your heart. Together, they work to bring oxygen in and push carbon dioxide out every time you breathe."

- question: "What happens to the air you breathe out? How is it different from the air you breathe in?"
  type: short-answer
  answer: "The air you breathe out has less oxygen and more carbon dioxide than the air you breathe in. Your body uses the oxygen and produces carbon dioxide as a waste product, and your lungs get rid of it when you exhale."
  explanation: "Breathing is a two-way exchange. You breathe in air to get oxygen, which your cells need for energy. Your cells use that oxygen and produce carbon dioxide as a byproduct. The blood carries that carbon dioxide back to the lungs, and you breathe it out. It is a continuous cycle — in with oxygen, out with carbon dioxide."
```
