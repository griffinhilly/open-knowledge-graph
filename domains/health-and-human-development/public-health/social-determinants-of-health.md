...
- Acknowledging social determinants does not mean individual behavior is irrelevant; it means behavior is itself shaped by structural conditions.
- 'Social determinants' is not synonymous with poverty alone; the gradient is continuous and affects even middle-income groups relative to higher-income ones.
- Interventions targeting social determinants are not inherently slower or less evidence-based than clinical ones; housing vouchers and income transfers have demonstrated health impacts in trials.

## Questions

```yaml
- question: "Studies consistently show that people in higher income groups live longer and have lower rates of chronic disease than people in middle income groups, who in turn outlive people in lower income groups. What does this pattern most directly demonstrate?"
  type: multiple-choice
  options: ["That poverty causes poor health but wealth has no additional effect above a threshold", "The social gradient in health — a dose-response relationship between socioeconomic position and health that operates continuously across the entire income distribution", "That individual health behaviors explain all health differences between income groups", "That clinical care is the primary driver of health outcomes across income levels"]
  answer: 1
  explanation: "The social gradient describes a stepwise relationship where health improves continuously with socioeconomic position — not just a gap between the poor and everyone else. Even upper-middle-income people have worse health outcomes than the highest-income group. This gradient, observed across virtually every society, is the core empirical signature of social determinants and cannot be explained by access to clinical care alone."

- question: "Recognizing that social determinants shape health outcomes means that individual behavior is not a meaningful target for health improvement."
  type: true-false
  answer: false
  explanation: "This is a common misreading of the social determinants framework. Acknowledging that structural conditions shape behavior does not make individual behavior irrelevant — it contextualizes it. The point is that behavior is itself produced by the environments people live in: food deserts limit dietary choices, chronic stress impairs decision-making, and insecure employment reduces time for exercise. Addressing structural conditions is the most powerful lever, but individual-level interventions remain valuable within that structure."

- question: "Why are social determinants described as 'upstream' causes of health, and what does this metaphor mean for public health strategy?"
  type: short-answer
  answer: "The upstream metaphor refers to root causes that operate earlier in the causal chain — before disease appears. Income, education, and neighborhood conditions shape exposure to risk, access to resources, and chronic stress levels long before a clinical diagnosis. Intervening upstream (e.g., improving housing, increasing income) prevents disease from occurring, whereas downstream clinical care treats it after it has developed. Upstream interventions tend to have larger population-level effects because they shift the entire distribution of risk."
  explanation: "The metaphor comes from a public health parable about rescuing people drowning in a river: at some point you must walk upstream to find out who is pushing them in. Clinical medicine is skilled at pulling people out of the water; social determinants work addresses why they fall in. Both are necessary, but population health depends far more on upstream conditions — which is why GDP and income inequality predict life expectancy better than physician density in cross-national comparisons."
```
