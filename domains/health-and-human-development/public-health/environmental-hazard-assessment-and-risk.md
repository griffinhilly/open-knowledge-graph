...
- question: "A chemical that has been identified as a hazard in animal toxicity studies poses the same health risk to all human populations regardless of their level of exposure to it."
  type: true-false
  answer: false
