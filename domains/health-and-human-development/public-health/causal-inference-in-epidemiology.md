...
- question: "Adjusting for most measured variables that are associated with both the exposure and outcome will eliminate confounding and yield an unbiased causal estimate."
  type: true-false
  answer: false
