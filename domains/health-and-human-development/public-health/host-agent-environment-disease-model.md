...
- question: "Because infectious diseases are driven primarily by the pathogenic properties of the agent, interventions targeting the host or environment are secondary and should primarily be used when agent-targeted treatments (like antibiotics) are unavailable."
  type: true-false
  answer: false
