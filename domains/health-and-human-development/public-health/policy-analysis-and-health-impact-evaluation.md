...
- question: "A well-designed difference-in-differences study establishes causal policy effects without any identifying assumptions, because comparing the same population before and after a policy controls for most pre-existing differences."
  type: true-false
  answer: false
