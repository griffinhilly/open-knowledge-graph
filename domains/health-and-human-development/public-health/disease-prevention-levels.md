...
- Secondary prevention is not the same as treatment; it aims to catch asymptomatic disease before clinical presentation.
- Tertiary prevention is still prevention—it prevents further deterioration and complications, not the original disease.
- 'More prevention is better' is not always true; overscreening has costs including false positives, overdiagnosis, and downstream harms.

## Questions

```yaml
- question: "A community health program offers free colonoscopies to asymptomatic adults over age 50 to detect colorectal polyps before they progress to cancer. This intervention is an example of:"
  type: multiple-choice
  options: ["Primary prevention", "Secondary prevention", "Tertiary prevention", "Primordial prevention"]
  answer: 1
  explanation: "Secondary prevention targets asymptomatic individuals to detect disease (or pre-disease) early, before symptoms appear, in order to interrupt progression. Colonoscopy screening in asymptomatic adults fits this definition precisely. Primary prevention would be reducing risk factors before any pathological change (e.g., promoting a high-fiber diet). Tertiary prevention would be managing colorectal cancer once diagnosed to limit disability. Primordial prevention addresses the social conditions that give rise to risk factors in the first place."

- question: "Tertiary prevention is not truly 'prevention' because it occurs after disease has already developed."
  type: true-false
  answer: false
  explanation: "Tertiary prevention is a genuine and important form of prevention — it prevents further deterioration, disability, and complications in people with established disease. Cardiac rehabilitation after a myocardial infarction prevents a second cardiac event; tight glycemic control in a diabetic patient prevents neuropathy and nephropathy. The word 'prevention' refers to preventing downstream consequences, not the original disease. Conflating 'prevention' with 'stopping disease from occurring at all' is a common error that undervalues this tier of care."

- question: "Why is the claim 'more screening is always better' a misconception in secondary prevention?"
  type: short-answer
  answer: "Screening imposes real costs even when tests are free: false positives trigger unnecessary follow-up procedures with their own risks and harms; overdiagnosis detects conditions (e.g., slow-growing prostate cancers) that would never have caused symptoms, leading to overtreatment; and screening resources spent on low-risk populations may not be cost-effective compared to higher-priority interventions. Screening is beneficial only when the target disease has sufficient prevalence, the test is sensitive and specific enough, effective treatment exists, and benefits outweigh harms in the screened population."
  explanation: "This misconception is common because 'catching things early' sounds intuitively good. The key insight is that screening is a population-level intervention that must be evaluated on net benefit across the entire screened population — including the harms to people who test false-positive or are overdiagnosed."
```
