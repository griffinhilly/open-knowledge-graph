...
- question: "When most four ABCD components (anthropometric, biochemical, clinical, dietary) converge on the same conclusion, the assessment is complete and no further investigation is needed."
  type: true-false
  answer: false
