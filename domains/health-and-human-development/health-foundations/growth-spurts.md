...
- Thinking you can control your adult height through diet or exercise -- while adequate nutrition is necessary for reaching your genetic potential, height is primarily determined by genetics.
- Believing growing pains mean something is wrong -- mild aching in the legs during growth spurts is common and usually harmless.
- Thinking growth continues indefinitely or can be restarted after it stops -- once growth plates fuse (typically by ages 15-17 for girls, 17-19 for boys), further height growth is not possible.

## Questions

```yaml
- question: "Why do growth plates matter for height growth, and what happens when they close?"
  type: multiple-choice
  options:
    - "Growth plates produce hormones that control height"
    - "Growth plates are areas of cartilage at the ends of long bones where new bone is produced; once they harden into solid bone, further height growth stops"
    - "Growth plates are muscles that stretch bones longer"
    - "Growth plates are gaps between bones that fill with calcium"
  answer: 1
  explanation: "Growth plates (epiphyseal plates) are bands of cartilage near the ends of long bones like the femur and tibia. During growth spurts, hormones stimulate these cartilage zones to produce new tissue, which then hardens into bone, lengthening the bone. When puberty hormones eventually cause the cartilage to fully harden (ossify), the growth plates 'close' and the bones can no longer get longer. This is why adults cannot grow taller."

- question: "A 13-year-old boy is shorter than most of his classmates. This means he will probably be shorter than average as an adult."
  type: true-false
  answer: false
  explanation: "Boys typically experience their growth spurt later than girls (around ages 12-16 vs. 10-14). A 13-year-old boy who hasn't hit his growth spurt yet may be temporarily shorter than female classmates who have already had theirs. Many boys who are shorter at 13 end up average height or taller by 18. Comparing heights during puberty is unreliable because everyone is on a different developmental timeline."

- question: "During a growth spurt, some adolescents feel temporarily clumsy or uncoordinated. Why might rapid growth cause this?"
  type: short-answer
  answer: "When bones grow rapidly, the arms and legs get longer quickly. The brain's motor coordination programs were calibrated for a shorter body, so there's a temporary mismatch between the body's new proportions and the brain's movement calculations. The brain adjusts, but it takes time to recalibrate -- during that adjustment period, movements can feel awkward."
  explanation: "This is similar to the experience of trying to drive a car that's a very different size from what you're used to. Your sense of where your body ends in space (proprioception) needs to update after rapid growth. This temporary clumsiness is completely normal and resolves as the nervous system adapts to the new body dimensions."
```
