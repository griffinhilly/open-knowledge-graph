...
- Thinking something is wrong if puberty starts earlier or later than peers -- the normal range spans several years, and early or late onset is usually just normal variation.
- Believing puberty happens all at once -- it's a gradual process that typically takes 2-5 years to complete.
- Thinking only physical changes occur during puberty -- hormonal changes also significantly affect emotions, moods, and social behavior.

## Questions

```yaml
- question: "What triggers the start of puberty?"
  type: multiple-choice
  options:
    - "Eating enough food to reach a certain weight"
    - "Hormones released by the brain signal the body to begin changing"
    - "A specific birthday or age"
    - "Physical exercise and activity levels"
  answer: 1
  explanation: "Puberty begins when the hypothalamus (a part of the brain) starts releasing a hormone called GnRH, which triggers a cascade of other hormones. These hormones signal the body to begin the physical changes of puberty. While nutrition and body weight can influence timing, the trigger is hormonal, not a specific food, age, or activity. This is why puberty starts at different ages for different people -- the brain's timing signal varies."

- question: "If two friends are the same age but one has started puberty and the other hasn't, something is probably wrong with the one who hasn't started yet."
  type: true-false
  answer: false
  explanation: "The normal age range for puberty to begin spans several years (roughly 8-13 for girls, 9-14 for boys). Two kids the same age can be at completely different stages and both be perfectly normal. Puberty timing is influenced by genetics, nutrition, and other factors. Being early or late relative to peers is usually just normal variation, not a sign of a problem."

- question: "Why does puberty cause increased body odor and acne, even though these aren't related to reproductive development?"
  type: short-answer
  answer: "The same hormones that trigger reproductive development also stimulate increased oil production in the skin (leading to acne) and increased sweat production from new types of sweat glands (leading to body odor when bacteria break down the sweat). These are side effects of the hormonal changes driving puberty, not directly related to reproduction but caused by the same hormonal surge."
  explanation: "Puberty hormones (especially androgens) affect many body systems beyond reproduction. They stimulate sebaceous (oil) glands in the skin, producing more oil that can clog pores and cause acne. They also activate apocrine sweat glands (concentrated in the armpits and groin), which produce a thicker sweat that skin bacteria break down into odor-causing compounds. These are normal parts of puberty that require new hygiene habits."
```
