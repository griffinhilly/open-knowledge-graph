...
title: Hydration and Water Needs
...
- Thinking that only plain water counts for hydration -- milk, juice, soup, and water-rich fruits all contribute to fluid intake.
- Believing the "8 glasses a day" rule is a precise scientific recommendation -- actual needs vary by age, activity level, climate, and body size.
- Thinking you should only drink when you feel thirsty -- by the time you feel thirst, you may already be mildly dehydrated.

## Questions

```yaml
- question: "A student drinks very little water during the school day and notices they have a headache and feel tired by afternoon. What is the most likely explanation?"
  type: multiple-choice
  options:
    - "They are getting sick with a cold"
    - "They are mildly dehydrated, which commonly causes headaches and fatigue"
    - "They didn't eat enough protein at lunch"
...
- question: "Why is water considered the most essential nutrient even though it provides zero calories?"
  type: short-answer
  answer: "Water is essential because it is involved in almost every bodily function: transporting nutrients, removing waste, regulating temperature, cushioning joints, and enabling chemical reactions in cells. You can survive weeks without food but only a few days without water, showing that the body's need for water is more urgent than its need for calories."
  explanation: "Calories measure energy, but water enables the processes that use that energy. Without water, cells cannot function, blood cannot flow properly, body temperature cannot be regulated, and waste products build up. Water's role is so fundamental that no amount of food can compensate for its absence."
```
