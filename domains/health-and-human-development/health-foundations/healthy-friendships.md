...
- Thinking real friends never disagree or argue -- conflict is normal in healthy friendships; what matters is how conflict is handled.
- Believing you should change who you are to keep friends -- a friend who requires you to be someone you're not is exhibiting an unhealthy dynamic.
- Thinking having more friends is always better -- the quality of friendships matters far more than the quantity for well-being.

## Questions

```yaml
- question: "Which of the following best describes a healthy friendship?"
  type: multiple-choice
  options:
    - "Friends who never disagree about anything"
    - "Friends who always do what you want to do"
    - "Friends who respect each other, can disagree without cruelty, and support each other's well-being"
    - "Friends who are always together and never spend time apart"
  answer: 2
  explanation: "Healthy friendships are defined by mutual respect, trust, and support -- not by the absence of disagreement or constant togetherness. Friends in healthy relationships can disagree, have different opinions, spend time apart, and pursue separate interests without the friendship being threatened. The key markers are that both people feel respected, valued, and free to be themselves."

- question: "If a friend regularly makes you feel bad about yourself, pressures you to do things you're uncomfortable with, and gets angry when you spend time with other people, this is a normal part of friendship."
  type: true-false
  answer: false
  explanation: "This pattern describes an unhealthy, potentially controlling friendship. Regular put-downs erode self-esteem. Pressure to act against your values or comfort level disrespects your autonomy. Jealousy about other friendships is possessive, not caring. While occasional friction is normal in any relationship, a consistent pattern of these behaviors is a warning sign. A friend who genuinely cares about you wants you to feel good about yourself, respects your boundaries, and supports your other relationships."

- question: "Why is conflict in a friendship not necessarily a bad sign, and how can you tell the difference between healthy conflict and a toxic pattern?"
  type: short-answer
  answer: "Conflict is normal because two separate people will naturally have different opinions, needs, and preferences. In healthy conflict, both people listen to each other, express feelings without attacking, work toward resolution, and the friendship feels stronger afterward. In a toxic pattern, one person dominates, uses insults or threats, refuses to acknowledge the other's feelings, and the conflicts leave you feeling worse about yourself over time."
  explanation: "The distinction is between conflict as a healthy process (disagreement → listening → understanding → resolution) and conflict as a weapon (disagreement → attacks → manipulation → submission). Healthy conflict actually strengthens relationships by building trust and communication skills. Toxic conflict weakens self-esteem and teaches unhealthy relational patterns. The key question is: after a disagreement, do both people feel heard and respected, or does one person feel diminished?"
```
