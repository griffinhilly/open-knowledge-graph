...
- Thinking the reproductive system is completely separate from other body systems -- it interacts with the endocrine (hormonal), circulatory, and nervous systems.
- Believing menstruation is a sign of illness or something unclean -- it is a normal, healthy biological process that occurs roughly monthly.
- Confusing the reproductive and urinary systems -- while some structures are shared or adjacent, the two systems have different functions.
...
- question: "What is the primary function of the ovaries in the female reproductive system?"
  ...
  options:
    ...
    - "To produce eggs (ova) and reproductive hormones like estrogen"
    - "To store nutrients for a developing baby"
    - "To produce breast milk"
  answer: 1
  explanation: "The ovaries have two main functions: producing egg cells (ova) and producing the hormones estrogen and progesterone. These hormones drive the development of female secondary sex characteristics during puberty and regulate the menstrual cycle. The ovaries release roughly one mature egg per month during a woman's reproductive years."

- question: "The reproductive system is the only organ system that is not necessary for an individual's own survival."
  type: true-false
  answer: true
  explanation: "Unlike the circulatory, respiratory, nervous, and digestive systems -- which you need to stay alive -- the reproductive system's primary purpose is to enable the creation of new individuals, not to maintain the life of the person who has it. You can survive perfectly well without a functional reproductive system (as is the case before puberty, or after surgical removal of reproductive organs). This makes it unique among the major organ systems."

- question: "Why does menstruation (a monthly period) occur, and what does it indicate about the reproductive cycle?"
  type: short-answer
  ...
  explanation: "Menstruation is the visible end of a roughly 28-day hormonal cycle. Rising estrogen causes the uterine lining to thicken. After ovulation (egg release), if the egg is not fertilized within about 24 hours, hormone levels drop, the thickened lining is no longer maintained, and it sheds over 3-7 days. The cycle then restarts. Understanding this process demystifies menstruation as a normal, predictable biological event."
```
