...
- Thinking calories are a substance in food rather than a unit of energy measurement.
- Believing all calories are equal regardless of source -- 100 calories of candy and 100 calories of vegetables have the same energy but very different nutritional value and effects on fullness.
- Thinking you only burn calories during exercise -- your body uses most of its calories just keeping organs running.

## Questions

```yaml
- question: "Fat provides 9 calories per gram while carbohydrates provide 4 calories per gram. If you eat 10 grams of fat and 10 grams of carbohydrates, how many total calories have you consumed?"
  type: multiple-choice
  options: ["40 calories", "90 calories", "130 calories", "140 calories"]
  answer: 2
