...
- Thinking that juice counts the same as whole fruit (juice lacks fiber and is easy to overconsume).
- Believing that potatoes are vegetables in the same nutritional sense as leafy greens (they are starchy vegetables, closer to grains nutritionally).
- Assuming "balanced" means equal portions of every food group -- the groups are intentionally unequal in recommended amounts.

## Questions

```yaml
- question: "A student's lunch is a turkey sandwich on white bread with a glass of milk. Which food group is missing from this meal?"
  type: multiple-choice
  options: ["Grains", "Protein", "Fruits or vegetables", "Dairy"]
  answer: 2
  explanation: "The sandwich has grains (bread) and protein (turkey), and the milk covers dairy. What's missing is any fruit or vegetable. A balanced meal according to MyPlate should have fruits and vegetables filling about half the plate. Adding an apple or carrot sticks would complete this meal."

- question: "A balanced diet means eating exactly the same amount of food from each of the five food groups."
  type: true-false
  answer: false
  explanation: "The five food groups are not meant to be eaten in equal amounts. MyPlate shows that fruits and vegetables should make up about half your plate, grains about a quarter, and protein about a quarter, with a side of dairy. The proportions differ because your body needs different amounts of the nutrients each group provides."

- question: "Why are foods organized into groups instead of just listing individual foods you should eat?"
  type: short-answer
  answer: "Foods within the same group provide similar types of nutrients, so grouping them helps people make substitutions and build variety. Instead of memorizing hundreds of individual foods, you can learn the five groups and choose different foods within each group to get the nutrients you need."
  explanation: "The grouping system works because nutritional similarity within groups means any fruit can partially substitute for another fruit, any protein for another protein, and so on. This makes planning a balanced diet practical rather than requiring a rigid food list."
```
