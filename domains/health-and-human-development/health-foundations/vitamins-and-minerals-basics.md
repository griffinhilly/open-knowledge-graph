...
title: Vitamins and Minerals Basics
...
- Thinking that taking vitamin pills is just as good as eating healthy food -- whole foods contain fiber, water, and combinations of nutrients that pills cannot replicate.
- Believing that more vitamins is always better -- some vitamins (especially A and D) can be harmful in excess.
- Assuming all vitamins do the same thing -- each vitamin has specific roles, and they are not interchangeable.

## Questions

```yaml
- question: "Why can't you just take a multivitamin pill and eat whatever you want?"
  type: multiple-choice
  options:
    - "Pills are too expensive to take every day"
    - "Whole foods provide fiber, water, and nutrient combinations that pills cannot replicate"
    - "Vitamins from pills are chemically different from vitamins in food"
    - "Your body cannot absorb vitamins from pills"
  answer: 1
...
- question: "Name two vitamins or minerals and explain what each one helps your body do."
  type: short-answer
  answer: "Examples: Calcium helps build and maintain strong bones and teeth. Iron helps red blood cells carry oxygen throughout the body. Vitamin C helps heal wounds and fight infections. Vitamin D helps your body absorb calcium for bone strength."
  explanation: "Each vitamin and mineral has specific roles in the body. Calcium is structural (bones/teeth), iron is functional (oxygen transport), vitamin C supports the immune system and tissue repair, and vitamin D enables calcium absorption. Understanding these specific roles explains why eating a variety of foods matters -- no single food provides everything."
```
