...
- Thinking bullying is just "kids being kids" or normal childhood behavior -- bullying causes real psychological harm and is not a normal or healthy part of development.
- Believing the target should just "ignore it and it will stop" -- ignoring doesn't address the power imbalance, and many bullying situations escalate without intervention.
- Thinking cyberbullying is less serious than physical bullying -- cyberbullying can follow the target everywhere (home, school, sleep) and has been linked to serious mental health consequences.

## Questions

```yaml
- question: "What distinguishes bullying from a normal conflict between two people?"
  type: multiple-choice
  options:
    - "Bullying involves physical contact; normal conflict doesn't"
    - "Bullying involves a power imbalance, is intentional, and is repeated over time; normal conflict is between equals and usually resolves"
    - "Bullying only happens at school; conflicts can happen anywhere"
    - "Bullying is always done by older students to younger students"
  answer: 1
  explanation: "Three key features distinguish bullying from normal conflict: (1) a power imbalance -- the person bullying has some advantage (physical size, social status, numbers) over the target, (2) intent to harm -- the behavior is deliberate, not accidental, and (3) repetition -- it happens multiple times, not as an isolated incident. Normal conflicts between peers of roughly equal power, even when heated, are not bullying -- they're a natural part of social interaction."

- question: "The best advice for someone being bullied is to just ignore the bully and they'll stop."
  type: true-false
  answer: false
  explanation: "While not reacting to provocation can sometimes be one component of a response, 'just ignore it' alone is insufficient and often ineffective. Bullying involves a power imbalance, and the target alone often cannot change the dynamic. Effective responses typically require adult intervention, bystander support, and sometimes changes to the environment. Telling targets to 'just ignore it' places the burden entirely on the person being harmed rather than addressing the behavior of the person causing harm."

- question: "Why do bystanders play such an important role in bullying situations, and what can a bystander do to help?"
  type: short-answer
  answer: "Bystanders play a crucial role because bullying often occurs in social settings where the bully is performing for an audience. When bystanders remain silent or laugh along, they inadvertently reinforce the behavior. When bystanders speak up, support the target, or report the behavior to an adult, they shift the social dynamic and can stop the bullying. Specific actions include saying 'that's not okay,' inviting the target to join their group, refusing to share hurtful content online, and reporting to a trusted adult."
  explanation: "Research shows that bullying stops within 10 seconds when a bystander intervenes in 57% of cases. Bystanders have more power than they realize because bullying is fundamentally a social behavior -- it thrives on an audience. An upstander (a bystander who takes action) doesn't need to be physically confrontational; even small acts like changing the subject, including the target in conversation, or privately telling an adult can be effective."
```
