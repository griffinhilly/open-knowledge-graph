...
title: How Body Systems Connect
...
- Thinking each organ system is self-contained and independent -- every system relies on inputs from other systems.
- Believing the brain controls everything directly -- many body system interactions happen automatically through chemical signals, hormones, and local feedback loops.
- Assuming that disease in one organ system stays contained to that system -- a problem in the circulatory system (like anemia) affects oxygen delivery to every other system.

## Questions

```yaml
- question: "A person with severe anemia (too few red blood cells) feels tired, short of breath, and has weak muscles. Why does a blood problem affect so many different body functions?"
  type: multiple-choice
  options:
    - "Red blood cells produce energy for muscles directly"
    - "Without enough red blood cells, oxygen delivery to all tissues is reduced, impairing every system that needs oxygen to function"
    - "Anemia destroys muscle and lung tissue"
    - "The brain shuts down all other systems when blood is low"
  answer: 1
...
- question: "Explain how at least three different body systems must work together when you eat and digest a meal."
  type: short-answer
