...
builds-toward:
  ...
  - neural-anatomy-and-organization
...
- Thinking the brain controls everything consciously -- many essential functions (heartbeat, digestion, breathing) are managed automatically by parts of the brain you're not aware of.
- Believing reflexes are processed by the brain -- most reflexes are spinal cord responses that happen before the brain even receives the signal.
- Thinking nerve signals travel at the speed of light -- they're fast (up to 270 mph) but much slower than light, which is why reaction time exists.

## Questions

```yaml
- question: "When you accidentally touch a hot pan, you pull your hand away before you even feel the pain. How is this possible?"
  type: multiple-choice
  options:
    - "Your hand has its own brain that makes decisions"
    - "The signal takes a shortcut through the spinal cord (a reflex) rather than traveling all the way to the brain first"
    - "You actually do feel the pain first, but you forget because it happens so fast"
    - "Your muscles react to heat directly without any nerve signals"
  answer: 1
...
- question: "Explain why reaction time exists -- why can't you respond to something instantly, the moment you see or feel it?"
  type: short-answer
  answer: "Reaction time exists because nerve signals, while fast, are not instantaneous. A signal must travel from the sensory receptor (like the eyes) along nerves to the brain, the brain must process the information and decide on a response, and then a motor signal must travel from the brain through nerves to the muscles. Each step takes a small amount of time, and the total adds up to measurable reaction time."
  explanation: "Nerve impulses travel at 30-270 mph depending on the nerve fiber -- fast, but not instant. Processing in the brain adds more time. The total delay (typically 150-300 milliseconds for visual stimuli) is why a batter can't wait until the ball is at the plate to decide whether to swing -- the ball arrives in less time than the full sensory-processing-motor chain requires."
```
