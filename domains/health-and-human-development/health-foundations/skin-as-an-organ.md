...
- Not recognizing skin as an organ -- many students think organs must be internal (heart, lungs, stomach) and don't consider skin in the same category.
- Thinking tanned skin is healthier than untanned skin -- tanning is actually the skin's damage response to UV radiation.
- Believing that the outer layer of skin you can see is alive -- the outermost cells of the epidermis are actually dead, forming a protective barrier that is constantly shed and replaced from below.

## Questions

```yaml
- question: "Why is skin classified as an organ rather than just a covering?"
  type: multiple-choice
  options:
    - "Because it's very large"
    - "Because it contains multiple tissue types working together to perform specific functions"
    - "Because it's on the outside of the body"
    - "Because it grows throughout your life"
  answer: 1
  explanation: "An organ is defined as a structure made of multiple tissue types that work together to perform specific functions. Skin contains epithelial tissue (outer barrier), connective tissue (support), nerve tissue (sensation), and muscle tissue (hair erection). These tissues collaborate to protect, regulate temperature, sense the environment, and produce vitamin D. Size and location are irrelevant -- what makes it an organ is the organized teamwork of different tissues."

- question: "A suntan is a sign that your skin is healthy and well-protected from the sun."
  type: true-false
  answer: false
  explanation: "A suntan is actually a damage response. When UV radiation from the sun hits your skin, cells called melanocytes produce extra melanin (a dark pigment) to try to protect deeper skin layers from further UV damage. The tan itself is evidence that damage has already occurred. Repeated UV damage increases the risk of skin cancer and accelerates skin aging. Sunscreen protects skin more effectively than tanning does."

- question: "How does your skin help regulate your body temperature when you are overheating?"
  type: short-answer
  answer: "Sweat glands in the dermis release sweat onto the skin surface. As the sweat evaporates, it absorbs heat from the skin and cools the body down. Blood vessels in the dermis also dilate (widen), bringing more warm blood near the skin surface where heat can escape into the surrounding air."
  explanation: "The skin uses two complementary cooling mechanisms. Evaporative cooling (sweating) is highly effective -- this is why humid days feel hotter, because high humidity slows evaporation. Vasodilation (widening blood vessels) radiates heat outward. These mechanisms work together to prevent overheating during exercise or in hot environments. When you're cold, the opposite happens: blood vessels constrict to conserve heat and tiny muscles make hairs stand up (goosebumps)."
```
