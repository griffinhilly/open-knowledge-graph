...
title: "Macronutrients: Carbohydrates, Protein, and Fat"
...
- Believing fat is always bad -- dietary fat is essential for brain function, vitamin absorption, and energy storage. The issue is the type and amount, not fat itself.
- Thinking carbohydrates are only in sweet or starchy foods -- fruits, vegetables, and milk all contain carbohydrates.
- Assuming protein only comes from meat -- beans, lentils, eggs, nuts, and dairy are all significant protein sources.

## Questions

```yaml
- question: "A student says 'I'm cutting out all fat from my diet to be healthier.' Why is this a bad idea?"
  type: multiple-choice
  options:
    - "Fat tastes good, so removing it makes food boring"
    - "Your body needs fat to absorb certain vitamins, protect organs, and store energy"
    - "Fat is the only source of calories in food"
    - "Without fat, carbohydrates stop working"
  answer: 1
...
- question: "What is the main role of protein in your body, and why does this make it especially important for growing children?"
  type: short-answer
  answer: "Protein provides amino acids that your body uses to build and repair tissues like muscle, skin, and organs. Growing children need extra protein because they are constantly building new tissue as they get taller and bigger, not just repairing what they already have."
  explanation: "Protein's primary role is structural -- it builds and maintains body tissues. While adults mainly need protein for repair and maintenance, children and teens are actively growing, which means they need protein both for maintaining existing tissue and for constructing entirely new tissue. This is why protein needs per pound of body weight are higher in childhood than in adulthood."
```
