...
- Thinking mindfulness means clearing your mind of all thoughts -- it actually means noticing your thoughts without getting caught up in them. A clear mind is not the goal; awareness is.
- Believing relaxation techniques should work immediately the first time -- like any skill, they improve with regular practice over weeks.
- Thinking mindfulness is only for people who are stressed or anxious -- it benefits everyone by improving focus, emotional regulation, and self-awareness.

## Questions

```yaml
- question: "During a mindfulness exercise, a student finds their mind keeps wandering to what they're having for lunch. They feel like they're failing at mindfulness. Are they?"
  type: multiple-choice
  options:
    - "Yes -- successful mindfulness means thinking about nothing"
    - "No -- noticing that the mind has wandered and gently bringing attention back IS the practice of mindfulness"
    - "Yes -- they should try harder to force their mind to stay focused"
    - "No -- mindfulness doesn't require any attention at all"
  answer: 1
...
- question: "How does deep breathing physically counteract the body's stress response?"
  type: short-answer
  answer: "Deep, slow breathing activates the parasympathetic nervous system, which is the 'rest and digest' counterpart to the fight-or-flight response. Specifically, slow exhalation stimulates the vagus nerve, which signals the heart to slow down, lowers blood pressure, and reduces stress hormone levels. This directly reverses the physical symptoms of the stress response."
  explanation: "This connects the nervous system topic to practical application. The autonomic nervous system has two branches: sympathetic (fight-or-flight, activated by stress) and parasympathetic (rest-and-digest, activated by relaxation). Deep breathing is one of the few voluntary actions that can shift the balance from sympathetic to parasympathetic activation, making it a powerful, portable, and free stress management tool."
```
