...
title: "Germs: Bacteria and Viruses"
...
- Thinking all bacteria are harmful -- the vast majority of bacteria are harmless or beneficial; only a small fraction cause disease.
- Believing antibiotics can treat viral infections like colds or flu -- antibiotics only work against bacteria, and misusing them contributes to antibiotic resistance.
- Confusing bacteria and viruses as the same thing -- they differ fundamentally in size, structure, whether they're alive, and how they're treated.

## Questions

```yaml
- question: "A student has the flu and asks their doctor for antibiotics. Why would a good doctor refuse this request?"
  type: multiple-choice
  options:
    - "Antibiotics are too expensive for the flu"
    - "The flu is caused by a virus, and antibiotics only work against bacteria"
    - "Doctors prefer to let all illnesses heal naturally"
    - "Antibiotics would make the flu worse"
  answer: 1
