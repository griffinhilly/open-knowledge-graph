...
- Thinking stress is always bad -- moderate stress (eustress) improves performance and motivation. The goal is managing stress, not eliminating it entirely.
- Believing strong people don't feel stressed -- everyone experiences stress; resilience is about managing it effectively, not about not feeling it.
- Thinking coping strategies must eliminate the stressor -- sometimes you can't change the situation, and managing your emotional response is the healthiest option.

## Questions

```yaml
- question: "A student has a big test tomorrow. Their heart is racing, palms are sweaty, and they feel energized but anxious. What is causing these physical symptoms?"
  type: multiple-choice
  options:
    - "They are getting sick from studying too much"
    - "The stress response is releasing hormones like adrenaline that prepare the body for action"
    - "They drank too much caffeine"
    - "Anxiety is a purely mental experience with no physical effects"
  answer: 1
