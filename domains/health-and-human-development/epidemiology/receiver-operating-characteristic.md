...
- question: "A diagnostic test with a higher AUC than a competing test should generally be preferred clinically, regardless of the specific sensitivity and specificity at the chosen threshold."
  type: true-false
  answer: false
