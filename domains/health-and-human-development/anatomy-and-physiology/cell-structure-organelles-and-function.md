...
- question: "Most eukaryotic cells contain the same organelles in roughly the same proportions — differences between cell types arise from gene expression, not from organelle number or abundance."
  type: true-false
  answer: false
