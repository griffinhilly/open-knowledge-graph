...
- question: "In endocrine axes, negative feedback from the effector hormone acts mainly at the hypothalamus (suppressing releasing hormone), not at the anterior pituitary."
  type: true-false
  answer: false
