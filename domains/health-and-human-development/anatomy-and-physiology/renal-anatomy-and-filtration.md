...
title: Renal Anatomy and Nephron Function
...
- The kidneys do not merely 'filter waste'; they precisely regulate blood volume, osmolarity, pH, electrolyte composition, and erythropoietin production.
- Glucose is not normally lost in urine — it is completely reabsorbed; glucosuria indicates that blood glucose has exceeded the renal threshold (as in diabetes).

## Questions

```yaml
- question: "The kidneys filter approximately 180 liters of plasma per day, yet only about 1.5 liters is excreted as urine. What happens to the remaining ~178.5 liters?"
  type: multiple-choice
  options: ["It is excreted as sweat and water vapor", "It is reabsorbed into the bloodstream through the nephron tubules", "It is stored temporarily in the bladder and released gradually", "It is converted to metabolic water by cellular respiration"]
  answer: 1
...
- question: "Glucose is normally detectable in urine because the kidneys cannot reabsorb all of the glucose that is filtered from the blood."
  type: true-false
  answer: false
