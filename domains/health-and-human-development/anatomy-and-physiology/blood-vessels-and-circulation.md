...
title: Blood Vessel Anatomy and Circulatory Dynamics
...
- Arteries do not always carry oxygenated blood — the pulmonary artery carries deoxygenated blood.
- High blood pressure is not merely a 'stress' condition; it is a consequence of altered vascular resistance, cardiac output, and fluid volume.

## Questions

```yaml
- question: "According to Poiseuille's Law, if an arteriole's radius is reduced by half (e.g., due to vasoconstriction), by what factor does resistance to blood flow increase?"
  type: multiple-choice
  options: ["2-fold", "4-fold", "8-fold", "16-fold"]
  answer: 3
...
- question: "Why are capillaries, rather than arteries or veins, the primary site of gas and nutrient exchange with tissues?"
  type: short-answer
  answer: "Capillaries have walls only one cell thick (simple squamous endothelium), blood moves slowly through them maximizing contact time, and their enormous total cross-sectional area provides vast surface for diffusion. Arteries and veins have thick walls that block exchange, and blood moves too quickly through them."
  explanation: "Exchange efficiency depends on diffusion distance, contact time, and surface area. Capillaries optimize all three: minimal wall thickness minimizes diffusion distance, slow velocity maximizes contact time, and the vast capillary network provides enormous surface area. Thick-walled arteries would block diffusion entirely."
```
