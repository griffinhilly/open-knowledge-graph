...
title: Tissue Types and Histology
...
- Blood is a connective tissue, which surprises most students who think of connective tissue as solid structural material.
- 'Smooth' vs. 'skeletal' vs. 'cardiac' muscle are not just locations — they have fundamentally different cellular architecture and control mechanisms.

## Questions

```yaml
- question: "Which of the following is correctly classified as a connective tissue?"
  type: multiple-choice
  options: ["The epithelial lining of the small intestine", "Blood", "The wall of the urinary bladder (smooth muscle)", "Neurons in the cerebral cortex"]
  answer: 1
...
- question: "Why is simple squamous epithelium found lining the alveoli and capillaries rather than a thicker, multi-layered epithelium?"
  type: short-answer
  answer: "Simple squamous epithelium consists of a single layer of extremely thin, flat cells, which minimizes the diffusion distance for gases and nutrients. Thicker or multi-layered epithelia would increase diffusion distance and slow the exchange of oxygen, carbon dioxide, and nutrients between blood and tissues — defeating the purpose of those structures."
