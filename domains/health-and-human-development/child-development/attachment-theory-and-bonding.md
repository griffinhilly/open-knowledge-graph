...
title: Attachment Theory and Early Bonding
...
- Secure attachment does not require perfection from caregivers — 'good enough' responsiveness, including repair after misattunement, predicts secure attachment.
- Attachment is not the same as love or bonding; it is a specific behavioral system with observable patterns.
- Disorganized attachment is not simply 'bad parenting'; it often reflects caregiver trauma or fear that disrupts normal attachment signaling.

## Questions

```yaml
- question: "In Ainsworth's Strange Situation, an infant who shows intense distress at separation, is difficult to soothe on reunion, and simultaneously seeks and resists contact with the returning caregiver is classified as:"
...
- question: "What is Bowlby's concept of an 'internal working model,' and how does it explain why early attachment patterns might influence adult relationships?"
  type: short-answer
