...
title: Social-Emotional Development in Toddlerhood
...
- Tantrums are not manipulative behavior in most toddlers — they reflect genuine dysregulation due to immature neural circuits.
- Saying 'no' and asserting autonomy is a healthy developmental achievement, not defiance to be suppressed.
- Empathy is not fully formed in toddlerhood; it is emerging and undifferentiated, easily overwhelmed by egocentric distress.

## Questions

```yaml
- question: "The 'rouge test' — placing a mark on a child's face and showing them a mirror — is used to assess which developmental milestone?"
  type: multiple-choice
  options: ["Object permanence", "Stranger anxiety", "Objective self-concept", "Prosocial behavior"]
  answer: 2
  explanation: "When a child touches their own face (rather than the mirror image) upon seeing the mark, they demonstrate that they recognize the reflection as themselves — they have developed an *objective self-concept*, a representation of themselves as a distinct, observable entity. This emerges around 18–24 months. Object permanence appears much earlier; stranger anxiety is an emotional, not self-representational, milestone; prosocial behavior is assessed through interactions with others."

- question: "Toddler tantrums are primarily strategic behavior — the child is deliberately manipulating caregivers to get what they want."
  type: true-false
  answer: false
  explanation: "Most toddler tantrums reflect genuine emotional dysregulation, not deliberate manipulation. Toddlers have strong desires and developing but limited language, while their prefrontal cortex — responsible for impulse control and emotion regulation — is highly immature. When overwhelmed by frustration they cannot communicate or regulate, they become genuinely dysregulated. The behavior decreases as language and frontal development mature, which is inconsistent with the strategic account."

- question: "What role does secure attachment play in a toddler's developing capacity for emotion regulation?"
  type: short-answer
  answer: "Securely attached toddlers experience repeated co-regulation with a responsive caregiver who helps them down-regulate intense emotions. Over time, these co-regulatory experiences are internalized as self-regulatory strategies. Insecurely attached toddlers have fewer such experiences and tend to show less effective self-regulation."
  explanation: "Emotion regulation is not developed in isolation — it is scaffolded by the caregiver relationship. Each time a responsive caregiver soothes an overwhelmed toddler, the child both calms in the moment and, across many repetitions, internalizes strategies for managing distress. This is the mechanism connecting the attachment relationship studied earlier to the self-regulation capacities that emerge across toddlerhood and beyond."
```
