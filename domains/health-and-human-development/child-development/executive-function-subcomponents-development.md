...
title: Executive Function Subcomponents Development
...
```yaml
- question: "A 4-year-old is taught to sort cards by color, then told to switch and sort by shape. She can state the new rule out loud but keeps sorting by color anyway. Which executive function subcomponent is primarily responsible for this failure?"
  type: multiple-choice
  options:
    - "Working memory — she cannot hold the new rule in mind while sorting"
    - "Cognitive flexibility — she cannot shift her mental set to apply the new rule even though she knows it"
    - "Inhibitory control — she cannot suppress the urge to reach for the cards"
    - "Sustained attention — she loses focus before completing each sort"
  answer: 1
  explanation: "This is the classic DCCS (Dimensional Change Card Sort) finding. The child can verbally state the new rule — so working memory is intact enough to represent it — but cognitive flexibility is immature: she cannot redirect her behavioral response to the new rule. The disconnect between knowing a rule and being able to act on it is the defining signature of immature cognitive flexibility. Inhibitory control (answer C) would be the culprit if she was grabbing cards impulsively, not perseverating on the old rule."

- question: "Which sequence correctly describes the typical developmental order of executive function subcomponents from earliest to latest emerging?"
  type: multiple-choice
  options:
    ...
    - "All three develop simultaneously during the preschool period"
  answer: 2
  explanation: "Inhibitory control shows measurable improvement between ages 2–3, making it the earliest-developing subcomponent. Working memory shows steep gains through the preschool and early school years. Cognitive flexibility develops more slowly, continuing to mature into adolescence. This staggered timeline reflects different rates of prefrontal cortex maturation across regions and circuits."

- question: "A 3-year-old who fails the day/night task (saying 'day' for a moon card) does so because she doesn't understand what the words 'day' and 'night' mean."
  type: true-false
  answer: false
  explanation: "Three-year-olds typically understand the word meanings — they can demonstrate this in other contexts. The failure reflects immature inhibitory control: the prepotent response (naming what the picture depicts) overrides the rule they have just been told. This is why the task is diagnostic: the child knows the rule but cannot suppress the competing automatic response. Interpreting the failure as a vocabulary problem misses the executive function explanation."

- question: "A child with primarily impaired inhibitory control and a child with primarily impaired working memory will show different behavioral profiles, even though both have executive function deficits."
  type: true-false
  answer: true
  explanation: "Executive function is not a single dial. A child with impaired inhibitory control appears impulsive, distractible, and reactive — acting before thinking. A child with impaired working memory appears forgetful, unable to follow multi-step instructions, and loses the thread of what she was doing. These profiles suggest different interventions: reducing distractors and practicing inhibition for the first child; using checklists and breaking tasks into smaller steps for the second."

- question: "Why is it important to identify which executive function subcomponent is impaired in a particular child, rather than simply noting that 'executive function is poor'?"
  type: short-answer
  answer: "Because inhibitory control, working memory, and cognitive flexibility are dissociable — they develop at different rates, are supported by overlapping but distinct neural circuits, and respond to different interventions. A child whose main difficulty is working memory overload needs environmental scaffolding (checklists, chunked instructions); a child whose main difficulty is inhibitory control needs cue reduction and practice suppressing prepotent responses. Treating EF as a single capacity leads to generic interventions that miss the specific constraint."
  explanation: "The dissociability of EF subcomponents also explains why different developmental and clinical profiles (ADHD, autism, prematurity, TBI) produce different patterns of difficulty rather than a uniform 'EF deficit.' Understanding the three-way structure of EF is prerequisite to both accurate assessment and targeted support."
```
