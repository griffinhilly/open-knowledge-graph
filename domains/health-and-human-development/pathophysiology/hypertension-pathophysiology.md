...
- question: "White-coat hypertension — elevated blood pressure readings that occur only in clinical settings — carries no cardiovascular risk because blood pressure is normal outside the clinic."
  type: true-false
  answer: false
