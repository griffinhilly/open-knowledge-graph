...
- question: "The therapeutic goal in sepsis is typically to reduce inflammation as aggressively as possible throughout the entire clinical course, since the immune response is uniformly harmful."
  type: true-false
  answer: false
