...
- Not every detail in a historical painting is symbolic — iconographic overreading is as much a mistake as missing real symbols.
- Iconographic meaning is culturally specific and changes across time; a symbol does not carry the same meaning in every context.

## Questions

```yaml
- question: "A scholar identifies that a figure in a 15th-century altarpiece holds a set of keys and concludes that the figure is Saint Peter, then asks what this tells us about the patron's theology and the painting's social function. Which of Panofsky's levels does this final interpretive step represent?"
  type: multiple-choice
  options:
    - "Pre-iconographic description, because the scholar is describing what is depicted"
    - "Iconographic analysis, because the scholar identified the keys as a conventional attribute"
    - "Iconological interpretation, because the scholar is reading the image as a document of cultural and social meaning"
    - "Stylistic analysis, because the scholar is connecting the painting to its historical period"
  answer: 2
