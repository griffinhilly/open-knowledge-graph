...
- The vanishing point is not always in the center of the page — it can be far off to one side, creating a dramatic angle.
- Vertical lines remain perfectly vertical in one-point perspective; only horizontal receding edges converge.

## Questions

```yaml
- question: "In a one-point perspective drawing of a hallway, what happens to the lines representing the top and bottom edges of the walls as they recede into the distance?"
  type: multiple-choice
  options: ["They remain parallel to the horizon line", "They converge toward the single vanishing point", "They curve slightly inward", "They remain vertical"]
  answer: 1
...
- question: "What does the position of the horizon line tell you about a one-point perspective drawing?"
  type: short-answer
  answer: "The horizon line represents the viewer's eye level. A low horizon line means the viewer is near the ground (a worm's-eye view), a high horizon line means the viewer is elevated (a bird's-eye view), and a midpoint horizon line represents a standing viewer. The horizon line's position fundamentally changes the mood and spatial logic of the scene."
  explanation: "Because the horizon line corresponds to eye level, all compositional decisions — where objects sit relative to the viewer, how much of a surface's top or bottom is visible — flow from its placement. Moving the horizon line is one of the most powerful compositional controls in perspective drawing."
```
