...
- Beginners grip the pencil too tightly near the tip, reducing control and causing cramping. Hold it further back for fluid strokes.
- 'Drawing' is not the same as 'tracing' — marks communicate gesture and decision, not just outline.

## Questions

```yaml
- question: "Which combination of variables most directly controls the character of a drawn mark?"
  type: multiple-choice
  options:
    - "Paper size, pencil brand, and room lighting"
    - "Pressure, speed, and direction of the stroke"
    - "The subject being drawn and the artist's experience level"
    - "Whether the artist is sitting or standing"
  answer: 1
  explanation: "Pressure determines line weight and darkness; speed affects smoothness and energy (slow strokes are more controlled, fast strokes are more fluid); direction determines the angle and taper of the mark. These three variables are the fundamental controls available to any mark-maker, regardless of tool or subject."

- question: "Holding the pencil close to the tip, as you would when writing, gives you the most control for drawing."
  type: true-false
  answer: false
  explanation: "This is the most common beginner error. Gripping close to the tip tightens the wrist and reduces the range of motion, producing stiff, cramped marks. Holding the pencil further back engages the whole arm and allows fluid, varied strokes. Writing grip is optimized for small, precise letterforms — not for the larger, more gestural marks that drawing requires."

- question: "What is the practical difference between making a deliberate mark and tracing an outline?"
  type: short-answer
  answer: "A deliberate mark carries information about pressure, speed, direction, and intent — it can indicate gesture, weight, texture, or light. Tracing only copies an existing edge without the drawer making observational or expressive decisions. Drawing develops the ability to translate perception and intention into marks; tracing bypasses that translation entirely."
  explanation: "Tracing can reproduce shapes but cannot develop the hand-eye coordination, decision-making, or expressive range that drawing requires. A traced line is passive; a drawn mark is active — it results from looking, deciding, and moving with intention. This is why copying from life builds skill in a way that tracing does not."
```
