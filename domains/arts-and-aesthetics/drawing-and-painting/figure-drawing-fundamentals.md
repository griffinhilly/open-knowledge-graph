...
- Anatomical memorization is less important than accurate observation. Anatomy knowledge helps interpret what you see, but does not replace looking.
- Beginners draw heads too large — this is a near-universal error. Actively check head-to-body proportions with sighting.

## Questions

```yaml
- question: "In the classical proportion system, the adult human figure is approximately how many heads tall?"
  ...
  options:
    ...
    - "Ten heads"
  answer: 2
  explanation: "The classical canon — used since antiquity and codified in Renaissance treatises — sets the ideal adult figure at seven to eight heads tall. This is also the proportion used in academic figure drawing today. Beginners typically draw heads that are too large relative to the body, effectively placing the figure at five or six heads — which reads as childlike."

- question: "Memorizing anatomical structures is the most important skill for becoming a strong figure drawer."
  type: true-false
  answer: false
  explanation: "This is a common misconception. Accurate observation is more fundamental than anatomical memorization. Anatomy knowledge helps you interpret and correct what you see — you notice when a shoulder looks wrong because you know where the deltoid attaches — but a figure drawer who observes carefully will outperform one who has memorized anatomy but stopped looking at the model."

- question: "Why do figure drawing instructors typically ask students to begin every pose with a 30-second gesture rather than immediately working out the proportions?"
  type: short-answer
  answer: "The gesture captures the overall movement, weight, and rhythm of the pose before detail work begins. Starting with proportions or anatomy risks producing a stiff, correct-but-lifeless figure. The gesture establishes the living quality of the pose that all subsequent work should preserve."
  explanation: "Gesture drawing trains the eye and hand to see and record the large dynamic forces of a pose — the tilt of hips against shoulders, the flow of weight through the spine — rather than fixating on parts. Working from large-to-small (gesture first, then proportion, then detail) prevents the 'assembled parts' error where anatomically correct pieces fail to read as a living figure."
```
