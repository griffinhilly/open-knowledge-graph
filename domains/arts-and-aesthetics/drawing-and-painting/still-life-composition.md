...
title: Still Life Drawing and Composition
...
- Randomly placing objects on a table and drawing whatever is there is not composition. The artist must actively arrange objects to create visual relationships.
- Beginning with outlines and then filling in tone produces flat-looking work. Work from tone masses first, then refine edges.
