...
title: 'Aesthetics and Philosophy of Art: Introduction'
...
```yaml
- question: "Which of the following questions falls within the scope of philosophical aesthetics?"
  type: multiple-choice
  options: ["How do I paint a realistic portrait?", "What makes something count as a work of art at all?", "Which artist sold the most paintings in the 19th century?", "How do I develop my personal taste in music?"]
  answer: 1
  explanation: "The question 'What makes something count as art?' is a foundational question in the philosophy of art (ontology of art). The other options are practical, historical, or personal-development questions that fall outside philosophical aesthetics. Aesthetics is concerned with the conceptual and normative underpinnings of art and aesthetic experience, not technique or market history."

- question: "Aesthetics, as a philosophical discipline, is primarily concerned with identifying which artworks are beautiful."
  type: true-false
  answer: false
  explanation: "This is the most common misconception about aesthetics. While beauty is one topic within aesthetics, the discipline is much broader: it addresses the definition of art, the nature and validity of aesthetic judgments, the relationship between art and morality, the role of the artist's intention, the ontological status of artworks, and aesthetic experience in general. Reducing it to 'identifying what is beautiful' confuses aesthetics with taste-evaluation."

- question: "What distinguishes a philosophical question about art from a merely personal opinion about art?"
  type: short-answer
  answer: "Philosophical questions about art aim at general, justified claims that apply across cases — such as what conditions must be met for something to be art, or whether aesthetic judgments can be objectively valid. Personal opinions are individual preferences without that generality or justification requirement. Aesthetics demands argument, counterexample, and conceptual clarity, not just expression of taste."
  explanation: "This distinction connects directly to philosophy-intro: philosophy seeks reasoned, generalizable claims rather than merely expressing preferences. Aesthetics applies that rigor to questions about art, beauty, and perception."
```
