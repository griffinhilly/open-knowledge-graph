...
- 'Font' and 'typeface' are often used interchangeably, but a typeface is the design family (e.g., Helvetica) while a font is a specific weight and size instance.
- More typefaces in a design does not mean more interest — it usually means visual noise.
- Justified text always looks 'professional': poorly justified text creates distracting word-spacing rivers.
