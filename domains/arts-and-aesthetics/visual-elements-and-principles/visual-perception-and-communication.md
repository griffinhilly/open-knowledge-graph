...
title: Visual Perception and Communication
...
- Assuming visual communication is objective or universal—in reality, cultural context, personal experience, and expectations fundamentally shape perception.
- Thinking that designers can completely control how audiences perceive their work—viewers always bring their own interpretations.

## Questions

```yaml
- question: "A designer notices that viewers' eyes consistently move to the brightest area of a poster before reading the headline. What principle best explains this?"
  type: multiple-choice
  options: ["Viewers have been trained by advertising to look at bright areas", "The visual system is biologically tuned to detect high-contrast regions as potentially important", "The headline font is too small relative to the bright area", "Cultural conventions dictate that brightness signals importance"]
  answer: 1
...
- question: "In what sense can a designer 'guide' viewer perception without fully controlling it?"
  type: short-answer
  answer: "Designers can use contrast, placement, hierarchy, and visual cues to direct where the eye goes and in what order — but viewers always bring prior knowledge, cultural context, and personal associations that shape the meaning they ultimately construct."
