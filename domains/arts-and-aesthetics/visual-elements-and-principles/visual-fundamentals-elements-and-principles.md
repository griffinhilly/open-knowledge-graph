...
title: 'Visual Fundamentals: Elements and Principles'
...
- spatial-awareness-depth-on-flat-surfaces
...
```yaml
- question: "Which of the following is a visual PRINCIPLE rather than a visual ELEMENT?"
  type: multiple-choice
  options: ["Color", "Texture", "Balance", "Line"]
  answer: 2
  explanation: "Color, texture, and line are all elements — the raw building blocks of a composition. Balance is a principle — a strategy for organizing those elements. Elements are what you use; principles describe how you arrange them to achieve an effect."

- question: "Visual elements and visual principles are two names for the same set of concepts."
  type: true-false
  answer: false
  explanation: "They are distinct categories. Elements (line, shape, form, color, value, texture, space) are the basic components that make up any visual composition — the 'what.' Principles (balance, contrast, emphasis, movement, pattern, rhythm, unity) are guidelines for organizing those components effectively — the 'how.' Conflating them leads to confusion when analyzing or creating art."

- question: "What is the relationship between visual elements and visual principles, and why do you need both?"
  type: short-answer
  answer: "Elements are the raw materials of visual art (line, shape, color, etc.); principles are the strategies for organizing those materials to communicate effectively (balance, contrast, etc.). Elements alone produce raw material; principles turn that material into composition."
  explanation: "You could have all the elements present in a work — lines, shapes, colors — and still produce a chaotic or incoherent image if you ignore the principles. The principles describe the relationships between elements: how much contrast exists between values, whether shapes balance each other across the picture plane, what draws the eye first. Understanding both layers is what allows someone to move from 'I drew some things' to 'I made a composition.'"
```
