...
title: Color Relationships and Harmony
...
- Complementary colors always clash — actually when one is dominant and one is an accent, they create dynamic energy without clashing.
- More colors always means richer art; in practice, limiting the palette to a clear scheme produces more coherent results.

## Questions

```yaml
- question: "A painter wants to create a composition that feels energetic and vibrant but not chaotic. She chooses blue-green as her main color. Which harmony scheme gives her the most dynamic contrast while keeping the palette manageable?"
  type: multiple-choice
  options:
    - "Analogous (blue, blue-green, green)"
    - "Complementary (blue-green and red-orange)"
    - "Split-complementary (blue-green, red, orange)"
    - "Monochromatic (shades of blue-green only)"
  answer: 2
...
- question: "Why does choosing a color scheme at the beginning of a work guide subsequent decisions more effectively than selecting colors one at a time?"
  type: short-answer
  answer: "A scheme defines a relational system: every color is chosen for its relationship to the others, ensuring automatic harmony. Adding colors one by one without a system risks accumulating combinations that each seemed fine individually but create incoherence together."
  explanation: "Color harmony is a relational property — it depends on how colors interact, not on any single color's intrinsic quality. A scheme commits you to a set of relationships (complementary tension, analogous cohesion, triadic balance) that then constrain subsequent choices productively. Without that commitment, each addition introduces new relationships that may conflict with earlier ones, and the palette drifts. Working within a scheme is a creative constraint that makes decisions easier and outcomes more coherent."
```
