...
title: Composition and Visual Organization
...
- Thinking composition is about symmetrical, centered arrangements—many effective compositions are asymmetrical and off-center.
- Assuming good composition happens by accident—in reality, it's typically intentional, planned, and refined through iteration.

## Questions

```yaml
- question: "Which of the following best explains how a designer creates a clear focal point in a composition?"
  type: multiple-choice
  options:
    - "By centering the most important element and surrounding it with symmetrical elements"
    - "By placing the most important element in the exact center of the frame"
    - "By giving the focal element higher visual weight through contrast, size, or isolation relative to its surroundings"
    - "By repeating the focal element multiple times so the viewer cannot miss it"
  answer: 2
  explanation: "A focal point is created by contrast — the focal element must differ from its surroundings in some meaningful visual property (size, color, value, texture, isolation). Centering works in some contexts but is not the defining mechanism. Repetition of an element actually distributes attention rather than concentrating it."

- question: "Symmetrical compositions are inherently stronger and more professional than asymmetrical ones."
  type: true-false
  answer: false
  explanation: "Symmetry creates balance but can also produce static, predictable compositions with limited visual energy. Many of the most effective compositions in art and design are asymmetrical — they distribute visual weight unevenly to create tension, movement, and interest. The goal is effective communication, not adherence to a symmetry rule."

- question: "How does visual weight influence the path a viewer's eye takes through a composition?"
  type: short-answer
  answer: "Elements with higher visual weight (larger size, higher contrast, bright or saturated colors, complex textures, or human faces) attract the eye first. By deliberately distributing visual weight, a designer can sequence what the viewer sees — drawing attention to the focal point first, then guiding it through secondary and supporting elements in an intentional order."
  explanation: "The eye does not move randomly through a composition. It is drawn to elements with the most visual weight, then moves to the next most prominent, following a path determined by how weight is distributed and balanced. Understanding this allows designers to sequence information and control narrative order within a single image."
```
