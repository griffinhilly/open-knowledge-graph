...
- Lines don't only appear as drawn marks; implied lines (a row of dots, a pointing finger) are equally powerful in guiding the eye.
- Thicker lines don't always mean more important — context and contrast determine emphasis.

## Questions

```yaml
- question: "An artist draws a horizon with long, unbroken horizontal lines. What emotional quality does this most likely convey?"
  type: multiple-choice
  options: ["Tension and instability", "Calm and stability", "Energy and movement", "Aggression and chaos"]
  answer: 1
  explanation: "Horizontal lines are associated with calm and stability because they echo the horizon and a resting body. Diagonal lines convey tension and movement; vertical lines suggest strength and activity."

- question: "A row of evenly spaced dots creates an implied line that can guide the viewer's eye just as effectively as a drawn line."
  type: true-false
  answer: true
  explanation: "Implied lines — formed by dots, glances, pointing fingers, or aligned edges — are a real and powerful compositional tool. The eye connects them automatically, making them as directionally effective as explicit drawn marks."

- question: "Why might an artist vary line weight (thickness) within a single drawing rather than keeping all lines uniform?"
  type: short-answer
  answer: "Varying line weight creates hierarchy, depth, and emphasis — thicker lines can bring edges forward or suggest shadow, while thinner lines recede, giving the composition a sense of dimension and guiding the viewer's attention."
  explanation: "Uniform line weight flattens a drawing. By making outlines heavier where objects overlap or where the artist wants focus, and lighter for background or subtle details, line weight functions like volume and depth cues without any shading."
```
