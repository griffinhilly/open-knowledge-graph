...
- Shadows are simply black or dark gray — shadows contain reflected light and often show color.
- The darkest dark is always in the shadow — the core shadow is darkest, but reflected light lifts values within the shadow zone.

## Questions

```yaml
- question: "Which term describes the shadow an object throws onto surrounding surfaces — distinct from the shadow on the object itself?"
